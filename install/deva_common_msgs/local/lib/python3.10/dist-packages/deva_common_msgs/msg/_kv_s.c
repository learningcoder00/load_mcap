...
bool deva_common_msgs__msg__kv__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_common_msgs.msg._kv.KV", full_classname_dest, 27) == 0);
  }
  deva_common_msgs__msg__KV * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of KV */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_common_msgs.msg._kv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KV");
