...
class Metaclass_Header(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from deva_common_msgs.msg import String
...
class Header(metaclass=Metaclass_Header):
    ...
    _fields_and_field_types = {
        ...
        'pub_stamp': 'builtin_interfaces/Time',
        'index': 'uint32',
        'frame_id': 'deva_common_msgs/String',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['deva_common_msgs', 'msg'], 'String'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from builtin_interfaces.msg import Time
        self.pub_stamp = kwargs.get('pub_stamp', Time())
    ...
    def __eq__(self, other):
        ...
        if self.stamp != other.stamp:
            return False
        if self.pub_stamp != other.pub_stamp:
            return False
    ...
    @builtins.property
    def pub_stamp(self):
        """Message field 'pub_stamp'."""
        return self._pub_stamp

    @pub_stamp.setter
    def pub_stamp(self, value):
        if __debug__:
            from builtin_interfaces.msg import Time
            assert \
                isinstance(value, Time), \
                "The 'pub_stamp' field must be a sub message of type 'Time'"
        self._pub_stamp = value
