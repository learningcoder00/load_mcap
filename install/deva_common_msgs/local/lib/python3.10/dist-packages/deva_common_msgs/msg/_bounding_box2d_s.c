...
bool deva_common_msgs__msg__bounding_box2d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_common_msgs.msg._bounding_box2d.BoundingBox2d", full_classname_dest, 50) == 0);
  }
  deva_common_msgs__msg__BoundingBox2d * ros_message = _ros_message;
  {  // x
...
PyObject * deva_common_msgs__msg__bounding_box2d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_common_msgs.msg._bounding_box2d");
