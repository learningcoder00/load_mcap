...
deva_common_msgs__msg__KV__init(deva_common_msgs__msg__KV * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->key)) {
    deva_common_msgs__msg__KV__fini(msg);
    return false;
  }
  // value
...
deva_common_msgs__msg__KV__create()
{
  ...
  deva_common_msgs__msg__KV * msg = (deva_common_msgs__msg__KV *)allocator.allocate(sizeof(deva_common_msgs__msg__KV), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_common_msgs__msg__KV));
  bool success = deva_common_msgs__msg__KV__init(msg);
  if (!success) {
...
deva_common_msgs__msg__KV__Sequence__init(deva_common_msgs__msg__KV__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_common_msgs__msg__KV * data = NULL;

  if (size) {
    data = (deva_common_msgs__msg__KV *)allocator.zero_allocate(size, sizeof(deva_common_msgs__msg__KV), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_common_msgs__msg__KV__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_common_msgs__msg__KV__fini(&data[i - 1]);
      }
...
deva_common_msgs__msg__KV__Sequence__fini(deva_common_msgs__msg__KV__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_common_msgs__msg__KV__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_common_msgs__msg__KV__Sequence * array = (deva_common_msgs__msg__KV__Sequence *)allocator.allocate(sizeof(deva_common_msgs__msg__KV__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_common_msgs__msg__KV__Sequence__init(array, size);
  if (!success) {
...
deva_common_msgs__msg__KV__Sequence__destroy(deva_common_msgs__msg__KV__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_common_msgs__msg__KV__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_common_msgs__msg__KV__Sequence__are_equal(const deva_common_msgs__msg__KV__Sequence * lhs, const deva_common_msgs__msg__KV__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_common_msgs__msg__KV__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_common_msgs__msg__KV__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_common_msgs__msg__KV);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_common_msgs__msg__KV * data =
      (deva_common_msgs__msg__KV *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_common_msgs__msg__KV__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_common_msgs__msg__KV__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_common_msgs__msg__KV__copy(
