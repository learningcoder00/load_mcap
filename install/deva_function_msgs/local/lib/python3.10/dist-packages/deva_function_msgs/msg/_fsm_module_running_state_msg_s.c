...
bool deva_function_msgs__msg__fsm_module_running_state_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_function_msgs.msg._fsm_module_running_state_msg.FsmModuleRunningStateMsg", full_classname_dest, 77) == 0);
  }
  deva_function_msgs__msg__FsmModuleRunningStateMsg * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FsmModuleRunningStateMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_function_msgs.msg._fsm_module_running_state_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FsmModuleRunningStateMsg");
