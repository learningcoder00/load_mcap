...
bool deva_planning_msgs__msg__planning_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._planning_trajectory.PlanningTrajectory", full_classname_dest, 62) == 0);
  }
  deva_planning_msgs__msg__PlanningTrajectory * ros_message = _ros_message;
  {  // path_type
    ...
    ros_message->path_type = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // trajectory_points
    ...
    if (!deva_planning_msgs__msg__TrajectoryPoint__Sequence__init(&(ros_message->trajectory_points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs__msg__TrajectoryPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs__msg__TrajectoryPoint * dest = ros_message->trajectory_points.data;
  ...
  {  // curve
    ...
    if (!deva_common_msgs__msg__equation_curve__convert_from_py(field, &ros_message->curve)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // stop_pose
    ...
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->stop_pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // vehicle_gear
    PyObject * field = PyObject_GetAttrString(_pymsg, "vehicle_gear");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->vehicle_gear = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // circle_center
    PyObject * field = PyObject_GetAttrString(_pymsg, "circle_center");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->circle_center)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PlanningTrajectory */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._planning_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanningTrajectory");
  ...
  {  // path_type
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->path_type);
    {
  ...
  {  // curve
    PyObject * field = NULL;
    field = deva_common_msgs__msg__equation_curve__convert_to_py(&ros_message->curve);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // stop_pose
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->stop_pose);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // vehicle_gear
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->vehicle_gear);
    {
      int rc = PyObject_SetAttrString(_pymessage, "vehicle_gear", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // circle_center
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->circle_center);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "circle_center", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
