...
bool deva_planning_msgs__msg__path_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._path_data.PathData", full_classname_dest, 42) == 0);
  }
  deva_planning_msgs__msg__PathData * ros_message = _ros_message;
  {  // x
...
PyObject * deva_planning_msgs__msg__path_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._path_data");
