...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__VEHICLE_STATUS__FUNCTIONS_H_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__VEHICLE_STATUS__FUNCTIONS_H_
 ...
 * calls
 * deva_planning_msgs__msg__VehicleStatus__init().
...
/**
 * It calls
 * deva_planning_msgs__msg__VehicleStatus__fini()
 ...
 * deva_planning_msgs__msg__VehicleStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * deva_planning_msgs__msg__VehicleStatus__Sequence__fini()
 * on the array,
...
#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__VEHICLE_STATUS__FUNCTIONS_H_
