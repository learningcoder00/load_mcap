...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__AVP_NAVIGATION_PLANNING_DEBUG_INFO__TRAITS_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__AVP_NAVIGATION_PLANNING_DEBUG_INFO__TRAITS_HPP_
...
#include "deva_planning_msgs/msg/detail/avp_debug_info__traits.hpp"
// Member 'nav_openspace_debug_info'
#include "deva_planning_msgs/msg/detail/nav_openspace_debug_info__traits.hpp"
...
inline void to_yaml(
  const deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo & msg)
{
  return deva_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo>()
{
  return "deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo";
}

template<>
inline const char * name<deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo>()
{
  return "deva_planning_msgs/msg/AvpNavigationPlanningDebugInfo";
}

template<>
struct has_fixed_size<deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo>
  : std::integral_constant<bool, has_fixed_size<deva_planning_msgs::msg::AvpDebugInfo>::value && has_fixed_size<deva_planning_msgs::msg::NavOpenspaceDebugInfo>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo>
  : std::integral_constant<bool, has_bounded_size<deva_planning_msgs::msg::AvpDebugInfo>::value && has_bounded_size<deva_planning_msgs::msg::NavOpenspaceDebugInfo>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<deva_planning_msgs::msg::AvpNavigationPlanningDebugInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__AVP_NAVIGATION_PLANNING_DEBUG_INFO__TRAITS_HPP_
