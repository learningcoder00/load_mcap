...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__VEHICLE_STATUS__STRUCT_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__VEHICLE_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs__msg__VehicleStatus __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs__msg__VehicleStatus __declspec(deprecated)
#endif
...
struct VehicleStatus_
{
  ...
  // pointer types
  using RawPtr =
    deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs__msg__VehicleStatus
    std::shared_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs__msg__VehicleStatus
    std::shared_ptr<deva_planning_msgs::msg::VehicleStatus_<ContainerAllocator> const>
...
using VehicleStatus =
  deva_planning_msgs::msg::VehicleStatus_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__VEHICLE_STATUS__STRUCT_HPP_
