...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__STITCH_DATA__TRAITS_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__STITCH_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const deva_planning_msgs::msg::StitchData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs::msg::StitchData & msg)
{
  return deva_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs::msg::StitchData>()
{
  return "deva_planning_msgs::msg::StitchData";
}

template<>
inline const char * name<deva_planning_msgs::msg::StitchData>()
{
  return "deva_planning_msgs/msg/StitchData";
}

template<>
struct has_fixed_size<deva_planning_msgs::msg::StitchData>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<deva_planning_msgs::msg::StitchData>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<deva_planning_msgs::msg::StitchData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__STITCH_DATA__TRAITS_HPP_
