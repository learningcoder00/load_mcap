...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__AVP_REF_LINE_TREE_POINT__STRUCT_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__AVP_REF_LINE_TREE_POINT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs__msg__AvpRefLineTreePoint __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs__msg__AvpRefLineTreePoint __declspec(deprecated)
#endif
...
struct AvpRefLineTreePoint_
{
  ...
  // pointer types
  using RawPtr =
    deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs__msg__AvpRefLineTreePoint
    std::shared_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs__msg__AvpRefLineTreePoint
    std::shared_ptr<deva_planning_msgs::msg::AvpRefLineTreePoint_<ContainerAllocator> const>
...
using AvpRefLineTreePoint =
  deva_planning_msgs::msg::AvpRefLineTreePoint_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__AVP_REF_LINE_TREE_POINT__STRUCT_HPP_
