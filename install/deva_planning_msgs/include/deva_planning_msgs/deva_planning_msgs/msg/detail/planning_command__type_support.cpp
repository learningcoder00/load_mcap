...
{
  new (message_memory) deva_planning_msgs::msg::PlanningCommand(_init);
}

void PlanningCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs::msg::PlanningCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PlanningCommand_message_member_array[7] = {
  {
    ...
    offsetof(deva_planning_msgs::msg::PlanningCommand, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::PlanningCommand, action),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::PlanningCommand, cruise_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::PlanningCommand, park_slot_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::PlanningCommand, park_out_direction),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::PlanningCommand, lane_width),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::PlanningCommand, function),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PlanningCommand_message_members = {
  ...
  7,  // number of fields
  sizeof(deva_planning_msgs::msg::PlanningCommand),
...
{
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PlanningCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs, msg, PlanningCommand)() {
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PlanningCommand_message_type_support_handle;
}
