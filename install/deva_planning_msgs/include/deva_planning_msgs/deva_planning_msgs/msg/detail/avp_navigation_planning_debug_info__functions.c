...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__init(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(msg);
    return false;
  }
  // planning_header
  ...
  // avp_debug_info
  if (!deva_planning_msgs__msg__AvpDebugInfo__init(&msg->avp_debug_info)) {
    deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(msg);
    return false;
  }
  // nav_openspace_debug_info
  if (!deva_planning_msgs__msg__NavOpenspaceDebugInfo__init(&msg->nav_openspace_debug_info)) {
    deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(msg);
    return false;
  }
  return true;
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * msg)
{
  ...
  // avp_debug_info
  deva_planning_msgs__msg__AvpDebugInfo__fini(&msg->avp_debug_info);
  // nav_openspace_debug_info
  deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(&msg->nav_openspace_debug_info);
}
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__are_equal(const deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * lhs, const deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * rhs)
{
  ...
  // avp_debug_info
  if (!deva_planning_msgs__msg__AvpDebugInfo__are_equal(
      &(lhs->avp_debug_info), &(rhs->avp_debug_info)))
  {
    return false;
  }
  // nav_openspace_debug_info
  if (!deva_planning_msgs__msg__NavOpenspaceDebugInfo__are_equal(
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__create()
{
  ...
  deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * msg = (deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo *)allocator.allocate(sizeof(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo));
  bool success = deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__init(msg);
  if (!success) {
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence__init(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * data = NULL;

  if (size) {
    data = (deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo *)allocator.zero_allocate(size, sizeof(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(&data[i - 1]);
      }
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence__fini(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * array = (deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence *)allocator.allocate(sizeof(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence__init(array, size);
  if (!success) {
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence__destroy(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence__are_equal(const deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * lhs, const deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo * data =
      (deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_planning_msgs__msg__AvpNavigationPlanningDebugInfo__copy(
