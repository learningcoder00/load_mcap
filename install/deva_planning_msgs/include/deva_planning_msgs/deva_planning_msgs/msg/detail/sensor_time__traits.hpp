...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__SENSOR_TIME__TRAITS_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__SENSOR_TIME__TRAITS_HPP_
...
inline void to_yaml(
  const deva_planning_msgs::msg::SensorTime & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs::msg::SensorTime & msg)
{
  return deva_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs::msg::SensorTime>()
{
  return "deva_planning_msgs::msg::SensorTime";
}

template<>
inline const char * name<deva_planning_msgs::msg::SensorTime>()
{
  return "deva_planning_msgs/msg/SensorTime";
}

template<>
struct has_fixed_size<deva_planning_msgs::msg::SensorTime>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<deva_planning_msgs::msg::SensorTime>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<deva_planning_msgs::msg::SensorTime>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__SENSOR_TIME__TRAITS_HPP_
