...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__init(deva_planning_msgs__msg__NavOpenspaceDebugInfo * msg)
{
  ...
  if (!rosidl_runtime_c__double__Sequence__init(&msg->xy_bounds, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // obstacles_info
  if (!deva_planning_msgs__msg__NavOpenspaceObstacle__Sequence__init(&msg->obstacles_info, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // parking_slots
  if (!deva_planning_msgs__msg__NavOpenspaceParkingSlot__Sequence__init(&msg->parking_slots, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // start_gear
  ...
  // timestamp
  // ref_points
  if (!deva_planning_msgs__msg__PathData__Sequence__init(&msg->ref_points, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // openspace_planning_status
  // last_trajectory
  if (!deva_planning_msgs__msg__TargetTrajectory__init(&msg->last_trajectory)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // last_trajectory_timestamp
  // last_internal_trajectory_paths
  if (!deva_planning_msgs__msg__TargetTrajectory__Sequence__init(&msg->last_internal_trajectory_paths, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // current_path_index
  // is_arrived_path_end
  // last_ref_points
  if (!deva_planning_msgs__msg__PathData__Sequence__init(&msg->last_ref_points, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // hybrid_astar_search_results
  if (!deva_planning_msgs__msg__TargetTrajectory__Sequence__init(&msg->hybrid_astar_search_results, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  // optimization_results
  if (!deva_planning_msgs__msg__TargetTrajectory__Sequence__init(&msg->optimization_results, 0)) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(msg);
    return false;
  }
  return true;
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(deva_planning_msgs__msg__NavOpenspaceDebugInfo * msg)
{
  ...
  // obstacles_info
  deva_planning_msgs__msg__NavOpenspaceObstacle__Sequence__fini(&msg->obstacles_info);
  // parking_slots
  deva_planning_msgs__msg__NavOpenspaceParkingSlot__Sequence__fini(&msg->parking_slots);
  // start_gear
  // speed
  // keep_start_gear_distance
  // kappa
  // timestamp
  // ref_points
  deva_planning_msgs__msg__PathData__Sequence__fini(&msg->ref_points);
  // openspace_planning_status
  // last_trajectory
  deva_planning_msgs__msg__TargetTrajectory__fini(&msg->last_trajectory);
  // last_trajectory_timestamp
  // last_internal_trajectory_paths
  deva_planning_msgs__msg__TargetTrajectory__Sequence__fini(&msg->last_internal_trajectory_paths);
  // current_path_index
  // is_arrived_path_end
  // last_ref_points
  deva_planning_msgs__msg__PathData__Sequence__fini(&msg->last_ref_points);
  // hybrid_astar_search_results
  deva_planning_msgs__msg__TargetTrajectory__Sequence__fini(&msg->hybrid_astar_search_results);
  // optimization_results
  deva_planning_msgs__msg__TargetTrajectory__Sequence__fini(&msg->optimization_results);
}
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__are_equal(const deva_planning_msgs__msg__NavOpenspaceDebugInfo * lhs, const deva_planning_msgs__msg__NavOpenspaceDebugInfo * rhs)
{
  ...
  // obstacles_info
  if (!deva_planning_msgs__msg__NavOpenspaceObstacle__Sequence__are_equal(
      &(lhs->obstacles_info), &(rhs->obstacles_info)))
  {
    return false;
  }
  // parking_slots
  if (!deva_planning_msgs__msg__NavOpenspaceParkingSlot__Sequence__are_equal(
  ...
  // ref_points
  if (!deva_planning_msgs__msg__PathData__Sequence__are_equal(
  ...
  // last_trajectory
  if (!deva_planning_msgs__msg__TargetTrajectory__are_equal(
  ...
  // last_internal_trajectory_paths
  if (!deva_planning_msgs__msg__TargetTrajectory__Sequence__are_equal(
  ...
  deva_planning_msgs__msg__NavOpenspaceDebugInfo * output)
{
  ...
  // obstacles_info
  if (!deva_planning_msgs__msg__NavOpenspaceObstacle__Sequence__copy(
      &(input->obstacles_info), &(output->obstacles_info)))
  {
    return false;
  }
  // parking_slots
  if (!deva_planning_msgs__msg__NavOpenspaceParkingSlot__Sequence__copy(
  ...
  // ref_points
  if (!deva_planning_msgs__msg__PathData__Sequence__copy(
  ...
  // last_internal_trajectory_paths
  if (!deva_planning_msgs__msg__TargetTrajectory__Sequence__copy(
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__create()
{
  ...
  deva_planning_msgs__msg__NavOpenspaceDebugInfo * msg = (deva_planning_msgs__msg__NavOpenspaceDebugInfo *)allocator.allocate(sizeof(deva_planning_msgs__msg__NavOpenspaceDebugInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_planning_msgs__msg__NavOpenspaceDebugInfo));
  bool success = deva_planning_msgs__msg__NavOpenspaceDebugInfo__init(msg);
  if (!success) {
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence__init(deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__NavOpenspaceDebugInfo * data = NULL;

  if (size) {
    data = (deva_planning_msgs__msg__NavOpenspaceDebugInfo *)allocator.zero_allocate(size, sizeof(deva_planning_msgs__msg__NavOpenspaceDebugInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_planning_msgs__msg__NavOpenspaceDebugInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(&data[i - 1]);
      }
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence__fini(deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * array = (deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence *)allocator.allocate(sizeof(deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence__init(array, size);
  if (!success) {
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence__destroy(deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence__are_equal(const deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * lhs, const deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_planning_msgs__msg__NavOpenspaceDebugInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_planning_msgs__msg__NavOpenspaceDebugInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_planning_msgs__msg__NavOpenspaceDebugInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_planning_msgs__msg__NavOpenspaceDebugInfo * data =
      (deva_planning_msgs__msg__NavOpenspaceDebugInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_planning_msgs__msg__NavOpenspaceDebugInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_planning_msgs__msg__NavOpenspaceDebugInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_planning_msgs__msg__NavOpenspaceDebugInfo__copy(
