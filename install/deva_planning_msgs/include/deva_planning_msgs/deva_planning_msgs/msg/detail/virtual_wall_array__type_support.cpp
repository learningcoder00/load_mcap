...
{
  new (message_memory) deva_planning_msgs::msg::VirtualWallArray(_init);
}

void VirtualWallArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs::msg::VirtualWallArray *>(message_memory);
  typed_message->~VirtualWallArray();
}

size_t size_function__VirtualWallArray__virtual_wall_array(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs::msg::VirtualWall> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs::msg::VirtualWall> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs::msg::VirtualWall> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs::msg::VirtualWall *>(
    get_const_function__VirtualWallArray__virtual_wall_array(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs::msg::VirtualWall *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<deva_planning_msgs::msg::VirtualWall *>(
    get_function__VirtualWallArray__virtual_wall_array(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs::msg::VirtualWall *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VirtualWallArray_message_member_array[3] = {
  {
    ...
    offsetof(deva_planning_msgs::msg::VirtualWallArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::VirtualWallArray, num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs::msg::VirtualWall>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::VirtualWallArray, virtual_wall_array),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VirtualWallArray_message_members = {
  ...
  3,  // number of fields
  sizeof(deva_planning_msgs::msg::VirtualWallArray),
...
{
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::VirtualWallArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs, msg, VirtualWallArray)() {
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::VirtualWallArray_message_type_support_handle;
}
