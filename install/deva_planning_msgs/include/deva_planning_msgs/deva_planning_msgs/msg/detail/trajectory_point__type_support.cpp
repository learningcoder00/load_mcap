...
{
  new (message_memory) deva_planning_msgs::msg::TrajectoryPoint(_init);
}

void TrajectoryPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs::msg::TrajectoryPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryPoint_message_member_array[6] = {
  {
    ...
    offsetof(deva_planning_msgs::msg::TrajectoryPoint, path_point),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::TrajectoryPoint, v),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::TrajectoryPoint, a),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::TrajectoryPoint, relative_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::TrajectoryPoint, da),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::TrajectoryPoint, steer),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryPoint_message_members = {
  ...
  6,  // number of fields
  sizeof(deva_planning_msgs::msg::TrajectoryPoint),
...
get_message_type_support_handle<deva_planning_msgs::msg::TrajectoryPoint>()
{
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs, msg, TrajectoryPoint)() {
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
