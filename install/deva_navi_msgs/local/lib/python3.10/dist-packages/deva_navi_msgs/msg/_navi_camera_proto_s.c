...
bool deva_navi_msgs__msg__navi_sub_camera_proto__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_navi_msgs__msg__navi_camera_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._navi_camera_proto.NaviCameraProto", full_classname_dest, 53) == 0);
  }
  deva_navi_msgs__msg__NaviCameraProto * ros_message = _ros_message;
  {  // coord_3d
    PyObject * field = PyObject_GetAttrString(_pymsg, "coord_3d");
    if (!field) {
      return false;
    }
    if (!deva_navi_msgs__msg__coord3_d_double_proto__convert_from_py(field, &ros_message->coord_3d)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // distance_to_end
    ...
    assert(PyLong_Check(field));
    ros_message->distance_to_end = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // sub_cameras
    PyObject * field = PyObject_GetAttrString(_pymsg, "sub_cameras");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sub_cameras'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_navi_msgs__msg__NaviSubCameraProto__Sequence__init(&(ros_message->sub_cameras), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_navi_msgs__msg__NaviSubCameraProto__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_navi_msgs__msg__NaviSubCameraProto * dest = ros_message->sub_cameras.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_navi_msgs__msg__navi_sub_camera_proto__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // penalty
    ...
    assert(PyLong_Check(field));
    ros_message->penalty = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // id
  ...
  {  // is_hidden
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_hidden");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_hidden = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of NaviCameraProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._navi_camera_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NaviCameraProto");
  ...
  {  // coord_3d
    PyObject * field = NULL;
    field = deva_navi_msgs__msg__coord3_d_double_proto__convert_to_py(&ros_message->coord_3d);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "coord_3d", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // distance_to_end
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->distance_to_end);
    {
  ...
  {  // sub_cameras
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->sub_cameras.data[i]);
      PyObject * pyitem = deva_navi_msgs__msg__navi_sub_camera_proto__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "sub_cameras", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // penalty
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->penalty);
    {
  ...
  {  // is_hidden
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_hidden ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_hidden", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
