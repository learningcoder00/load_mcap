...
bool deva_navi_msgs__msg__coord3_d_double_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._coord3_d_double_proto.Coord3DDoubleProto", full_classname_dest, 60) == 0);
  }
  deva_navi_msgs__msg__Coord3DDoubleProto * ros_message = _ros_message;
  {  // lon
...
{
  /* NOTE(esteve): Call constructor of Coord3DDoubleProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._coord3_d_double_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Coord3DDoubleProto");
