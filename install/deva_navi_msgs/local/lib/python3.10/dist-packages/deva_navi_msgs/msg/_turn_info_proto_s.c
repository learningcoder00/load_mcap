...
bool deva_navi_msgs__msg__turn_info_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._turn_info_proto.TurnInfoProto", full_classname_dest, 49) == 0);
  }
  deva_navi_msgs__msg__TurnInfoProto * ros_message = _ros_message;
  {  // type
  ...
  {  // lot
    PyObject * field = PyObject_GetAttrString(_pymsg, "lot");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->lot = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // lat
...
{
  /* NOTE(esteve): Call constructor of TurnInfoProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._turn_info_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TurnInfoProto");
  ...
  {  // lot
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->lot);
    {
      int rc = PyObject_SetAttrString(_pymessage, "lot", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
