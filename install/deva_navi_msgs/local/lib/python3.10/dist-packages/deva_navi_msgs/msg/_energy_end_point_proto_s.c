...
bool deva_navi_msgs__msg__energy_end_point_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._energy_end_point_proto.EnergyEndPointProto", full_classname_dest, 62) == 0);
  }
  deva_navi_msgs__msg__EnergyEndPointProto * ros_message = _ros_message;
  {  // show
...
{
  /* NOTE(esteve): Call constructor of EnergyEndPointProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._energy_end_point_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EnergyEndPointProto");
