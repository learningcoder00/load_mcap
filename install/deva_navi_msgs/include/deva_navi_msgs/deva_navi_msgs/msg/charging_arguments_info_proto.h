...
#ifndef DEVA_NAVI_MSGS__MSG__CHARGING_ARGUMENTS_INFO_PROTO_H_
#define DEVA_NAVI_MSGS__MSG__CHARGING_ARGUMENTS_INFO_PROTO_H_
...
#endif  // DEVA_NAVI_MSGS__MSG__CHARGING_ARGUMENTS_INFO_PROTO_H_
