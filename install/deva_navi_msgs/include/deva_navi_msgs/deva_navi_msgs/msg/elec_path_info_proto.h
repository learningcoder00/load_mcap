...
#ifndef DEVA_NAVI_MSGS__MSG__ELEC_PATH_INFO_PROTO_H_
#define DEVA_NAVI_MSGS__MSG__ELEC_PATH_INFO_PROTO_H_
...
#endif  // DEVA_NAVI_MSGS__MSG__ELEC_PATH_INFO_PROTO_H_
