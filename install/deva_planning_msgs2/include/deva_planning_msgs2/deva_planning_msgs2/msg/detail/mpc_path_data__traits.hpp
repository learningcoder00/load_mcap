...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__MPC_PATH_DATA__TRAITS_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__MPC_PATH_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const deva_planning_msgs2::msg::MpcPathData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs2::msg::MpcPathData & msg)
{
  return deva_planning_msgs2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs2::msg::MpcPathData>()
{
  return "deva_planning_msgs2::msg::MpcPathData";
}

template<>
inline const char * name<deva_planning_msgs2::msg::MpcPathData>()
{
  return "deva_planning_msgs2/msg/MpcPathData";
}

template<>
struct has_fixed_size<deva_planning_msgs2::msg::MpcPathData>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<deva_planning_msgs2::msg::MpcPathData>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<deva_planning_msgs2::msg::MpcPathData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__MPC_PATH_DATA__TRAITS_HPP_
