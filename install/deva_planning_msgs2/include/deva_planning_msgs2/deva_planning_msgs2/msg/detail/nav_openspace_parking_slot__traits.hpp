...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__NAV_OPENSPACE_PARKING_SLOT__TRAITS_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__NAV_OPENSPACE_PARKING_SLOT__TRAITS_HPP_
...
inline void to_yaml(
  const deva_planning_msgs2::msg::NavOpenspaceParkingSlot & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs2::msg::NavOpenspaceParkingSlot & msg)
{
  return deva_planning_msgs2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs2::msg::NavOpenspaceParkingSlot>()
{
  return "deva_planning_msgs2::msg::NavOpenspaceParkingSlot";
}

template<>
inline const char * name<deva_planning_msgs2::msg::NavOpenspaceParkingSlot>()
{
  return "deva_planning_msgs2/msg/NavOpenspaceParkingSlot";
}

template<>
struct has_fixed_size<deva_planning_msgs2::msg::NavOpenspaceParkingSlot>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs2::msg::NavOpenspaceParkingSlot>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs2::msg::NavOpenspaceParkingSlot>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__NAV_OPENSPACE_PARKING_SLOT__TRAITS_HPP_
