...
{
  new (message_memory) deva_planning_msgs2::msg::NavOpenspaceParkingSlot(_init);
}

void NavOpenspaceParkingSlot_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs2::msg::NavOpenspaceParkingSlot *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavOpenspaceParkingSlot_message_member_array[6] = {
  {
    ...
    offsetof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot, xyz_vec),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot, is_occupied),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot, is_stable_tracked),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot, occupied_confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NavOpenspaceParkingSlot_message_members = {
  ...
  6,  // number of fields
  sizeof(deva_planning_msgs2::msg::NavOpenspaceParkingSlot),
...
{
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::NavOpenspaceParkingSlot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs2, msg, NavOpenspaceParkingSlot)() {
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::NavOpenspaceParkingSlot_message_type_support_handle;
}
