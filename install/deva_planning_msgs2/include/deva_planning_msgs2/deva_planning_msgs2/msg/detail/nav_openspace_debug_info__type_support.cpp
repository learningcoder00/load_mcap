...
{
  new (message_memory) deva_planning_msgs2::msg::NavOpenspaceDebugInfo(_init);
}

void NavOpenspaceDebugInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs2::msg::NavOpenspaceDebugInfo *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::NavOpenspaceObstacle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::NavOpenspaceObstacle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::NavOpenspaceObstacle> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__NavOpenspaceDebugInfo__obstacles_info(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::NavOpenspaceObstacle *>(
    get_const_function__NavOpenspaceDebugInfo__obstacles_info(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::NavOpenspaceObstacle *>(untyped_value);
  value = item;
}
...
void assign_function__NavOpenspaceDebugInfo__obstacles_info(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::NavOpenspaceObstacle *>(
    get_function__NavOpenspaceDebugInfo__obstacles_info(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::NavOpenspaceObstacle *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::NavOpenspaceParkingSlot> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::NavOpenspaceParkingSlot> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::NavOpenspaceParkingSlot> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__NavOpenspaceDebugInfo__parking_slots(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::NavOpenspaceParkingSlot *>(
    get_const_function__NavOpenspaceDebugInfo__parking_slots(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::NavOpenspaceParkingSlot *>(untyped_value);
  value = item;
}
...
void assign_function__NavOpenspaceDebugInfo__parking_slots(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::NavOpenspaceParkingSlot *>(
    get_function__NavOpenspaceDebugInfo__parking_slots(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::NavOpenspaceParkingSlot *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::PathData> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::PathData> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::PathData> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__NavOpenspaceDebugInfo__ref_points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::PathData *>(
    get_const_function__NavOpenspaceDebugInfo__ref_points(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::PathData *>(untyped_value);
  value = item;
}
...
void assign_function__NavOpenspaceDebugInfo__ref_points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::PathData *>(
    get_function__NavOpenspaceDebugInfo__ref_points(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::PathData *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::TargetTrajectory> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::TargetTrajectory> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::TargetTrajectory> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__NavOpenspaceDebugInfo__last_internal_trajectory_paths(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::TargetTrajectory *>(
    get_const_function__NavOpenspaceDebugInfo__last_internal_trajectory_paths(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::TargetTrajectory *>(untyped_value);
  value = item;
}
...
void assign_function__NavOpenspaceDebugInfo__last_internal_trajectory_paths(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::TargetTrajectory *>(
    get_function__NavOpenspaceDebugInfo__last_internal_trajectory_paths(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::TargetTrajectory *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavOpenspaceDebugInfo_message_member_array[24] = {
  {
    ...
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, x_s),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, y_s),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, theta_s),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, x_e),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, y_e),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, theta_e),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, xy_bounds),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::NavOpenspaceObstacle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, obstacles_info),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::NavOpenspaceParkingSlot>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, parking_slots),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, start_gear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, keep_start_gear_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, kappa),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::PathData>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, ref_points),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, openspace_planning_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::TargetTrajectory>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, last_trajectory),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, last_trajectory_timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, last_internal_trajectory_paths),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, current_path_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, is_arrived_path_end),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, last_ref_points),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, hybrid_astar_search_results),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo, optimization_results),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NavOpenspaceDebugInfo_message_members = {
  ...
  24,  // number of fields
  sizeof(deva_planning_msgs2::msg::NavOpenspaceDebugInfo),
...
get_message_type_support_handle<deva_planning_msgs2::msg::NavOpenspaceDebugInfo>()
{
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::NavOpenspaceDebugInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs2, msg, NavOpenspaceDebugInfo)() {
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::NavOpenspaceDebugInfo_message_type_support_handle;
}
