...
deva_planning_msgs2__msg__NaviAction__init(deva_planning_msgs2__msg__NaviAction * msg)
{
  ...
  if (!deva_common_msgs__msg__Header__init(&msg->header)) {
    deva_planning_msgs2__msg__NaviAction__fini(msg);
    return false;
  }
  // meta_action
  // current_score
...
deva_planning_msgs2__msg__NaviAction__create()
{
  ...
  deva_planning_msgs2__msg__NaviAction * msg = (deva_planning_msgs2__msg__NaviAction *)allocator.allocate(sizeof(deva_planning_msgs2__msg__NaviAction), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_planning_msgs2__msg__NaviAction));
  bool success = deva_planning_msgs2__msg__NaviAction__init(msg);
  if (!success) {
...
deva_planning_msgs2__msg__NaviAction__Sequence__init(deva_planning_msgs2__msg__NaviAction__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs2__msg__NaviAction * data = NULL;

  if (size) {
    data = (deva_planning_msgs2__msg__NaviAction *)allocator.zero_allocate(size, sizeof(deva_planning_msgs2__msg__NaviAction), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_planning_msgs2__msg__NaviAction__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_planning_msgs2__msg__NaviAction__fini(&data[i - 1]);
      }
...
deva_planning_msgs2__msg__NaviAction__Sequence__fini(deva_planning_msgs2__msg__NaviAction__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_planning_msgs2__msg__NaviAction__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs2__msg__NaviAction__Sequence * array = (deva_planning_msgs2__msg__NaviAction__Sequence *)allocator.allocate(sizeof(deva_planning_msgs2__msg__NaviAction__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_planning_msgs2__msg__NaviAction__Sequence__init(array, size);
  if (!success) {
...
deva_planning_msgs2__msg__NaviAction__Sequence__destroy(deva_planning_msgs2__msg__NaviAction__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_planning_msgs2__msg__NaviAction__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_planning_msgs2__msg__NaviAction__Sequence__are_equal(const deva_planning_msgs2__msg__NaviAction__Sequence * lhs, const deva_planning_msgs2__msg__NaviAction__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_planning_msgs2__msg__NaviAction__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_planning_msgs2__msg__NaviAction__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_planning_msgs2__msg__NaviAction);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_planning_msgs2__msg__NaviAction * data =
      (deva_planning_msgs2__msg__NaviAction *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_planning_msgs2__msg__NaviAction__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_planning_msgs2__msg__NaviAction__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_planning_msgs2__msg__NaviAction__copy(
