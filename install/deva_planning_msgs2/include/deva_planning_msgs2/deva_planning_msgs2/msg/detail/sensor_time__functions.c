...
bool
deva_planning_msgs2__msg__SensorTime__init(deva_planning_msgs2__msg__SensorTime * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->localization_header)) {
    deva_planning_msgs2__msg__SensorTime__fini(msg);
    return false;
  }
  // prediction_header
...
void
deva_planning_msgs2__msg__SensorTime__fini(deva_planning_msgs2__msg__SensorTime * msg)
{
  if (!msg) {
    return;
  }
...
bool
deva_planning_msgs2__msg__SensorTime__are_equal(const deva_planning_msgs2__msg__SensorTime * lhs, const deva_planning_msgs2__msg__SensorTime * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
deva_planning_msgs2__msg__SensorTime__copy(
  const deva_planning_msgs2__msg__SensorTime * input,
  deva_planning_msgs2__msg__SensorTime * output)
{
  if (!input || !output) {
    return false;
  }
...
deva_planning_msgs2__msg__SensorTime__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs2__msg__SensorTime * msg = (deva_planning_msgs2__msg__SensorTime *)allocator.allocate(sizeof(deva_planning_msgs2__msg__SensorTime), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_planning_msgs2__msg__SensorTime));
  bool success = deva_planning_msgs2__msg__SensorTime__init(msg);
  if (!success) {
...
void
deva_planning_msgs2__msg__SensorTime__destroy(deva_planning_msgs2__msg__SensorTime * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_planning_msgs2__msg__SensorTime__fini(msg);
...
bool
deva_planning_msgs2__msg__SensorTime__Sequence__init(deva_planning_msgs2__msg__SensorTime__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs2__msg__SensorTime * data = NULL;

  if (size) {
    data = (deva_planning_msgs2__msg__SensorTime *)allocator.zero_allocate(size, sizeof(deva_planning_msgs2__msg__SensorTime), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_planning_msgs2__msg__SensorTime__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_planning_msgs2__msg__SensorTime__fini(&data[i - 1]);
      }
...
void
deva_planning_msgs2__msg__SensorTime__Sequence__fini(deva_planning_msgs2__msg__SensorTime__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_planning_msgs2__msg__SensorTime__fini(&array->data[i]);
    }
...
deva_planning_msgs2__msg__SensorTime__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs2__msg__SensorTime__Sequence * array = (deva_planning_msgs2__msg__SensorTime__Sequence *)allocator.allocate(sizeof(deva_planning_msgs2__msg__SensorTime__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_planning_msgs2__msg__SensorTime__Sequence__init(array, size);
  if (!success) {
...
void
deva_planning_msgs2__msg__SensorTime__Sequence__destroy(deva_planning_msgs2__msg__SensorTime__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_planning_msgs2__msg__SensorTime__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
deva_planning_msgs2__msg__SensorTime__Sequence__are_equal(const deva_planning_msgs2__msg__SensorTime__Sequence * lhs, const deva_planning_msgs2__msg__SensorTime__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_planning_msgs2__msg__SensorTime__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
deva_planning_msgs2__msg__SensorTime__Sequence__copy(
  const deva_planning_msgs2__msg__SensorTime__Sequence * input,
  deva_planning_msgs2__msg__SensorTime__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_planning_msgs2__msg__SensorTime);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_planning_msgs2__msg__SensorTime * data =
      (deva_planning_msgs2__msg__SensorTime *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_planning_msgs2__msg__SensorTime__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_planning_msgs2__msg__SensorTime__fini(&output->data[i]);
        }
        return false;
      }
    }
