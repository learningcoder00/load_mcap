...
{
  new (message_memory) deva_planning_msgs2::msg::VehicleStatus(_init);
}

void VehicleStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs2::msg::VehicleStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleStatus_message_member_array[2] = {
  {
    ...
    offsetof(deva_planning_msgs2::msg::VehicleStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::VehicleStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(deva_planning_msgs2::msg::VehicleStatus),
...
get_message_type_support_handle<deva_planning_msgs2::msg::VehicleStatus>()
{
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::VehicleStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs2, msg, VehicleStatus)() {
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::VehicleStatus_message_type_support_handle;
}
