...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__SENSOR_TIME__STRUCT_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__SENSOR_TIME__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs2__msg__SensorTime __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs2__msg__SensorTime __declspec(deprecated)
#endif
...
struct SensorTime_
{
  ...
  using ConstRawPtr =
    const deva_planning_msgs2::msg::SensorTime_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs2::msg::SensorTime_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs2__msg__SensorTime
    std::shared_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs2__msg__SensorTime
    std::shared_ptr<deva_planning_msgs2::msg::SensorTime_<ContainerAllocator> const>
...
using SensorTime =
  deva_planning_msgs2::msg::SensorTime_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__SENSOR_TIME__STRUCT_HPP_
