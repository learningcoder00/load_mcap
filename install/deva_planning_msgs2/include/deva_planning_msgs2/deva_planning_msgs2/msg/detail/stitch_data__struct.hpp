...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__STITCH_DATA__STRUCT_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__STITCH_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs2__msg__StitchData __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs2__msg__StitchData __declspec(deprecated)
#endif
...
struct StitchData_
{
  ...
  using ConstRawPtr =
    const deva_planning_msgs2::msg::StitchData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs2::msg::StitchData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs2__msg__StitchData
    std::shared_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs2__msg__StitchData
    std::shared_ptr<deva_planning_msgs2::msg::StitchData_<ContainerAllocator> const>
...
using StitchData =
  deva_planning_msgs2::msg::StitchData_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__STITCH_DATA__STRUCT_HPP_
