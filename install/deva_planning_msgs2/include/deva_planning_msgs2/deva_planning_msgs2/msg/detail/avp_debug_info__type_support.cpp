...
{
  new (message_memory) deva_planning_msgs2::msg::AvpDebugInfo(_init);
}

void AvpDebugInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs2::msg::AvpDebugInfo *>(message_memory);
  typed_message->~AvpDebugInfo();
}

size_t size_function__AvpDebugInfo__origin_ref_line(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::AvpRefLine> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::AvpRefLine> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::AvpRefLine> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::AvpRefLine *>(
    get_const_function__AvpDebugInfo__origin_ref_line(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::AvpRefLine *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::AvpRefLine *>(
    get_function__AvpDebugInfo__origin_ref_line(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::AvpRefLine *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::AvpRefLineTreePointVec> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::AvpRefLineTreePointVec> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::AvpRefLineTreePointVec> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__AvpDebugInfo__used_ref_line_tree(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::AvpRefLineTreePointVec *>(
    get_const_function__AvpDebugInfo__used_ref_line_tree(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::AvpRefLineTreePointVec *>(untyped_value);
  value = item;
}
...
void assign_function__AvpDebugInfo__used_ref_line_tree(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::AvpRefLineTreePointVec *>(
    get_function__AvpDebugInfo__used_ref_line_tree(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::AvpRefLineTreePointVec *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::MpcPathData> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::MpcPathData> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::MpcPathData> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__AvpDebugInfo__now_mpc_data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::MpcPathData *>(
    get_const_function__AvpDebugInfo__now_mpc_data(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::MpcPathData *>(untyped_value);
  value = item;
}
...
void assign_function__AvpDebugInfo__now_mpc_data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::MpcPathData *>(
    get_function__AvpDebugInfo__now_mpc_data(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::MpcPathData *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<deva_planning_msgs2::msg::PathPoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<deva_planning_msgs2::msg::PathPoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<deva_planning_msgs2::msg::PathPoint> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__AvpDebugInfo__boundary_poses(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const deva_planning_msgs2::msg::PathPoint *>(
    get_const_function__AvpDebugInfo__boundary_poses(untyped_member, index));
  auto & value = *reinterpret_cast<deva_planning_msgs2::msg::PathPoint *>(untyped_value);
  value = item;
}
...
void assign_function__AvpDebugInfo__boundary_poses(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<deva_planning_msgs2::msg::PathPoint *>(
    get_function__AvpDebugInfo__boundary_poses(untyped_member, index));
  const auto & value = *reinterpret_cast<const deva_planning_msgs2::msg::PathPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AvpDebugInfo_message_member_array[12] = {
  {
    ...
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, solve_num),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, acados_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::AvpRefLine>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, origin_ref_line),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::AvpRefLineTreePointVec>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, smooth_line),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, used_ref_line_tree),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, driver_path),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::MpcPathData>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, now_mpc_data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, now_path_data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, past_path_data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::PathPoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, boundary_poses),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, obstacle_poses),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<deva_planning_msgs2::msg::StitchData>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs2::msg::AvpDebugInfo, stitch_data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AvpDebugInfo_message_members = {
  ...
  12,  // number of fields
  sizeof(deva_planning_msgs2::msg::AvpDebugInfo),
...
{
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::AvpDebugInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs2, msg, AvpDebugInfo)() {
  return &::deva_planning_msgs2::msg::rosidl_typesupport_introspection_cpp::AvpDebugInfo_message_type_support_handle;
}
