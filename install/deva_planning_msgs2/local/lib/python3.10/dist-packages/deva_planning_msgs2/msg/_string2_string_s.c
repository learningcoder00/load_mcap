...
bool deva_planning_msgs2__msg__string2_string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._string2_string.String2String", full_classname_dest, 53) == 0);
  }
  deva_planning_msgs2__msg__String2String * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of String2String */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._string2_string");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "String2String");
