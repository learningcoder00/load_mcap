...
bool deva_planning_msgs2__msg__string2_sl_boundary__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_planning_msgs2__msg__lane_bind_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._lane_bind_info.LaneBindInfo", full_classname_dest, 52) == 0);
  }
  deva_planning_msgs2__msg__LaneBindInfo * ros_message = _ros_message;
  {  // ref_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "ref_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ref_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // binded_obs
    PyObject * field = PyObject_GetAttrString(_pymsg, "binded_obs");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'binded_obs'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    deva_planning_msgs2__msg__UInt2String * dest = ros_message->binded_obs.data;
  ...
  {  // sl_boundary
    PyObject * field = PyObject_GetAttrString(_pymsg, "sl_boundary");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'sl_boundary'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_planning_msgs2__msg__String2SLBoundary__Sequence__init(&(ros_message->sl_boundary), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__String2SLBoundary__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__String2SLBoundary * dest = ros_message->sl_boundary.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__string2_sl_boundary__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of LaneBindInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._lane_bind_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneBindInfo");
  ...
  {  // ref_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->ref_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ref_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // binded_obs
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->binded_obs.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "binded_obs", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // sl_boundary
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->sl_boundary.data[i]);
      PyObject * pyitem = deva_planning_msgs2__msg__string2_sl_boundary__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "sl_boundary", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
