    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_planning_msgs2.msg.PlanningLog')
            logger.debug(
            ...
            from deva_planning_msgs2.msg import String2Bool
            if String2Bool.__class__._TYPE_SUPPORT is None:
                String2Bool.__class__.__import_type_support__()
            ...
            from deva_planning_msgs2.msg import String2Int
            if String2Int.__class__._TYPE_SUPPORT is None:
                String2Int.__class__.__import_type_support__()
...
class PlanningLog(metaclass=Metaclass_PlanningLog):
    ...
    _fields_and_field_types = {
        ...
        'scalable_int': 'sequence<deva_planning_msgs2/String2Int>',
        'scalable_double': 'sequence<deva_planning_msgs2/String2Double>',
        'scalable_bool': 'sequence<deva_planning_msgs2/String2Bool>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'String2Int')),  # noqa: E501
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'String2Bool')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.scalable_int = kwargs.get('scalable_int', [])
        self.scalable_double = kwargs.get('scalable_double', [])
        self.scalable_bool = kwargs.get('scalable_bool', [])
    ...
    def __eq__(self, other):
        ...
        if self.scalable_stream != other.scalable_stream:
            return False
        if self.scalable_int != other.scalable_int:
            return False
        if self.scalable_double != other.scalable_double:
            return False
        if self.scalable_bool != other.scalable_bool:
            return False
        return True
    ...
    @builtins.property
    def scalable_int(self):
        """Message field 'scalable_int'."""
        return self._scalable_int

    @scalable_int.setter
    def scalable_int(self, value):
        if __debug__:
            from deva_planning_msgs2.msg import String2Int
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, String2Int) for v in value) and
                 True), \
                "The 'scalable_int' field must be a set or sequence and each value of type 'String2Int'"
        self._scalable_int = value

    @builtins.property
    def scalable_double(self):
        """Message field 'scalable_double'."""
        return self._scalable_double

    @scalable_double.setter
    def scalable_double(self, value):
        if __debug__:
            from deva_planning_msgs2.msg import String2Double
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'scalable_double' field must be a set or sequence and each value of type 'String2Double'"
        self._scalable_double = value

    @builtins.property
    def scalable_bool(self):
        """Message field 'scalable_bool'."""
        return self._scalable_bool

    @scalable_bool.setter
    def scalable_bool(self, value):
        if __debug__:
            from deva_planning_msgs2.msg import String2Bool
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, String2Bool) for v in value) and
                 True), \
                "The 'scalable_bool' field must be a set or sequence and each value of type 'String2Bool'"
        self._scalable_bool = value
