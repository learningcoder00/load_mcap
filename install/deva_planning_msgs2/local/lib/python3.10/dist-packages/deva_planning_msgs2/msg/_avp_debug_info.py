...
class AvpDebugInfo(metaclass=Metaclass_AvpDebugInfo):
    ...
    _fields_and_field_types = {
        'solve_num': 'int32',
        'acados_status': 'int32',
        'origin_ref_line': 'sequence<deva_planning_msgs2/AvpRefLine>',
        'smooth_line': 'deva_planning_msgs2/AvpRefLineTreePointVec',
        'used_ref_line_tree': 'sequence<deva_planning_msgs2/AvpRefLineTreePointVec>',
        'driver_path': 'sequence<deva_planning_msgs2/AvpRefLineTreePointVec>',
        'now_mpc_data': 'sequence<deva_planning_msgs2/MpcPathData>',
        'now_path_data': 'sequence<deva_planning_msgs2/MpcPathData>',
        'past_path_data': 'sequence<deva_planning_msgs2/MpcPathData>',
        'boundary_poses': 'sequence<deva_planning_msgs2/PathPoint>',
        'obstacle_poses': 'sequence<deva_planning_msgs2/PathPoint>',
        'stitch_data': 'deva_planning_msgs2/StitchData',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'AvpRefLine')),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'AvpRefLineTreePointVec'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'AvpRefLineTreePointVec')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'AvpRefLineTreePointVec')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'MpcPathData')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'MpcPathData')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'MpcPathData')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'PathPoint')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'PathPoint')),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'StitchData'),  # noqa: E501
    )
