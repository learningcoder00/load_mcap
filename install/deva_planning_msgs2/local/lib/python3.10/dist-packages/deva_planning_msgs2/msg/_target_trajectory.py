...
class TargetTrajectory(metaclass=Metaclass_TargetTrajectory):
    ...
    _fields_and_field_types = {
        ...
        'sensor_timestamp': 'deva_planning_msgs2/SensorTime',
        'start_gnss_time': 'double',
        'total_path_length': 'double',
        'total_path_time': 'double',
        'trajectory_point': 'sequence<deva_planning_msgs2/TrajectoryPoint>',
        'path_point': 'sequence<deva_planning_msgs2/PathPoint>',
        'gear': 'string',
        'is_estop': 'boolean',
        'estop_reason': 'string',
        'is_stop': 'boolean',
        'stop_pose': 'deva_planning_msgs2/PathPoint',
        'stop_reason': 'string',
        'is_replan': 'boolean',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'PathPoint'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
