    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_planning_msgs2.msg.ReferenceLines')
            logger.debug(
            ...
            from deva_planning_msgs2.msg import ReferenceLine
...
class ReferenceLines(metaclass=Metaclass_ReferenceLines):
    ...
    _fields_and_field_types = {
        ...
        'reference_lines': 'sequence<deva_planning_msgs2/ReferenceLine>',
        'curr_id': 'int32',
        'tar_id': 'int32',
        'curr_model_id': 'int32',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs2', 'msg'], 'ReferenceLine')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.curr_model_id = kwargs.get('curr_model_id', int())
    ...
    def __eq__(self, other):
        ...
        if self.tar_id != other.tar_id:
            return False
        if self.curr_model_id != other.curr_model_id:
            return False
    ...
    @builtins.property
    def curr_model_id(self):
        """Message field 'curr_model_id'."""
        return self._curr_model_id

    @curr_model_id.setter
    def curr_model_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'curr_model_id' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'curr_model_id' field must be an integer in [-2147483648, 2147483647]"
        self._curr_model_id = value
