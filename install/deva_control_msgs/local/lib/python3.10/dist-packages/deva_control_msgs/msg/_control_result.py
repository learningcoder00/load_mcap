...
class Metaclass_ControlResult(type):
    """Metaclass of message 'ControlResult'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_control_msgs.msg.ControlResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__control_result
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__control_result
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__control_result
            cls._TYPE_SUPPORT = module.type_support_msg__msg__control_result
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__control_result
...
class ControlResult(metaclass=Metaclass_ControlResult):
    """Message class 'ControlResult'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.protocol_version = kwargs.get(
            'protocol_version', ControlResult.PROTOCOL_VERSION__DEFAULT)
        ...
        self.limit_command_enable = kwargs.get(
            'limit_command_enable', ControlResult.LIMIT_COMMAND_ENABLE__DEFAULT)
        from deva_control_msgs.msg import ControlValidLimit
    ...
    def gear_cmd_val(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'gear_cmd_val' field must be an integer in [-2147483648, 2147483647]"
