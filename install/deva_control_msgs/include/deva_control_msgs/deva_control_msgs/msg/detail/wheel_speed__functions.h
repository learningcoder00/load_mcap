...
#ifndef DEVA_CONTROL_MSGS__MSG__DETAIL__WHEEL_SPEED__FUNCTIONS_H_
#define DEVA_CONTROL_MSGS__MSG__DETAIL__WHEEL_SPEED__FUNCTIONS_H_
 ...
 * calls
 * deva_control_msgs__msg__WheelSpeed__init().
...
/**
 * It calls
 * deva_control_msgs__msg__WheelSpeed__fini()
 ...
 * deva_control_msgs__msg__WheelSpeed__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * deva_control_msgs__msg__WheelSpeed__Sequence__fini()
 * on the array,
...
#endif  // DEVA_CONTROL_MSGS__MSG__DETAIL__WHEEL_SPEED__FUNCTIONS_H_
