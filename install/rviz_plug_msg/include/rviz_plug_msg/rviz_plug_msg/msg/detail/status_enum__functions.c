...
rviz_plug_msg__msg__StatusEnum__create()
{
  ...
  rviz_plug_msg__msg__StatusEnum * msg = (rviz_plug_msg__msg__StatusEnum *)allocator.allocate(sizeof(rviz_plug_msg__msg__StatusEnum), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rviz_plug_msg__msg__StatusEnum));
  bool success = rviz_plug_msg__msg__StatusEnum__init(msg);
  if (!success) {
...
rviz_plug_msg__msg__StatusEnum__destroy(rviz_plug_msg__msg__StatusEnum * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rviz_plug_msg__msg__StatusEnum__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rviz_plug_msg__msg__StatusEnum__Sequence__init(rviz_plug_msg__msg__StatusEnum__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rviz_plug_msg__msg__StatusEnum * data = NULL;

  if (size) {
    data = (rviz_plug_msg__msg__StatusEnum *)allocator.zero_allocate(size, sizeof(rviz_plug_msg__msg__StatusEnum), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rviz_plug_msg__msg__StatusEnum__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rviz_plug_msg__msg__StatusEnum__fini(&data[i - 1]);
      }
...
rviz_plug_msg__msg__StatusEnum__Sequence__fini(rviz_plug_msg__msg__StatusEnum__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rviz_plug_msg__msg__StatusEnum__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rviz_plug_msg__msg__StatusEnum__Sequence * array = (rviz_plug_msg__msg__StatusEnum__Sequence *)allocator.allocate(sizeof(rviz_plug_msg__msg__StatusEnum__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rviz_plug_msg__msg__StatusEnum__Sequence__init(array, size);
  if (!success) {
...
rviz_plug_msg__msg__StatusEnum__Sequence__destroy(rviz_plug_msg__msg__StatusEnum__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rviz_plug_msg__msg__StatusEnum__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rviz_plug_msg__msg__StatusEnum__Sequence__are_equal(const rviz_plug_msg__msg__StatusEnum__Sequence * lhs, const rviz_plug_msg__msg__StatusEnum__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rviz_plug_msg__msg__StatusEnum__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rviz_plug_msg__msg__StatusEnum__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rviz_plug_msg__msg__StatusEnum);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rviz_plug_msg__msg__StatusEnum * data =
      (rviz_plug_msg__msg__StatusEnum *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rviz_plug_msg__msg__StatusEnum__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rviz_plug_msg__msg__StatusEnum__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rviz_plug_msg__msg__StatusEnum__copy(
