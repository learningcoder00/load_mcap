...
deva_mdriver_msgs__msg__ObstacleNudgeBuffer__create()
{
  ...
  deva_mdriver_msgs__msg__ObstacleNudgeBuffer * msg = (deva_mdriver_msgs__msg__ObstacleNudgeBuffer *)allocator.allocate(sizeof(deva_mdriver_msgs__msg__ObstacleNudgeBuffer), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_mdriver_msgs__msg__ObstacleNudgeBuffer));
  bool success = deva_mdriver_msgs__msg__ObstacleNudgeBuffer__init(msg);
  if (!success) {
...
deva_mdriver_msgs__msg__ObstacleNudgeBuffer__destroy(deva_mdriver_msgs__msg__ObstacleNudgeBuffer * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_mdriver_msgs__msg__ObstacleNudgeBuffer__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence__init(deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_mdriver_msgs__msg__ObstacleNudgeBuffer * data = NULL;

  if (size) {
    data = (deva_mdriver_msgs__msg__ObstacleNudgeBuffer *)allocator.zero_allocate(size, sizeof(deva_mdriver_msgs__msg__ObstacleNudgeBuffer), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_mdriver_msgs__msg__ObstacleNudgeBuffer__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_mdriver_msgs__msg__ObstacleNudgeBuffer__fini(&data[i - 1]);
      }
...
deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence__fini(deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_mdriver_msgs__msg__ObstacleNudgeBuffer__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * array = (deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence *)allocator.allocate(sizeof(deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence__init(array, size);
  if (!success) {
...
deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence__destroy(deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence__are_equal(const deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * lhs, const deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_mdriver_msgs__msg__ObstacleNudgeBuffer__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_mdriver_msgs__msg__ObstacleNudgeBuffer__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_mdriver_msgs__msg__ObstacleNudgeBuffer);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_mdriver_msgs__msg__ObstacleNudgeBuffer * data =
      (deva_mdriver_msgs__msg__ObstacleNudgeBuffer *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_mdriver_msgs__msg__ObstacleNudgeBuffer__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_mdriver_msgs__msg__ObstacleNudgeBuffer__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_mdriver_msgs__msg__ObstacleNudgeBuffer__copy(
