...
#ifndef DEVA_AEB_MSGS__MSG__DETAIL__SF_SEC_LANE_ESTIMN__STRUCT_HPP_
#define DEVA_AEB_MSGS__MSG__DETAIL__SF_SEC_LANE_ESTIMN__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_aeb_msgs__msg__SFSecLaneEstimn __attribute__((deprecated))
#else
# define DEPRECATED__deva_aeb_msgs__msg__SFSecLaneEstimn __declspec(deprecated)
#endif
...
struct SFSecLaneEstimn_
{
  using Type = SFSecLaneEstimn_<ContainerAllocator>;

  explicit SFSecLaneEstimn_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SFSecLaneEstimn_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using ConstRawPtr =
    const deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_aeb_msgs__msg__SFSecLaneEstimn
    std::shared_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_aeb_msgs__msg__SFSecLaneEstimn
    std::shared_ptr<deva_aeb_msgs::msg::SFSecLaneEstimn_<ContainerAllocator> const>
  ...
  bool operator==(const SFSecLaneEstimn_ & other) const
  {
...
using SFSecLaneEstimn =
  deva_aeb_msgs::msg::SFSecLaneEstimn_<std::allocator<void>>;
...
#endif  // DEVA_AEB_MSGS__MSG__DETAIL__SF_SEC_LANE_ESTIMN__STRUCT_HPP_
