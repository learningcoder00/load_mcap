...
#ifndef DEVA_AEB_MSGS__MSG__DETAIL__SF_OBJ_INFO_NOA__STRUCT_HPP_
#define DEVA_AEB_MSGS__MSG__DETAIL__SF_OBJ_INFO_NOA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_aeb_msgs__msg__SFObjInfoNOA __attribute__((deprecated))
#else
# define DEPRECATED__deva_aeb_msgs__msg__SFObjInfoNOA __declspec(deprecated)
#endif
...
struct SFObjInfoNOA_
{
  using Type = SFObjInfoNOA_<ContainerAllocator>;

  explicit SFObjInfoNOA_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->lan_assignment = 0;
    }
  }

  explicit SFObjInfoNOA_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : reserved(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using _lan_assignment_type =
    uint8_t;
  _lan_assignment_type lan_assignment;
  ...
  Type & set__lan_assignment(
    const uint8_t & _arg)
  {
    this->lan_assignment = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_aeb_msgs__msg__SFObjInfoNOA
    std::shared_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_aeb_msgs__msg__SFObjInfoNOA
    std::shared_ptr<deva_aeb_msgs::msg::SFObjInfoNOA_<ContainerAllocator> const>
  ...
  bool operator==(const SFObjInfoNOA_ & other) const
  {
    ...
    if (this->lan_assignment != other.lan_assignment) {
      return false;
    }
    return true;
  }
...
using SFObjInfoNOA =
  deva_aeb_msgs::msg::SFObjInfoNOA_<std::allocator<void>>;
...
#endif  // DEVA_AEB_MSGS__MSG__DETAIL__SF_OBJ_INFO_NOA__STRUCT_HPP_
