...
bool deva_aeb_msgs__msg__sf_diag_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_diag_info.SFDiagInfo", full_classname_dest, 42) == 0);
  }
  deva_aeb_msgs__msg__SFDiagInfo * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of SFDiagInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_diag_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFDiagInfo");
