...
class Metaclass_SFSecLaneEstimn(type):
    """Metaclass of message 'SFSecLaneEstimn'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sf_sec_lane_estimn
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sf_sec_lane_estimn
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sf_sec_lane_estimn
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sf_sec_lane_estimn
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sf_sec_lane_estimn
...
class SFSecLaneEstimn(metaclass=Metaclass_SFSecLaneEstimn):
    """Message class 'SFSecLaneEstimn'."""
