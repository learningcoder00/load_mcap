...
bool deva_aeb_msgs__msg__sf_sec_lane_estimn__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_sec_lane_estimn.SFSecLaneEstimn", full_classname_dest, 53) == 0);
  }
  deva_aeb_msgs__msg__SFSecLaneEstimn * ros_message = _ros_message;
  {  // constcoeff
...
{
  /* NOTE(esteve): Call constructor of SFSecLaneEstimn */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_sec_lane_estimn");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFSecLaneEstimn");
