...
bool deva_aeb_msgs__msg__sf_road_edge_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_road_edge_info.SFRoadEdgeInfo", full_classname_dest, 51) == 0);
  }
  deva_aeb_msgs__msg__SFRoadEdgeInfo * ros_message = _ros_message;
  {  // overrideflag
...
{
  /* NOTE(esteve): Call constructor of SFRoadEdgeInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_road_edge_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFRoadEdgeInfo");
