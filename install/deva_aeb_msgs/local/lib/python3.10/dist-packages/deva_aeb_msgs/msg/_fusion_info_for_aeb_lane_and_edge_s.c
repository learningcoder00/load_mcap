...
bool deva_aeb_msgs__msg__fusion_info_for_aeb_lane_and_edge__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._fusion_info_for_aeb_lane_and_edge.FusionInfoForAEBLaneAndEdge", full_classname_dest, 80) == 0);
  }
  deva_aeb_msgs__msg__FusionInfoForAEBLaneAndEdge * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FusionInfoForAEBLaneAndEdge */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._fusion_info_for_aeb_lane_and_edge");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FusionInfoForAEBLaneAndEdge");
