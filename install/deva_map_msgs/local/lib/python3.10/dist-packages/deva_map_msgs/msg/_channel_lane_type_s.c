...
bool deva_map_msgs__msg__channel_lane_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._channel_lane_type.ChannelLaneType", full_classname_dest, 52) == 0);
  }
  deva_map_msgs__msg__ChannelLaneType * ros_message = _ros_message;
  {  // s_start
...
{
  /* NOTE(esteve): Call constructor of ChannelLaneType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._channel_lane_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChannelLaneType");
