...
bool deva_map_msgs__msg__lane_waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._lane_waypoint.LaneWaypoint", full_classname_dest, 45) == 0);
  }
  deva_map_msgs__msg__LaneWaypoint * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of LaneWaypoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._lane_waypoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneWaypoint");
