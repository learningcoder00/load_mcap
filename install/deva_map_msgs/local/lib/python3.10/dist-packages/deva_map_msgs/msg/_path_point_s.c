...
bool deva_map_msgs__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._path_point.PathPoint", full_classname_dest, 39) == 0);
  }
  deva_map_msgs__msg__PathPoint * ros_message = _ros_message;
  {  // pos
  ...
  {  // is_expand
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_expand");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_expand = (Py_True == field);
    Py_DECREF(field);
  }
  {  // is_junction
...
PyObject * deva_map_msgs__msg__path_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._path_point");
  ...
  {  // is_expand
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_expand ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_expand", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
