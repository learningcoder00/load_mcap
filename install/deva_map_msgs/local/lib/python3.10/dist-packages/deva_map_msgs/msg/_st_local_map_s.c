...
ROSIDL_GENERATOR_C_IMPORT
bool deva_perception_msgs__msg__signal__convert_from_py(PyObject * _pymsg, void * _ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
bool deva_map_msgs__msg__st_local_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._st_local_map.STLocalMap", full_classname_dest, 42) == 0);
  }
  deva_map_msgs__msg__STLocalMap * ros_message = _ros_message;
  {  // channels
    ...
    if (!deva_map_msgs__msg__Channel__Sequence__init(&(ros_message->channels), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_map_msgs__msg__Channel__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_map_msgs__msg__Channel * dest = ros_message->channels.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_map_msgs__msg__channel__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // reference_channals
    PyObject * field = PyObject_GetAttrString(_pymsg, "reference_channals");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'reference_channals'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_map_msgs__msg__ReferenceChannal__Sequence__init(&(ros_message->reference_channals), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_map_msgs__msg__ReferenceChannal__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_map_msgs__msg__ReferenceChannal * dest = ros_message->reference_channals.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_map_msgs__msg__reference_channal__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // obstacles
    ...
    deva_perception_msgs__msg__StaticObstacle * dest = ros_message->obstacles.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // signals
    ...
    if (!deva_perception_msgs__msg__Signal__Sequence__init(&(ros_message->signals), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_perception_msgs__msg__Signal__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_perception_msgs__msg__Signal * dest = ros_message->signals.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_perception_msgs__msg__signal__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of STLocalMap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._st_local_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "STLocalMap");
  ...
  {  // channels
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_map_msgs__msg__channel__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // reference_channals
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->reference_channals.data[i]);
      PyObject * pyitem = deva_map_msgs__msg__reference_channal__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "reference_channals", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // signals
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_perception_msgs__msg__signal__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
