...
class Metaclass_ChannelLaneType(type):
    """Metaclass of message 'ChannelLaneType'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__channel_lane_type
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__channel_lane_type
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__channel_lane_type
            cls._TYPE_SUPPORT = module.type_support_msg__msg__channel_lane_type
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__channel_lane_type
...
class ChannelLaneType(metaclass=Metaclass_ChannelLaneType):
    """Message class 'ChannelLaneType'."""
