...
#ifndef DEVA_MAP_MSGS__MSG__DETAIL__PATH_POINT__TRAITS_HPP_
#define DEVA_MAP_MSGS__MSG__DETAIL__PATH_POINT__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "is_expand: ";
    rosidl_generator_traits::value_to_yaml(msg.is_expand, out);
    out << ", ";
  }
...
inline void to_yaml(
  const deva_map_msgs::msg::PathPoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_map_msgs::msg::PathPoint & msg)
{
  return deva_map_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_map_msgs::msg::PathPoint>()
{
  return "deva_map_msgs::msg::PathPoint";
}

template<>
inline const char * name<deva_map_msgs::msg::PathPoint>()
{
  return "deva_map_msgs/msg/PathPoint";
}

template<>
struct has_fixed_size<deva_map_msgs::msg::PathPoint>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_map_msgs::msg::PathPoint>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_map_msgs::msg::PathPoint>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_MAP_MSGS__MSG__DETAIL__PATH_POINT__TRAITS_HPP_
