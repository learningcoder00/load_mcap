...
bool deva_localization_msgs__msg__localization_revise__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_localization_msgs.msg._localization_revise.LocalizationRevise", full_classname_dest, 66) == 0);
  }
  deva_localization_msgs__msg__LocalizationRevise * ros_message = _ros_message;
  {  // header
  ...
  {  // state_message
    ...
    ros_message->state_message = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of LocalizationRevise */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_localization_msgs.msg._localization_revise");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LocalizationRevise");
  ...
  {  // state_message
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->state_message);
    {
