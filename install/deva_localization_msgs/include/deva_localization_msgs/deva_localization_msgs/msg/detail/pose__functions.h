...
#ifndef DEVA_LOCALIZATION_MSGS__MSG__DETAIL__POSE__FUNCTIONS_H_
#define DEVA_LOCALIZATION_MSGS__MSG__DETAIL__POSE__FUNCTIONS_H_
 ...
 * calls
 * deva_localization_msgs__msg__Pose__init().
...
/**
 * It calls
 * deva_localization_msgs__msg__Pose__fini()
 ...
 * deva_localization_msgs__msg__Pose__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * deva_localization_msgs__msg__Pose__Sequence__fini()
 * on the array,
...
#endif  // DEVA_LOCALIZATION_MSGS__MSG__DETAIL__POSE__FUNCTIONS_H_
