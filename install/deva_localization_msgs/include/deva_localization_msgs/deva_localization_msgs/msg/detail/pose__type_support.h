...
#ifndef DEVA_LOCALIZATION_MSGS__MSG__DETAIL__POSE__TYPE_SUPPORT_H_
#define DEVA_LOCALIZATION_MSGS__MSG__DETAIL__POSE__TYPE_SUPPORT_H_
...
#endif  // DEVA_LOCALIZATION_MSGS__MSG__DETAIL__POSE__TYPE_SUPPORT_H_
