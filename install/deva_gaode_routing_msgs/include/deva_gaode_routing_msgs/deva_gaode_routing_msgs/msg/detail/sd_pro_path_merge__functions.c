...
deva_gaode_routing_msgs__msg__SdProPathMerge__create()
{
  ...
  deva_gaode_routing_msgs__msg__SdProPathMerge * msg = (deva_gaode_routing_msgs__msg__SdProPathMerge *)allocator.allocate(sizeof(deva_gaode_routing_msgs__msg__SdProPathMerge), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_gaode_routing_msgs__msg__SdProPathMerge));
  bool success = deva_gaode_routing_msgs__msg__SdProPathMerge__init(msg);
  if (!success) {
...
deva_gaode_routing_msgs__msg__SdProPathMerge__destroy(deva_gaode_routing_msgs__msg__SdProPathMerge * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_gaode_routing_msgs__msg__SdProPathMerge__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence__init(deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_gaode_routing_msgs__msg__SdProPathMerge * data = NULL;

  if (size) {
    data = (deva_gaode_routing_msgs__msg__SdProPathMerge *)allocator.zero_allocate(size, sizeof(deva_gaode_routing_msgs__msg__SdProPathMerge), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_gaode_routing_msgs__msg__SdProPathMerge__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_gaode_routing_msgs__msg__SdProPathMerge__fini(&data[i - 1]);
      }
...
deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence__fini(deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_gaode_routing_msgs__msg__SdProPathMerge__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * array = (deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence *)allocator.allocate(sizeof(deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence__init(array, size);
  if (!success) {
...
deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence__destroy(deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence__are_equal(const deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * lhs, const deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_gaode_routing_msgs__msg__SdProPathMerge__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_gaode_routing_msgs__msg__SdProPathMerge__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_gaode_routing_msgs__msg__SdProPathMerge);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_gaode_routing_msgs__msg__SdProPathMerge * data =
      (deva_gaode_routing_msgs__msg__SdProPathMerge *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_gaode_routing_msgs__msg__SdProPathMerge__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_gaode_routing_msgs__msg__SdProPathMerge__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_gaode_routing_msgs__msg__SdProPathMerge__copy(
