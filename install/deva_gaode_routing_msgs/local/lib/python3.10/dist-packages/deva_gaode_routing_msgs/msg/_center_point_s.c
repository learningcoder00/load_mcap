...
bool deva_gaode_routing_msgs__msg__center_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._center_point.CenterPoint", full_classname_dest, 53) == 0);
  }
  deva_gaode_routing_msgs__msg__CenterPoint * ros_message = _ros_message;
  {  // offset
  ...
  {  // point
    ...
    if (!deva_gaode_routing_msgs__msg__web_point__convert_from_py(field, &ros_message->point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CenterPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._center_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CenterPoint");
  ...
  {  // point
    PyObject * field = NULL;
    field = deva_gaode_routing_msgs__msg__web_point__convert_to_py(&ros_message->point);
    if (!field) {
      return NULL;
    }
    {
