...
bool deva_gaode_routing_msgs__msg__feature_point_by_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._feature_point_by_id.FeaturePointById", full_classname_dest, 65) == 0);
  }
  deva_gaode_routing_msgs__msg__FeaturePointById * ros_message = _ros_message;
  {  // id
  ...
  {  // lane_id_s
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_id_s");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'lane_id_s'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_gaode_routing_msgs__msg__FeatureIDType__Sequence__init(&(ros_message->lane_id_s), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_gaode_routing_msgs__msg__FeatureIDType__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_gaode_routing_msgs__msg__FeatureIDType * dest = ros_message->lane_id_s.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of FeaturePointById */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._feature_point_by_id");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FeaturePointById");
  ...
  {  // lane_id_s
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->lane_id_s.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_id_s", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
