...
class Coordinate(metaclass=Metaclass_Coordinate):
    ...
    def __init__(self, **kwargs):
        ...
        self.relative_z = kwargs.get('relative_z', float())
    ...
    def __eq__(self, other):
        ...
        if self.y != other.y:
            return False
        if self.relative_z != other.relative_z:
            return False
        return True
    ...
    def relative_z(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'relative_z' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'relative_z' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
