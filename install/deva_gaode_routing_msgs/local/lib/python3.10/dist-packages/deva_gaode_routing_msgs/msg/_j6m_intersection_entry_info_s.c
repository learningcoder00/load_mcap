...
bool deva_gaode_routing_msgs__msg__j6m_intersection_entry_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._j6m_intersection_entry_info.J6mIntersectionEntryInfo", full_classname_dest, 81) == 0);
  }
  deva_gaode_routing_msgs__msg__J6mIntersectionEntryInfo * ros_message = _ros_message;
  {  // crowd_sourcing_link_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "crowd_sourcing_link_id");
    if (!field) {
      return false;
    }
    if (!deva_gaode_routing_msgs__msg__link_id_type__convert_from_py(field, &ros_message->crowd_sourcing_link_id)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of J6mIntersectionEntryInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._j6m_intersection_entry_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "J6mIntersectionEntryInfo");
  ...
  {  // crowd_sourcing_link_id
    PyObject * field = NULL;
    field = deva_gaode_routing_msgs__msg__link_id_type__convert_to_py(&ros_message->crowd_sourcing_link_id);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "crowd_sourcing_link_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
