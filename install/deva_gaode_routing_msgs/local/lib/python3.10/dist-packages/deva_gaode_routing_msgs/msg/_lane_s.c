...
bool deva_gaode_routing_msgs__msg__feature_id_type__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_gaode_routing_msgs__msg__feature_id_type__convert_to_py(void * raw_ros_message);
bool deva_gaode_routing_msgs__msg__lane_restriction__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_gaode_routing_msgs__msg__lane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._lane.LANE", full_classname_dest, 38) == 0);
  }
  deva_gaode_routing_msgs__msg__LANE * ros_message = _ros_message;
  {  // id
  ...
  {  // left_border_types
    PyObject * field = PyObject_GetAttrString(_pymsg, "left_border_types");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->left_border_types.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'left_border_types'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // right_border_types
    PyObject * field = PyObject_GetAttrString(_pymsg, "right_border_types");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->right_border_types.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'right_border_types'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // left_border_colors
    PyObject * field = PyObject_GetAttrString(_pymsg, "left_border_colors");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->left_border_colors.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'left_border_colors'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // right_border_colors
    PyObject * field = PyObject_GetAttrString(_pymsg, "right_border_colors");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->right_border_colors.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'right_border_colors'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // change_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "change_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->change_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // lane_width
  ...
  {  // seq_num
    ...
    assert(PyLong_Check(field));
    ros_message->seq_num = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // previous_id_s
  ...
  {  // lsl_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "lsl_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->lsl_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // arrows
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->arrows.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // lane_restricts
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_restricts");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'lane_restricts'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_gaode_routing_msgs__msg__LaneRestriction__Sequence__init(&(ros_message->lane_restricts), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_gaode_routing_msgs__msg__LaneRestriction__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_gaode_routing_msgs__msg__LaneRestriction * dest = ros_message->lane_restricts.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_gaode_routing_msgs__msg__lane_restriction__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * deva_gaode_routing_msgs__msg__lane__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._lane");
  ...
  {  // left_border_types
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "left_border_types");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->left_border_types.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->left_border_types.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->left_border_types.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // right_border_types
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "right_border_types");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->right_border_types.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->right_border_types.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->right_border_types.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // left_border_colors
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "left_border_colors");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->left_border_colors.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->left_border_colors.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->left_border_colors.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // right_border_colors
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "right_border_colors");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->right_border_colors.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->right_border_colors.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->right_border_colors.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // change_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->change_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "change_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // lsl_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->lsl_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "lsl_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // arrows
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "arrows");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->arrows.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->arrows.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->arrows.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // lane_restricts
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->lane_restricts.data[i]);
      PyObject * pyitem = deva_gaode_routing_msgs__msg__lane_restriction__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_restricts", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
