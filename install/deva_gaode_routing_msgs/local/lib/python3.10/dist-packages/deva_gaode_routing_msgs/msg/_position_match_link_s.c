...
bool deva_gaode_routing_msgs__msg__position_match_link__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._position_match_link.PositionMatchLink", full_classname_dest, 66) == 0);
  }
  deva_gaode_routing_msgs__msg__PositionMatchLink * ros_message = _ros_message;
  {  // links
...
{
  /* NOTE(esteve): Call constructor of PositionMatchLink */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._position_match_link");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionMatchLink");
