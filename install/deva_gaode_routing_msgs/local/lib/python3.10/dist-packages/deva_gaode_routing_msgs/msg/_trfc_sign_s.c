...
bool deva_gaode_routing_msgs__msg__trfc_sign__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._trfc_sign.TrfcSign", full_classname_dest, 47) == 0);
  }
  deva_gaode_routing_msgs__msg__TrfcSign * ros_message = _ros_message;
  {  // id
  ...
  {  // speedflag
    PyObject * field = PyObject_GetAttrString(_pymsg, "speedflag");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->speedflag = (Py_True == field);
    Py_DECREF(field);
  }
  {  // speed
...
{
  /* NOTE(esteve): Call constructor of TrfcSign */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._trfc_sign");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrfcSign");
  ...
  {  // speedflag
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->speedflag ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "speedflag", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
