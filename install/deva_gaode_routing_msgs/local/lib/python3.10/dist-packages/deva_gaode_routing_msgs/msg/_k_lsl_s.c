...
bool deva_gaode_routing_msgs__msg__k_lsl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._k_lsl.KLsl", full_classname_dest, 39) == 0);
  }
  deva_gaode_routing_msgs__msg__KLsl * ros_message = _ros_message;
  {  // in_link_id
  ...
  {  // seqnum
    PyObject * field = PyObject_GetAttrString(_pymsg, "seqnum");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->seqnum = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // lsl_type
  ...
  {  // lane_nums
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_nums");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->lane_nums = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // lsl_lanes
    PyObject * field = PyObject_GetAttrString(_pymsg, "lsl_lanes");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__uint8__Sequence__init(&(ros_message->lsl_lanes), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create uint8__Sequence ros_message");
        PyBuffer_Release(&view);
        Py_DECREF(field);
        return false;
      }
      uint8_t * dest = ros_message->lsl_lanes.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'lsl_lanes'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of KLsl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._k_lsl");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KLsl");
  ...
  {  // seqnum
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->seqnum);
    {
      int rc = PyObject_SetAttrString(_pymessage, "seqnum", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // lane_nums
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->lane_nums);
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_nums", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // lsl_lanes
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "lsl_lanes");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->lsl_lanes.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->lsl_lanes.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->lsl_lanes.size * sizeof(uint8_t));
      assert(data != NULL);
