...
bool deva_gaode_routing_msgs__msg__heterogeneous_match_link__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._heterogeneous_match_link.HeterogeneousMatchLink", full_classname_dest, 76) == 0);
  }
  deva_gaode_routing_msgs__msg__HeterogeneousMatchLink * ros_message = _ros_message;
  {  // links
    ...
    deva_gaode_routing_msgs__msg__LinkIDType * dest = ros_message->links.data;
...
{
  /* NOTE(esteve): Call constructor of HeterogeneousMatchLink */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._heterogeneous_match_link");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HeterogeneousMatchLink");
