...
bool environment_model_msgs__msg__road_struct_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("environment_model_msgs.msg._road_struct_type.RoadStructType", full_classname_dest, 59) == 0);
  }
  environment_model_msgs__msg__RoadStructType * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of RoadStructType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("environment_model_msgs.msg._road_struct_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoadStructType");
