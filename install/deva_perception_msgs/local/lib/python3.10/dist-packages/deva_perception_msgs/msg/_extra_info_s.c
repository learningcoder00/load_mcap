...
bool deva_perception_msgs__msg__extra_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._extra_info.ExtraInfo", full_classname_dest, 46) == 0);
  }
  deva_perception_msgs__msg__ExtraInfo * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of ExtraInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._extra_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExtraInfo");
