...
bool deva_perception_msgs__msg__steering_arrow__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._steering_arrow.SteeringArrow", full_classname_dest, 54) == 0);
  }
  deva_perception_msgs__msg__SteeringArrow * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of SteeringArrow */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._steering_arrow");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SteeringArrow");
