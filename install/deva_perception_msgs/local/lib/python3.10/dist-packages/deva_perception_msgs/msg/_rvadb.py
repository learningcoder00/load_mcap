...
class Metaclass_RVADB(type):
    """Metaclass of message 'RVADB'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_perception_msgs.msg.RVADB')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rvadb
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rvadb
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rvadb
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rvadb
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rvadb
            ...
            from deva_perception_msgs.msg import RVLightList
            if RVLightList.__class__._TYPE_SUPPORT is None:
                RVLightList.__class__.__import_type_support__()
...
class RVADB(metaclass=Metaclass_RVADB):
    """Message class 'RVADB'."""
    ...
    _fields_and_field_types = {
        ...
        'lights_list': 'sequence<deva_perception_msgs/RVLightList>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_perception_msgs', 'msg'], 'RVLightList')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.lights_list = kwargs.get('lights_list', [])
    ...
    def __eq__(self, other):
        ...
        if self.orientation != other.orientation:
            return False
        if self.lights_list != other.lights_list:
            return False
    ...
    def lights_list(self):
        """Message field 'lights_list'."""
        return self._lights_list

    @lights_list.setter
    def lights_list(self, value):
        if __debug__:
            from deva_perception_msgs.msg import RVLightList
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, RVLightList) for v in value) and
                 True), \
                "The 'lights_list' field must be a set or sequence and each value of type 'RVLightList'"
        self._lights_list = value
