...
class Metaclass_ImageRadarPacket(type):
    """Metaclass of message 'ImageRadarPacket'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_perception_msgs.msg.ImageRadarPacket')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__image_radar_packet
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__image_radar_packet
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__image_radar_packet
            cls._TYPE_SUPPORT = module.type_support_msg__msg__image_radar_packet
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__image_radar_packet
...
class ImageRadarPacket(metaclass=Metaclass_ImageRadarPacket):
    """Message class 'ImageRadarPacket'."""
