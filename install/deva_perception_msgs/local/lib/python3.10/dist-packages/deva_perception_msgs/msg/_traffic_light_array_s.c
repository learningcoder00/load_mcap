...
bool deva_perception_msgs__msg__traffic_light_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._traffic_light_array.TrafficLightArray", full_classname_dest, 63) == 0);
  }
  deva_perception_msgs__msg__TrafficLightArray * ros_message = _ros_message;
  {  // header
  ...
  {  // traffic_lights
    ...
    deva_perception_msgs__msg__TrafficLight * dest = ros_message->traffic_lights.data;
...
{
  /* NOTE(esteve): Call constructor of TrafficLightArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._traffic_light_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficLightArray");
