...
bool deva_perception_msgs__msg__rv_light__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._rv_light.RVLight", full_classname_dest, 42) == 0);
  }
  deva_perception_msgs__msg__RVLight * ros_message = _ros_message;
  {  // obstacle
  ...
  {  // heading_type
    ...
    assert(PyLong_Check(field));
    ros_message->heading_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // depth
  ...
  {  // sign_occ_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "sign_occ_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->sign_occ_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // sign_trun_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "sign_trun_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->sign_trun_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // extra_infos
...
{
  /* NOTE(esteve): Call constructor of RVLight */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._rv_light");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RVLight");
  ...
  {  // sign_occ_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->sign_occ_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "sign_occ_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // sign_trun_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->sign_trun_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "sign_trun_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
