...
bool deva_perception_msgs__msg__polygon__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._polygon.Polygon", full_classname_dest, 41) == 0);
  }
  deva_perception_msgs__msg__Polygon * ros_message = _ros_message;
  {  // num_points
...
PyObject * deva_perception_msgs__msg__polygon__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._polygon");
