...
bool deva_perception_msgs__msg__edge_line_segment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._edge_line_segment.EdgeLineSegment", full_classname_dest, 59) == 0);
  }
  deva_perception_msgs__msg__EdgeLineSegment * ros_message = _ros_message;
  {  // segment
    PyObject * field = PyObject_GetAttrString(_pymsg, "segment");
    if (!field) {
      return false;
    }
    if (!deva_common_msgs__msg__line_segment__convert_from_py(field, &ros_message->segment)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of EdgeLineSegment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._edge_line_segment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EdgeLineSegment");
  ...
  {  // segment
    PyObject * field = NULL;
    field = deva_common_msgs__msg__line_segment__convert_to_py(&ros_message->segment);
    if (!field) {
      return NULL;
    }
    {
