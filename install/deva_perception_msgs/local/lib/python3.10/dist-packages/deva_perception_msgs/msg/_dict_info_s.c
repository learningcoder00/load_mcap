...
bool deva_perception_msgs__msg__dict_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._dict_info.DictInfo", full_classname_dest, 44) == 0);
  }
  deva_perception_msgs__msg__DictInfo * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of DictInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._dict_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DictInfo");
