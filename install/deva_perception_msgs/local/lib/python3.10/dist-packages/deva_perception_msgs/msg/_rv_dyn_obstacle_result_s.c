...
bool deva_perception_msgs__msg__rv_dyn_obstacle_list__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_perception_msgs__msg__rv_dyn_obstacle_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._rv_dyn_obstacle_result.RVDynObstacleResult", full_classname_dest, 68) == 0);
  }
  deva_perception_msgs__msg__RVDynObstacleResult * ros_message = _ros_message;
  {  // header
  ...
  {  // dynamic_obs_list
    ...
    if (!deva_perception_msgs__msg__RVDynObstacleList__Sequence__init(&(ros_message->dynamic_obs_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_perception_msgs__msg__RVDynObstacleList__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_perception_msgs__msg__RVDynObstacleList * dest = ros_message->dynamic_obs_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_perception_msgs__msg__rv_dyn_obstacle_list__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of RVDynObstacleResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._rv_dyn_obstacle_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RVDynObstacleResult");
  ...
  {  // dynamic_obs_list
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_perception_msgs__msg__rv_dyn_obstacle_list__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
