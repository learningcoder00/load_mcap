...
bool deva_perception_msgs__msg__entrance_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._entrance_array.EntranceArray", full_classname_dest, 54) == 0);
  }
  deva_perception_msgs__msg__EntranceArray * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of EntranceArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._entrance_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EntranceArray");
