...
bool deva_perception_msgs__msg__traffic_channel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._traffic_channel.TrafficChannel", full_classname_dest, 56) == 0);
  }
  deva_perception_msgs__msg__TrafficChannel * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TrafficChannel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._traffic_channel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficChannel");
