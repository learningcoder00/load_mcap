...
bool deva_perception_msgs__msg__aeb_obstacle_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._aeb_obstacle_array.AEBObstacleArray", full_classname_dest, 61) == 0);
  }
  deva_perception_msgs__msg__AEBObstacleArray * ros_message = _ros_message;
  {  // header
  ...
  {  // aeb_obstacles
    PyObject * field = PyObject_GetAttrString(_pymsg, "aeb_obstacles");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'aeb_obstacles'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_perception_msgs__msg__AEBObstacle__Sequence__init(&(ros_message->aeb_obstacles), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_perception_msgs__msg__AEBObstacle__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_perception_msgs__msg__AEBObstacle * dest = ros_message->aeb_obstacles.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_perception_msgs__msg__aeb_obstacle__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of AEBObstacleArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._aeb_obstacle_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AEBObstacleArray");
  ...
  {  // aeb_obstacles
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->aeb_obstacles.data[i]);
      PyObject * pyitem = deva_perception_msgs__msg__aeb_obstacle__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "aeb_obstacles", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
