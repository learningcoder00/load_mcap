...
bool deva_perception_msgs__msg__lane_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._lane_type.LaneType", full_classname_dest, 44) == 0);
  }
  deva_perception_msgs__msg__LaneType * ros_message = _ros_message;
  {  // lane_type
...
PyObject * deva_perception_msgs__msg__lane_type__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._lane_type");
