...
bool deva_perception_msgs__msg__image_radar_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._image_radar_packet.ImageRadarPacket", full_classname_dest, 61) == 0);
  }
  deva_perception_msgs__msg__ImageRadarPacket * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of ImageRadarPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._image_radar_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageRadarPacket");
