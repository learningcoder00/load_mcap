...
#ifndef DEVA_PERCEPTION_MSGS__MSG__FIXED_OBSTACLE_LIST_H_
#define DEVA_PERCEPTION_MSGS__MSG__FIXED_OBSTACLE_LIST_H_
...
#endif  // DEVA_PERCEPTION_MSGS__MSG__FIXED_OBSTACLE_LIST_H_
