...
#ifndef DEVA_PERCEPTION_MSGS__MSG__DETAIL__CONE__STRUCT_HPP_
#define DEVA_PERCEPTION_MSGS__MSG__DETAIL__CONE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_perception_msgs__msg__Cone __attribute__((deprecated))
#else
# define DEPRECATED__deva_perception_msgs__msg__Cone __declspec(deprecated)
#endif
...
struct Cone_
{
  ...
  // pointer types
  using RawPtr =
    deva_perception_msgs::msg::Cone_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_perception_msgs::msg::Cone_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_perception_msgs::msg::Cone_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_perception_msgs__msg__Cone
    std::shared_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_perception_msgs__msg__Cone
    std::shared_ptr<deva_perception_msgs::msg::Cone_<ContainerAllocator> const>
...
using Cone =
  deva_perception_msgs::msg::Cone_<std::allocator<void>>;

// constant definitions
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Cone_<ContainerAllocator>::FAIL;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Cone_<ContainerAllocator>::LEFT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Cone_<ContainerAllocator>::MID;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Cone_<ContainerAllocator>::RIGHT;
#endif  // __cplusplus < 201703L
...
#endif  // DEVA_PERCEPTION_MSGS__MSG__DETAIL__CONE__STRUCT_HPP_
