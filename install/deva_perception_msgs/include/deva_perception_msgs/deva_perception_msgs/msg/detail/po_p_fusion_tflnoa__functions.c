...
deva_perception_msgs__msg__PoPFusionTFLNOA__create()
{
  ...
  deva_perception_msgs__msg__PoPFusionTFLNOA * msg = (deva_perception_msgs__msg__PoPFusionTFLNOA *)allocator.allocate(sizeof(deva_perception_msgs__msg__PoPFusionTFLNOA), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_perception_msgs__msg__PoPFusionTFLNOA));
  bool success = deva_perception_msgs__msg__PoPFusionTFLNOA__init(msg);
  if (!success) {
...
deva_perception_msgs__msg__PoPFusionTFLNOA__destroy(deva_perception_msgs__msg__PoPFusionTFLNOA * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_perception_msgs__msg__PoPFusionTFLNOA__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence__init(deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__PoPFusionTFLNOA * data = NULL;

  if (size) {
    data = (deva_perception_msgs__msg__PoPFusionTFLNOA *)allocator.zero_allocate(size, sizeof(deva_perception_msgs__msg__PoPFusionTFLNOA), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_perception_msgs__msg__PoPFusionTFLNOA__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_perception_msgs__msg__PoPFusionTFLNOA__fini(&data[i - 1]);
      }
...
deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence__fini(deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_perception_msgs__msg__PoPFusionTFLNOA__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * array = (deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence *)allocator.allocate(sizeof(deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence__init(array, size);
  if (!success) {
...
deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence__destroy(deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence__are_equal(const deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * lhs, const deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_perception_msgs__msg__PoPFusionTFLNOA__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_perception_msgs__msg__PoPFusionTFLNOA__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_perception_msgs__msg__PoPFusionTFLNOA);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_perception_msgs__msg__PoPFusionTFLNOA * data =
      (deva_perception_msgs__msg__PoPFusionTFLNOA *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_perception_msgs__msg__PoPFusionTFLNOA__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_perception_msgs__msg__PoPFusionTFLNOA__fini(&output->data[i]);
        }
        return false;
      }
    }
