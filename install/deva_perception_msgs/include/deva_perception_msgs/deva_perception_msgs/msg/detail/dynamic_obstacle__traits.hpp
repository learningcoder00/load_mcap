...
#ifndef DEVA_PERCEPTION_MSGS__MSG__DETAIL__DYNAMIC_OBSTACLE__TRAITS_HPP_
#define DEVA_PERCEPTION_MSGS__MSG__DETAIL__DYNAMIC_OBSTACLE__TRAITS_HPP_
...
inline void to_yaml(
  const deva_perception_msgs::msg::DynamicObstacle & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_perception_msgs::msg::DynamicObstacle & msg)
{
  return deva_perception_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_perception_msgs::msg::DynamicObstacle>()
{
  return "deva_perception_msgs::msg::DynamicObstacle";
}

template<>
inline const char * name<deva_perception_msgs::msg::DynamicObstacle>()
{
  return "deva_perception_msgs/msg/DynamicObstacle";
}

template<>
struct has_fixed_size<deva_perception_msgs::msg::DynamicObstacle>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_perception_msgs::msg::DynamicObstacle>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_perception_msgs::msg::DynamicObstacle>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PERCEPTION_MSGS__MSG__DETAIL__DYNAMIC_OBSTACLE__TRAITS_HPP_
