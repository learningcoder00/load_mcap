...
deva_perception_msgs__msg__ChannelArray__init(deva_perception_msgs__msg__ChannelArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    deva_perception_msgs__msg__ChannelArray__fini(msg);
    return false;
  }
  // traffic_channel_array
  if (!deva_perception_msgs__msg__Channel__Sequence__init(&msg->traffic_channel_array, 0)) {
    deva_perception_msgs__msg__ChannelArray__fini(msg);
    return false;
  }
  // position
...
deva_perception_msgs__msg__ChannelArray__fini(deva_perception_msgs__msg__ChannelArray * msg)
{
  ...
  // traffic_channel_array
  deva_perception_msgs__msg__Channel__Sequence__fini(&msg->traffic_channel_array);
  // position
...
deva_perception_msgs__msg__ChannelArray__are_equal(const deva_perception_msgs__msg__ChannelArray * lhs, const deva_perception_msgs__msg__ChannelArray * rhs)
{
  ...
  // traffic_channel_array
  if (!deva_perception_msgs__msg__Channel__Sequence__are_equal(
  ...
  deva_perception_msgs__msg__ChannelArray * output)
{
  ...
  // traffic_channel_array
  if (!deva_perception_msgs__msg__Channel__Sequence__copy(
...
deva_perception_msgs__msg__ChannelArray__create()
{
  ...
  deva_perception_msgs__msg__ChannelArray * msg = (deva_perception_msgs__msg__ChannelArray *)allocator.allocate(sizeof(deva_perception_msgs__msg__ChannelArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_perception_msgs__msg__ChannelArray));
  bool success = deva_perception_msgs__msg__ChannelArray__init(msg);
  if (!success) {
...
deva_perception_msgs__msg__ChannelArray__Sequence__init(deva_perception_msgs__msg__ChannelArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__ChannelArray * data = NULL;

  if (size) {
    data = (deva_perception_msgs__msg__ChannelArray *)allocator.zero_allocate(size, sizeof(deva_perception_msgs__msg__ChannelArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_perception_msgs__msg__ChannelArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_perception_msgs__msg__ChannelArray__fini(&data[i - 1]);
      }
...
deva_perception_msgs__msg__ChannelArray__Sequence__fini(deva_perception_msgs__msg__ChannelArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_perception_msgs__msg__ChannelArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__ChannelArray__Sequence * array = (deva_perception_msgs__msg__ChannelArray__Sequence *)allocator.allocate(sizeof(deva_perception_msgs__msg__ChannelArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_perception_msgs__msg__ChannelArray__Sequence__init(array, size);
  if (!success) {
...
deva_perception_msgs__msg__ChannelArray__Sequence__destroy(deva_perception_msgs__msg__ChannelArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_perception_msgs__msg__ChannelArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_perception_msgs__msg__ChannelArray__Sequence__are_equal(const deva_perception_msgs__msg__ChannelArray__Sequence * lhs, const deva_perception_msgs__msg__ChannelArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_perception_msgs__msg__ChannelArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_perception_msgs__msg__ChannelArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_perception_msgs__msg__ChannelArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_perception_msgs__msg__ChannelArray * data =
      (deva_perception_msgs__msg__ChannelArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_perception_msgs__msg__ChannelArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_perception_msgs__msg__ChannelArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_perception_msgs__msg__ChannelArray__copy(
