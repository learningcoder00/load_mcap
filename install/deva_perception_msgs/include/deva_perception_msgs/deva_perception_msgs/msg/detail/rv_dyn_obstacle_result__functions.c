...
deva_perception_msgs__msg__RVDynObstacleResult__init(deva_perception_msgs__msg__RVDynObstacleResult * msg)
{
  ...
  if (!deva_common_msgs__msg__Header__init(&msg->header)) {
    deva_perception_msgs__msg__RVDynObstacleResult__fini(msg);
    return false;
  }
  // translation
  ...
  // dynamic_obs_list
  if (!deva_perception_msgs__msg__RVDynObstacleList__Sequence__init(&msg->dynamic_obs_list, 0)) {
    deva_perception_msgs__msg__RVDynObstacleResult__fini(msg);
    return false;
  }
  // extra_infos
...
deva_perception_msgs__msg__RVDynObstacleResult__fini(deva_perception_msgs__msg__RVDynObstacleResult * msg)
{
  ...
  // dynamic_obs_list
  deva_perception_msgs__msg__RVDynObstacleList__Sequence__fini(&msg->dynamic_obs_list);
  // extra_infos
...
deva_perception_msgs__msg__RVDynObstacleResult__are_equal(const deva_perception_msgs__msg__RVDynObstacleResult * lhs, const deva_perception_msgs__msg__RVDynObstacleResult * rhs)
{
  ...
  // dynamic_obs_list
  if (!deva_perception_msgs__msg__RVDynObstacleList__Sequence__are_equal(
  ...
  deva_perception_msgs__msg__RVDynObstacleResult * output)
{
  ...
  // dynamic_obs_list
  if (!deva_perception_msgs__msg__RVDynObstacleList__Sequence__copy(
...
deva_perception_msgs__msg__RVDynObstacleResult__create()
{
  ...
  deva_perception_msgs__msg__RVDynObstacleResult * msg = (deva_perception_msgs__msg__RVDynObstacleResult *)allocator.allocate(sizeof(deva_perception_msgs__msg__RVDynObstacleResult), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_perception_msgs__msg__RVDynObstacleResult));
  bool success = deva_perception_msgs__msg__RVDynObstacleResult__init(msg);
  if (!success) {
...
deva_perception_msgs__msg__RVDynObstacleResult__Sequence__init(deva_perception_msgs__msg__RVDynObstacleResult__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__RVDynObstacleResult * data = NULL;

  if (size) {
    data = (deva_perception_msgs__msg__RVDynObstacleResult *)allocator.zero_allocate(size, sizeof(deva_perception_msgs__msg__RVDynObstacleResult), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_perception_msgs__msg__RVDynObstacleResult__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_perception_msgs__msg__RVDynObstacleResult__fini(&data[i - 1]);
      }
...
deva_perception_msgs__msg__RVDynObstacleResult__Sequence__fini(deva_perception_msgs__msg__RVDynObstacleResult__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_perception_msgs__msg__RVDynObstacleResult__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__RVDynObstacleResult__Sequence * array = (deva_perception_msgs__msg__RVDynObstacleResult__Sequence *)allocator.allocate(sizeof(deva_perception_msgs__msg__RVDynObstacleResult__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_perception_msgs__msg__RVDynObstacleResult__Sequence__init(array, size);
  if (!success) {
...
deva_perception_msgs__msg__RVDynObstacleResult__Sequence__destroy(deva_perception_msgs__msg__RVDynObstacleResult__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_perception_msgs__msg__RVDynObstacleResult__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_perception_msgs__msg__RVDynObstacleResult__Sequence__are_equal(const deva_perception_msgs__msg__RVDynObstacleResult__Sequence * lhs, const deva_perception_msgs__msg__RVDynObstacleResult__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_perception_msgs__msg__RVDynObstacleResult__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_perception_msgs__msg__RVDynObstacleResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_perception_msgs__msg__RVDynObstacleResult);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_perception_msgs__msg__RVDynObstacleResult * data =
      (deva_perception_msgs__msg__RVDynObstacleResult *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_perception_msgs__msg__RVDynObstacleResult__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_perception_msgs__msg__RVDynObstacleResult__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_perception_msgs__msg__RVDynObstacleResult__copy(
