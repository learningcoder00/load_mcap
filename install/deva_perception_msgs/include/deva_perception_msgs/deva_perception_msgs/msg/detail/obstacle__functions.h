...
#ifndef DEVA_PERCEPTION_MSGS__MSG__DETAIL__OBSTACLE__FUNCTIONS_H_
#define DEVA_PERCEPTION_MSGS__MSG__DETAIL__OBSTACLE__FUNCTIONS_H_
 ...
 * calls
 * deva_perception_msgs__msg__Obstacle__init().
...
/**
 * It calls
 * deva_perception_msgs__msg__Obstacle__fini()
 ...
 * deva_perception_msgs__msg__Obstacle__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * deva_perception_msgs__msg__Obstacle__Sequence__fini()
 * on the array,
...
#endif  // DEVA_PERCEPTION_MSGS__MSG__DETAIL__OBSTACLE__FUNCTIONS_H_
