...
{
  new (message_memory) deva_perception_msgs::msg::RoadInfo(_init);
}

void RoadInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_perception_msgs::msg::RoadInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoadInfo_message_member_array[3] = {
  {
    ...
    offsetof(deva_perception_msgs::msg::RoadInfo, has_traffic_light),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_perception_msgs::msg::RoadInfo, road_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_perception_msgs::msg::RoadInfo, road_class),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoadInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(deva_perception_msgs::msg::RoadInfo),
...
get_message_type_support_handle<deva_perception_msgs::msg::RoadInfo>()
{
  return &::deva_perception_msgs::msg::rosidl_typesupport_introspection_cpp::RoadInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_perception_msgs, msg, RoadInfo)() {
  return &::deva_perception_msgs::msg::rosidl_typesupport_introspection_cpp::RoadInfo_message_type_support_handle;
}
