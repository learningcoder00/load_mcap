...
#include "deva_control_msgs/msg/detail/wheel_speed__rosidl_typesupport_fastrtps_c.h"
...
using _WheelSpeed__ros_msg_type = deva_control_msgs__msg__WheelSpeed;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: loop_count_start
  {
    cdr << ros_message->loop_count_start;
  }

  // Field name: loop_count_end
  {
  ...
  {
    size_t size = 4;
    auto array_ptr = ros_message->wheelspeed_rc_valid;
  ...
  {
    size_t size = 4;
    auto array_ptr = ros_message->wheelspeed_rc;
    cdr.serializeArray(array_ptr, size);
  }
...
static uint32_t _WheelSpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_control_msgs__msg__WheelSpeed(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_control_msgs__msg__WheelSpeed;
    is_plain =
      (
...
static size_t _WheelSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_control_msgs__msg__WheelSpeed(
