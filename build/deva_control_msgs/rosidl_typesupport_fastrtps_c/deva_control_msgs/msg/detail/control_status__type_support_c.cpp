...
#include "deva_control_msgs/msg/detail/control_status__rosidl_typesupport_fastrtps_c.h"
...
using _ControlStatus__ros_msg_type = deva_control_msgs__msg__ControlStatus;
  ...
  void * untyped_ros_message)
{
  ...
  _ControlStatus__ros_msg_type * ros_message = static_cast<_ControlStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
...
size_t get_serialized_size_deva_control_msgs__msg__ControlStatus(
  const void * untyped_ros_message,
...
static uint32_t _ControlStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_control_msgs__msg__ControlStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_control_msgs
size_t max_serialized_size_deva_control_msgs__msg__ControlStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_control_msgs__msg__ControlStatus;
    is_plain =
      (
...
static size_t _ControlStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_control_msgs__msg__ControlStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_control_msgs, msg, ControlStatus)() {
