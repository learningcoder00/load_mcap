...
static const _WheelSpeed_type_support_symbol_names_t _WheelSpeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_control_msgs, msg, WheelSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_control_msgs, msg, WheelSpeed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_control_msgs, msg, WheelSpeed)() {
  return &::deva_control_msgs::msg::rosidl_typesupport_c::WheelSpeed_message_type_support_handle;
}
