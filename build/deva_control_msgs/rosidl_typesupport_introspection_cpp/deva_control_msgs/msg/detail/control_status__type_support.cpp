...
{
  new (message_memory) deva_control_msgs::msg::ControlStatus(_init);
}

void ControlStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_control_msgs::msg::ControlStatus *>(message_memory);
  typed_message->~ControlStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlStatus_message_member_array[1] = {
  {
    "status",  // name
    ...
    offsetof(deva_control_msgs::msg::ControlStatus, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControlStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(deva_control_msgs::msg::ControlStatus),
...
get_message_type_support_handle<deva_control_msgs::msg::ControlStatus>()
{
  return &::deva_control_msgs::msg::rosidl_typesupport_introspection_cpp::ControlStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_control_msgs, msg, ControlStatus)() {
  return &::deva_control_msgs::msg::rosidl_typesupport_introspection_cpp::ControlStatus_message_type_support_handle;
}
