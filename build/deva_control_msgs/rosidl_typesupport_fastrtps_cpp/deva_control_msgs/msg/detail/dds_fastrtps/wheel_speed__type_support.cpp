...
#include "deva_control_msgs/msg/detail/wheel_speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_control_msgs::msg::WheelSpeed & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.loop_count_start;
  // Member: loop_count_end
  cdr << ros_message.loop_count_end;
  // Member: wheelspeed_rc_valid
  {
    cdr << ros_message.wheelspeed_rc_valid;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_control_msgs::msg::WheelSpeed & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: loop_count_start
  {
    size_t item_size = sizeof(ros_message.loop_count_start);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: loop_count_end
  {
    size_t item_size = sizeof(ros_message.loop_count_end);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: wheelspeed_rc_valid
  {
    size_t array_size = 4;
    size_t item_size = sizeof(ros_message.wheelspeed_rc_valid[0]);
  ...
  {
    size_t array_size = 4;
    size_t item_size = sizeof(ros_message.wheelspeed_rc[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_control_msgs::msg::WheelSpeed;
    is_plain =
      (
      offsetof(DataType, wheelspeed_rc) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const deva_control_msgs::msg::WheelSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_control_msgs::msg::WheelSpeed *>(
    untyped_ros_message);
...
{
  return &deva_control_msgs::msg::typesupport_fastrtps_cpp::_WheelSpeed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_control_msgs, msg, WheelSpeed)() {
  return &deva_control_msgs::msg::typesupport_fastrtps_cpp::_WheelSpeed__handle;
}
