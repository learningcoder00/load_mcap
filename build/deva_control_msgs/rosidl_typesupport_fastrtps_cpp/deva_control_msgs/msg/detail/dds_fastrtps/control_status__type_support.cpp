...
#include "deva_control_msgs/msg/detail/control_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_control_msgs::msg::ControlStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_control_msgs::msg::ControlStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_control_msgs::msg::ControlStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_control_msgs::msg::ControlStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_control_msgs::msg::ControlStatus *>(
    untyped_ros_message);
...
{
  return &deva_control_msgs::msg::typesupport_fastrtps_cpp::_ControlStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_control_msgs, msg, ControlStatus)() {
  return &deva_control_msgs::msg::typesupport_fastrtps_cpp::_ControlStatus__handle;
}
