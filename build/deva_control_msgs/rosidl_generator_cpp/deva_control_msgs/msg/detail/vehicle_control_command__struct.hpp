...
#ifndef DEVA_CONTROL_MSGS__MSG__DETAIL__VEHICLE_CONTROL_COMMAND__STRUCT_HPP_
#define DEVA_CONTROL_MSGS__MSG__DETAIL__VEHICLE_CONTROL_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_control_msgs__msg__VehicleControlCommand __attribute__((deprecated))
#else
# define DEPRECATED__deva_control_msgs__msg__VehicleControlCommand __declspec(deprecated)
#endif
...
struct VehicleControlCommand_
{
  ...
  // pointer types
  using RawPtr =
    deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_control_msgs__msg__VehicleControlCommand
    std::shared_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_control_msgs__msg__VehicleControlCommand
    std::shared_ptr<deva_control_msgs::msg::VehicleControlCommand_<ContainerAllocator> const>
...
using VehicleControlCommand =
  deva_control_msgs::msg::VehicleControlCommand_<std::allocator<void>>;
...
#endif  // DEVA_CONTROL_MSGS__MSG__DETAIL__VEHICLE_CONTROL_COMMAND__STRUCT_HPP_
