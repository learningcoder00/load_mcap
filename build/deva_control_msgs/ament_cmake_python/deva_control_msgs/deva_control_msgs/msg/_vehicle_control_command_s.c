...
bool deva_control_msgs__msg__vehicle_control_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_control_msgs.msg._vehicle_control_command.VehicleControlCommand", full_classname_dest, 68) == 0);
  }
  deva_control_msgs__msg__VehicleControlCommand * ros_message = _ros_message;
  {  // header
...
PyObject * deva_control_msgs__msg__vehicle_control_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_control_msgs.msg._vehicle_control_command");
