    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_localization_msgs.msg.RawImu')
            logger.debug(
...
class RawImu(metaclass=Metaclass_RawImu):
    ...
    def __init__(self, **kwargs):
        ...
        self.measurement_span = kwargs.get('measurement_span', float())
        from geometry_msgs.msg import Point
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.measurement_span != other.measurement_span:
            return False
    ...
    @builtins.property
    def measurement_span(self):
        """Message field 'measurement_span'."""
        return self._measurement_span

    @measurement_span.setter
    def measurement_span(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'measurement_span' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'measurement_span' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._measurement_span = value
