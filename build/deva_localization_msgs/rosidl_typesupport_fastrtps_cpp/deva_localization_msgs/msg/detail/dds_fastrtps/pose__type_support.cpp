...
#include "deva_localization_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_localization_msgs::msg::Pose & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: utm_id
  cdr << ros_message.utm_id;
  // Member: position
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_localization_msgs::msg::Pose & ros_message)
{
  // Member: utm_id
  cdr >> ros_message.utm_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: utm_id
  {
    size_t item_size = sizeof(ros_message.utm_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_localization_msgs::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_localization_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_localization_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  return &deva_localization_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_localization_msgs, msg, Pose)() {
  return &deva_localization_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
