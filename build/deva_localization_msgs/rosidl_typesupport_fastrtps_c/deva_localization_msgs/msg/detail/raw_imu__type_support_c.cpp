...
#include "deva_localization_msgs/msg/detail/raw_imu__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // angular_velocity, linear_acceleration
...
using _RawImu__ros_msg_type = deva_localization_msgs__msg__RawImu;
...
size_t get_serialized_size_deva_localization_msgs__msg__RawImu(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RawImu__ros_msg_type * ros_message = static_cast<const _RawImu__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RawImu__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_localization_msgs__msg__RawImu(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_localization_msgs
size_t max_serialized_size_deva_localization_msgs__msg__RawImu(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_localization_msgs__msg__RawImu;
    is_plain =
      (
...
static size_t _RawImu__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_localization_msgs__msg__RawImu(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_localization_msgs, msg, RawImu)() {
