...
#include "deva_localization_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // angular_velocity, angular_velocity_vrf, euler_angles, linear_acceleration, linear_acceleration_vrf, linear_velocity, position
...
using _Pose__ros_msg_type = deva_localization_msgs__msg__Pose;
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_localization_msgs__msg__Pose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_localization_msgs__msg__Pose;
    is_plain =
      (
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_localization_msgs__msg__Pose(
