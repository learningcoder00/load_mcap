...
static const _GnssBestPose_type_support_symbol_names_t _GnssBestPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_localization_msgs, msg, GnssBestPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_localization_msgs, msg, GnssBestPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_localization_msgs, msg, GnssBestPose)() {
  return &::deva_localization_msgs::msg::rosidl_typesupport_c::GnssBestPose_message_type_support_handle;
}
