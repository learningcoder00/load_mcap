...
bool deva_localization_msgs__msg__raw_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_localization_msgs.msg._raw_imu.RawImu", full_classname_dest, 42) == 0);
  }
  deva_localization_msgs__msg__RawImu * ros_message = _ros_message;
  {  // header
  ...
  {  // measurement_span
    PyObject * field = PyObject_GetAttrString(_pymsg, "measurement_span");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->measurement_span = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // linear_acceleration
...
PyObject * deva_localization_msgs__msg__raw_imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_localization_msgs.msg._raw_imu");
  ...
  {  // measurement_span
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->measurement_span);
    {
      int rc = PyObject_SetAttrString(_pymessage, "measurement_span", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
