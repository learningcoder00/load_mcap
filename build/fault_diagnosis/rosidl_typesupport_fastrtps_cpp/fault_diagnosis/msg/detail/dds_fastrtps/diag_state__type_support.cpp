...
#include "fault_diagnosis/msg/detail/diag_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fault_diagnosis::msg::DiagState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fault_diagnosis::msg::DiagState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fault_diagnosis::msg::DiagState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fault_diagnosis::msg::DiagState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fault_diagnosis::msg::DiagState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DiagState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fault_diagnosis::msg::DiagState *>(
...
static size_t _DiagState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DiagState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DiagState__callbacks = {
  "fault_diagnosis::msg",
  "DiagState",
...
static rosidl_message_type_support_t _DiagState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DiagState__callbacks,
...
{
  return &fault_diagnosis::msg::typesupport_fastrtps_cpp::_DiagState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fault_diagnosis, msg, DiagState)() {
  return &fault_diagnosis::msg::typesupport_fastrtps_cpp::_DiagState__handle;
}
