...
#include "deva_planning_msgs2/msg/detail/avp_ref_line__rosidl_typesupport_fastrtps_c.h"
...
using _AvpRefLine__ros_msg_type = deva_planning_msgs2__msg__AvpRefLine;
...
static uint32_t _AvpRefLine__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__AvpRefLine(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__AvpRefLine;
    is_plain =
      (
...
static size_t _AvpRefLine__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__AvpRefLine(
