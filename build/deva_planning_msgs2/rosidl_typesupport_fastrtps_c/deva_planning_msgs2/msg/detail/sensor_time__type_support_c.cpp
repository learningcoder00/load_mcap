...
#include "deva_planning_msgs2/msg/detail/sensor_time__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/header__functions.h"  // chassis_header, cone_header, decision_header, finish_planning_header, localization_header, map_header, navigator_end_header, navigator_start_header, padmsg_header, prediction_header, pull_over_header, routing_header, start_planning_header, traffic_light_header, traffic_pole_header
...
using _SensorTime__ros_msg_type = deva_planning_msgs2__msg__SensorTime;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SensorTime__ros_msg_type * ros_message = static_cast<const _SensorTime__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: decision_header
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->decision_header, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: traffic_light_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->traffic_light_header, cdr))
    {
      return false;
    }
  }

  // Field name: traffic_pole_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->traffic_pole_header, cdr))
    {
      return false;
    }
  }

  // Field name: cone_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  // Field name: padmsg_header
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->padmsg_header, cdr))
    {
      return false;
    }
  }

  // Field name: pull_over_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->pull_over_header, cdr))
    {
      return false;
    }
  }

  // Field name: routing_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->routing_header, cdr))
    {
      return false;
    }
  }

  // Field name: start_planning_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->start_planning_header, cdr))
    {
      return false;
    }
  }

  // Field name: finish_planning_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->finish_planning_header, cdr))
    {
      return false;
    }
  }

  // Field name: navigator_start_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->navigator_start_header, cdr))
    {
      return false;
    }
  }

  // Field name: navigator_end_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->navigator_end_header, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _SensorTime__ros_msg_type * ros_message = static_cast<_SensorTime__ros_msg_type *>(untyped_ros_message);
  // Field name: localization_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _SensorTime__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__SensorTime(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__SensorTime;
    is_plain =
      (
...
static size_t _SensorTime__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__SensorTime(
...
static message_type_support_callbacks_t __callbacks_SensorTime = {
...
static rosidl_message_type_support_t _SensorTime__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SensorTime,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, SensorTime)() {
  return &_SensorTime__type_support;
}
