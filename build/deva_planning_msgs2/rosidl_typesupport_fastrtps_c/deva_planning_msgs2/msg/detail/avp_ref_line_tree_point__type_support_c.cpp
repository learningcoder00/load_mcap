...
#include "deva_planning_msgs2/msg/detail/avp_ref_line_tree_point__rosidl_typesupport_fastrtps_c.h"
...
using _AvpRefLineTreePoint__ros_msg_type = deva_planning_msgs2__msg__AvpRefLineTreePoint;
...
static uint32_t _AvpRefLineTreePoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__AvpRefLineTreePoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__AvpRefLineTreePoint;
    is_plain =
      (
...
static size_t _AvpRefLineTreePoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__AvpRefLineTreePoint(
