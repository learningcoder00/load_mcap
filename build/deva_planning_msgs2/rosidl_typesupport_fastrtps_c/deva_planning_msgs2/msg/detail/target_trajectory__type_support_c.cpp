...
#include "deva_planning_msgs2/msg/detail/target_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs2/msg/detail/path_point__functions.h"  // path_point, stop_pose
#include "deva_planning_msgs2/msg/detail/sensor_time__functions.h"  // sensor_timestamp
#include "deva_planning_msgs2/msg/detail/trajectory_point__functions.h"  // trajectory_point
...
using _TargetTrajectory__ros_msg_type = deva_planning_msgs2__msg__TargetTrajectory;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trajectory_point
  {
    ...
    if (ros_message->trajectory_point.data) {
      deva_planning_msgs2__msg__TrajectoryPoint__Sequence__fini(&ros_message->trajectory_point);
    }
  ...
  // Field name: path_point
  {
    ...
    if (ros_message->path_point.data) {
      deva_planning_msgs2__msg__PathPoint__Sequence__fini(&ros_message->path_point);
    }
...
static uint32_t _TargetTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__TargetTrajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__TargetTrajectory;
    is_plain =
      (
...
static size_t _TargetTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__TargetTrajectory(
