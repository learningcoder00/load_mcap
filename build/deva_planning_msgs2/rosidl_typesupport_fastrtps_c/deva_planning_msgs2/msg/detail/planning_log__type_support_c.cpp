...
#include "deva_planning_msgs2/msg/detail/planning_log__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs2/msg/detail/string2_bool__functions.h"  // scalable_bool
#include "deva_planning_msgs2/msg/detail/string2_double__functions.h"  // scalable_double
#include "deva_planning_msgs2/msg/detail/string2_int__functions.h"  // scalable_int
...
size_t get_serialized_size_deva_planning_msgs2__msg__String2Bool(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs2__msg__String2Bool(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, String2Bool)();
...
size_t get_serialized_size_deva_planning_msgs2__msg__String2Int(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs2__msg__String2Int(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, String2Int)();
...
using _PlanningLog__ros_msg_type = deva_planning_msgs2__msg__PlanningLog;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: scalable_int
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, String2Int
      )()->data);
    size_t size = ros_message->scalable_int.size;
    auto array_ptr = ros_message->scalable_int.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: scalable_double
  {
    ...
    size_t size = ros_message->scalable_double.size;
    auto array_ptr = ros_message->scalable_double.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: scalable_bool
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, String2Bool
      )()->data);
    size_t size = ros_message->scalable_bool.size;
    auto array_ptr = ros_message->scalable_bool.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: scalable_int
  {
    ...
    if (ros_message->scalable_int.data) {
      deva_planning_msgs2__msg__String2Int__Sequence__fini(&ros_message->scalable_int);
    }
    if (!deva_planning_msgs2__msg__String2Int__Sequence__init(&ros_message->scalable_int, size)) {
      fprintf(stderr, "failed to create array for field 'scalable_int'");
      return false;
    }
    auto array_ptr = ros_message->scalable_int.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: scalable_double
  {
    ...
    if (ros_message->scalable_double.data) {
      deva_planning_msgs2__msg__String2Double__Sequence__fini(&ros_message->scalable_double);
    }
    if (!deva_planning_msgs2__msg__String2Double__Sequence__init(&ros_message->scalable_double, size)) {
      fprintf(stderr, "failed to create array for field 'scalable_double'");
      return false;
    }
    auto array_ptr = ros_message->scalable_double.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: scalable_bool
  {
    ...
    if (ros_message->scalable_bool.data) {
      deva_planning_msgs2__msg__String2Bool__Sequence__fini(&ros_message->scalable_bool);
    }
    if (!deva_planning_msgs2__msg__String2Bool__Sequence__init(&ros_message->scalable_bool, size)) {
      fprintf(stderr, "failed to create array for field 'scalable_bool'");
      return false;
    }
    auto array_ptr = ros_message->scalable_bool.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_deva_planning_msgs2__msg__PlanningLog(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanningLog__ros_msg_type * ros_message = static_cast<const _PlanningLog__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name scalable_int
  {
    size_t array_size = ros_message->scalable_int.size;
    auto array_ptr = ros_message->scalable_int.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);

    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs2__msg__String2Int(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name scalable_double
  {
    size_t array_size = ros_message->scalable_double.size;
    auto array_ptr = ros_message->scalable_double.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
  ...
  // field.name scalable_bool
  {
    size_t array_size = ros_message->scalable_bool.size;
    auto array_ptr = ros_message->scalable_bool.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);

    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs2__msg__String2Bool(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _PlanningLog__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__PlanningLog(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_planning_msgs2
size_t max_serialized_size_deva_planning_msgs2__msg__PlanningLog(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: scalable_int
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs2__msg__String2Int(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: scalable_bool
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs2__msg__String2Bool(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__PlanningLog;
    is_plain =
      (
      offsetof(DataType, scalable_bool) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PlanningLog__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__PlanningLog(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, PlanningLog)() {
