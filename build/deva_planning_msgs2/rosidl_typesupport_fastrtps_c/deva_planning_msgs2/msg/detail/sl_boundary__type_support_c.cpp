...
#include "deva_planning_msgs2/msg/detail/sl_boundary__rosidl_typesupport_fastrtps_c.h"
...
using _SLBoundary__ros_msg_type = deva_planning_msgs2__msg__SLBoundary;
...
static uint32_t _SLBoundary__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__SLBoundary(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__SLBoundary;
    is_plain =
      (
...
static size_t _SLBoundary__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__SLBoundary(
