...
#include "deva_planning_msgs2/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs2/msg/detail/path_point__functions.h"  // path_point
...
using _TrajectoryPoint__ros_msg_type = deva_planning_msgs2__msg__TrajectoryPoint;
...
static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__TrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__TrajectoryPoint;
    is_plain =
      (
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__TrajectoryPoint(
