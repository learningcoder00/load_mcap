...
#include "deva_planning_msgs2/msg/detail/string2_string__rosidl_typesupport_fastrtps_c.h"
...
using _String2String__ros_msg_type = deva_planning_msgs2__msg__String2String;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _String2String__ros_msg_type * ros_message = static_cast<const _String2String__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
  ...
  void * untyped_ros_message)
{
  ...
  _String2String__ros_msg_type * ros_message = static_cast<_String2String__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _String2String__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__String2String(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__String2String;
    is_plain =
      (
...
static size_t _String2String__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__String2String(
...
static message_type_support_callbacks_t __callbacks_String2String = {
...
static rosidl_message_type_support_t _String2String__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_String2String,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, String2String)() {
  return &_String2String__type_support;
}
