...
#include "deva_planning_msgs2/msg/detail/u_int2_string__rosidl_typesupport_fastrtps_c.h"
...
using _UInt2String__ros_msg_type = deva_planning_msgs2__msg__UInt2String;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UInt2String__ros_msg_type * ros_message = static_cast<const _UInt2String__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    cdr << ros_message->key;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _UInt2String__ros_msg_type * ros_message = static_cast<_UInt2String__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    cdr >> ros_message->key;
  }
...
static uint32_t _UInt2String__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__UInt2String(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__UInt2String;
    is_plain =
      (
...
static size_t _UInt2String__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs2__msg__UInt2String(
...
static message_type_support_callbacks_t __callbacks_UInt2String = {
...
static rosidl_message_type_support_t _UInt2String__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UInt2String,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, UInt2String)() {
  return &_UInt2String__type_support;
}
