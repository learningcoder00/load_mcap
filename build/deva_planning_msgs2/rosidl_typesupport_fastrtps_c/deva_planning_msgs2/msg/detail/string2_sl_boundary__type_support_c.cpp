...
#include "deva_planning_msgs2/msg/detail/string2_sl_boundary__rosidl_typesupport_fastrtps_c.h"
...
using _String2SLBoundary__ros_msg_type = deva_planning_msgs2__msg__String2SLBoundary;

static bool _String2SLBoundary__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _String2SLBoundary__ros_msg_type * ros_message = static_cast<const _String2SLBoundary__ros_msg_type *>(untyped_ros_message);
  // Field name: obs_id
  {
...
static bool _String2SLBoundary__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _String2SLBoundary__ros_msg_type * ros_message = static_cast<_String2SLBoundary__ros_msg_type *>(untyped_ros_message);
  // Field name: obs_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _String2SLBoundary__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs2__msg__String2SLBoundary(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2__msg__String2SLBoundary;
    is_plain =
      (
...
static size_t _String2SLBoundary__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_planning_msgs2__msg__String2SLBoundary(
...
static message_type_support_callbacks_t __callbacks_String2SLBoundary = {
  "deva_planning_msgs2::msg",
  "String2SLBoundary",
  _String2SLBoundary__cdr_serialize,
  _String2SLBoundary__cdr_deserialize,
  _String2SLBoundary__get_serialized_size,
  _String2SLBoundary__max_serialized_size
};

static rosidl_message_type_support_t _String2SLBoundary__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_String2SLBoundary,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs2, msg, String2SLBoundary)() {
  return &_String2SLBoundary__type_support;
}
