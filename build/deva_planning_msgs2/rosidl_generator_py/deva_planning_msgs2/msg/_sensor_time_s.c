...
bool deva_planning_msgs2__msg__sensor_time__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._sensor_time.SensorTime", full_classname_dest, 47) == 0);
  }
  deva_planning_msgs2__msg__SensorTime * ros_message = _ros_message;
  {  // localization_header
...
PyObject * deva_planning_msgs2__msg__sensor_time__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._sensor_time");
