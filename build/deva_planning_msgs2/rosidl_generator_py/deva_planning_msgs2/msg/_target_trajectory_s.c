...
bool deva_planning_msgs2__msg__target_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._target_trajectory.TargetTrajectory", full_classname_dest, 59) == 0);
  }
  deva_planning_msgs2__msg__TargetTrajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // sensor_timestamp
    ...
    if (!deva_planning_msgs2__msg__sensor_time__convert_from_py(field, &ros_message->sensor_timestamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // trajectory_point
    ...
    if (!deva_planning_msgs2__msg__TrajectoryPoint__Sequence__init(&(ros_message->trajectory_point), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__TrajectoryPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__TrajectoryPoint * dest = ros_message->trajectory_point.data;
  ...
  {  // path_point
    ...
    if (!deva_planning_msgs2__msg__PathPoint__Sequence__init(&(ros_message->path_point), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__PathPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__PathPoint * dest = ros_message->path_point.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // stop_pose
    ...
    if (!deva_planning_msgs2__msg__path_point__convert_from_py(field, &ros_message->stop_pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * deva_planning_msgs2__msg__target_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._target_trajectory");
  ...
  {  // sensor_timestamp
    PyObject * field = NULL;
    field = deva_planning_msgs2__msg__sensor_time__convert_to_py(&ros_message->sensor_timestamp);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // stop_pose
    PyObject * field = NULL;
    field = deva_planning_msgs2__msg__path_point__convert_to_py(&ros_message->stop_pose);
    if (!field) {
      return NULL;
    }
    {
