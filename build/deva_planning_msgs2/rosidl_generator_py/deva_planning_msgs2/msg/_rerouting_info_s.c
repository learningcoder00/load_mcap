...
bool deva_planning_msgs2__msg__rerouting_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._rerouting_info.ReroutingInfo", full_classname_dest, 53) == 0);
  }
  deva_planning_msgs2__msg__ReroutingInfo * ros_message = _ros_message;
  {  // obstacle_edges
...
PyObject * deva_planning_msgs2__msg__rerouting_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._rerouting_info");
