...
class ReferenceLine(metaclass=Metaclass_ReferenceLine):
    ...
    def __init__(self, **kwargs):
        ...
        self.line_is_model = kwargs.get('line_is_model', bool())
    ...
    def __eq__(self, other):
        ...
        if self.reference_line_type != other.reference_line_type:
            return False
        if self.line_is_model != other.line_is_model:
            return False
    ...
    @builtins.property
    def line_is_model(self):
        """Message field 'line_is_model'."""
        return self._line_is_model

    @line_is_model.setter
    def line_is_model(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'line_is_model' field must be of type 'bool'"
        self._line_is_model = value
