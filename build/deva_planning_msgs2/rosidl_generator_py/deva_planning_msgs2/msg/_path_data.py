...
class Metaclass_PathData(type):
    """Metaclass of message 'PathData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__path_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__path_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__path_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__path_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__path_data
...
class PathData(metaclass=Metaclass_PathData):
    """Message class 'PathData'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.speedlimit = kwargs.get('speedlimit', float())
    ...
    def speedlimit(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'speedlimit' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'speedlimit' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
