...
bool deva_planning_msgs2__msg__u_int2_string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._u_int2_string.UInt2String", full_classname_dest, 50) == 0);
  }
  deva_planning_msgs2__msg__UInt2String * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of UInt2String */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._u_int2_string");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UInt2String");
