...
bool deva_planning_msgs2__msg__planning_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._planning_obstacle.PlanningObstacle", full_classname_dest, 59) == 0);
  }
  deva_planning_msgs2__msg__PlanningObstacle * ros_message = _ros_message;
  {  // id
  ...
  {  // current_line_id
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->current_line_id.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'current_line_id'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // target_line_id
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->target_line_id.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'target_line_id'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // decision_tag
    PyObject * field = PyObject_GetAttrString(_pymsg, "decision_tag");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->decision_tag.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'decision_tag'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // scene_understanding
    PyObject * field = PyObject_GetAttrString(_pymsg, "scene_understanding");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->scene_understanding.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'scene_understanding'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // cutin_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "cutin_time");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cutin_time = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // cutout_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "cutout_time");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cutout_time = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // distance
...
{
  /* NOTE(esteve): Call constructor of PlanningObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._planning_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanningObstacle");
  ...
  {  // current_line_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "current_line_id");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->current_line_id.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->current_line_id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->current_line_id.size * sizeof(int32_t));
      assert(data != NULL);
  ...
  {  // target_line_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "target_line_id");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->target_line_id.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->target_line_id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->target_line_id.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // decision_tag
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "decision_tag");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->decision_tag.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->decision_tag.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->decision_tag.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // scene_understanding
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "scene_understanding");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->scene_understanding.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->scene_understanding.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->scene_understanding.size * sizeof(uint8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // cutin_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cutin_time);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cutin_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cutout_time
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cutout_time);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cutout_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
