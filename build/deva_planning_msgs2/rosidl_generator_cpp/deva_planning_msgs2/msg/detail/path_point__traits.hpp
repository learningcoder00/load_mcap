...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__PATH_POINT__TRAITS_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__PATH_POINT__TRAITS_HPP_
...
inline void to_yaml(
  const deva_planning_msgs2::msg::PathPoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs2::msg::PathPoint & msg)
{
  return deva_planning_msgs2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs2::msg::PathPoint>()
{
  return "deva_planning_msgs2::msg::PathPoint";
}

template<>
inline const char * name<deva_planning_msgs2::msg::PathPoint>()
{
  return "deva_planning_msgs2/msg/PathPoint";
}

template<>
struct has_fixed_size<deva_planning_msgs2::msg::PathPoint>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs2::msg::PathPoint>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs2::msg::PathPoint>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__PATH_POINT__TRAITS_HPP_
