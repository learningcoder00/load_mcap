...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__PATH_POINT__STRUCT_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__PATH_POINT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs2__msg__PathPoint __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs2__msg__PathPoint __declspec(deprecated)
#endif
...
struct PathPoint_
{
  ...
  using ConstRawPtr =
    const deva_planning_msgs2::msg::PathPoint_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs2::msg::PathPoint_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs2__msg__PathPoint
    std::shared_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs2__msg__PathPoint
    std::shared_ptr<deva_planning_msgs2::msg::PathPoint_<ContainerAllocator> const>
...
using PathPoint =
  deva_planning_msgs2::msg::PathPoint_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__PATH_POINT__STRUCT_HPP_
