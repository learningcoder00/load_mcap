...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__PLANNING_LOG__TRAITS_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__PLANNING_LOG__TRAITS_HPP_
...
// Member 'scalable_int'
#include "deva_planning_msgs2/msg/detail/string2_int__traits.hpp"
// Member 'scalable_double'
#include "deva_planning_msgs2/msg/detail/string2_double__traits.hpp"
// Member 'scalable_bool'
#include "deva_planning_msgs2/msg/detail/string2_bool__traits.hpp"
  ...
  std::ostream & out)
{
  ...
  // member: scalable_int
  {
    if (msg.scalable_int.size() == 0) {
      out << "scalable_int: []";
    } else {
      out << "scalable_int: [";
      size_t pending_items = msg.scalable_int.size();
      for (auto item : msg.scalable_int) {
        to_flow_style_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: scalable_double
  {
    if (msg.scalable_double.size() == 0) {
      out << "scalable_double: []";
    } else {
      out << "scalable_double: [";
      size_t pending_items = msg.scalable_double.size();
      for (auto item : msg.scalable_double) {
        to_flow_style_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: scalable_bool
  {
    if (msg.scalable_bool.size() == 0) {
      out << "scalable_bool: []";
    } else {
      out << "scalable_bool: [";
      size_t pending_items = msg.scalable_bool.size();
      for (auto item : msg.scalable_bool) {
        to_flow_style_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
...
inline void to_yaml(
  const deva_planning_msgs2::msg::PlanningLog & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs2::msg::PlanningLog & msg)
{
  return deva_planning_msgs2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs2::msg::PlanningLog>()
{
  return "deva_planning_msgs2::msg::PlanningLog";
}

template<>
inline const char * name<deva_planning_msgs2::msg::PlanningLog>()
{
  return "deva_planning_msgs2/msg/PlanningLog";
}

template<>
struct has_fixed_size<deva_planning_msgs2::msg::PlanningLog>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs2::msg::PlanningLog>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs2::msg::PlanningLog>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__PLANNING_LOG__TRAITS_HPP_
