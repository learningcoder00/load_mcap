...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__REFERENCE_LINE__TRAITS_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__REFERENCE_LINE__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "line_is_model: ";
    rosidl_generator_traits::value_to_yaml(msg.line_is_model, out);
    out << ", ";
  }
...
inline void to_yaml(
  const deva_planning_msgs2::msg::ReferenceLine & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs2::msg::ReferenceLine & msg)
{
  return deva_planning_msgs2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs2::msg::ReferenceLine>()
{
  return "deva_planning_msgs2::msg::ReferenceLine";
}

template<>
inline const char * name<deva_planning_msgs2::msg::ReferenceLine>()
{
  return "deva_planning_msgs2/msg/ReferenceLine";
}

template<>
struct has_fixed_size<deva_planning_msgs2::msg::ReferenceLine>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs2::msg::ReferenceLine>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs2::msg::ReferenceLine>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__REFERENCE_LINE__TRAITS_HPP_
