...
#ifndef DEVA_PLANNING_MSGS2__MSG__DETAIL__AVP_NAVIGATION_PLANNING_DEBUG_INFO__STRUCT_HPP_
#define DEVA_PLANNING_MSGS2__MSG__DETAIL__AVP_NAVIGATION_PLANNING_DEBUG_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs2__msg__AvpNavigationPlanningDebugInfo __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs2__msg__AvpNavigationPlanningDebugInfo __declspec(deprecated)
#endif
...
struct AvpNavigationPlanningDebugInfo_
{
  ...
  Type & set__avp_debug_info(
    const deva_planning_msgs2::msg::AvpDebugInfo_<ContainerAllocator> & _arg)
  {
    this->avp_debug_info = _arg;
    return *this;
  }
  Type & set__nav_openspace_debug_info(
    const deva_planning_msgs2::msg::NavOpenspaceDebugInfo_<ContainerAllocator> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs2__msg__AvpNavigationPlanningDebugInfo
    std::shared_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs2__msg__AvpNavigationPlanningDebugInfo
    std::shared_ptr<deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<ContainerAllocator> const>
...
using AvpNavigationPlanningDebugInfo =
  deva_planning_msgs2::msg::AvpNavigationPlanningDebugInfo_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS2__MSG__DETAIL__AVP_NAVIGATION_PLANNING_DEBUG_INFO__STRUCT_HPP_
