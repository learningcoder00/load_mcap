...
bool deva_planning_msgs2__msg__avp_ref_line__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__avp_ref_line__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__mpc_path_data__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_planning_msgs2__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__path_point__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__stitch_data__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__stitch_data__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool deva_planning_msgs2__msg__avp_debug_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._avp_debug_info.AvpDebugInfo", full_classname_dest, 52) == 0);
  }
  deva_planning_msgs2__msg__AvpDebugInfo * ros_message = _ros_message;
  {  // solve_num
  ...
  {  // origin_ref_line
    ...
    if (!deva_planning_msgs2__msg__AvpRefLine__Sequence__init(&(ros_message->origin_ref_line), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__AvpRefLine__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__AvpRefLine * dest = ros_message->origin_ref_line.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__avp_ref_line__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // smooth_line
    ...
    if (!deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_from_py(field, &ros_message->smooth_line)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // used_ref_line_tree
    ...
    if (!deva_planning_msgs2__msg__AvpRefLineTreePointVec__Sequence__init(&(ros_message->used_ref_line_tree), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__AvpRefLineTreePointVec__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__AvpRefLineTreePointVec * dest = ros_message->used_ref_line_tree.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // driver_path
    ...
    deva_planning_msgs2__msg__AvpRefLineTreePointVec * dest = ros_message->driver_path.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // now_mpc_data
    ...
    if (!deva_planning_msgs2__msg__MpcPathData__Sequence__init(&(ros_message->now_mpc_data), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__MpcPathData__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__MpcPathData * dest = ros_message->now_mpc_data.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__mpc_path_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // now_path_data
    ...
    deva_planning_msgs2__msg__MpcPathData * dest = ros_message->now_path_data.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__mpc_path_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // past_path_data
    ...
    deva_planning_msgs2__msg__MpcPathData * dest = ros_message->past_path_data.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__mpc_path_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // boundary_poses
    ...
    if (!deva_planning_msgs2__msg__PathPoint__Sequence__init(&(ros_message->boundary_poses), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__PathPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__PathPoint * dest = ros_message->boundary_poses.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__path_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // obstacle_poses
    ...
    deva_planning_msgs2__msg__PathPoint * dest = ros_message->obstacle_poses.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__path_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // stitch_data
    ...
    if (!deva_planning_msgs2__msg__stitch_data__convert_from_py(field, &ros_message->stitch_data)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * deva_planning_msgs2__msg__avp_debug_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._avp_debug_info");
  ...
  {  // origin_ref_line
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__avp_ref_line__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // smooth_line
    PyObject * field = NULL;
    field = deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_to_py(&ros_message->smooth_line);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // used_ref_line_tree
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__avp_ref_line_tree_point_vec__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // now_mpc_data
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__mpc_path_data__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // boundary_poses
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__path_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // stitch_data
    PyObject * field = NULL;
    field = deva_planning_msgs2__msg__stitch_data__convert_to_py(&ros_message->stitch_data);
    if (!field) {
      return NULL;
    }
    {
