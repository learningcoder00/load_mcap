...
bool deva_planning_msgs2__msg__reference_line__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._reference_line.ReferenceLine", full_classname_dest, 53) == 0);
  }
  deva_planning_msgs2__msg__ReferenceLine * ros_message = _ros_message;
  {  // reference_line
  ...
  {  // line_is_model
    PyObject * field = PyObject_GetAttrString(_pymsg, "line_is_model");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->line_is_model = (Py_True == field);
    Py_DECREF(field);
  }
  {  // line_is_virtual
...
PyObject * deva_planning_msgs2__msg__reference_line__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._reference_line");
  ...
  {  // line_is_model
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->line_is_model ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "line_is_model", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
