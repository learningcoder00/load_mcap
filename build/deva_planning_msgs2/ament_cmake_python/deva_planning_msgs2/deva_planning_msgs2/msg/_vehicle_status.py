...
class Metaclass_VehicleStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_planning_msgs2.msg.VehicleStatus')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'PILOT': cls.__constants['PILOT'],
            'AVP': cls.__constants['AVP'],
    ...
    def STARTING(self):
        ...
        return Metaclass_VehicleStatus.__constants['STARTING']

    @property
    def READY(self):
        """Message constant 'READY'."""
        return Metaclass_VehicleStatus.__constants['READY']

    @property
    def STOPPING(self):
        """Message constant 'STOPPING'."""
        return Metaclass_VehicleStatus.__constants['STOPPING']

    @property
    def FATAL(self):
        """Message constant 'FATAL'."""
        return Metaclass_VehicleStatus.__constants['FATAL']

    @property
    def PILOT(self):
        """Message constant 'PILOT'."""
        return Metaclass_VehicleStatus.__constants['PILOT']

    @property
    def AVP(self):
        """Message constant 'AVP'."""
        return Metaclass_VehicleStatus.__constants['AVP']

    @property
    def APA(self):
        """Message constant 'APA'."""
        return Metaclass_VehicleStatus.__constants['APA']

    @property
    def EMERGENCY_STOP(self):
        """Message constant 'EMERGENCY_STOP'."""
        return Metaclass_VehicleStatus.__constants['EMERGENCY_STOP']
