...
bool deva_planning_msgs2__msg__string2_u_int__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._string2_u_int.String2UInt", full_classname_dest, 50) == 0);
  }
  deva_planning_msgs2__msg__String2UInt * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of String2UInt */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._string2_u_int");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "String2UInt");
