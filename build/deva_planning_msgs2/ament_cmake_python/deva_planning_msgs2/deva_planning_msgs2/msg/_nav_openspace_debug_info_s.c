...
bool deva_planning_msgs2__msg__nav_openspace_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__nav_openspace_obstacle__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__nav_openspace_parking_slot__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__nav_openspace_parking_slot__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__path_data__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_planning_msgs2__msg__path_data__convert_to_py(void * raw_ros_message);
bool deva_planning_msgs2__msg__target_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_planning_msgs2__msg__nav_openspace_debug_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._nav_openspace_debug_info.NavOpenspaceDebugInfo", full_classname_dest, 71) == 0);
  }
  deva_planning_msgs2__msg__NavOpenspaceDebugInfo * ros_message = _ros_message;
  {  // x_s
  ...
  {  // obstacles_info
    ...
    if (!deva_planning_msgs2__msg__NavOpenspaceObstacle__Sequence__init(&(ros_message->obstacles_info), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__NavOpenspaceObstacle__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__NavOpenspaceObstacle * dest = ros_message->obstacles_info.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__nav_openspace_obstacle__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // parking_slots
    ...
    if (!deva_planning_msgs2__msg__NavOpenspaceParkingSlot__Sequence__init(&(ros_message->parking_slots), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__NavOpenspaceParkingSlot__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__NavOpenspaceParkingSlot * dest = ros_message->parking_slots.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__nav_openspace_parking_slot__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // ref_points
    ...
    if (!deva_planning_msgs2__msg__PathData__Sequence__init(&(ros_message->ref_points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__PathData__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__PathData * dest = ros_message->ref_points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__path_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // last_trajectory
    ...
    if (!deva_planning_msgs2__msg__target_trajectory__convert_from_py(field, &ros_message->last_trajectory)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // last_internal_trajectory_paths
    ...
    if (!deva_planning_msgs2__msg__TargetTrajectory__Sequence__init(&(ros_message->last_internal_trajectory_paths), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_planning_msgs2__msg__TargetTrajectory__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_planning_msgs2__msg__TargetTrajectory * dest = ros_message->last_internal_trajectory_paths.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__target_trajectory__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // last_ref_points
    ...
    deva_planning_msgs2__msg__PathData * dest = ros_message->last_ref_points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__path_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // hybrid_astar_search_results
    ...
    deva_planning_msgs2__msg__TargetTrajectory * dest = ros_message->hybrid_astar_search_results.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__target_trajectory__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // optimization_results
    ...
    deva_planning_msgs2__msg__TargetTrajectory * dest = ros_message->optimization_results.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_planning_msgs2__msg__target_trajectory__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
PyObject * deva_planning_msgs2__msg__nav_openspace_debug_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._nav_openspace_debug_info");
  ...
  {  // obstacles_info
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__nav_openspace_obstacle__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // parking_slots
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__nav_openspace_parking_slot__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // ref_points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__path_data__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // last_trajectory
    PyObject * field = NULL;
    field = deva_planning_msgs2__msg__target_trajectory__convert_to_py(&ros_message->last_trajectory);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // last_internal_trajectory_paths
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_planning_msgs2__msg__target_trajectory__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
