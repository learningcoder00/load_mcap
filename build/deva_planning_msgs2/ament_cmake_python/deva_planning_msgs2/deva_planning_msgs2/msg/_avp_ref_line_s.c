...
bool deva_planning_msgs2__msg__avp_ref_line__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._avp_ref_line.AvpRefLine", full_classname_dest, 48) == 0);
  }
  deva_planning_msgs2__msg__AvpRefLine * ros_message = _ros_message;
  {  // s
...
PyObject * deva_planning_msgs2__msg__avp_ref_line__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._avp_ref_line");
