...
bool deva_planning_msgs2__msg__path_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._path_data.PathData", full_classname_dest, 43) == 0);
  }
  deva_planning_msgs2__msg__PathData * ros_message = _ros_message;
  {  // x
  ...
  {  // speedlimit
    ...
    assert(PyFloat_Check(field));
    ros_message->speedlimit = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PathData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._path_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathData");
