...
bool deva_planning_msgs2__msg__planning_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._planning_trajectory.PlanningTrajectory", full_classname_dest, 63) == 0);
  }
  deva_planning_msgs2__msg__PlanningTrajectory * ros_message = _ros_message;
  {  // path_type
  ...
  {  // turn_light
    ...
    assert(PyLong_Check(field));
    ros_message->turn_light = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // id
...
PyObject * deva_planning_msgs2__msg__planning_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._planning_trajectory");
  ...
  {  // turn_light
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->turn_light);
    {
