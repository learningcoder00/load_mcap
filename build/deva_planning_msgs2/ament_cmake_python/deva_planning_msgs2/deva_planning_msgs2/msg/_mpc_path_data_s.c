...
bool deva_planning_msgs2__msg__mpc_path_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs2.msg._mpc_path_data.MpcPathData", full_classname_dest, 50) == 0);
  }
  deva_planning_msgs2__msg__MpcPathData * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of MpcPathData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs2.msg._mpc_path_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MpcPathData");
