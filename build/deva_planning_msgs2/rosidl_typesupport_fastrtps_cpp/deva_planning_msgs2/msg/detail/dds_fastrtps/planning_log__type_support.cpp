...
#include "deva_planning_msgs2/msg/detail/planning_log__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::String2Int &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs2::msg::String2Int &);
size_t get_serialized_size(
  const deva_planning_msgs2::msg::String2Int &,
  size_t current_alignment);
size_t
max_serialized_size_String2Int(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::String2Bool &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs2::msg::String2Bool &);
size_t get_serialized_size(
  const deva_planning_msgs2::msg::String2Bool &,
  size_t current_alignment);
size_t
max_serialized_size_String2Bool(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_planning_msgs2::msg::PlanningLog & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::PlanningLog & ros_message)
{
  // Member: header
  ...
  // Member: scalable_int
  {
    ...
    ros_message.scalable_int.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_planning_msgs2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.scalable_int[i]);
    }
  }
  ...
  // Member: scalable_double
  {
    ...
    ros_message.scalable_double.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_planning_msgs2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.scalable_double[i]);
    }
  }
  ...
  // Member: scalable_bool
  {
    ...
    ros_message.scalable_bool.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_planning_msgs2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.scalable_bool[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: scalable_int
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.scalable_int[index], current_alignment);
    }
  }
  // Member: scalable_double
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.scalable_double[index], current_alignment);
    }
  }
  // Member: scalable_bool
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.scalable_bool[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: scalable_int
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_String2Int(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: scalable_bool
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_String2Bool(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::PlanningLog;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::PlanningLog *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::PlanningLog *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PlanningLog__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, PlanningLog)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PlanningLog__handle;
}
