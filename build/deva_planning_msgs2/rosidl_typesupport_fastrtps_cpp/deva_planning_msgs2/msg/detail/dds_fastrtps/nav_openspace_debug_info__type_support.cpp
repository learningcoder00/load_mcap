...
#include "deva_planning_msgs2/msg/detail/nav_openspace_debug_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::NavOpenspaceObstacle &,
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::NavOpenspaceParkingSlot &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs2::msg::NavOpenspaceParkingSlot &);
size_t get_serialized_size(
  const deva_planning_msgs2::msg::NavOpenspaceParkingSlot &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::PathData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs2::msg::PathData &);
size_t get_serialized_size(
  const deva_planning_msgs2::msg::PathData &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::TargetTrajectory &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs2::msg::TargetTrajectory &);
size_t get_serialized_size(
  const deva_planning_msgs2::msg::TargetTrajectory &,
  size_t current_alignment);
size_t
...
// functions for deva_planning_msgs2::msg::TargetTrajectory already declared above

// functions for deva_planning_msgs2::msg::PathData already declared above
...
cdr_serialize(
  const deva_planning_msgs2::msg::NavOpenspaceDebugInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::NavOpenspaceDebugInfo & ros_message)
{
  // Member: x_s
  cdr >> ros_message.x_s;
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_NavOpenspaceObstacle(
  ...
  // Member: parking_slots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_NavOpenspaceParkingSlot(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: ref_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_PathData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: last_trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_TargetTrajectory(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::NavOpenspaceDebugInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::NavOpenspaceDebugInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::NavOpenspaceDebugInfo *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_NavOpenspaceDebugInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, NavOpenspaceDebugInfo)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_NavOpenspaceDebugInfo__handle;
}
