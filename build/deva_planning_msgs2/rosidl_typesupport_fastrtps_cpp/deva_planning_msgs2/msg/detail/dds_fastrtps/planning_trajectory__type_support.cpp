...
#include "deva_planning_msgs2/msg/detail/planning_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_planning_msgs2::msg::PlanningTrajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::PlanningTrajectory & ros_message)
{
  // Member: path_type
  cdr >> ros_message.path_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::PlanningTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::PlanningTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::PlanningTrajectory *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PlanningTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, PlanningTrajectory)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PlanningTrajectory__handle;
}
