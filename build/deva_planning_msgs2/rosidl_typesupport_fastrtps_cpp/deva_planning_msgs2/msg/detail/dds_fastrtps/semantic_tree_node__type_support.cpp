...
#include "deva_planning_msgs2/msg/detail/semantic_tree_node__rosidl_typesupport_fastrtps_cpp.hpp"
...
// functions for deva_planning_msgs2::msg::String2Double already declared above
...
cdr_serialize(
  const deva_planning_msgs2::msg::SemanticTreeNode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::SemanticTreeNode & ros_message)
{
  // Member: node_id
  cdr >> ros_message.node_id;
  ...
  // Member: rollout_cost
  {
    ...
    ros_message.rollout_cost.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_planning_msgs2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.rollout_cost[i]);
    }
  }
  ...
  // Member: game_cost
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.game_cost[index], current_alignment);
    }
  }
  // Member: rollout_cost
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.rollout_cost[index], current_alignment);
    }
  }
  // Member: scalable_flags
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::SemanticTreeNode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::SemanticTreeNode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::SemanticTreeNode *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SemanticTreeNode__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::SemanticTreeNode *>(
...
static size_t _SemanticTreeNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SemanticTreeNode(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SemanticTreeNode__callbacks = {
...
static rosidl_message_type_support_t _SemanticTreeNode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SemanticTreeNode__callbacks,
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_SemanticTreeNode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, SemanticTreeNode)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_SemanticTreeNode__handle;
}
