...
#include "deva_planning_msgs2/msg/detail/vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_planning_msgs2::msg::VehicleStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::VehicleStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::VehicleStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, VehicleStatus)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
