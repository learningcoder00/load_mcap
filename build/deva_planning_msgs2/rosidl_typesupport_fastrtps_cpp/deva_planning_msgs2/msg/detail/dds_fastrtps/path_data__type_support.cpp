...
#include "deva_planning_msgs2/msg/detail/path_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_planning_msgs2::msg::PathData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::PathData & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::PathData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::PathData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::PathData *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PathData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, PathData)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PathData__handle;
}
