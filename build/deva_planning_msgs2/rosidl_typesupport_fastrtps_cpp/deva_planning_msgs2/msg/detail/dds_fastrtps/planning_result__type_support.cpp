...
#include "deva_planning_msgs2/msg/detail/planning_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::SensorTime &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const deva_planning_msgs2::msg::PlanningFail &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs2::msg::PlanningFail &);
size_t get_serialized_size(
  const deva_planning_msgs2::msg::PlanningFail &,
  size_t current_alignment);
size_t
max_serialized_size_PlanningFail(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_planning_msgs2::msg::PlanningResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::PlanningResult & ros_message)
{
  // Member: header
  ...
  // Member: fail_reason
  {
    ...
    ros_message.fail_reason.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_planning_msgs2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.fail_reason[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: fail_reason
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.fail_reason[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_planning_msgs2
max_serialized_size_PlanningResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: sensor_time
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_SensorTime(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: fail_reason
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs2::msg::typesupport_fastrtps_cpp::max_serialized_size_PlanningFail(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::PlanningResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::PlanningResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::PlanningResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlanningResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::PlanningResult *>(
...
static size_t _PlanningResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanningResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlanningResult__callbacks = {
...
static rosidl_message_type_support_t _PlanningResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanningResult__callbacks,
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PlanningResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, PlanningResult)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_PlanningResult__handle;
}
