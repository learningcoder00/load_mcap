...
#include "deva_planning_msgs2/msg/detail/navi_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_planning_msgs2::msg::NaviAction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs2::msg::NaviAction & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_planning_msgs2
max_serialized_size_NaviAction(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs2::msg::NaviAction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::NaviAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs2::msg::NaviAction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NaviAction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_planning_msgs2::msg::NaviAction *>(
...
static size_t _NaviAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NaviAction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NaviAction__callbacks = {
...
static rosidl_message_type_support_t _NaviAction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NaviAction__callbacks,
...
{
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_NaviAction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs2, msg, NaviAction)() {
  return &deva_planning_msgs2::msg::typesupport_fastrtps_cpp::_NaviAction__handle;
}
