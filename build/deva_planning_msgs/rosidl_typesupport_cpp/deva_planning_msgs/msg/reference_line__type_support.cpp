...
static const _ReferenceLine_type_support_symbol_names_t _ReferenceLine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs, msg, ReferenceLine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs, msg, ReferenceLine)),
  }
};
...
{
  return &::deva_planning_msgs::msg::rosidl_typesupport_cpp::ReferenceLine_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_planning_msgs, msg, ReferenceLine)() {
  return get_message_type_support_handle<deva_planning_msgs::msg::ReferenceLine>();
}
