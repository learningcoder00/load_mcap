...
bool deva_planning_msgs__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._path_point.PathPoint", full_classname_dest, 44) == 0);
  }
  deva_planning_msgs__msg__PathPoint * ros_message = _ros_message;
  {  // pos
...
PyObject * deva_planning_msgs__msg__path_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._path_point");
