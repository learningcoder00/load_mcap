...
class NavOpenspaceDebugInfo(metaclass=Metaclass_NavOpenspaceDebugInfo):
    ...
    _fields_and_field_types = {
        ...
        'obstacles_info': 'sequence<deva_planning_msgs/NavOpenspaceObstacle>',
        'parking_slots': 'sequence<deva_planning_msgs/NavOpenspaceParkingSlot>',
        'start_gear': 'uint32',
        'speed': 'double',
        'keep_start_gear_distance': 'double',
        'kappa': 'double',
        'timestamp': 'double',
        'ref_points': 'sequence<deva_planning_msgs/PathData>',
        'openspace_planning_status': 'uint32',
        'last_trajectory': 'deva_planning_msgs/TargetTrajectory',
        'last_trajectory_timestamp': 'double',
        'last_internal_trajectory_paths': 'sequence<deva_planning_msgs/TargetTrajectory>',
        'current_path_index': 'uint32',
        'is_arrived_path_end': 'boolean',
        'last_ref_points': 'sequence<deva_planning_msgs/PathData>',
        'hybrid_astar_search_results': 'sequence<deva_planning_msgs/TargetTrajectory>',
        'optimization_results': 'sequence<deva_planning_msgs/TargetTrajectory>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs', 'msg'], 'NavOpenspaceObstacle')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs', 'msg'], 'NavOpenspaceParkingSlot')),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs', 'msg'], 'PathData')),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['deva_planning_msgs', 'msg'], 'TargetTrajectory'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs', 'msg'], 'TargetTrajectory')),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
