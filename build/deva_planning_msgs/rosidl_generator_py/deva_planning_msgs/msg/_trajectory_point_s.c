...
bool deva_planning_msgs__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 56) == 0);
  }
  deva_planning_msgs__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // path_point
    PyObject * field = PyObject_GetAttrString(_pymsg, "path_point");
    if (!field) {
      return false;
    }
    if (!deva_planning_msgs__msg__path_point__convert_from_py(field, &ros_message->path_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * deva_planning_msgs__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._trajectory_point");
  ...
  {  // path_point
    PyObject * field = NULL;
    field = deva_planning_msgs__msg__path_point__convert_to_py(&ros_message->path_point);
    if (!field) {
      return NULL;
    }
    {
