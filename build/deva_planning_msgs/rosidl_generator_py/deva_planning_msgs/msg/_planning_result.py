    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_planning_msgs.msg.PlanningResult')
            logger.debug(
            ...
            from deva_planning_msgs.msg import PlanningTrajectory
...
class PlanningResult(metaclass=Metaclass_PlanningResult):
    ...
    _fields_and_field_types = {
        ...
        'sensor_time': 'deva_planning_msgs/SensorTime',
        'trajectories': 'sequence<deva_planning_msgs/PlanningTrajectory>',
        'status': 'int8',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['deva_planning_msgs', 'msg'], 'PlanningTrajectory')),  # noqa: E501
