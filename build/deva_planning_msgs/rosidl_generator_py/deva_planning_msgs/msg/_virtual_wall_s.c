...
bool deva_planning_msgs__msg__virtual_wall__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._virtual_wall.VirtualWall", full_classname_dest, 48) == 0);
  }
  deva_planning_msgs__msg__VirtualWall * ros_message = _ros_message;
  {  // id
...
PyObject * deva_planning_msgs__msg__virtual_wall__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._virtual_wall");
