...
bool deva_planning_msgs__msg__navi_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._navi_action.NaviAction", full_classname_dest, 46) == 0);
  }
  deva_planning_msgs__msg__NaviAction * ros_message = _ros_message;
  {  // header
...
PyObject * deva_planning_msgs__msg__navi_action__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._navi_action");
