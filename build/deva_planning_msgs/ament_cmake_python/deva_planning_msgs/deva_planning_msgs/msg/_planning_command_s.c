...
bool deva_planning_msgs__msg__planning_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_planning_msgs.msg._planning_command.PlanningCommand", full_classname_dest, 56) == 0);
  }
  deva_planning_msgs__msg__PlanningCommand * ros_message = _ros_message;
  {  // header
...
PyObject * deva_planning_msgs__msg__planning_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_planning_msgs.msg._planning_command");
