...
{
  new (message_memory) deva_planning_msgs::msg::NavOpenspaceObstacle(_init);
}

void NavOpenspaceObstacle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs::msg::NavOpenspaceObstacle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavOpenspaceObstacle_message_member_array[2] = {
  {
    ...
    offsetof(deva_planning_msgs::msg::NavOpenspaceObstacle, obs_type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_planning_msgs::msg::NavOpenspaceObstacle, xy_vec),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NavOpenspaceObstacle_message_members = {
  ...
  2,  // number of fields
  sizeof(deva_planning_msgs::msg::NavOpenspaceObstacle),
...
{
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::NavOpenspaceObstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs, msg, NavOpenspaceObstacle)() {
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::NavOpenspaceObstacle_message_type_support_handle;
}
