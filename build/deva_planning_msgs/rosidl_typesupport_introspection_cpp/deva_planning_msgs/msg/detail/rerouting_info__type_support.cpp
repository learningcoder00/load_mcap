...
{
  new (message_memory) deva_planning_msgs::msg::ReroutingInfo(_init);
}

void ReroutingInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_planning_msgs::msg::ReroutingInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ReroutingInfo_message_member_array[1] = {
  {
    ...
    offsetof(deva_planning_msgs::msg::ReroutingInfo, obstacle_edges),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ReroutingInfo_message_members = {
  ...
  1,  // number of fields
  sizeof(deva_planning_msgs::msg::ReroutingInfo),
...
{
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::ReroutingInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_planning_msgs, msg, ReroutingInfo)() {
  return &::deva_planning_msgs::msg::rosidl_typesupport_introspection_cpp::ReroutingInfo_message_type_support_handle;
}
