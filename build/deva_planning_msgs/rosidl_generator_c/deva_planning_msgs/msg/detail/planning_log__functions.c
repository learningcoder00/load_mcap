...
bool
deva_planning_msgs__msg__PlanningLog__init(deva_planning_msgs__msg__PlanningLog * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    deva_planning_msgs__msg__PlanningLog__fini(msg);
    return false;
  }
  // localization
...
void
deva_planning_msgs__msg__PlanningLog__fini(deva_planning_msgs__msg__PlanningLog * msg)
{
  if (!msg) {
    return;
  }
...
bool
deva_planning_msgs__msg__PlanningLog__are_equal(const deva_planning_msgs__msg__PlanningLog * lhs, const deva_planning_msgs__msg__PlanningLog * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // drving_state
  if (lhs->drving_state != rhs->drving_state) {
    return false;
  }
  // auto_function
  if (lhs->auto_function != rhs->auto_function) {
    return false;
  }
  // drive_action
  if (lhs->drive_action != rhs->drive_action) {
    return false;
  }
  // env_info_index
  if (lhs->env_info_index != rhs->env_info_index) {
    return false;
  }
  return true;
}
...
bool
deva_planning_msgs__msg__PlanningLog__copy(
  const deva_planning_msgs__msg__PlanningLog * input,
  deva_planning_msgs__msg__PlanningLog * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // drving_state
  output->drving_state = input->drving_state;
  // auto_function
  output->auto_function = input->auto_function;
  // drive_action
  output->drive_action = input->drive_action;
  // env_info_index
  output->env_info_index = input->env_info_index;
  return true;
}

deva_planning_msgs__msg__PlanningLog *
deva_planning_msgs__msg__PlanningLog__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__PlanningLog * msg = (deva_planning_msgs__msg__PlanningLog *)allocator.allocate(sizeof(deva_planning_msgs__msg__PlanningLog), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_planning_msgs__msg__PlanningLog));
  bool success = deva_planning_msgs__msg__PlanningLog__init(msg);
  if (!success) {
...
void
deva_planning_msgs__msg__PlanningLog__destroy(deva_planning_msgs__msg__PlanningLog * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_planning_msgs__msg__PlanningLog__fini(msg);
...
bool
deva_planning_msgs__msg__PlanningLog__Sequence__init(deva_planning_msgs__msg__PlanningLog__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__PlanningLog * data = NULL;

  if (size) {
    data = (deva_planning_msgs__msg__PlanningLog *)allocator.zero_allocate(size, sizeof(deva_planning_msgs__msg__PlanningLog), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_planning_msgs__msg__PlanningLog__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_planning_msgs__msg__PlanningLog__fini(&data[i - 1]);
      }
...
void
deva_planning_msgs__msg__PlanningLog__Sequence__fini(deva_planning_msgs__msg__PlanningLog__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_planning_msgs__msg__PlanningLog__fini(&array->data[i]);
    }
...
deva_planning_msgs__msg__PlanningLog__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_planning_msgs__msg__PlanningLog__Sequence * array = (deva_planning_msgs__msg__PlanningLog__Sequence *)allocator.allocate(sizeof(deva_planning_msgs__msg__PlanningLog__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_planning_msgs__msg__PlanningLog__Sequence__init(array, size);
  if (!success) {
...
void
deva_planning_msgs__msg__PlanningLog__Sequence__destroy(deva_planning_msgs__msg__PlanningLog__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_planning_msgs__msg__PlanningLog__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
deva_planning_msgs__msg__PlanningLog__Sequence__are_equal(const deva_planning_msgs__msg__PlanningLog__Sequence * lhs, const deva_planning_msgs__msg__PlanningLog__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_planning_msgs__msg__PlanningLog__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
deva_planning_msgs__msg__PlanningLog__Sequence__copy(
  const deva_planning_msgs__msg__PlanningLog__Sequence * input,
  deva_planning_msgs__msg__PlanningLog__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_planning_msgs__msg__PlanningLog);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_planning_msgs__msg__PlanningLog * data =
      (deva_planning_msgs__msg__PlanningLog *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_planning_msgs__msg__PlanningLog__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_planning_msgs__msg__PlanningLog__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_planning_msgs__msg__PlanningLog__copy(
