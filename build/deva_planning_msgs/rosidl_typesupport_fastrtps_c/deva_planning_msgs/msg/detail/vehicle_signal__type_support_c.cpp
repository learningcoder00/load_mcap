...
#include "deva_planning_msgs/msg/detail/vehicle_signal__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleSignal__ros_msg_type = deva_planning_msgs__msg__VehicleSignal;
...
size_t get_serialized_size_deva_planning_msgs__msg__VehicleSignal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleSignal__ros_msg_type * ros_message = static_cast<const _VehicleSignal__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleSignal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__VehicleSignal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_planning_msgs
size_t max_serialized_size_deva_planning_msgs__msg__VehicleSignal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__VehicleSignal;
    is_plain =
      (
...
static size_t _VehicleSignal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__VehicleSignal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, VehicleSignal)() {
