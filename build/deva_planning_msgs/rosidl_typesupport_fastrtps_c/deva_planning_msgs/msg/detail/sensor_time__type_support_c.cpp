...
#include "deva_planning_msgs/msg/detail/sensor_time__rosidl_typesupport_fastrtps_c.h"
...
using _SensorTime__ros_msg_type = deva_planning_msgs__msg__SensorTime;
...
static uint32_t _SensorTime__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__SensorTime(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__SensorTime;
    is_plain =
      (
...
static size_t _SensorTime__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__SensorTime(
