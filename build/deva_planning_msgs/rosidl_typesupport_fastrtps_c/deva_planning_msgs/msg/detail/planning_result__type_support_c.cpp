...
#include "deva_planning_msgs/msg/detail/planning_result__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs/msg/detail/planning_trajectory__functions.h"  // trajectories
#include "deva_planning_msgs/msg/detail/sensor_time__functions.h"  // sensor_time
...
size_t get_serialized_size_deva_planning_msgs__msg__PlanningTrajectory(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__PlanningTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PlanningTrajectory)();
...
using _PlanningResult__ros_msg_type = deva_planning_msgs__msg__PlanningResult;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trajectories
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PlanningTrajectory
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trajectories
  {
    ...
    if (ros_message->trajectories.data) {
      deva_planning_msgs__msg__PlanningTrajectory__Sequence__fini(&ros_message->trajectories);
    }
...
size_t get_serialized_size_deva_planning_msgs__msg__PlanningResult(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanningResult__ros_msg_type * ros_message = static_cast<const _PlanningResult__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name trajectories
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__PlanningTrajectory(
...
static uint32_t _PlanningResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__PlanningResult(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_planning_msgs
size_t max_serialized_size_deva_planning_msgs__msg__PlanningResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: trajectories
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__PlanningTrajectory(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__PlanningResult;
    is_plain =
      (
...
static size_t _PlanningResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__PlanningResult(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PlanningResult)() {
