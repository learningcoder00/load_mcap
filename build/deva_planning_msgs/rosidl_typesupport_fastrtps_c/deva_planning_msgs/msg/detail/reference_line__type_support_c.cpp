...
#include "deva_planning_msgs/msg/detail/reference_line__rosidl_typesupport_fastrtps_c.h"
...
using _ReferenceLine__ros_msg_type = deva_planning_msgs__msg__ReferenceLine;
...
static uint32_t _ReferenceLine__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__ReferenceLine(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__ReferenceLine;
    is_plain =
      (
...
static size_t _ReferenceLine__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__ReferenceLine(
