...
#include "deva_planning_msgs/msg/detail/nav_openspace_debug_info__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs/msg/detail/nav_openspace_obstacle__functions.h"  // obstacles_info
#include "deva_planning_msgs/msg/detail/nav_openspace_parking_slot__functions.h"  // parking_slots
#include "deva_planning_msgs/msg/detail/path_data__functions.h"  // last_ref_points, ref_points
#include "deva_planning_msgs/msg/detail/target_trajectory__functions.h"  // hybrid_astar_search_results, last_internal_trajectory_paths, last_trajectory, optimization_results
...
size_t get_serialized_size_deva_planning_msgs__msg__NavOpenspaceObstacle(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__NavOpenspaceObstacle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, NavOpenspaceObstacle)();
size_t get_serialized_size_deva_planning_msgs__msg__NavOpenspaceParkingSlot(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__NavOpenspaceParkingSlot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, NavOpenspaceParkingSlot)();
size_t get_serialized_size_deva_planning_msgs__msg__PathData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__PathData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PathData)();
...
using _NavOpenspaceDebugInfo__ros_msg_type = deva_planning_msgs__msg__NavOpenspaceDebugInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: obstacles_info
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, NavOpenspaceObstacle
      )()->data);
  ...
  // Field name: parking_slots
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, NavOpenspaceParkingSlot
      )()->data);
  ...
  // Field name: ref_points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PathData
      )()->data);
  ...
  // Field name: last_trajectory
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, TargetTrajectory
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: obstacles_info
  {
    ...
    if (ros_message->obstacles_info.data) {
      deva_planning_msgs__msg__NavOpenspaceObstacle__Sequence__fini(&ros_message->obstacles_info);
    }
  ...
  // Field name: parking_slots
  {
    ...
    if (ros_message->parking_slots.data) {
      deva_planning_msgs__msg__NavOpenspaceParkingSlot__Sequence__fini(&ros_message->parking_slots);
    }
  ...
  // Field name: ref_points
  {
    ...
    if (ros_message->ref_points.data) {
      deva_planning_msgs__msg__PathData__Sequence__fini(&ros_message->ref_points);
    }
  ...
  // Field name: last_internal_trajectory_paths
  {
    ...
    if (ros_message->last_internal_trajectory_paths.data) {
      deva_planning_msgs__msg__TargetTrajectory__Sequence__fini(&ros_message->last_internal_trajectory_paths);
    }
  ...
  // Field name: last_ref_points
  {
    ...
    if (ros_message->last_ref_points.data) {
      deva_planning_msgs__msg__PathData__Sequence__fini(&ros_message->last_ref_points);
    }
  ...
  // Field name: hybrid_astar_search_results
  {
    ...
    if (ros_message->hybrid_astar_search_results.data) {
      deva_planning_msgs__msg__TargetTrajectory__Sequence__fini(&ros_message->hybrid_astar_search_results);
    }
  ...
  // Field name: optimization_results
  {
    ...
    if (ros_message->optimization_results.data) {
      deva_planning_msgs__msg__TargetTrajectory__Sequence__fini(&ros_message->optimization_results);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name obstacles_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__NavOpenspaceObstacle(
  ...
  // field.name parking_slots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__NavOpenspaceParkingSlot(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name start_gear
  ...
  // field.name ref_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__PathData(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name openspace_planning_status
  ...
  current_alignment += get_serialized_size_deva_planning_msgs__msg__TargetTrajectory(
...
static uint32_t _NavOpenspaceDebugInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__NavOpenspaceDebugInfo(
  ...
  size_t current_alignment)
{
  ...
  // member: obstacles_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__NavOpenspaceObstacle(
  ...
  // member: parking_slots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__NavOpenspaceParkingSlot(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: ref_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__PathData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: last_trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__TargetTrajectory(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__NavOpenspaceDebugInfo;
    is_plain =
      (
...
static size_t _NavOpenspaceDebugInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__NavOpenspaceDebugInfo(
