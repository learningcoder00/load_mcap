...
#include "deva_planning_msgs/msg/detail/reference_lines__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs/msg/detail/reference_line__functions.h"  // reference_lines
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_deva_planning_msgs__msg__ReferenceLine(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__ReferenceLine(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, ReferenceLine)();
...
using _ReferenceLines__ros_msg_type = deva_planning_msgs__msg__ReferenceLines;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: reference_lines
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, ReferenceLine
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: reference_lines
  {
    ...
    if (ros_message->reference_lines.data) {
      deva_planning_msgs__msg__ReferenceLine__Sequence__fini(&ros_message->reference_lines);
    }
...
size_t get_serialized_size_deva_planning_msgs__msg__ReferenceLines(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReferenceLines__ros_msg_type * ros_message = static_cast<const _ReferenceLines__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name reference_lines
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__ReferenceLine(
...
static uint32_t _ReferenceLines__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__ReferenceLines(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_planning_msgs
size_t max_serialized_size_deva_planning_msgs__msg__ReferenceLines(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: reference_lines
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__ReferenceLine(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__ReferenceLines;
    is_plain =
      (
...
static size_t _ReferenceLines__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__ReferenceLines(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, ReferenceLines)() {
