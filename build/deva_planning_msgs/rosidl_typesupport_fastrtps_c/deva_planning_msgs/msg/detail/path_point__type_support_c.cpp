...
#include "deva_planning_msgs/msg/detail/path_point__rosidl_typesupport_fastrtps_c.h"
...
using _PathPoint__ros_msg_type = deva_planning_msgs__msg__PathPoint;
...
static uint32_t _PathPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__PathPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__PathPoint;
    is_plain =
      (
...
static size_t _PathPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__PathPoint(
