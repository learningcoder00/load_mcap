...
#include "deva_planning_msgs/msg/detail/planning_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs/msg/detail/trajectory_point__functions.h"  // trajectory_points
#include "geometry_msgs/msg/detail/point__functions.h"  // circle_center, stop_pose
...
using _PlanningTrajectory__ros_msg_type = deva_planning_msgs__msg__PlanningTrajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: vehicle_gear
  {
    cdr << ros_message->vehicle_gear;
  }

  // Field name: circle_center
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trajectory_points
  {
    ...
    if (ros_message->trajectory_points.data) {
      deva_planning_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->trajectory_points);
    }
...
static uint32_t _PlanningTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__PlanningTrajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__PlanningTrajectory;
    is_plain =
      (
...
static size_t _PlanningTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__PlanningTrajectory(
