...
#include "deva_planning_msgs/msg/detail/avp_debug_info__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs/msg/detail/avp_ref_line__functions.h"  // origin_ref_line
#include "deva_planning_msgs/msg/detail/avp_ref_line_tree_point_vec__functions.h"  // driver_path, smooth_line, used_ref_line_tree
#include "deva_planning_msgs/msg/detail/mpc_path_data__functions.h"  // now_mpc_data, now_path_data, past_path_data
#include "deva_planning_msgs/msg/detail/path_point__functions.h"  // boundary_poses, obstacle_poses
#include "deva_planning_msgs/msg/detail/stitch_data__functions.h"  // stitch_data
...
size_t get_serialized_size_deva_planning_msgs__msg__AvpRefLineTreePointVec(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__AvpRefLineTreePointVec(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, AvpRefLineTreePointVec)();
size_t get_serialized_size_deva_planning_msgs__msg__MpcPathData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__MpcPathData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, MpcPathData)();
...
size_t get_serialized_size_deva_planning_msgs__msg__StitchData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_planning_msgs__msg__StitchData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, StitchData)();


using _AvpDebugInfo__ros_msg_type = deva_planning_msgs__msg__AvpDebugInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: origin_ref_line
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, AvpRefLine
      )()->data);
  ...
  // Field name: smooth_line
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, AvpRefLineTreePointVec
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: now_mpc_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, MpcPathData
      )()->data);
  ...
  // Field name: stitch_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, StitchData
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: origin_ref_line
  {
    ...
    if (ros_message->origin_ref_line.data) {
      deva_planning_msgs__msg__AvpRefLine__Sequence__fini(&ros_message->origin_ref_line);
    }
  ...
  // Field name: used_ref_line_tree
  {
    ...
    if (ros_message->used_ref_line_tree.data) {
      deva_planning_msgs__msg__AvpRefLineTreePointVec__Sequence__fini(&ros_message->used_ref_line_tree);
    }
  ...
  // Field name: driver_path
  {
    ...
    if (ros_message->driver_path.data) {
      deva_planning_msgs__msg__AvpRefLineTreePointVec__Sequence__fini(&ros_message->driver_path);
    }
  ...
  // Field name: now_mpc_data
  {
    ...
    if (ros_message->now_mpc_data.data) {
      deva_planning_msgs__msg__MpcPathData__Sequence__fini(&ros_message->now_mpc_data);
    }
  ...
  // Field name: now_path_data
  {
    ...
    if (ros_message->now_path_data.data) {
      deva_planning_msgs__msg__MpcPathData__Sequence__fini(&ros_message->now_path_data);
    }
  ...
  // Field name: past_path_data
  {
    ...
    if (ros_message->past_path_data.data) {
      deva_planning_msgs__msg__MpcPathData__Sequence__fini(&ros_message->past_path_data);
    }
  ...
  // Field name: boundary_poses
  {
    ...
    if (ros_message->boundary_poses.data) {
      deva_planning_msgs__msg__PathPoint__Sequence__fini(&ros_message->boundary_poses);
    }
  ...
  // Field name: obstacle_poses
  {
    ...
    if (ros_message->obstacle_poses.data) {
      deva_planning_msgs__msg__PathPoint__Sequence__fini(&ros_message->obstacle_poses);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name origin_ref_line
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__AvpRefLine(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name smooth_line

  current_alignment += get_serialized_size_deva_planning_msgs__msg__AvpRefLineTreePointVec(
  ...
  // field.name now_mpc_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__MpcPathData(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name now_path_data
  ...
  current_alignment += get_serialized_size_deva_planning_msgs__msg__StitchData(
...
static uint32_t _AvpDebugInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__AvpDebugInfo(
  ...
  size_t current_alignment)
{
  ...
  // member: origin_ref_line
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__AvpRefLine(
  ...
  // member: smooth_line
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__AvpRefLineTreePointVec(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: now_mpc_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__MpcPathData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: stitch_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__StitchData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__AvpDebugInfo;
    is_plain =
      (
...
static size_t _AvpDebugInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__AvpDebugInfo(
