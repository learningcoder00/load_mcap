...
#include "deva_planning_msgs/msg/detail/planning_state__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_planning_msgs/msg/detail/planning_fail__functions.h"  // fail_reason
#include "rosidl_runtime_c/string.h"  // navi_state, pilot_planning_state
#include "rosidl_runtime_c/string_functions.h"  // navi_state, pilot_planning_state
...
using _PlanningState__ros_msg_type = deva_planning_msgs__msg__PlanningState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->pilot_planning_state;
  ...
  // Field name: navi_state
  {
    const rosidl_runtime_c__String * str = &ros_message->navi_state;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: fail_reason
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PlanningFail
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _PlanningState__ros_msg_type * ros_message = static_cast<_PlanningState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: pilot_planning_state
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->pilot_planning_state.data) {
      rosidl_runtime_c__String__init(&ros_message->pilot_planning_state);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->pilot_planning_state,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'pilot_planning_state'\n");
      return false;
    }
  }
  ...
  // Field name: navi_state
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->navi_state.data) {
      rosidl_runtime_c__String__init(&ros_message->navi_state);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->navi_state,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'navi_state'\n");
      return false;
    }
  }
  ...
  // Field name: fail_reason
  {
    ...
    if (ros_message->fail_reason.data) {
      deva_planning_msgs__msg__PlanningFail__Sequence__fini(&ros_message->fail_reason);
    }
...
size_t get_serialized_size_deva_planning_msgs__msg__PlanningState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanningState__ros_msg_type * ros_message = static_cast<const _PlanningState__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += padding +
    ...
    (ros_message->pilot_planning_state.size + 1);
  // field.name navi_state
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->navi_state.size + 1);
  // field.name fail_reason
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_planning_msgs__msg__PlanningFail(
...
static uint32_t _PlanningState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_planning_msgs__msg__PlanningState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_planning_msgs
size_t max_serialized_size_deva_planning_msgs__msg__PlanningState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: fail_reason
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_planning_msgs__msg__PlanningFail(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs__msg__PlanningState;
    is_plain =
      (
...
static size_t _PlanningState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_planning_msgs__msg__PlanningState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, PlanningState)() {
