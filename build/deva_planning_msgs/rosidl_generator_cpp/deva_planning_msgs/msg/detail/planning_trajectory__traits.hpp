...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__PLANNING_TRAJECTORY__TRAITS_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__PLANNING_TRAJECTORY__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "vehicle_gear: ";
    rosidl_generator_traits::value_to_yaml(msg.vehicle_gear, out);
    out << ", ";
  }
  ...
  {
    out << "circle_center: ";
    to_flow_style_yaml(msg.circle_center, out);
    out << ", ";
  }
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: circle_center
  {
    ...
    out << "circle_center:\n";
    to_block_style_yaml(msg.circle_center, out, indentation + 2);
  }
...
inline void to_yaml(
  const deva_planning_msgs::msg::PlanningTrajectory & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs::msg::PlanningTrajectory & msg)
{
  return deva_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs::msg::PlanningTrajectory>()
{
  return "deva_planning_msgs::msg::PlanningTrajectory";
}

template<>
inline const char * name<deva_planning_msgs::msg::PlanningTrajectory>()
{
  return "deva_planning_msgs/msg/PlanningTrajectory";
}

template<>
struct has_fixed_size<deva_planning_msgs::msg::PlanningTrajectory>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs::msg::PlanningTrajectory>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs::msg::PlanningTrajectory>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__PLANNING_TRAJECTORY__TRAITS_HPP_
