...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__NAV_OPENSPACE_DEBUG_INFO__TRAITS_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__NAV_OPENSPACE_DEBUG_INFO__TRAITS_HPP_
...
#include "deva_planning_msgs/msg/detail/nav_openspace_obstacle__traits.hpp"
// Member 'parking_slots'
#include "deva_planning_msgs/msg/detail/nav_openspace_parking_slot__traits.hpp"
// Member 'ref_points'
// Member 'last_ref_points'
#include "deva_planning_msgs/msg/detail/path_data__traits.hpp"
// Member 'last_trajectory'
// Member 'last_internal_trajectory_paths'
// Member 'hybrid_astar_search_results'
// Member 'optimization_results'
#include "deva_planning_msgs/msg/detail/target_trajectory__traits.hpp"
...
inline void to_yaml(
  const deva_planning_msgs::msg::NavOpenspaceDebugInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs::msg::NavOpenspaceDebugInfo & msg)
{
  return deva_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs::msg::NavOpenspaceDebugInfo>()
{
  return "deva_planning_msgs::msg::NavOpenspaceDebugInfo";
}

template<>
inline const char * name<deva_planning_msgs::msg::NavOpenspaceDebugInfo>()
{
  return "deva_planning_msgs/msg/NavOpenspaceDebugInfo";
}

template<>
struct has_fixed_size<deva_planning_msgs::msg::NavOpenspaceDebugInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs::msg::NavOpenspaceDebugInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs::msg::NavOpenspaceDebugInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__NAV_OPENSPACE_DEBUG_INFO__TRAITS_HPP_
