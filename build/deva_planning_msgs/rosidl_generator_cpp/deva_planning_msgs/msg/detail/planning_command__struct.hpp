...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__PLANNING_COMMAND__STRUCT_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__PLANNING_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs__msg__PlanningCommand __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs__msg__PlanningCommand __declspec(deprecated)
#endif
...
struct PlanningCommand_
{
  ...
  // pointer types
  using RawPtr =
    deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs__msg__PlanningCommand
    std::shared_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs__msg__PlanningCommand
    std::shared_ptr<deva_planning_msgs::msg::PlanningCommand_<ContainerAllocator> const>
...
using PlanningCommand =
  deva_planning_msgs::msg::PlanningCommand_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__PLANNING_COMMAND__STRUCT_HPP_
