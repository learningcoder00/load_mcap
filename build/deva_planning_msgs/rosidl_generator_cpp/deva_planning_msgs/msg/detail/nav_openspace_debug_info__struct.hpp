...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__NAV_OPENSPACE_DEBUG_INFO__STRUCT_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__NAV_OPENSPACE_DEBUG_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_planning_msgs__msg__NavOpenspaceDebugInfo __attribute__((deprecated))
#else
# define DEPRECATED__deva_planning_msgs__msg__NavOpenspaceDebugInfo __declspec(deprecated)
#endif
...
struct NavOpenspaceDebugInfo_
{
  ...
  using _obstacles_info_type =
    std::vector<deva_planning_msgs::msg::NavOpenspaceObstacle_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::NavOpenspaceObstacle_<ContainerAllocator>>>;
  _obstacles_info_type obstacles_info;
  using _parking_slots_type =
    std::vector<deva_planning_msgs::msg::NavOpenspaceParkingSlot_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::NavOpenspaceParkingSlot_<ContainerAllocator>>>;
  ...
  using _ref_points_type =
    std::vector<deva_planning_msgs::msg::PathData_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::PathData_<ContainerAllocator>>>;
  ...
  using _last_trajectory_type =
    deva_planning_msgs::msg::TargetTrajectory_<ContainerAllocator>;
  ...
  using _last_internal_trajectory_paths_type =
    std::vector<deva_planning_msgs::msg::TargetTrajectory_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::TargetTrajectory_<ContainerAllocator>>>;
  ...
  Type & set__obstacles_info(
    const std::vector<deva_planning_msgs::msg::NavOpenspaceObstacle_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::NavOpenspaceObstacle_<ContainerAllocator>>> & _arg)
  {
    this->obstacles_info = _arg;
    return *this;
  }
  Type & set__parking_slots(
    const std::vector<deva_planning_msgs::msg::NavOpenspaceParkingSlot_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::NavOpenspaceParkingSlot_<ContainerAllocator>>> & _arg)
  {
  ...
  Type & set__ref_points(
    const std::vector<deva_planning_msgs::msg::PathData_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::PathData_<ContainerAllocator>>> & _arg)
  {
  ...
  Type & set__last_trajectory(
    const deva_planning_msgs::msg::TargetTrajectory_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__last_internal_trajectory_paths(
    const std::vector<deva_planning_msgs::msg::TargetTrajectory_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<deva_planning_msgs::msg::TargetTrajectory_<ContainerAllocator>>> & _arg)
  {
  ...
  using ConstRawPtr =
    const deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_planning_msgs__msg__NavOpenspaceDebugInfo
    std::shared_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_planning_msgs__msg__NavOpenspaceDebugInfo
    std::shared_ptr<deva_planning_msgs::msg::NavOpenspaceDebugInfo_<ContainerAllocator> const>
...
using NavOpenspaceDebugInfo =
  deva_planning_msgs::msg::NavOpenspaceDebugInfo_<std::allocator<void>>;
...
#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__NAV_OPENSPACE_DEBUG_INFO__STRUCT_HPP_
