...
#ifndef DEVA_PLANNING_MSGS__MSG__DETAIL__REFERENCE_LINES__TRAITS_HPP_
#define DEVA_PLANNING_MSGS__MSG__DETAIL__REFERENCE_LINES__TRAITS_HPP_
...
#include "deva_planning_msgs/msg/detail/reference_line__traits.hpp"
...
inline void to_yaml(
  const deva_planning_msgs::msg::ReferenceLines & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_planning_msgs::msg::ReferenceLines & msg)
{
  return deva_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_planning_msgs::msg::ReferenceLines>()
{
  return "deva_planning_msgs::msg::ReferenceLines";
}

template<>
inline const char * name<deva_planning_msgs::msg::ReferenceLines>()
{
  return "deva_planning_msgs/msg/ReferenceLines";
}

template<>
struct has_fixed_size<deva_planning_msgs::msg::ReferenceLines>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_planning_msgs::msg::ReferenceLines>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_planning_msgs::msg::ReferenceLines>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PLANNING_MSGS__MSG__DETAIL__REFERENCE_LINES__TRAITS_HPP_
