...
static const _ReferenceLine_type_support_symbol_names_t _ReferenceLine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_planning_msgs, msg, ReferenceLine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_planning_msgs, msg, ReferenceLine)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_planning_msgs, msg, ReferenceLine)() {
  return &::deva_planning_msgs::msg::rosidl_typesupport_c::ReferenceLine_message_type_support_handle;
}
