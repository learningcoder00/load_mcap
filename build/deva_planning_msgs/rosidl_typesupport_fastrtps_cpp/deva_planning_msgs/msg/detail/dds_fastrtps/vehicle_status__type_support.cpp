...
#include "deva_planning_msgs/msg/detail/vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs::msg::VehicleStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
