...
#include "deva_planning_msgs/msg/detail/reference_lines__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_planning_msgs::msg::ReferenceLine &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const deva_planning_msgs::msg::ReferenceLines & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs::msg::ReferenceLines & ros_message)
{
  // Member: header
  ...
  // Member: reference_lines
  {
    ...
    ros_message.reference_lines.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_planning_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.reference_lines[i]);
    }
  }
  ...
  // Member: reference_lines
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.reference_lines[index], current_alignment);
    }
  }
  // Member: curr_id
  {
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_planning_msgs
max_serialized_size_ReferenceLines(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: reference_lines
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ReferenceLine(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs::msg::ReferenceLines;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs::msg::ReferenceLines *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs::msg::ReferenceLines *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ReferenceLines__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_planning_msgs::msg::ReferenceLines *>(
...
static size_t _ReferenceLines__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ReferenceLines(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ReferenceLines__callbacks = {
...
static rosidl_message_type_support_t _ReferenceLines__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ReferenceLines__callbacks,
...
{
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_ReferenceLines__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs, msg, ReferenceLines)() {
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_ReferenceLines__handle;
}
