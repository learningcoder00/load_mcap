...
#include "deva_planning_msgs/msg/detail/planning_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_planning_msgs::msg::PlanningFail &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs::msg::PlanningFail &);
size_t get_serialized_size(
  const deva_planning_msgs::msg::PlanningFail &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const deva_planning_msgs::msg::PlanningState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs::msg::PlanningState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: fail_reason
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PlanningFail(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs::msg::PlanningState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs::msg::PlanningState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs::msg::PlanningState *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_PlanningState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs, msg, PlanningState)() {
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_PlanningState__handle;
}
