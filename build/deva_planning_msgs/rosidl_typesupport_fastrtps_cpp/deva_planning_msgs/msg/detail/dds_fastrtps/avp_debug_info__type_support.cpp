...
#include "deva_planning_msgs/msg/detail/avp_debug_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_planning_msgs::msg::AvpRefLine &,
...
{
bool cdr_serialize(
  const deva_planning_msgs::msg::AvpRefLineTreePointVec &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs::msg::AvpRefLineTreePointVec &);
size_t get_serialized_size(
  const deva_planning_msgs::msg::AvpRefLineTreePointVec &,
  size_t current_alignment);
size_t
...
// functions for deva_planning_msgs::msg::AvpRefLineTreePointVec already declared above
...
{
bool cdr_serialize(
  const deva_planning_msgs::msg::MpcPathData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs::msg::MpcPathData &);
size_t get_serialized_size(
  const deva_planning_msgs::msg::MpcPathData &,
  size_t current_alignment);
size_t
...
// functions for deva_planning_msgs::msg::MpcPathData already declared above
...
{
bool cdr_serialize(
  const deva_planning_msgs::msg::StitchData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_planning_msgs::msg::StitchData &);
size_t get_serialized_size(
  const deva_planning_msgs::msg::StitchData &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const deva_planning_msgs::msg::AvpDebugInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs::msg::AvpDebugInfo & ros_message)
{
  // Member: solve_num
  cdr >> ros_message.solve_num;
  ...
  size_t current_alignment)
{
  ...
  // Member: origin_ref_line
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AvpRefLine(
  ...
  // Member: smooth_line
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AvpRefLineTreePointVec(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: now_mpc_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MpcPathData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: stitch_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_StitchData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs::msg::AvpDebugInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs::msg::AvpDebugInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs::msg::AvpDebugInfo *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_AvpDebugInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs, msg, AvpDebugInfo)() {
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_AvpDebugInfo__handle;
}
