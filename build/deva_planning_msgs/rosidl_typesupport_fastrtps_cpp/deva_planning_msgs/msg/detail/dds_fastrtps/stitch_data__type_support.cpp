...
#include "deva_planning_msgs/msg/detail/stitch_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_planning_msgs::msg::StitchData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_planning_msgs::msg::StitchData & ros_message)
{
  // Member: stitch_mode
  cdr >> ros_message.stitch_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_planning_msgs::msg::StitchData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_planning_msgs::msg::StitchData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_planning_msgs::msg::StitchData *>(
    untyped_ros_message);
...
{
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_StitchData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_planning_msgs, msg, StitchData)() {
  return &deva_planning_msgs::msg::typesupport_fastrtps_cpp::_StitchData__handle;
}
