...
bool serialize_msgs__msg__serialize_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("serialize_msgs.msg._serialize_proto.SerializeProto", full_classname_dest, 50) == 0);
  }
  serialize_msgs__msg__SerializeProto * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SerializeProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("serialize_msgs.msg._serialize_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SerializeProto");
