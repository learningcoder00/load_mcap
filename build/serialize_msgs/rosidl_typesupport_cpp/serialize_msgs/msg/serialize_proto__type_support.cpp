...
static const _SerializeProto_type_support_symbol_names_t _SerializeProto_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serialize_msgs, msg, SerializeProto)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serialize_msgs, msg, SerializeProto)),
  }
};
...
{
  return &::serialize_msgs::msg::rosidl_typesupport_cpp::SerializeProto_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, serialize_msgs, msg, SerializeProto)() {
  return get_message_type_support_handle<serialize_msgs::msg::SerializeProto>();
}
