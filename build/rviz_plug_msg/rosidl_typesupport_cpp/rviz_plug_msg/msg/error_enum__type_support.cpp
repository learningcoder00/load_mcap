...
static const _ErrorEnum_type_support_symbol_names_t _ErrorEnum_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_plug_msg, msg, ErrorEnum)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rviz_plug_msg, msg, ErrorEnum)),
  }
};
...
{
  return &::rviz_plug_msg::msg::rosidl_typesupport_cpp::ErrorEnum_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rviz_plug_msg, msg, ErrorEnum)() {
  return get_message_type_support_handle<rviz_plug_msg::msg::ErrorEnum>();
}
