...
static const _ExceptionMonitor_type_support_symbol_names_t _ExceptionMonitor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rviz_plug_msg, msg, ExceptionMonitor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_plug_msg, msg, ExceptionMonitor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rviz_plug_msg, msg, ExceptionMonitor)() {
  return &::rviz_plug_msg::msg::rosidl_typesupport_c::ExceptionMonitor_message_type_support_handle;
}
