...
bool
deva_aeb_msgs__msg__FusionInfoForAEB__init(deva_aeb_msgs__msg__FusionInfoForAEB * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!deva_common_msgs__msg__Header__init(&msg->header)) {
    deva_aeb_msgs__msg__FusionInfoForAEB__fini(msg);
    return false;
  }
  // fusionobjlist
  ...
  // fusionobstraclelist
  if (!deva_aeb_msgs__msg__SFFusionObstacleList__init(&msg->fusionobstraclelist)) {
    deva_aeb_msgs__msg__FusionInfoForAEB__fini(msg);
    return false;
  }
  // fusionroadsignlist
...
void
deva_aeb_msgs__msg__FusionInfoForAEB__fini(deva_aeb_msgs__msg__FusionInfoForAEB * msg)
{
  if (!msg) {
    return;
  }
  ...
  // fusionobstraclelist
  deva_aeb_msgs__msg__SFFusionObstacleList__fini(&msg->fusionobstraclelist);
  // fusionroadsignlist
...
bool
deva_aeb_msgs__msg__FusionInfoForAEB__are_equal(const deva_aeb_msgs__msg__FusionInfoForAEB * lhs, const deva_aeb_msgs__msg__FusionInfoForAEB * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // fusionobstraclelist
  if (!deva_aeb_msgs__msg__SFFusionObstacleList__are_equal(
      &(lhs->fusionobstraclelist), &(rhs->fusionobstraclelist)))
  {
    return false;
  }
  // fusionroadsignlist
...
bool
deva_aeb_msgs__msg__FusionInfoForAEB__copy(
  const deva_aeb_msgs__msg__FusionInfoForAEB * input,
  deva_aeb_msgs__msg__FusionInfoForAEB * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  if (!deva_aeb_msgs__msg__SFFusionObstacleList__copy(
      &(input->fusionobstraclelist), &(output->fusionobstraclelist)))
  {
    return false;
  }
  // fusionroadsignlist
...
deva_aeb_msgs__msg__FusionInfoForAEB__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_aeb_msgs__msg__FusionInfoForAEB * msg = (deva_aeb_msgs__msg__FusionInfoForAEB *)allocator.allocate(sizeof(deva_aeb_msgs__msg__FusionInfoForAEB), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_aeb_msgs__msg__FusionInfoForAEB));
  bool success = deva_aeb_msgs__msg__FusionInfoForAEB__init(msg);
  if (!success) {
...
void
deva_aeb_msgs__msg__FusionInfoForAEB__destroy(deva_aeb_msgs__msg__FusionInfoForAEB * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_aeb_msgs__msg__FusionInfoForAEB__fini(msg);
...
bool
deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__init(deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_aeb_msgs__msg__FusionInfoForAEB * data = NULL;

  if (size) {
    data = (deva_aeb_msgs__msg__FusionInfoForAEB *)allocator.zero_allocate(size, sizeof(deva_aeb_msgs__msg__FusionInfoForAEB), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_aeb_msgs__msg__FusionInfoForAEB__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_aeb_msgs__msg__FusionInfoForAEB__fini(&data[i - 1]);
      }
...
void
deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__fini(deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_aeb_msgs__msg__FusionInfoForAEB__fini(&array->data[i]);
    }
...
deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * array = (deva_aeb_msgs__msg__FusionInfoForAEB__Sequence *)allocator.allocate(sizeof(deva_aeb_msgs__msg__FusionInfoForAEB__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__init(array, size);
  if (!success) {
...
void
deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__destroy(deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__are_equal(const deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * lhs, const deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_aeb_msgs__msg__FusionInfoForAEB__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
deva_aeb_msgs__msg__FusionInfoForAEB__Sequence__copy(
  const deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * input,
  deva_aeb_msgs__msg__FusionInfoForAEB__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_aeb_msgs__msg__FusionInfoForAEB);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_aeb_msgs__msg__FusionInfoForAEB * data =
      (deva_aeb_msgs__msg__FusionInfoForAEB *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_aeb_msgs__msg__FusionInfoForAEB__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_aeb_msgs__msg__FusionInfoForAEB__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_aeb_msgs__msg__FusionInfoForAEB__copy(
