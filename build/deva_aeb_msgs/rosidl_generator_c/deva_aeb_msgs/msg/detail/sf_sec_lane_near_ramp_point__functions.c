...
deva_aeb_msgs__msg__SFSecLaneNearRampPoint__create()
{
  ...
  deva_aeb_msgs__msg__SFSecLaneNearRampPoint * msg = (deva_aeb_msgs__msg__SFSecLaneNearRampPoint *)allocator.allocate(sizeof(deva_aeb_msgs__msg__SFSecLaneNearRampPoint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_aeb_msgs__msg__SFSecLaneNearRampPoint));
  bool success = deva_aeb_msgs__msg__SFSecLaneNearRampPoint__init(msg);
  if (!success) {
...
deva_aeb_msgs__msg__SFSecLaneNearRampPoint__destroy(deva_aeb_msgs__msg__SFSecLaneNearRampPoint * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_aeb_msgs__msg__SFSecLaneNearRampPoint__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence__init(deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_aeb_msgs__msg__SFSecLaneNearRampPoint * data = NULL;

  if (size) {
    data = (deva_aeb_msgs__msg__SFSecLaneNearRampPoint *)allocator.zero_allocate(size, sizeof(deva_aeb_msgs__msg__SFSecLaneNearRampPoint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_aeb_msgs__msg__SFSecLaneNearRampPoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_aeb_msgs__msg__SFSecLaneNearRampPoint__fini(&data[i - 1]);
      }
...
deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence__fini(deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_aeb_msgs__msg__SFSecLaneNearRampPoint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * array = (deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence *)allocator.allocate(sizeof(deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence__init(array, size);
  if (!success) {
...
deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence__destroy(deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence__are_equal(const deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * lhs, const deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_aeb_msgs__msg__SFSecLaneNearRampPoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_aeb_msgs__msg__SFSecLaneNearRampPoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_aeb_msgs__msg__SFSecLaneNearRampPoint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_aeb_msgs__msg__SFSecLaneNearRampPoint * data =
      (deva_aeb_msgs__msg__SFSecLaneNearRampPoint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_aeb_msgs__msg__SFSecLaneNearRampPoint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_aeb_msgs__msg__SFSecLaneNearRampPoint__fini(&output->data[i]);
        }
        return false;
      }
    }
