...
class Metaclass_SFFusionObjList(type):
    """Metaclass of message 'SFFusionObjList'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sf_fusion_obj_list
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sf_fusion_obj_list
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sf_fusion_obj_list
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sf_fusion_obj_list
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sf_fusion_obj_list

            from deva_aeb_msgs.msg import SFFusionObjNOA
            if SFFusionObjNOA.__class__._TYPE_SUPPORT is None:
                SFFusionObjNOA.__class__.__import_type_support__()
...
class SFFusionObjList(metaclass=Metaclass_SFFusionObjList):
    """Message class 'SFFusionObjList'."""
    ...
    _fields_and_field_types = {
        ...
        'snsrstate': 'uint8',
        'reserved': 'uint8[2]',
        'obj': 'deva_aeb_msgs/SFFusionObjNOA[64]',
        'validsize': 'uint8',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['deva_aeb_msgs', 'msg'], 'SFFusionObjNOA'), 64),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.obj = kwargs.get(
            'obj',
            [SFFusionObjNOA() for x in range(64)]
        )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) == 64 and
                 all(isinstance(v, SFFusionObjNOA) for v in value) and
                 True), \
                "The 'obj' field must be a set or sequence with length 64 and each value of type 'SFFusionObjNOA'"
        self._obj = value
