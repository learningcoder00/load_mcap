...
bool deva_aeb_msgs__msg__sf_fusion_tfl_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_fusion_tfl_list.SFFusionTFLList", full_classname_dest, 53) == 0);
  }
  deva_aeb_msgs__msg__SFFusionTFLList * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // tfllist
    ...
    Py_ssize_t size = 8;
    deva_aeb_msgs__msg__SFFusionTFL * dest = ros_message->tfllist;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_aeb_msgs__msg__sf_fusion_tfl__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of SFFusionTFLList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_fusion_tfl_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFFusionTFLList");
  ...
  {  // tfllist
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_aeb_msgs__msg__sf_fusion_tfl__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
