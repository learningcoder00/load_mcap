...
class Metaclass_SFObjEstimnNOA(type):
    """Metaclass of message 'SFObjEstimnNOA'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sf_obj_estimn_noa
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sf_obj_estimn_noa
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sf_obj_estimn_noa
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sf_obj_estimn_noa
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sf_obj_estimn_noa
...
class SFObjEstimnNOA(metaclass=Metaclass_SFObjEstimnNOA):
    """Message class 'SFObjEstimnNOA'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.agdirstd = kwargs.get('agdirstd', float())
    ...
    def __eq__(self, other):
        ...
        if self.crvt != other.crvt:
            return False
        if self.agdirstd != other.agdirstd:
            return False
        return True
    ...
    @builtins.property
    def agdirstd(self):
        """Message field 'agdirstd'."""
        return self._agdirstd

    @agdirstd.setter
    def agdirstd(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'agdirstd' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'agdirstd' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._agdirstd = value
