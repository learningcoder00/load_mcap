...
bool deva_aeb_msgs__msg__sf_fusion_obj_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_fusion_obj_list.SFFusionObjList", full_classname_dest, 53) == 0);
  }
  deva_aeb_msgs__msg__SFFusionObjList * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // obj
    ...
    Py_ssize_t size = 64;
    deva_aeb_msgs__msg__SFFusionObjNOA * dest = ros_message->obj;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_aeb_msgs__msg__sf_fusion_obj_noa__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of SFFusionObjList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_fusion_obj_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFFusionObjList");
  ...
  {  // obj
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_aeb_msgs__msg__sf_fusion_obj_noa__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
