...
bool deva_aeb_msgs__msg__sf_sec_lane_near_ramp_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_sec_lane_near_ramp_point.SFSecLaneNearRampPoint", full_classname_dest, 69) == 0);
  }
  deva_aeb_msgs__msg__SFSecLaneNearRampPoint * ros_message = _ros_message;
  {  // posx
...
{
  /* NOTE(esteve): Call constructor of SFSecLaneNearRampPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_sec_lane_near_ramp_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFSecLaneNearRampPoint");
