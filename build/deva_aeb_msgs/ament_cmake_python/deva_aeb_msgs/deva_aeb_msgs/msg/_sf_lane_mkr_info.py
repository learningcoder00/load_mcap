...
class Metaclass_SFLaneMkrInfo(type):
    """Metaclass of message 'SFLaneMkrInfo'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sf_lane_mkr_info
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sf_lane_mkr_info
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sf_lane_mkr_info
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sf_lane_mkr_info
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sf_lane_mkr_info
...
class SFLaneMkrInfo(metaclass=Metaclass_SFLaneMkrInfo):
    """Message class 'SFLaneMkrInfo'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.lanecolor = kwargs.get('lanecolor', int())
    ...
    def __eq__(self, other):
        ...
        if self.width != other.width:
            return False
        if self.lanecolor != other.lanecolor:
            return False
    ...
    @builtins.property
    def lanecolor(self):
        """Message field 'lanecolor'."""
        return self._lanecolor

    @lanecolor.setter
    def lanecolor(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'lanecolor' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'lanecolor' field must be an unsigned integer in [0, 255]"
        self._lanecolor = value
