...
bool deva_aeb_msgs__msg__sf_fusion_obstacle_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_fusion_obstacle_list.SFFusionObstacleList", full_classname_dest, 63) == 0);
  }
  deva_aeb_msgs__msg__SFFusionObstacleList * ros_message = _ros_message;
  {  // obslist
...
{
  /* NOTE(esteve): Call constructor of SFFusionObstacleList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_fusion_obstacle_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFFusionObstacleList");
