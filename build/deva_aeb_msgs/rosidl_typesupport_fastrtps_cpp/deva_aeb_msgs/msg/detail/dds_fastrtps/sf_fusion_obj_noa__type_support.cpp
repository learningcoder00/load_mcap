...
#include "deva_aeb_msgs/msg/detail/sf_fusion_obj_noa__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFObjEstimnNOA &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_aeb_msgs::msg::SFObjEstimnNOA &);
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFObjInfoNOA &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_aeb_msgs::msg::SFObjInfoNOA &);
size_t get_serialized_size(
  const deva_aeb_msgs::msg::SFObjInfoNOA &,
  size_t current_alignment);
size_t
max_serialized_size_SFObjInfoNOA(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionObjNOA & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFFusionObjNOA & ros_message)
{
  // Member: estimn
  ...
  size_t current_alignment)
{
  ...
  // Member: estimn
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFObjEstimnNOA(
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFObjInfoNOA(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFFusionObjNOA;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionObjNOA *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFFusionObjNOA *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFFusionObjNOA__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionObjNOA *>(
...
static size_t _SFFusionObjNOA__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFFusionObjNOA(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFFusionObjNOA__callbacks = {
  "deva_aeb_msgs::msg",
  "SFFusionObjNOA",
...
static rosidl_message_type_support_t _SFFusionObjNOA__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFFusionObjNOA__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionObjNOA__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFFusionObjNOA)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionObjNOA__handle;
}
