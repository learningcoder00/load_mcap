...
#include "deva_aeb_msgs/msg/detail/sf_veh_self__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFVehSelf & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFVehSelf & ros_message)
{
  // Member: vlgt
  cdr >> ros_message.vlgt;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFVehSelf;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFVehSelf *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFVehSelf *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFVehSelf__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFVehSelf *>(
...
static size_t _SFVehSelf__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFVehSelf(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFVehSelf__callbacks = {
  "deva_aeb_msgs::msg",
  "SFVehSelf",
...
static rosidl_message_type_support_t _SFVehSelf__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFVehSelf__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFVehSelf__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFVehSelf)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFVehSelf__handle;
}
