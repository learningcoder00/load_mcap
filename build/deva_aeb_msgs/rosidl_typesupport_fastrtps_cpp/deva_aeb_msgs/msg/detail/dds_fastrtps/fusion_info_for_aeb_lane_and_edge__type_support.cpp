...
#include "deva_aeb_msgs/msg/detail/fusion_info_for_aeb_lane_and_edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::FusionInfoForAEBLaneAndEdge & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::FusionInfoForAEBLaneAndEdge & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_aeb_msgs
max_serialized_size_FusionInfoForAEBLaneAndEdge(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::FusionInfoForAEBLaneAndEdge;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::FusionInfoForAEBLaneAndEdge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::FusionInfoForAEBLaneAndEdge *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FusionInfoForAEBLaneAndEdge__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::FusionInfoForAEBLaneAndEdge *>(
...
static size_t _FusionInfoForAEBLaneAndEdge__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FusionInfoForAEBLaneAndEdge(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FusionInfoForAEBLaneAndEdge__callbacks = {
  "deva_aeb_msgs::msg",
...
static rosidl_message_type_support_t _FusionInfoForAEBLaneAndEdge__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FusionInfoForAEBLaneAndEdge__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_FusionInfoForAEBLaneAndEdge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, FusionInfoForAEBLaneAndEdge)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_FusionInfoForAEBLaneAndEdge__handle;
}
