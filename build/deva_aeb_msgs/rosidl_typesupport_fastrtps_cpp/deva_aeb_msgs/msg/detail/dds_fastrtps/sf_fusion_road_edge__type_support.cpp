...
#include "deva_aeb_msgs/msg/detail/sf_fusion_road_edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::RoadInfo &,
...
// functions for deva_aeb_msgs::msg::RoadInfo already declared above
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionRoadEdge & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.frontleft,
    cdr);
  // Member: frontright
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.frontright,
    cdr);
  // Member: rearleft
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.rearleft,
    cdr);
  // Member: rearright
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.rearright,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFFusionRoadEdge & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  // Member: frontleft
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RoadInfo(
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFFusionRoadEdge;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionRoadEdge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFFusionRoadEdge *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFFusionRoadEdge__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionRoadEdge *>(
...
static size_t _SFFusionRoadEdge__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFFusionRoadEdge(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFFusionRoadEdge__callbacks = {
  "deva_aeb_msgs::msg",
  "SFFusionRoadEdge",
...
static rosidl_message_type_support_t _SFFusionRoadEdge__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFFusionRoadEdge__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionRoadEdge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFFusionRoadEdge)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionRoadEdge__handle;
}
