...
#include "deva_aeb_msgs/msg/detail/sf_obj_info_noa__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFObjInfoNOA & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFObjInfoNOA & ros_message)
{
  // Member: length
  cdr >> ros_message.length;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFObjInfoNOA;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFObjInfoNOA *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFObjInfoNOA *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFObjInfoNOA__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFObjInfoNOA *>(
...
static size_t _SFObjInfoNOA__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFObjInfoNOA(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFObjInfoNOA__callbacks = {
  "deva_aeb_msgs::msg",
  "SFObjInfoNOA",
...
static rosidl_message_type_support_t _SFObjInfoNOA__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFObjInfoNOA__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFObjInfoNOA__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFObjInfoNOA)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFObjInfoNOA__handle;
}
