...
#include "deva_aeb_msgs/msg/detail/sf_lane_two_seg_estimn__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFLaneTwoSegEstimn & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFLaneTwoSegEstimn & ros_message)
{
  // Member: constcoeff
  cdr >> ros_message.constcoeff;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFLaneTwoSegEstimn;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFLaneTwoSegEstimn *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFLaneTwoSegEstimn *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFLaneTwoSegEstimn__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFLaneTwoSegEstimn *>(
...
static size_t _SFLaneTwoSegEstimn__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFLaneTwoSegEstimn(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFLaneTwoSegEstimn__callbacks = {
  "deva_aeb_msgs::msg",
  "SFLaneTwoSegEstimn",
...
static rosidl_message_type_support_t _SFLaneTwoSegEstimn__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFLaneTwoSegEstimn__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFLaneTwoSegEstimn__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFLaneTwoSegEstimn)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFLaneTwoSegEstimn__handle;
}
