...
#include "deva_aeb_msgs/msg/detail/sf_curve_function_extra__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFCurveFunctionExtra & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFCurveFunctionExtra & ros_message)
{
  // Member: poslgt
  cdr >> ros_message.poslgt;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFCurveFunctionExtra;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFCurveFunctionExtra *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFCurveFunctionExtra *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFCurveFunctionExtra__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFCurveFunctionExtra *>(
...
static size_t _SFCurveFunctionExtra__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFCurveFunctionExtra(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFCurveFunctionExtra__callbacks = {
  "deva_aeb_msgs::msg",
...
static rosidl_message_type_support_t _SFCurveFunctionExtra__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFCurveFunctionExtra__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFCurveFunctionExtra__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFCurveFunctionExtra)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFCurveFunctionExtra__handle;
}
