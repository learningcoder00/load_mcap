...
#include "deva_aeb_msgs/msg/detail/road_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFRoadEdgeEstimn &,
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFRoadEdgeInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_aeb_msgs::msg::SFRoadEdgeInfo &);
size_t get_serialized_size(
  const deva_aeb_msgs::msg::SFRoadEdgeInfo &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const deva_aeb_msgs::msg::RoadInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::RoadInfo & ros_message)
{
  // Member: estimn
  ...
  size_t current_alignment)
{
  ...
  // Member: estimn
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFRoadEdgeEstimn(
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFRoadEdgeInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::RoadInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::RoadInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::RoadInfo *>(
    untyped_ros_message);
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_RoadInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, RoadInfo)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_RoadInfo__handle;
}
