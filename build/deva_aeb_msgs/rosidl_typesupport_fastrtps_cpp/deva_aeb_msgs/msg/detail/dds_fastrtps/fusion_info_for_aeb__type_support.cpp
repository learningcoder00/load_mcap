...
#include "deva_aeb_msgs/msg/detail/fusion_info_for_aeb__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionObjList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_aeb_msgs::msg::SFFusionObjList &);
size_t get_serialized_size(
  const deva_aeb_msgs::msg::SFFusionObjList &,
  size_t current_alignment);
size_t
max_serialized_size_SFFusionObjList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionLaneMkrList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionRoadEdge &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_SFFusionRoadEdge(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionObstacleList &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_aeb_msgs::msg::SFFusionObstacleList &);
size_t get_serialized_size(
  const deva_aeb_msgs::msg::SFFusionObstacleList &,
  size_t current_alignment);
size_t
max_serialized_size_SFFusionObstacleList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_aeb_msgs::msg::FusionInfoForAEB & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.fusionobjlist,
    cdr);
  // Member: fusionlanemkrlist
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.fusionlanemkrlist,
    cdr);
  // Member: fusionroadedge
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.fusionroadedge,
    cdr);
  // Member: roadppty
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  deva_aeb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.fusionobstraclelist,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::FusionInfoForAEB & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_aeb_msgs
max_serialized_size_FusionInfoForAEB(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: fusionobjlist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFFusionObjList(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: fusionlanemkrlist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFFusionLaneMkrList(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: fusionroadedge
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFFusionRoadEdge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: fusionobstraclelist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFFusionObstacleList(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::FusionInfoForAEB;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::FusionInfoForAEB *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::FusionInfoForAEB *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FusionInfoForAEB__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::FusionInfoForAEB *>(
...
static size_t _FusionInfoForAEB__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FusionInfoForAEB(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FusionInfoForAEB__callbacks = {
  "deva_aeb_msgs::msg",
  "FusionInfoForAEB",
...
static rosidl_message_type_support_t _FusionInfoForAEB__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FusionInfoForAEB__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_FusionInfoForAEB__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, FusionInfoForAEB)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_FusionInfoForAEB__handle;
}
