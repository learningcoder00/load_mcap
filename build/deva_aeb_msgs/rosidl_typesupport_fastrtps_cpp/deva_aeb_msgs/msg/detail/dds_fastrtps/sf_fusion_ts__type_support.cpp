...
#include "deva_aeb_msgs/msg/detail/sf_fusion_ts__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionTS & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFFusionTS & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFFusionTS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionTS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFFusionTS *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFFusionTS__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionTS *>(
...
static size_t _SFFusionTS__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFFusionTS(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFFusionTS__callbacks = {
  "deva_aeb_msgs::msg",
  "SFFusionTS",
...
static rosidl_message_type_support_t _SFFusionTS__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFFusionTS__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionTS__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFFusionTS)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionTS__handle;
}
