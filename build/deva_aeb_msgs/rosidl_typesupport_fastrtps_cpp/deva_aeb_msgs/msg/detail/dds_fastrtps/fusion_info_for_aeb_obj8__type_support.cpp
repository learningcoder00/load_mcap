...
#include "deva_aeb_msgs/msg/detail/fusion_info_for_aeb_obj8__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionObj &,
...
cdr_serialize(
  const deva_aeb_msgs::msg::FusionInfoForAEBObj8 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::FusionInfoForAEBObj8 & ros_message)
{
  // Member: obj
  {
    for (size_t i = 0; i < 8; i++) {
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_aeb_msgs
max_serialized_size_FusionInfoForAEBObj8(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: obj
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_aeb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SFFusionObj(
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::FusionInfoForAEBObj8;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::FusionInfoForAEBObj8 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::FusionInfoForAEBObj8 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FusionInfoForAEBObj8__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::FusionInfoForAEBObj8 *>(
...
static size_t _FusionInfoForAEBObj8__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FusionInfoForAEBObj8(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FusionInfoForAEBObj8__callbacks = {
  "deva_aeb_msgs::msg",
...
static rosidl_message_type_support_t _FusionInfoForAEBObj8__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FusionInfoForAEBObj8__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_FusionInfoForAEBObj8__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, FusionInfoForAEBObj8)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_FusionInfoForAEBObj8__handle;
}
