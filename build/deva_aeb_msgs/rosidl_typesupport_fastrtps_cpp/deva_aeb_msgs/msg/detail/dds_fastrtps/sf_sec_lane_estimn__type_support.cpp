...
#include "deva_aeb_msgs/msg/detail/sf_sec_lane_estimn__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFSecLaneEstimn & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFSecLaneEstimn & ros_message)
{
  // Member: constcoeff
  cdr >> ros_message.constcoeff;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFSecLaneEstimn;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFSecLaneEstimn *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFSecLaneEstimn *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFSecLaneEstimn__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFSecLaneEstimn *>(
...
static size_t _SFSecLaneEstimn__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFSecLaneEstimn(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFSecLaneEstimn__callbacks = {
  "deva_aeb_msgs::msg",
  "SFSecLaneEstimn",
...
static rosidl_message_type_support_t _SFSecLaneEstimn__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFSecLaneEstimn__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFSecLaneEstimn__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFSecLaneEstimn)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFSecLaneEstimn__handle;
}
