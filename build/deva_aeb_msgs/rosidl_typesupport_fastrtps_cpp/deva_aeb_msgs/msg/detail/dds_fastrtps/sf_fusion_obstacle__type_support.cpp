...
#include "deva_aeb_msgs/msg/detail/sf_fusion_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_aeb_msgs::msg::SFFusionObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_aeb_msgs::msg::SFFusionObstacle & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs::msg::SFFusionObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_aeb_msgs::msg::SFFusionObstacle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SFFusionObstacle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_aeb_msgs::msg::SFFusionObstacle *>(
...
static size_t _SFFusionObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SFFusionObstacle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SFFusionObstacle__callbacks = {
  "deva_aeb_msgs::msg",
  "SFFusionObstacle",
...
static rosidl_message_type_support_t _SFFusionObstacle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SFFusionObstacle__callbacks,
...
{
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_aeb_msgs, msg, SFFusionObstacle)() {
  return &deva_aeb_msgs::msg::typesupport_fastrtps_cpp::_SFFusionObstacle__handle;
}
