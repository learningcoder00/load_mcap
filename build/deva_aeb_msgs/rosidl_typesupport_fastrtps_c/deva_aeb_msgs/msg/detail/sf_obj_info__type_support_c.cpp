...
#include "deva_aeb_msgs/msg/detail/sf_obj_info__rosidl_typesupport_fastrtps_c.h"
...
using _SFObjInfo__ros_msg_type = deva_aeb_msgs__msg__SFObjInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFObjInfo__ros_msg_type * ros_message = static_cast<const _SFObjInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: length
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SFObjInfo__ros_msg_type * ros_message = static_cast<_SFObjInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: length
  {
    cdr >> ros_message->length;
  }
...
static uint32_t _SFObjInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFObjInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFObjInfo;
    is_plain =
      (
...
static size_t _SFObjInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFObjInfo(
...
static message_type_support_callbacks_t __callbacks_SFObjInfo = {
  "deva_aeb_msgs::msg",
  "SFObjInfo",
...
static rosidl_message_type_support_t _SFObjInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SFObjInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFObjInfo)() {
  return &_SFObjInfo__type_support;
}
