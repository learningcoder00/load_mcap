...
#include "deva_aeb_msgs/msg/detail/sf_fusion_obstacle_list__rosidl_typesupport_fastrtps_c.h"
...
using _SFFusionObstacleList__ros_msg_type = deva_aeb_msgs__msg__SFFusionObstacleList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFFusionObstacleList__ros_msg_type * ros_message = static_cast<const _SFFusionObstacleList__ros_msg_type *>(untyped_ros_message);
  // Field name: obslist
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SFFusionObstacleList__ros_msg_type * ros_message = static_cast<_SFFusionObstacleList__ros_msg_type *>(untyped_ros_message);
  // Field name: obslist
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _SFFusionObstacleList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFFusionObstacleList(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFFusionObstacleList;
    is_plain =
      (
...
static size_t _SFFusionObstacleList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFFusionObstacleList(
...
static message_type_support_callbacks_t __callbacks_SFFusionObstacleList = {
  "deva_aeb_msgs::msg",
...
static rosidl_message_type_support_t _SFFusionObstacleList__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SFFusionObstacleList,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFFusionObstacleList)() {
  return &_SFFusionObstacleList__type_support;
}
