...
#include "deva_aeb_msgs/msg/detail/fusion_info_for_aeb_obj_list__rosidl_typesupport_fastrtps_c.h"
...
using _FusionInfoForAEBObjList__ros_msg_type = deva_aeb_msgs__msg__FusionInfoForAEBObjList;

static bool _FusionInfoForAEBObjList__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FusionInfoForAEBObjList__ros_msg_type * ros_message = static_cast<const _FusionInfoForAEBObjList__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _FusionInfoForAEBObjList__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _FusionInfoForAEBObjList__ros_msg_type * ros_message = static_cast<_FusionInfoForAEBObjList__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_deva_aeb_msgs__msg__FusionInfoForAEBObjList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FusionInfoForAEBObjList__ros_msg_type * ros_message = static_cast<const _FusionInfoForAEBObjList__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FusionInfoForAEBObjList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__FusionInfoForAEBObjList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_aeb_msgs
size_t max_serialized_size_deva_aeb_msgs__msg__FusionInfoForAEBObjList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__FusionInfoForAEBObjList;
    is_plain =
      (
      offsetof(DataType, vehself) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _FusionInfoForAEBObjList__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_aeb_msgs__msg__FusionInfoForAEBObjList(
...
static message_type_support_callbacks_t __callbacks_FusionInfoForAEBObjList = {
  "deva_aeb_msgs::msg",
  "FusionInfoForAEBObjList",
  _FusionInfoForAEBObjList__cdr_serialize,
  _FusionInfoForAEBObjList__cdr_deserialize,
  _FusionInfoForAEBObjList__get_serialized_size,
  _FusionInfoForAEBObjList__max_serialized_size
};

static rosidl_message_type_support_t _FusionInfoForAEBObjList__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FusionInfoForAEBObjList,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, FusionInfoForAEBObjList)() {
  return &_FusionInfoForAEBObjList__type_support;
}
