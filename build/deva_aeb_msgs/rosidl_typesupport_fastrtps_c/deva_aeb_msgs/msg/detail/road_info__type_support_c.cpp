...
#include "deva_aeb_msgs/msg/detail/road_info__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_aeb_msgs/msg/detail/sf_road_edge_estimn__functions.h"  // estimn
#include "deva_aeb_msgs/msg/detail/sf_road_edge_info__functions.h"  // info
...
using _RoadInfo__ros_msg_type = deva_aeb_msgs__msg__RoadInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: estimn
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFRoadEdgeEstimn
      )()->data);
  ...
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFRoadEdgeInfo
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFRoadEdgeEstimn(
  ...
  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFRoadEdgeInfo(
...
static uint32_t _RoadInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__RoadInfo(
  ...
  size_t current_alignment)
{
  ...
  // member: estimn
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFRoadEdgeEstimn(
  ...
  // member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFRoadEdgeInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__RoadInfo;
    is_plain =
      (
...
static size_t _RoadInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__RoadInfo(
