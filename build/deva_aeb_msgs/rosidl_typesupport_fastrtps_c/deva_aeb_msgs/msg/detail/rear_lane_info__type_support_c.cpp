...
#include "deva_aeb_msgs/msg/detail/rear_lane_info__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_aeb_msgs/msg/detail/sf_lane_mkr_info__functions.h"  // info
#include "deva_aeb_msgs/msg/detail/sf_rear_line_ppty__functions.h"  // ppty
...
size_t get_serialized_size_deva_aeb_msgs__msg__SFRearLinePpty(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_aeb_msgs__msg__SFRearLinePpty(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFRearLinePpty)();


using _RearLaneInfo__ros_msg_type = deva_aeb_msgs__msg__RearLaneInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RearLaneInfo__ros_msg_type * ros_message = static_cast<const _RearLaneInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: estimn
  {
  ...
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFLaneMkrInfo
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: ppty
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFRearLinePpty
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _RearLaneInfo__ros_msg_type * ros_message = static_cast<_RearLaneInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: estimn
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFLaneMkrInfo(
    &(ros_message->info), current_alignment);
  // field.name ppty

  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFRearLinePpty(
    &(ros_message->ppty), current_alignment);

  return current_alignment - initial_alignment;
}

static uint32_t _RearLaneInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__RearLaneInfo(
  ...
  size_t current_alignment)
{
  ...
  // member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFLaneMkrInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: ppty
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFRearLinePpty(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__RearLaneInfo;
    is_plain =
      (
...
static size_t _RearLaneInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__RearLaneInfo(
...
static message_type_support_callbacks_t __callbacks_RearLaneInfo = {
  "deva_aeb_msgs::msg",
  "RearLaneInfo",
