...
#include "deva_aeb_msgs/msg/detail/sf_lane_info__rosidl_typesupport_fastrtps_c.h"
...
using _SFLaneInfo__ros_msg_type = deva_aeb_msgs__msg__SFLaneInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFLaneInfo__ros_msg_type * ros_message = static_cast<const _SFLaneInfo__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _SFLaneInfo__ros_msg_type * ros_message = static_cast<_SFLaneInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: lanecolor
  {
    cdr >> ros_message->lanecolor;
  }
...
static uint32_t _SFLaneInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFLaneInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFLaneInfo;
    is_plain =
      (
...
static size_t _SFLaneInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFLaneInfo(
...
static message_type_support_callbacks_t __callbacks_SFLaneInfo = {
  "deva_aeb_msgs::msg",
  "SFLaneInfo",
...
static rosidl_message_type_support_t _SFLaneInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SFLaneInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFLaneInfo)() {
  return &_SFLaneInfo__type_support;
}
