...
#include "deva_aeb_msgs/msg/detail/sf_sec_lane_estimn__rosidl_typesupport_fastrtps_c.h"
...
using _SFSecLaneEstimn__ros_msg_type = deva_aeb_msgs__msg__SFSecLaneEstimn;

static bool _SFSecLaneEstimn__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFSecLaneEstimn__ros_msg_type * ros_message = static_cast<const _SFSecLaneEstimn__ros_msg_type *>(untyped_ros_message);
...
static bool _SFSecLaneEstimn__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _SFSecLaneEstimn__ros_msg_type * ros_message = static_cast<_SFSecLaneEstimn__ros_msg_type *>(untyped_ros_message);
  // Field name: constcoeff
  {
    cdr >> ros_message->constcoeff;
  }
...
static uint32_t _SFSecLaneEstimn__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFSecLaneEstimn(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFSecLaneEstimn;
    is_plain =
      (
      offsetof(DataType, trackstatus) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _SFSecLaneEstimn__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFSecLaneEstimn(
...
static message_type_support_callbacks_t __callbacks_SFSecLaneEstimn = {
  "deva_aeb_msgs::msg",
  "SFSecLaneEstimn",
  _SFSecLaneEstimn__cdr_serialize,
  _SFSecLaneEstimn__cdr_deserialize,
  _SFSecLaneEstimn__get_serialized_size,
  _SFSecLaneEstimn__max_serialized_size
};

static rosidl_message_type_support_t _SFSecLaneEstimn__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SFSecLaneEstimn,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFSecLaneEstimn)() {
  return &_SFSecLaneEstimn__type_support;
}
