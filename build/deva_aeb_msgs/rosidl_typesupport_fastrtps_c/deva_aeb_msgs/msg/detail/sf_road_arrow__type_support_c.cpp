...
#include "deva_aeb_msgs/msg/detail/sf_road_arrow__rosidl_typesupport_fastrtps_c.h"
...
using _SFRoadArrow__ros_msg_type = deva_aeb_msgs__msg__SFRoadArrow;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFRoadArrow__ros_msg_type * ros_message = static_cast<const _SFRoadArrow__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _SFRoadArrow__ros_msg_type * ros_message = static_cast<_SFRoadArrow__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _SFRoadArrow__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFRoadArrow(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFRoadArrow;
    is_plain =
      (
...
static size_t _SFRoadArrow__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFRoadArrow(
...
static message_type_support_callbacks_t __callbacks_SFRoadArrow = {
  "deva_aeb_msgs::msg",
  "SFRoadArrow",
...
static rosidl_message_type_support_t _SFRoadArrow__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SFRoadArrow,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFRoadArrow)() {
  return &_SFRoadArrow__type_support;
}
