...
#include "deva_aeb_msgs/msg/detail/sf_fusion_tfl__rosidl_typesupport_fastrtps_c.h"
...
using _SFFusionTFL__ros_msg_type = deva_aeb_msgs__msg__SFFusionTFL;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFFusionTFL__ros_msg_type * ros_message = static_cast<const _SFFusionTFL__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _SFFusionTFL__ros_msg_type * ros_message = static_cast<_SFFusionTFL__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _SFFusionTFL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFFusionTFL(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFFusionTFL;
    is_plain =
      (
...
static size_t _SFFusionTFL__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFFusionTFL(
...
static message_type_support_callbacks_t __callbacks_SFFusionTFL = {
  "deva_aeb_msgs::msg",
  "SFFusionTFL",
...
static rosidl_message_type_support_t _SFFusionTFL__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SFFusionTFL,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFFusionTFL)() {
  return &_SFFusionTFL__type_support;
}
