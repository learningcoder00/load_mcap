...
#include "deva_aeb_msgs/msg/detail/sf_fusion_obj__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_aeb_msgs/msg/detail/sf_obj_estimn__functions.h"  // estimn
#include "deva_aeb_msgs/msg/detail/sf_obj_info__functions.h"  // info
...
size_t get_serialized_size_deva_aeb_msgs__msg__SFObjInfo(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_aeb_msgs__msg__SFObjInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFObjInfo)();
...
using _SFFusionObj__ros_msg_type = deva_aeb_msgs__msg__SFFusionObj;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SFFusionObj__ros_msg_type * ros_message = static_cast<const _SFFusionObj__ros_msg_type *>(untyped_ros_message);
  // Field name: estimn
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFObjEstimn
      )()->data);
  ...
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFObjInfo
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _SFFusionObj__ros_msg_type * ros_message = static_cast<_SFFusionObj__ros_msg_type *>(untyped_ros_message);
  // Field name: estimn
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFObjEstimn(
    &(ros_message->estimn), current_alignment);
  // field.name info

  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFObjInfo(
...
static uint32_t _SFFusionObj__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__SFFusionObj(
  ...
  size_t current_alignment)
{
  ...
  // member: estimn
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFObjEstimn(
  ...
  // member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFObjInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__SFFusionObj;
    is_plain =
      (
...
static size_t _SFFusionObj__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__SFFusionObj(
...
static message_type_support_callbacks_t __callbacks_SFFusionObj = {
  "deva_aeb_msgs::msg",
  "SFFusionObj",
