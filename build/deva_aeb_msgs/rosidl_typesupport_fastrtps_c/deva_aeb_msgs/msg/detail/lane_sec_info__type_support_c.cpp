...
#include "deva_aeb_msgs/msg/detail/lane_sec_info__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_aeb_msgs/msg/detail/sf_sec_lane_estimn__functions.h"  // estimn
#include "deva_aeb_msgs/msg/detail/sf_sec_lane_near_ramp_point__functions.h"  // nearramppoint
...
size_t get_serialized_size_deva_aeb_msgs__msg__SFSecLaneEstimn(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_aeb_msgs__msg__SFSecLaneEstimn(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFSecLaneEstimn)();
size_t get_serialized_size_deva_aeb_msgs__msg__SFSecLaneNearRampPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_aeb_msgs__msg__SFSecLaneNearRampPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFSecLaneNearRampPoint)();


using _LaneSecInfo__ros_msg_type = deva_aeb_msgs__msg__LaneSecInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LaneSecInfo__ros_msg_type * ros_message = static_cast<const _LaneSecInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: estimn
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFSecLaneEstimn
      )()->data);
  ...
  // Field name: nearramppoint
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, SFSecLaneNearRampPoint
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->nearramppoint, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _LaneSecInfo__ros_msg_type * ros_message = static_cast<_LaneSecInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: estimn
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFSecLaneEstimn(
  ...
  current_alignment += get_serialized_size_deva_aeb_msgs__msg__SFSecLaneNearRampPoint(
    &(ros_message->nearramppoint), current_alignment);

  return current_alignment - initial_alignment;
}

static uint32_t _LaneSecInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_aeb_msgs__msg__LaneSecInfo(
  ...
  size_t current_alignment)
{
  ...
  // member: estimn
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFSecLaneEstimn(
  ...
  // member: nearramppoint
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_aeb_msgs__msg__SFSecLaneNearRampPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_aeb_msgs__msg__LaneSecInfo;
    is_plain =
      (
...
static size_t _LaneSecInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_aeb_msgs__msg__LaneSecInfo(
...
static message_type_support_callbacks_t __callbacks_LaneSecInfo = {
  "deva_aeb_msgs::msg",
  "LaneSecInfo",
