...
static const _LaneSecInfo_type_support_symbol_names_t _LaneSecInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_aeb_msgs, msg, LaneSecInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_aeb_msgs, msg, LaneSecInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_aeb_msgs, msg, LaneSecInfo)() {
  return &::deva_aeb_msgs::msg::rosidl_typesupport_c::LaneSecInfo_message_type_support_handle;
}
