...
class Metaclass_SFFusionTFLList(type):
    """Metaclass of message 'SFFusionTFLList'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sf_fusion_tfl_list
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sf_fusion_tfl_list
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sf_fusion_tfl_list
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sf_fusion_tfl_list
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sf_fusion_tfl_list

            from deva_aeb_msgs.msg import SFFusionTFL
            if SFFusionTFL.__class__._TYPE_SUPPORT is None:
                SFFusionTFL.__class__.__import_type_support__()
...
class SFFusionTFLList(metaclass=Metaclass_SFFusionTFLList):
    """Message class 'SFFusionTFLList'."""
    ...
    _fields_and_field_types = {
        ...
        'tflcount': 'uint8',
        'reserved': 'uint8[2]',
        'tfllist': 'deva_aeb_msgs/SFFusionTFL[8]',
        'validsize': 'uint8',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['deva_aeb_msgs', 'msg'], 'SFFusionTFL'), 8),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) == 8 and
                 all(isinstance(v, SFFusionTFL) for v in value) and
                 True), \
                "The 'tfllist' field must be a set or sequence with length 8 and each value of type 'SFFusionTFL'"
        self._tfllist = value
