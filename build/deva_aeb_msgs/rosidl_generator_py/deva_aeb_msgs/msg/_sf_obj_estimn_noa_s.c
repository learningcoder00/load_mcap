...
bool deva_aeb_msgs__msg__sf_obj_estimn_noa__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_obj_estimn_noa.SFObjEstimnNOA", full_classname_dest, 51) == 0);
  }
  deva_aeb_msgs__msg__SFObjEstimnNOA * ros_message = _ros_message;
  {  // posnlgt
  ...
  {  // agdirstd
    PyObject * field = PyObject_GetAttrString(_pymsg, "agdirstd");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->agdirstd = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of SFObjEstimnNOA */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_obj_estimn_noa");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFObjEstimnNOA");
  ...
  {  // agdirstd
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->agdirstd);
    {
      int rc = PyObject_SetAttrString(_pymessage, "agdirstd", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
