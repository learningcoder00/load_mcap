...
class Metaclass_SFObjInfoNOA(type):
    """Metaclass of message 'SFObjInfoNOA'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sf_obj_info_noa
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sf_obj_info_noa
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sf_obj_info_noa
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sf_obj_info_noa
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sf_obj_info_noa
...
class SFObjInfoNOA(metaclass=Metaclass_SFObjInfoNOA):
    """Message class 'SFObjInfoNOA'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.lan_assignment = kwargs.get('lan_assignment', int())
    ...
    def __eq__(self, other):
        ...
        if any(self.reserved != other.reserved):
            return False
        if self.lan_assignment != other.lan_assignment:
            return False
        return True
    ...
    @builtins.property
    def lan_assignment(self):
        """Message field 'lan_assignment'."""
        return self._lan_assignment

    @lan_assignment.setter
    def lan_assignment(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'lan_assignment' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'lan_assignment' field must be an unsigned integer in [0, 255]"
        self._lan_assignment = value
