...
bool deva_aeb_msgs__msg__sf_obj_info__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_aeb_msgs__msg__sf_fusion_obj__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._sf_fusion_obj.SFFusionObj", full_classname_dest, 44) == 0);
  }
  deva_aeb_msgs__msg__SFFusionObj * ros_message = _ros_message;
  {  // estimn
    PyObject * field = PyObject_GetAttrString(_pymsg, "estimn");
    if (!field) {
      return false;
    }
    if (!deva_aeb_msgs__msg__sf_obj_estimn__convert_from_py(field, &ros_message->estimn)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // info
    ...
    if (!deva_aeb_msgs__msg__sf_obj_info__convert_from_py(field, &ros_message->info)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SFFusionObj */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._sf_fusion_obj");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SFFusionObj");
  ...
  {  // estimn
    PyObject * field = NULL;
    field = deva_aeb_msgs__msg__sf_obj_estimn__convert_to_py(&ros_message->estimn);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // info
    PyObject * field = NULL;
    field = deva_aeb_msgs__msg__sf_obj_info__convert_to_py(&ros_message->info);
    if (!field) {
      return NULL;
    }
    {
