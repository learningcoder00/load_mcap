...
class Metaclass_FusionInfoForAEBOther(type):
    """Metaclass of message 'FusionInfoForAEBOther'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_aeb_msgs.msg.FusionInfoForAEBOther')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__fusion_info_for_aeb_other
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__fusion_info_for_aeb_other
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__fusion_info_for_aeb_other
            cls._TYPE_SUPPORT = module.type_support_msg__msg__fusion_info_for_aeb_other
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__fusion_info_for_aeb_other
...
class FusionInfoForAEBOther(metaclass=Metaclass_FusionInfoForAEBOther):
    """Message class 'FusionInfoForAEBOther'."""
