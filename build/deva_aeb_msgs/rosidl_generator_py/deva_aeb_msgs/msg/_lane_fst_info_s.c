...
bool deva_aeb_msgs__msg__lane_fst_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_aeb_msgs.msg._lane_fst_info.LaneFstInfo", full_classname_dest, 44) == 0);
  }
  deva_aeb_msgs__msg__LaneFstInfo * ros_message = _ros_message;
  {  // estimn
    PyObject * field = PyObject_GetAttrString(_pymsg, "estimn");
    if (!field) {
      return false;
    }
    if (!deva_aeb_msgs__msg__sf_lane_two_seg_estimn__convert_from_py(field, &ros_message->estimn)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // extracurveinfo
    PyObject * field = PyObject_GetAttrString(_pymsg, "extracurveinfo");
    if (!field) {
      return false;
    }
    if (!deva_aeb_msgs__msg__sf_curve_function_extra__convert_from_py(field, &ros_message->extracurveinfo)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of LaneFstInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_aeb_msgs.msg._lane_fst_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneFstInfo");
  ...
  {  // estimn
    PyObject * field = NULL;
    field = deva_aeb_msgs__msg__sf_lane_two_seg_estimn__convert_to_py(&ros_message->estimn);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // extracurveinfo
    PyObject * field = NULL;
    field = deva_aeb_msgs__msg__sf_curve_function_extra__convert_to_py(&ros_message->extracurveinfo);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "extracurveinfo", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
