...
static const _LinkInfoProto_type_support_symbol_names_t _LinkInfoProto_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_navi_msgs, msg, LinkInfoProto)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_navi_msgs, msg, LinkInfoProto)),
  }
};
...
{
  return &::deva_navi_msgs::msg::rosidl_typesupport_cpp::LinkInfoProto_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_navi_msgs, msg, LinkInfoProto)() {
  return get_message_type_support_handle<deva_navi_msgs::msg::LinkInfoProto>();
}
