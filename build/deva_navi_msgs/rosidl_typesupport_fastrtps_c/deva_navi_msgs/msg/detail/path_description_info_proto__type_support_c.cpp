...
#include "deva_navi_msgs/msg/detail/path_description_info_proto__rosidl_typesupport_fastrtps_c.h"
...
using _PathDescriptionInfoProto__ros_msg_type = deva_navi_msgs__msg__PathDescriptionInfoProto;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PathDescriptionInfoProto__ros_msg_type * ros_message = static_cast<const _PathDescriptionInfoProto__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PathDescriptionInfoProto__ros_msg_type * ros_message = static_cast<_PathDescriptionInfoProto__ros_msg_type *>(untyped_ros_message);
  // Field name: path_type
  {
    cdr >> ros_message->path_type;
  }
...
static uint32_t _PathDescriptionInfoProto__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_navi_msgs__msg__PathDescriptionInfoProto(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs__msg__PathDescriptionInfoProto;
    is_plain =
      (
...
static size_t _PathDescriptionInfoProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_navi_msgs__msg__PathDescriptionInfoProto(
...
static message_type_support_callbacks_t __callbacks_PathDescriptionInfoProto = {
  "deva_navi_msgs::msg",
...
static rosidl_message_type_support_t _PathDescriptionInfoProto__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PathDescriptionInfoProto,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_navi_msgs, msg, PathDescriptionInfoProto)() {
  return &_PathDescriptionInfoProto__type_support;
}
