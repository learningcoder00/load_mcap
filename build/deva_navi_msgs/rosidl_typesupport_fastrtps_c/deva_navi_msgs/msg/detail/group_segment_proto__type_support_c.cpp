...
#include "deva_navi_msgs/msg/detail/group_segment_proto__rosidl_typesupport_fastrtps_c.h"
...
using _GroupSegmentProto__ros_msg_type = deva_navi_msgs__msg__GroupSegmentProto;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GroupSegmentProto__ros_msg_type * ros_message = static_cast<const _GroupSegmentProto__ros_msg_type *>(untyped_ros_message);
  // Field name: length
  {
  ...
  // Field name: start_segment_index
  {
  ...
  // Field name: is_via_point
  {
    cdr << (ros_message->is_via_point ? true : false);
  }

  // Field name: is_crucial
  {
  ...
  void * untyped_ros_message)
{
  ...
  _GroupSegmentProto__ros_msg_type * ros_message = static_cast<_GroupSegmentProto__ros_msg_type *>(untyped_ros_message);
  // Field name: length
  {
    cdr >> ros_message->length;
  }
...
static uint32_t _GroupSegmentProto__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_navi_msgs__msg__GroupSegmentProto(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs__msg__GroupSegmentProto;
    is_plain =
      (
...
static size_t _GroupSegmentProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_navi_msgs__msg__GroupSegmentProto(
...
static message_type_support_callbacks_t __callbacks_GroupSegmentProto = {
  "deva_navi_msgs::msg",
  "GroupSegmentProto",
...
static rosidl_message_type_support_t _GroupSegmentProto__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GroupSegmentProto,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_navi_msgs, msg, GroupSegmentProto)() {
  return &_GroupSegmentProto__type_support;
}
