...
#include "deva_navi_msgs/msg/detail/group_time_range_proto__rosidl_typesupport_fastrtps_c.h"
...
using _GroupTimeRangeProto__ros_msg_type = deva_navi_msgs__msg__GroupTimeRangeProto;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GroupTimeRangeProto__ros_msg_type * ros_message = static_cast<const _GroupTimeRangeProto__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _GroupTimeRangeProto__ros_msg_type * ros_message = static_cast<_GroupTimeRangeProto__ros_msg_type *>(untyped_ros_message);
  // Field name: start_time
  {
    cdr >> ros_message->start_time;
  }
...
static uint32_t _GroupTimeRangeProto__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_navi_msgs__msg__GroupTimeRangeProto(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs__msg__GroupTimeRangeProto;
    is_plain =
      (
...
static size_t _GroupTimeRangeProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_navi_msgs__msg__GroupTimeRangeProto(
...
static message_type_support_callbacks_t __callbacks_GroupTimeRangeProto = {
  "deva_navi_msgs::msg",
  "GroupTimeRangeProto",
...
static rosidl_message_type_support_t _GroupTimeRangeProto__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GroupTimeRangeProto,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_navi_msgs, msg, GroupTimeRangeProto)() {
  return &_GroupTimeRangeProto__type_support;
}
