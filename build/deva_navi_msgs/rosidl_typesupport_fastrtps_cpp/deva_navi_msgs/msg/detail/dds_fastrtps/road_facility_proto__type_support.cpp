...
#include "deva_navi_msgs/msg/detail/road_facility_proto__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_navi_msgs::msg::GroupTimeRangeProto &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_navi_msgs::msg::GroupTimeRangeProto &);
...
cdr_serialize(
  const deva_navi_msgs::msg::RoadFacilityProto & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_navi_msgs::msg::RoadFacilityProto & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  // Member: time_range
  {
    ...
    ros_message.time_range.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_navi_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.time_range[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: speed_limit
  {
    ...
    size_t item_size = sizeof(ros_message.speed_limit[0]);
  ...
  // Member: time_range
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.time_range[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: time_range
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_navi_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GroupTimeRangeProto(
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs::msg::RoadFacilityProto;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::RoadFacilityProto *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_navi_msgs::msg::RoadFacilityProto *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RoadFacilityProto__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::RoadFacilityProto *>(
...
static size_t _RoadFacilityProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoadFacilityProto(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RoadFacilityProto__callbacks = {
  "deva_navi_msgs::msg",
  "RoadFacilityProto",
...
static rosidl_message_type_support_t _RoadFacilityProto__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RoadFacilityProto__callbacks,
...
{
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_RoadFacilityProto__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_navi_msgs, msg, RoadFacilityProto)() {
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_RoadFacilityProto__handle;
}
