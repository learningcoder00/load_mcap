...
#include "deva_navi_msgs/msg/detail/energy_end_point_proto__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_navi_msgs::msg::EnergyEndPointProto & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_navi_msgs::msg::EnergyEndPointProto & ros_message)
{
  // Member: show
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs::msg::EnergyEndPointProto;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::EnergyEndPointProto *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_navi_msgs::msg::EnergyEndPointProto *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EnergyEndPointProto__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::EnergyEndPointProto *>(
...
static size_t _EnergyEndPointProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EnergyEndPointProto(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EnergyEndPointProto__callbacks = {
  "deva_navi_msgs::msg",
  "EnergyEndPointProto",
...
static rosidl_message_type_support_t _EnergyEndPointProto__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EnergyEndPointProto__callbacks,
...
{
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_EnergyEndPointProto__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_navi_msgs, msg, EnergyEndPointProto)() {
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_EnergyEndPointProto__handle;
}
