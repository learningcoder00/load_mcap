...
#include "deva_navi_msgs/msg/detail/poi_info_proto__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_navi_msgs::msg::ChargingArgumentsInfoProto &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const deva_navi_msgs::msg::POIInfoProto & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: real_pos
  deva_navi_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.real_pos,
    cdr);
  // Member: navi_pos
  deva_navi_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.navi_pos,
    cdr);
  // Member: sigshelter
  ...
  // Member: floor_name
  cdr << ros_message.floor_name;
  // Member: parent_name
  cdr << ros_message.parent_name;
  // Member: parent_simple_name
  cdr << ros_message.parent_simple_name;
  // Member: angel
  cdr << ros_message.angel;
  // Member: points
  {
  ...
  cdr << ros_message.extend_info_flag;
  // Member: src_app
  cdr << ros_message.src_app;
  // Member: charge_info
  deva_navi_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_navi_msgs::msg::POIInfoProto & ros_message)
{
  // Member: real_pos
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_navi_msgs
max_serialized_size_POIInfoProto(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: charge_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_navi_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ChargingArgumentsInfoProto(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs::msg::POIInfoProto;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::POIInfoProto *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_navi_msgs::msg::POIInfoProto *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _POIInfoProto__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::POIInfoProto *>(
...
static size_t _POIInfoProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_POIInfoProto(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _POIInfoProto__callbacks = {
  "deva_navi_msgs::msg",
  "POIInfoProto",
...
static rosidl_message_type_support_t _POIInfoProto__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_POIInfoProto__callbacks,
...
get_message_type_support_handle<deva_navi_msgs::msg::POIInfoProto>()
{
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_POIInfoProto__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_navi_msgs, msg, POIInfoProto)() {
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_POIInfoProto__handle;
}
