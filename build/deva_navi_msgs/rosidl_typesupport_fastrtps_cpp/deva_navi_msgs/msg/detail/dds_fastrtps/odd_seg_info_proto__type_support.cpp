...
#include "deva_navi_msgs/msg/detail/odd_seg_info_proto__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_navi_msgs::msg::OddSegInfoProto & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_navi_msgs::msg::OddSegInfoProto & ros_message)
{
  // Member: m_odd_len
  cdr >> ros_message.m_odd_len;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_navi_msgs
max_serialized_size_OddSegInfoProto(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_navi_msgs::msg::OddSegInfoProto;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::OddSegInfoProto *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_navi_msgs::msg::OddSegInfoProto *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OddSegInfoProto__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_navi_msgs::msg::OddSegInfoProto *>(
...
static size_t _OddSegInfoProto__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OddSegInfoProto(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OddSegInfoProto__callbacks = {
  "deva_navi_msgs::msg",
  "OddSegInfoProto",
...
static rosidl_message_type_support_t _OddSegInfoProto__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OddSegInfoProto__callbacks,
...
{
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_OddSegInfoProto__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_navi_msgs, msg, OddSegInfoProto)() {
  return &deva_navi_msgs::msg::typesupport_fastrtps_cpp::_OddSegInfoProto__handle;
}
