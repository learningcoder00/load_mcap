...
bool deva_navi_msgs__msg__tip_info_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._tip_info_proto.TipInfoProto", full_classname_dest, 47) == 0);
  }
  deva_navi_msgs__msg__TipInfoProto * ros_message = _ros_message;
  {  // tip
    ...
    rosidl_runtime_c__String__assign(&ros_message->tip, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of TipInfoProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._tip_info_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TipInfoProto");
  ...
  {  // tip
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->tip.data,
      strlen(ros_message->tip.data),
      "replace");
    if (!field) {
      return NULL;
    }
