...
bool deva_navi_msgs__msg__icon_road_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._icon_road_proto.IconRoadProto", full_classname_dest, 49) == 0);
  }
  deva_navi_msgs__msg__IconRoadProto * ros_message = _ros_message;
  {  // usage
    ...
    ros_message->usage = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // type
...
{
  /* NOTE(esteve): Call constructor of IconRoadProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._icon_road_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IconRoadProto");
  ...
  {  // usage
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->usage);
    {
