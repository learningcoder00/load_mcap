...
static const _RoadFacilityProto_type_support_symbol_names_t _RoadFacilityProto_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_navi_msgs, msg, RoadFacilityProto)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_navi_msgs, msg, RoadFacilityProto)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_navi_msgs, msg, RoadFacilityProto)() {
  return &::deva_navi_msgs::msg::rosidl_typesupport_c::RoadFacilityProto_message_type_support_handle;
}
