...
bool deva_navi_msgs__msg__line_icon_point_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._line_icon_point_proto.LineIconPointProto", full_classname_dest, 60) == 0);
  }
  deva_navi_msgs__msg__LineIconPointProto * ros_message = _ros_message;
  {  // point
    PyObject * field = PyObject_GetAttrString(_pymsg, "point");
    if (!field) {
      return false;
    }
    if (!deva_navi_msgs__msg__coord3_d_double_proto__convert_from_py(field, &ros_message->point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of LineIconPointProto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._line_icon_point_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LineIconPointProto");
  ...
  {  // point
    PyObject * field = NULL;
    field = deva_navi_msgs__msg__coord3_d_double_proto__convert_to_py(&ros_message->point);
    if (!field) {
      return NULL;
    }
    {
