...
bool deva_navi_msgs__msg__adas_v2_proto__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_navi_msgs.msg._adas_v2_proto.AdasV2Proto", full_classname_dest, 45) == 0);
  }
  deva_navi_msgs__msg__AdasV2Proto * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of AdasV2Proto */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_navi_msgs.msg._adas_v2_proto");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AdasV2Proto");
