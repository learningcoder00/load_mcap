...
deva_perception_msgs__msg__RVLight__init(deva_perception_msgs__msg__RVLight * msg)
{
  ...
  if (!deva_perception_msgs__msg__ObstacleCommon__init(&msg->obstacle)) {
    deva_perception_msgs__msg__RVLight__fini(msg);
    return false;
  }
  // light_type
  // heading_type
...
deva_perception_msgs__msg__RVLight__are_equal(const deva_perception_msgs__msg__RVLight * lhs, const deva_perception_msgs__msg__RVLight * rhs)
{
  ...
  // sign_occ_type
  if (lhs->sign_occ_type != rhs->sign_occ_type) {
    return false;
  }
  // sign_trun_type
  if (lhs->sign_trun_type != rhs->sign_trun_type) {
    return false;
  }
  // extra_infos
  ...
  deva_perception_msgs__msg__RVLight * output)
{
  ...
  // sign_occ_type
  output->sign_occ_type = input->sign_occ_type;
  // sign_trun_type
  output->sign_trun_type = input->sign_trun_type;
  // extra_infos
...
deva_perception_msgs__msg__RVLight__create()
{
  ...
  deva_perception_msgs__msg__RVLight * msg = (deva_perception_msgs__msg__RVLight *)allocator.allocate(sizeof(deva_perception_msgs__msg__RVLight), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_perception_msgs__msg__RVLight));
  bool success = deva_perception_msgs__msg__RVLight__init(msg);
  if (!success) {
...
deva_perception_msgs__msg__RVLight__Sequence__init(deva_perception_msgs__msg__RVLight__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__RVLight * data = NULL;

  if (size) {
    data = (deva_perception_msgs__msg__RVLight *)allocator.zero_allocate(size, sizeof(deva_perception_msgs__msg__RVLight), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_perception_msgs__msg__RVLight__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_perception_msgs__msg__RVLight__fini(&data[i - 1]);
      }
...
deva_perception_msgs__msg__RVLight__Sequence__fini(deva_perception_msgs__msg__RVLight__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_perception_msgs__msg__RVLight__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__RVLight__Sequence * array = (deva_perception_msgs__msg__RVLight__Sequence *)allocator.allocate(sizeof(deva_perception_msgs__msg__RVLight__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_perception_msgs__msg__RVLight__Sequence__init(array, size);
  if (!success) {
...
deva_perception_msgs__msg__RVLight__Sequence__destroy(deva_perception_msgs__msg__RVLight__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_perception_msgs__msg__RVLight__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_perception_msgs__msg__RVLight__Sequence__are_equal(const deva_perception_msgs__msg__RVLight__Sequence * lhs, const deva_perception_msgs__msg__RVLight__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_perception_msgs__msg__RVLight__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_perception_msgs__msg__RVLight__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_perception_msgs__msg__RVLight);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_perception_msgs__msg__RVLight * data =
      (deva_perception_msgs__msg__RVLight *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_perception_msgs__msg__RVLight__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_perception_msgs__msg__RVLight__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_perception_msgs__msg__RVLight__copy(
