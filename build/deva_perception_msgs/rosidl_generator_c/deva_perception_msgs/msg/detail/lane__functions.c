...
bool
deva_perception_msgs__msg__Lane__init(deva_perception_msgs__msg__Lane * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!deva_common_msgs__msg__Point2d__Sequence__init(&msg->imagepoints, 0)) {
    deva_perception_msgs__msg__Lane__fini(msg);
    return false;
  }
  // v_min
  // v_max
...
void
deva_perception_msgs__msg__Lane__fini(deva_perception_msgs__msg__Lane * msg)
{
  if (!msg) {
    return;
  }
...
bool
deva_perception_msgs__msg__Lane__are_equal(const deva_perception_msgs__msg__Lane * lhs, const deva_perception_msgs__msg__Lane * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
deva_perception_msgs__msg__Lane__copy(
  const deva_perception_msgs__msg__Lane * input,
  deva_perception_msgs__msg__Lane * output)
{
  if (!input || !output) {
    return false;
  }
...
deva_perception_msgs__msg__Lane__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__Lane * msg = (deva_perception_msgs__msg__Lane *)allocator.allocate(sizeof(deva_perception_msgs__msg__Lane), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_perception_msgs__msg__Lane));
  bool success = deva_perception_msgs__msg__Lane__init(msg);
  if (!success) {
...
void
deva_perception_msgs__msg__Lane__destroy(deva_perception_msgs__msg__Lane * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_perception_msgs__msg__Lane__fini(msg);
...
bool
deva_perception_msgs__msg__Lane__Sequence__init(deva_perception_msgs__msg__Lane__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__Lane * data = NULL;

  if (size) {
    data = (deva_perception_msgs__msg__Lane *)allocator.zero_allocate(size, sizeof(deva_perception_msgs__msg__Lane), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_perception_msgs__msg__Lane__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_perception_msgs__msg__Lane__fini(&data[i - 1]);
      }
...
void
deva_perception_msgs__msg__Lane__Sequence__fini(deva_perception_msgs__msg__Lane__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_perception_msgs__msg__Lane__fini(&array->data[i]);
    }
...
deva_perception_msgs__msg__Lane__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_perception_msgs__msg__Lane__Sequence * array = (deva_perception_msgs__msg__Lane__Sequence *)allocator.allocate(sizeof(deva_perception_msgs__msg__Lane__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_perception_msgs__msg__Lane__Sequence__init(array, size);
  if (!success) {
...
void
deva_perception_msgs__msg__Lane__Sequence__destroy(deva_perception_msgs__msg__Lane__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_perception_msgs__msg__Lane__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
deva_perception_msgs__msg__Lane__Sequence__are_equal(const deva_perception_msgs__msg__Lane__Sequence * lhs, const deva_perception_msgs__msg__Lane__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_perception_msgs__msg__Lane__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
deva_perception_msgs__msg__Lane__Sequence__copy(
  const deva_perception_msgs__msg__Lane__Sequence * input,
  deva_perception_msgs__msg__Lane__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_perception_msgs__msg__Lane);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_perception_msgs__msg__Lane * data =
      (deva_perception_msgs__msg__Lane *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_perception_msgs__msg__Lane__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_perception_msgs__msg__Lane__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_perception_msgs__msg__Lane__copy(
