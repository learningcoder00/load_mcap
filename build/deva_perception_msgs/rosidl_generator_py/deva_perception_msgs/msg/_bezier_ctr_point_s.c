...
bool deva_perception_msgs__msg__bezier_ctr_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._bezier_ctr_point.BezierCtrPoint", full_classname_dest, 57) == 0);
  }
  deva_perception_msgs__msg__BezierCtrPoint * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BezierCtrPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._bezier_ctr_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BezierCtrPoint");
