...
bool deva_perception_msgs__msg__crosswalk__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._crosswalk.Crosswalk", full_classname_dest, 45) == 0);
  }
  deva_perception_msgs__msg__Crosswalk * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Crosswalk */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._crosswalk");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Crosswalk");
