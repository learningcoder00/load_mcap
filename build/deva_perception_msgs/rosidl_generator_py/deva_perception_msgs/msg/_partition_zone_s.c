...
bool deva_perception_msgs__msg__partition_zone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._partition_zone.PartitionZone", full_classname_dest, 54) == 0);
  }
  deva_perception_msgs__msg__PartitionZone * ros_message = _ros_message;
  {  // waypoints
...
{
  /* NOTE(esteve): Call constructor of PartitionZone */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._partition_zone");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PartitionZone");
