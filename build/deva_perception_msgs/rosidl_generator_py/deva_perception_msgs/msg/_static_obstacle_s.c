...
bool deva_perception_msgs__msg__static_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._static_obstacle.StaticObstacle", full_classname_dest, 56) == 0);
  }
  deva_perception_msgs__msg__StaticObstacle * ros_message = _ros_message;
  {  // obstacle
  ...
  {  // static_obstacle_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "static_obstacle_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->static_obstacle_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // slot_lock_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "slot_lock_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->slot_lock_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * deva_perception_msgs__msg__static_obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._static_obstacle");
  ...
  {  // static_obstacle_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->static_obstacle_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "static_obstacle_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // slot_lock_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->slot_lock_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "slot_lock_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
