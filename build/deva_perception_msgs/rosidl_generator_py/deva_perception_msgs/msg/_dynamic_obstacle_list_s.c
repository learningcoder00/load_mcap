...
bool deva_perception_msgs__msg__dynamic_obstacle_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._dynamic_obstacle_list.DynamicObstacleList", full_classname_dest, 67) == 0);
  }
  deva_perception_msgs__msg__DynamicObstacleList * ros_message = _ros_message;
  {  // dynamic_obstacles
    ...
    if (!deva_perception_msgs__msg__DynamicObstacle__Sequence__init(&(ros_message->dynamic_obstacles), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_perception_msgs__msg__DynamicObstacle__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_perception_msgs__msg__DynamicObstacle * dest = ros_message->dynamic_obstacles.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_perception_msgs__msg__dynamic_obstacle__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of DynamicObstacleList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._dynamic_obstacle_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamicObstacleList");
  ...
  {  // dynamic_obstacles
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_perception_msgs__msg__dynamic_obstacle__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
