...
bool deva_perception_msgs__msg__fixed_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._fixed_obstacle.FixedObstacle", full_classname_dest, 54) == 0);
  }
  deva_perception_msgs__msg__FixedObstacle * ros_message = _ros_message;
  {  // obstacle
  ...
  {  // fixed_obstacle_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "fixed_obstacle_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->fixed_obstacle_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // det_score
...
{
  /* NOTE(esteve): Call constructor of FixedObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._fixed_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FixedObstacle");
  ...
  {  // fixed_obstacle_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->fixed_obstacle_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fixed_obstacle_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
