...
class Metaclass_TrafficChannel(type):
    """Metaclass of message 'TrafficChannel'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__traffic_channel
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__traffic_channel
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__traffic_channel
            cls._TYPE_SUPPORT = module.type_support_msg__msg__traffic_channel
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__traffic_channel
    ...
    def ETC(self):
        ...
        return Metaclass_TrafficChannel.__constants['ETC']

    @property
    def MANUAL(self):
        """Message constant 'MANUAL'."""
        return Metaclass_TrafficChannel.__constants['MANUAL']

    @property
    def ETCORMANUAL(self):
        """Message constant 'ETCORMANUAL'."""
        return Metaclass_TrafficChannel.__constants['ETCORMANUAL']

    @property
    def CLOSE(self):
        """Message constant 'CLOSE'."""
        return Metaclass_TrafficChannel.__constants['CLOSE']

    @property
    def REVERSE(self):
        """Message constant 'REVERSE'."""
        return Metaclass_TrafficChannel.__constants['REVERSE']


class TrafficChannel(metaclass=Metaclass_TrafficChannel):
    """
    Message class 'TrafficChannel'.
