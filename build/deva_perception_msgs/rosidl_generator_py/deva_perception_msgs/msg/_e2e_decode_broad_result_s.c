...
bool deva_perception_msgs__msg__e2e_decode_broad_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._e2e_decode_broad_result.E2eDecodeBroadResult", full_classname_dest, 70) == 0);
  }
  deva_perception_msgs__msg__E2eDecodeBroadResult * ros_message = _ros_message;
  {  // pred_category
...
{
  /* NOTE(esteve): Call constructor of E2eDecodeBroadResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._e2e_decode_broad_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "E2eDecodeBroadResult");
