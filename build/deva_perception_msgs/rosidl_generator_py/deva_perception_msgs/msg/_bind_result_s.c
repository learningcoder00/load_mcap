...
bool deva_perception_msgs__msg__bind_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._bind_result.BindResult", full_classname_dest, 48) == 0);
  }
  deva_perception_msgs__msg__BindResult * ros_message = _ros_message;
  {  // header
  ...
  {  // result
    ...
    if (!deva_perception_msgs__msg__perception_result__convert_from_py(field, &ros_message->result)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BindResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._bind_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BindResult");
  ...
  {  // result
    PyObject * field = NULL;
    field = deva_perception_msgs__msg__perception_result__convert_to_py(&ros_message->result);
    if (!field) {
      return NULL;
    }
    {
