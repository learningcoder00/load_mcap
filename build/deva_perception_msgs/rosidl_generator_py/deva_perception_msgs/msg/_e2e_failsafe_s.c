...
bool deva_perception_msgs__msg__e2e_failsafe__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._e2e_failsafe.E2eFailsafe", full_classname_dest, 50) == 0);
  }
  deva_perception_msgs__msg__E2eFailsafe * ros_message = _ros_message;
  {  // header
...
PyObject * deva_perception_msgs__msg__e2e_failsafe__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._e2e_failsafe");
