...
bool deva_perception_msgs__msg__percept_center_line__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._percept_center_line.PerceptCenterLine", full_classname_dest, 63) == 0);
  }
  deva_perception_msgs__msg__PerceptCenterLine * ros_message = _ros_message;
  {  // id
  ...
  {  // center_line_property
    PyObject * field = PyObject_GetAttrString(_pymsg, "center_line_property");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->center_line_property = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // waypoints
...
{
  /* NOTE(esteve): Call constructor of PerceptCenterLine */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._percept_center_line");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PerceptCenterLine");
  ...
  {  // center_line_property
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->center_line_property);
    {
      int rc = PyObject_SetAttrString(_pymessage, "center_line_property", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
