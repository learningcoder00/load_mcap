...
{
  new (message_memory) deva_perception_msgs::msg::ExtraInfo(_init);
}

void ExtraInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_perception_msgs::msg::ExtraInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ExtraInfo_message_member_array[2] = {
  {
    ...
    offsetof(deva_perception_msgs::msg::ExtraInfo, key),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_perception_msgs::msg::ExtraInfo, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ExtraInfo_message_members = {
  ...
  2,  // number of fields
  sizeof(deva_perception_msgs::msg::ExtraInfo),
...
{
  return &::deva_perception_msgs::msg::rosidl_typesupport_introspection_cpp::ExtraInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_perception_msgs, msg, ExtraInfo)() {
  return &::deva_perception_msgs::msg::rosidl_typesupport_introspection_cpp::ExtraInfo_message_type_support_handle;
}
