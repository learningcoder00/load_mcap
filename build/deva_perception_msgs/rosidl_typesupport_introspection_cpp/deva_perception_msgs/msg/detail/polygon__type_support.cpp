...
{
  new (message_memory) deva_perception_msgs::msg::Polygon(_init);
}

void Polygon_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_perception_msgs::msg::Polygon *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Polygon_message_member_array[2] = {
  {
    "num_points",  // name
    ...
    offsetof(deva_perception_msgs::msg::Polygon, num_points),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_perception_msgs::msg::Polygon, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Polygon_message_members = {
  ...
  2,  // number of fields
  sizeof(deva_perception_msgs::msg::Polygon),
...
get_message_type_support_handle<deva_perception_msgs::msg::Polygon>()
{
  return &::deva_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Polygon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_perception_msgs, msg, Polygon)() {
  return &::deva_perception_msgs::msg::rosidl_typesupport_introspection_cpp::Polygon_message_type_support_handle;
}
