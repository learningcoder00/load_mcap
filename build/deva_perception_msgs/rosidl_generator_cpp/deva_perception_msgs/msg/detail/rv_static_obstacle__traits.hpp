...
#ifndef DEVA_PERCEPTION_MSGS__MSG__DETAIL__RV_STATIC_OBSTACLE__TRAITS_HPP_
#define DEVA_PERCEPTION_MSGS__MSG__DETAIL__RV_STATIC_OBSTACLE__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  // member: horizontal_distance
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.horizontal_distance, out);
    out << ", ";
  }
...
inline std::string to_yaml(const RvStaticObstacle & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const deva_perception_msgs::msg::RvStaticObstacle & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_perception_msgs::msg::RvStaticObstacle & msg)
{
  return deva_perception_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_perception_msgs::msg::RvStaticObstacle>()
{
  return "deva_perception_msgs::msg::RvStaticObstacle";
}

template<>
inline const char * name<deva_perception_msgs::msg::RvStaticObstacle>()
{
  return "deva_perception_msgs/msg/RvStaticObstacle";
}

template<>
struct has_fixed_size<deva_perception_msgs::msg::RvStaticObstacle>
...
template<>
struct has_bounded_size<deva_perception_msgs::msg::RvStaticObstacle>
...
template<>
struct is_message<deva_perception_msgs::msg::RvStaticObstacle>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_PERCEPTION_MSGS__MSG__DETAIL__RV_STATIC_OBSTACLE__TRAITS_HPP_
