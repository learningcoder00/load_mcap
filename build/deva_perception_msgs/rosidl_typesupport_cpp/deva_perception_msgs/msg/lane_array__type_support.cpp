...
static const _LaneArray_type_support_symbol_names_t _LaneArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, LaneArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_perception_msgs, msg, LaneArray)),
  }
};
...
{
  return &::deva_perception_msgs::msg::rosidl_typesupport_cpp::LaneArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_perception_msgs, msg, LaneArray)() {
  return get_message_type_support_handle<deva_perception_msgs::msg::LaneArray>();
}
