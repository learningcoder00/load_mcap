...
static const _TrafficLightArray_type_support_symbol_names_t _TrafficLightArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, TrafficLightArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_perception_msgs, msg, TrafficLightArray)),
  }
};
...
{
  return &::deva_perception_msgs::msg::rosidl_typesupport_cpp::TrafficLightArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_perception_msgs, msg, TrafficLightArray)() {
  return get_message_type_support_handle<deva_perception_msgs::msg::TrafficLightArray>();
}
