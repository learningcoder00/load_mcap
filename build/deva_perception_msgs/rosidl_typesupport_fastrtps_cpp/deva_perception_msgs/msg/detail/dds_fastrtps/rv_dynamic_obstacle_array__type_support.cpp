...
#include "deva_perception_msgs/msg/detail/rv_dynamic_obstacle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_perception_msgs::msg::RVDynamicObstacle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const deva_perception_msgs::msg::RVDynamicObstacleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::RVDynamicObstacleArray & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_perception_msgs
max_serialized_size_RVDynamicObstacleArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RVDynamicObstacle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::RVDynamicObstacleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVDynamicObstacleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::RVDynamicObstacleArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RVDynamicObstacleArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVDynamicObstacleArray *>(
...
static size_t _RVDynamicObstacleArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RVDynamicObstacleArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RVDynamicObstacleArray__callbacks = {
...
static rosidl_message_type_support_t _RVDynamicObstacleArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RVDynamicObstacleArray__callbacks,
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVDynamicObstacleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, RVDynamicObstacleArray)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVDynamicObstacleArray__handle;
}
