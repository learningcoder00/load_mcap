...
#include "deva_perception_msgs/msg/detail/rv_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::RVObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::RVObstacle & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::RVObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::RVObstacle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RVObstacle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVObstacle *>(
...
static size_t _RVObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RVObstacle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RVObstacle__callbacks = {
...
static rosidl_message_type_support_t _RVObstacle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RVObstacle__callbacks,
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, RVObstacle)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVObstacle__handle;
}
