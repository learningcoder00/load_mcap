...
#include "deva_perception_msgs/msg/detail/bind_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_perception_msgs::msg::PerceptionResult &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_PerceptionResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_perception_msgs::msg::BindResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::BindResult & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_perception_msgs
max_serialized_size_BindResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PerceptionResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::BindResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::BindResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::BindResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BindResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::BindResult *>(
...
static size_t _BindResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BindResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BindResult__callbacks = {
...
static rosidl_message_type_support_t _BindResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BindResult__callbacks,
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_BindResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, BindResult)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_BindResult__handle;
}
