...
#include "deva_perception_msgs/msg/detail/edge_line_segment__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_common_msgs::msg::LineSegment &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_common_msgs::msg::LineSegment &);
...
cdr_serialize(
  const deva_perception_msgs::msg::EdgeLineSegment & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::EdgeLineSegment & ros_message)
{
  // Member: segment
  ...
  size_t current_alignment)
{
  ...
  // Member: segment
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_common_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LineSegment(
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::EdgeLineSegment;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::EdgeLineSegment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::EdgeLineSegment *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EdgeLineSegment__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::EdgeLineSegment *>(
...
static size_t _EdgeLineSegment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EdgeLineSegment(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EdgeLineSegment__callbacks = {
...
static rosidl_message_type_support_t _EdgeLineSegment__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EdgeLineSegment__callbacks,
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_EdgeLineSegment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, EdgeLineSegment)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_EdgeLineSegment__handle;
}
