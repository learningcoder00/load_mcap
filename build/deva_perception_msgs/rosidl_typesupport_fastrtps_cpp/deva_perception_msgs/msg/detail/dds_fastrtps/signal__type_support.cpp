...
#include "deva_perception_msgs/msg/detail/signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::Signal & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  deva_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: signal_type
  cdr << ros_message.signal_type;
  // Member: geometry_type
  cdr << ros_message.geometry_type;
  // Member: state_type
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::Signal & ros_message)
{
  // Member: so
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.so, current_alignment);
  // Member: signal_type
  {
    size_t item_size = sizeof(ros_message.signal_type);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: geometry_type
  {
    size_t item_size = sizeof(ros_message.geometry_type);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: state_type
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::Signal;
    is_plain =
      (
      offsetof(DataType, state_type) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::Signal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::Signal *>(
    untyped_ros_message);
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, Signal)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
