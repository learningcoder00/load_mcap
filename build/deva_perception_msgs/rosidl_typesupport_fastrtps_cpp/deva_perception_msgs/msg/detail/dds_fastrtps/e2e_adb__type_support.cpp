...
#include "deva_perception_msgs/msg/detail/e2e_adb__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::E2eAdb & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::E2eAdb & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::E2eAdb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::E2eAdb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::E2eAdb *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _E2eAdb__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::E2eAdb *>(
...
static size_t _E2eAdb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_E2eAdb(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _E2eAdb__callbacks = {
...
static rosidl_message_type_support_t _E2eAdb__handle = {
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_E2eAdb__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, E2eAdb)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_E2eAdb__handle;
}
