...
#include "deva_perception_msgs/msg/detail/fixed_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::FixedObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::FixedObstacle & ros_message)
{
  // Member: obstacle
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::FixedObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::FixedObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::FixedObstacle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FixedObstacle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::FixedObstacle *>(
...
static size_t _FixedObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FixedObstacle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FixedObstacle__callbacks = {
...
static rosidl_message_type_support_t _FixedObstacle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FixedObstacle__callbacks,
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_FixedObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, FixedObstacle)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_FixedObstacle__handle;
}
