...
#include "deva_perception_msgs/msg/detail/lanev2__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_perception_msgs::msg::LanePropertySegment &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  deva_perception_msgs::msg::LanePropertySegment &);
size_t get_serialized_size(
  const deva_perception_msgs::msg::LanePropertySegment &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const deva_perception_msgs::msg::Lanev2 & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  deva_perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.lane_property_segment,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::Lanev2 & ros_message)
{
  // Member: confidence
  cdr >> ros_message.confidence;
  ...
  size_t current_alignment)
{
  ...
  // Member: lane_property_segment
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LanePropertySegment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::Lanev2;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::Lanev2 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::Lanev2 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Lanev2__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::Lanev2 *>(
...
static size_t _Lanev2__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Lanev2(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Lanev2__callbacks = {
...
static rosidl_message_type_support_t _Lanev2__handle = {
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_Lanev2__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, Lanev2)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_Lanev2__handle;
}
