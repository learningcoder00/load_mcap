...
#include "deva_perception_msgs/msg/detail/rv_light__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::RVLight & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::RVLight & ros_message)
{
  // Member: obstacle
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::RVLight;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVLight *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::RVLight *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RVLight__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVLight *>(
...
static size_t _RVLight__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RVLight(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RVLight__callbacks = {
...
static rosidl_message_type_support_t _RVLight__handle = {
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVLight__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, RVLight)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVLight__handle;
}
