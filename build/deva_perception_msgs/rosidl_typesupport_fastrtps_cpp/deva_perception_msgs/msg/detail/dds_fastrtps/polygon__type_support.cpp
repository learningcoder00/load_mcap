...
#include "deva_perception_msgs/msg/detail/polygon__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::Polygon & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::Polygon & ros_message)
{
  // Member: num_points
  cdr >> ros_message.num_points;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::Polygon;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::Polygon *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::Polygon *>(
    untyped_ros_message);
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_Polygon__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, Polygon)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_Polygon__handle;
}
