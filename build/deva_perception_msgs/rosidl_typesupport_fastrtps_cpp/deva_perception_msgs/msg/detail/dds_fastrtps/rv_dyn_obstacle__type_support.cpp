...
#include "deva_perception_msgs/msg/detail/rv_dyn_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::RVDynObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::RVDynObstacle & ros_message)
{
  // Member: obstacle
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::RVDynObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVDynObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::RVDynObstacle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RVDynObstacle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::RVDynObstacle *>(
...
static size_t _RVDynObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RVDynObstacle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RVDynObstacle__callbacks = {
...
static rosidl_message_type_support_t _RVDynObstacle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RVDynObstacle__callbacks,
...
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVDynObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, RVDynObstacle)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_RVDynObstacle__handle;
}
