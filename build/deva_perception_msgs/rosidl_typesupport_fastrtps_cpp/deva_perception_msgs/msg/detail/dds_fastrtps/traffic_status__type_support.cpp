...
#include "deva_perception_msgs/msg/detail/traffic_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_perception_msgs::msg::TrafficStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_perception_msgs::msg::TrafficStatus & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs::msg::TrafficStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::TrafficStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_perception_msgs::msg::TrafficStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrafficStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_perception_msgs::msg::TrafficStatus *>(
...
static size_t _TrafficStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrafficStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrafficStatus__callbacks = {
...
static rosidl_message_type_support_t _TrafficStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrafficStatus__callbacks,
...
get_message_type_support_handle<deva_perception_msgs::msg::TrafficStatus>()
{
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_perception_msgs, msg, TrafficStatus)() {
  return &deva_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficStatus__handle;
}
