...
#include "deva_perception_msgs/msg/detail/moving_obstacle__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/accel__functions.h"  // acceleration, acceleration_var
#include "geometry_msgs/msg/detail/twist__functions.h"  // velocity, velocity_var
#include "rosidl_runtime_c/string.h"  // det_type
#include "rosidl_runtime_c/string_functions.h"  // det_type
...
using _MovingObstacle__ros_msg_type = deva_perception_msgs__msg__MovingObstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MovingObstacle__ros_msg_type * ros_message = static_cast<const _MovingObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: obstacle
  {
  ...
  // Field name: moving_obstacle_type
  {
  ...
  // Field name: det_type
  {
    const rosidl_runtime_c__String * str = &ros_message->det_type;
  ...
  // Field name: velocity_var
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->velocity_var, cdr))
    {
      return false;
    }
  }

  // Field name: acceleration_var
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acceleration_var, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MovingObstacle__ros_msg_type * ros_message = static_cast<_MovingObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: obstacle
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: det_type
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->det_type.data) {
      rosidl_runtime_c__String__init(&ros_message->det_type);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->det_type,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'det_type'\n");
      return false;
    }
  }
...
static uint32_t _MovingObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__MovingObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__MovingObstacle;
    is_plain =
      (
...
static size_t _MovingObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__MovingObstacle(
...
static message_type_support_callbacks_t __callbacks_MovingObstacle = {
...
static rosidl_message_type_support_t _MovingObstacle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MovingObstacle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, MovingObstacle)() {
  return &_MovingObstacle__type_support;
}
