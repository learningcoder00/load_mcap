...
#include "deva_perception_msgs/msg/detail/traffic_light_array__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/traffic_light__functions.h"  // traffic_lights
...
size_t get_serialized_size_deva_perception_msgs__msg__TrafficLight(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_perception_msgs__msg__TrafficLight(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, TrafficLight)();


using _TrafficLightArray__ros_msg_type = deva_perception_msgs__msg__TrafficLightArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: traffic_lights
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, TrafficLight
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: traffic_lights
  {
    ...
    if (ros_message->traffic_lights.data) {
      deva_perception_msgs__msg__TrafficLight__Sequence__fini(&ros_message->traffic_lights);
    }
    if (!deva_perception_msgs__msg__TrafficLight__Sequence__init(&ros_message->traffic_lights, size)) {
...
size_t get_serialized_size_deva_perception_msgs__msg__TrafficLightArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrafficLightArray__ros_msg_type * ros_message = static_cast<const _TrafficLightArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name traffic_lights
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_perception_msgs__msg__TrafficLight(
...
static uint32_t _TrafficLightArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__TrafficLightArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_perception_msgs
size_t max_serialized_size_deva_perception_msgs__msg__TrafficLightArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: traffic_lights
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__TrafficLight(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__TrafficLightArray;
    is_plain =
      (
...
static size_t _TrafficLightArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__TrafficLightArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, TrafficLightArray)() {
