...
#include "deva_perception_msgs/msg/detail/rv_static_obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _RvStaticObstacle__ros_msg_type = deva_perception_msgs__msg__RvStaticObstacle;

static bool _RvStaticObstacle__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RvStaticObstacle__ros_msg_type * ros_message = static_cast<const _RvStaticObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
...
static bool _RvStaticObstacle__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _RvStaticObstacle__ros_msg_type * ros_message = static_cast<_RvStaticObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _RvStaticObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__RvStaticObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__RvStaticObstacle;
    is_plain =
      (
...
static size_t _RvStaticObstacle__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_perception_msgs__msg__RvStaticObstacle(
...
static message_type_support_callbacks_t __callbacks_RvStaticObstacle = {
  "deva_perception_msgs::msg",
  "RvStaticObstacle",
  _RvStaticObstacle__cdr_serialize,
  _RvStaticObstacle__cdr_deserialize,
  _RvStaticObstacle__get_serialized_size,
  _RvStaticObstacle__max_serialized_size
};

static rosidl_message_type_support_t _RvStaticObstacle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RvStaticObstacle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, RvStaticObstacle)() {
  return &_RvStaticObstacle__type_support;
}
