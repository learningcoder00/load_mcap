...
#include "deva_perception_msgs/msg/detail/e2e_adb_traffic_sign__rosidl_typesupport_fastrtps_c.h"
...
using _E2eAdbTrafficSign__ros_msg_type = deva_perception_msgs__msg__E2eAdbTrafficSign;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _E2eAdbTrafficSign__ros_msg_type * ros_message = static_cast<const _E2eAdbTrafficSign__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: traffic_sign_for_adb_adb_trk_info
  {
    cdr << ros_message->traffic_sign_for_adb_adb_trk_info;
  }

  // Field name: traffic_sign_for_adb_adb_abs_dist
  {
    cdr << ros_message->traffic_sign_for_adb_adb_abs_dist;
  }

  // Field name: traffic_sign_for_adb_adb_vert_ag_bot
  {
    cdr << ros_message->traffic_sign_for_adb_adb_vert_ag_bot;
  }

  // Field name: traffic_sign_for_adb_adb_vert_ag_top
  {
    cdr << ros_message->traffic_sign_for_adb_adb_vert_ag_top;
  }

  // Field name: traffic_sign_for_adb_adb_hozl_ag_le
  {
    cdr << ros_message->traffic_sign_for_adb_adb_hozl_ag_le;
  }

  // Field name: traffic_sign_for_adb_adb_hozl_ag_ri
  {
    cdr << ros_message->traffic_sign_for_adb_adb_hozl_ag_ri;
  }

  // Field name: traffic_sign_for_adb_adb_detd_qly
  {
  ...
  void * untyped_ros_message)
{
  ...
  _E2eAdbTrafficSign__ros_msg_type * ros_message = static_cast<_E2eAdbTrafficSign__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _E2eAdbTrafficSign__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__E2eAdbTrafficSign(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__E2eAdbTrafficSign;
    is_plain =
      (
...
static size_t _E2eAdbTrafficSign__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__E2eAdbTrafficSign(
...
static message_type_support_callbacks_t __callbacks_E2eAdbTrafficSign = {
...
static rosidl_message_type_support_t _E2eAdbTrafficSign__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_E2eAdbTrafficSign,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, E2eAdbTrafficSign)() {
  return &_E2eAdbTrafficSign__type_support;
}
