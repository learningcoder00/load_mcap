...
#include "deva_perception_msgs/msg/detail/traffic_e2e_stable_pair__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficE2eStablePair__ros_msg_type = deva_perception_msgs__msg__TrafficE2eStablePair;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrafficE2eStablePair__ros_msg_type * ros_message = static_cast<const _TrafficE2eStablePair__ros_msg_type *>(untyped_ros_message);
  // Field name: traffic_e2e_result
  {
    cdr << ros_message->traffic_e2e_result;
  }

  // Field name: is_stable
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrafficE2eStablePair__ros_msg_type * ros_message = static_cast<_TrafficE2eStablePair__ros_msg_type *>(untyped_ros_message);
  // Field name: traffic_e2e_result
  {
    cdr >> ros_message->traffic_e2e_result;
  }
...
static uint32_t _TrafficE2eStablePair__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__TrafficE2eStablePair(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__TrafficE2eStablePair;
    is_plain =
      (
...
static size_t _TrafficE2eStablePair__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__TrafficE2eStablePair(
...
static message_type_support_callbacks_t __callbacks_TrafficE2eStablePair = {
...
static rosidl_message_type_support_t _TrafficE2eStablePair__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrafficE2eStablePair,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, TrafficE2eStablePair)() {
  return &_TrafficE2eStablePair__type_support;
}
