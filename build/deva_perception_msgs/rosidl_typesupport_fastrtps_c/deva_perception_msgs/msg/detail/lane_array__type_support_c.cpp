...
#include "deva_perception_msgs/msg/detail/lane_array__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/lane__functions.h"  // lanes
...
using _LaneArray__ros_msg_type = deva_perception_msgs__msg__LaneArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lanes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, Lane
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lanes
  {
    ...
    if (ros_message->lanes.data) {
      deva_perception_msgs__msg__Lane__Sequence__fini(&ros_message->lanes);
    }
...
size_t get_serialized_size_deva_perception_msgs__msg__LaneArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaneArray__ros_msg_type * ros_message = static_cast<const _LaneArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_perception_msgs__msg__Lane(
...
static uint32_t _LaneArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__LaneArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_perception_msgs
size_t max_serialized_size_deva_perception_msgs__msg__LaneArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__Lane(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__LaneArray;
    is_plain =
      (
...
static size_t _LaneArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__LaneArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, LaneArray)() {
