...
#include "deva_perception_msgs/msg/detail/channel__rosidl_typesupport_fastrtps_c.h"
...
using _Channel__ros_msg_type = deva_perception_msgs__msg__Channel;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: last_observation_depth
  {
    cdr << ros_message->last_observation_depth;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name last_observation_depth
  {
    size_t item_size = sizeof(ros_message->last_observation_depth);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name type
...
static uint32_t _Channel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__Channel(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__Channel;
    is_plain =
      (
...
static size_t _Channel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__Channel(
