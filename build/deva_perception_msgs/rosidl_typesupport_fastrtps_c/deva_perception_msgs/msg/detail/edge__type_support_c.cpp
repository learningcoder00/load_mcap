...
#include "deva_perception_msgs/msg/detail/edge__rosidl_typesupport_fastrtps_c.h"
...
using _Edge__ros_msg_type = deva_perception_msgs__msg__Edge;
...
size_t get_serialized_size_deva_perception_msgs__msg__Edge(
  const void * untyped_ros_message,
...
static uint32_t _Edge__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__Edge(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_perception_msgs
size_t max_serialized_size_deva_perception_msgs__msg__Edge(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__Edge;
    is_plain =
      (
...
static size_t _Edge__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__Edge(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, Edge)() {
