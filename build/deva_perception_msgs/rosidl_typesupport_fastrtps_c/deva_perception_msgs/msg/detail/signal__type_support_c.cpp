...
#include "deva_perception_msgs/msg/detail/signal__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/static_obstacle__functions.h"  // so
...
using _Signal__ros_msg_type = deva_perception_msgs__msg__Signal;
...
static uint32_t _Signal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__Signal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__Signal;
    is_plain =
      (
...
static size_t _Signal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__Signal(
