...
#include "deva_perception_msgs/msg/detail/aeb_obstacle__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_common_msgs/msg/detail/bounding_box2d__functions.h"  // head_bbox, tail_bbox
...
using _AEBObstacle__ros_msg_type = deva_perception_msgs__msg__AEBObstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AEBObstacle__ros_msg_type * ros_message = static_cast<const _AEBObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: obstacle
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AEBObstacle__ros_msg_type * ros_message = static_cast<_AEBObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: obstacle
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _AEBObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__AEBObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__AEBObstacle;
    is_plain =
      (
...
static size_t _AEBObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__AEBObstacle(
...
static message_type_support_callbacks_t __callbacks_AEBObstacle = {
...
static rosidl_message_type_support_t _AEBObstacle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AEBObstacle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, AEBObstacle)() {
  return &_AEBObstacle__type_support;
}
