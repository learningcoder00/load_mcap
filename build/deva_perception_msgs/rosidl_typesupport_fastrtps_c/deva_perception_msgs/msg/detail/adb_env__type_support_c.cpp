...
#include "deva_perception_msgs/msg/detail/adb_env__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/adb_traffic_sign__functions.h"  // sign_list
...
using _AdbEnv__ros_msg_type = deva_perception_msgs__msg__AdbEnv;

static bool _AdbEnv__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AdbEnv__ros_msg_type * ros_message = static_cast<const _AdbEnv__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: sign_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, AdbTrafficSign
      )()->data);
    size_t size = ros_message->sign_list.size;
    auto array_ptr = ros_message->sign_list.data;
...
static bool _AdbEnv__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _AdbEnv__ros_msg_type * ros_message = static_cast<_AdbEnv__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: sign_list
  {
    ...
    if (ros_message->sign_list.data) {
      deva_perception_msgs__msg__AdbTrafficSign__Sequence__fini(&ros_message->sign_list);
    }
    if (!deva_perception_msgs__msg__AdbTrafficSign__Sequence__init(&ros_message->sign_list, size)) {
      fprintf(stderr, "failed to create array for field 'sign_list'");
      return false;
    }
    auto array_ptr = ros_message->sign_list.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_deva_perception_msgs__msg__AdbEnv(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AdbEnv__ros_msg_type * ros_message = static_cast<const _AdbEnv__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name sign_list
  {
    size_t array_size = ros_message->sign_list.size;
    auto array_ptr = ros_message->sign_list.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);

    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_perception_msgs__msg__AdbTrafficSign(
...
static uint32_t _AdbEnv__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__AdbEnv(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_perception_msgs
size_t max_serialized_size_deva_perception_msgs__msg__AdbEnv(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: sign_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__AdbTrafficSign(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__AdbEnv;
    is_plain =
      (
...
static size_t _AdbEnv__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_perception_msgs__msg__AdbEnv(
...
static message_type_support_callbacks_t __callbacks_AdbEnv = {
  "deva_perception_msgs::msg",
  "AdbEnv",
  _AdbEnv__cdr_serialize,
  _AdbEnv__cdr_deserialize,
  _AdbEnv__get_serialized_size,
  _AdbEnv__max_serialized_size
};

static rosidl_message_type_support_t _AdbEnv__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, AdbEnv)() {
  return &_AdbEnv__type_support;
}
