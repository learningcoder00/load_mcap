...
#include "deva_perception_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/dict_info__functions.h"  // extra_info
#include "geometry_msgs/msg/detail/pose__functions.h"  // pose
#include "geometry_msgs/msg/detail/twist__functions.h"  // acceleration, acceleration_variance, detection_velocity, velocity, velocity_variance
...
using _Obstacle__ros_msg_type = deva_perception_msgs__msg__Obstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detection_velocity
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->detection_velocity, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: velocity_variance
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->velocity_variance, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: acceleration_variance
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acceleration_variance, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: extra_info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, DictInfo
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detection_velocity
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->detection_velocity))
    {
      return false;
    }
  }
  ...
  // Field name: acceleration_variance
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->acceleration_variance))
    {
      return false;
    }
  }
  ...
  // Field name: extra_info
  {
    ...
    if (ros_message->extra_info.data) {
      deva_perception_msgs__msg__DictInfo__Sequence__fini(&ros_message->extra_info);
    }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Twist(
    &(ros_message->detection_velocity), current_alignment);
  // field.name velocity
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Twist(
    &(ros_message->velocity_variance), current_alignment);
  // field.name acceleration
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Twist(
    &(ros_message->acceleration_variance), current_alignment);
  // field.name tracking_time
  {
  ...
  // field.name extra_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_perception_msgs__msg__DictInfo(
...
static uint32_t _Obstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__Obstacle(
  ...
  size_t current_alignment)
{
  ...
  // member: extra_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__DictInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__Obstacle;
    is_plain =
      (
...
static size_t _Obstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__Obstacle(
