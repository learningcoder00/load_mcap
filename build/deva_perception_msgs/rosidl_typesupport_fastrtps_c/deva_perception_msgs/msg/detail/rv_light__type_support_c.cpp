...
#include "deva_perception_msgs/msg/detail/rv_light__rosidl_typesupport_fastrtps_c.h"
...
using _RVLight__ros_msg_type = deva_perception_msgs__msg__RVLight;

static bool _RVLight__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RVLight__ros_msg_type * ros_message = static_cast<const _RVLight__ros_msg_type *>(untyped_ros_message);
  // Field name: obstacle
  {
  ...
  // Field name: sign_occ_type
  {
    cdr << ros_message->sign_occ_type;
  }

  // Field name: sign_trun_type
  {
    cdr << ros_message->sign_trun_type;
  }
...
static bool _RVLight__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _RVLight__ros_msg_type * ros_message = static_cast<_RVLight__ros_msg_type *>(untyped_ros_message);
  // Field name: obstacle
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  // field.name sign_occ_type
  {
    size_t item_size = sizeof(ros_message->sign_occ_type);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name sign_trun_type
  {
    size_t item_size = sizeof(ros_message->sign_trun_type);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name extra_infos
...
static uint32_t _RVLight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__RVLight(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__RVLight;
    is_plain =
      (
...
static size_t _RVLight__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_perception_msgs__msg__RVLight(
...
static message_type_support_callbacks_t __callbacks_RVLight = {
  "deva_perception_msgs::msg",
  "RVLight",
  _RVLight__cdr_serialize,
  _RVLight__cdr_deserialize,
  _RVLight__get_serialized_size,
  _RVLight__max_serialized_size
};

static rosidl_message_type_support_t _RVLight__type_support = {
