...
#include "deva_perception_msgs/msg/detail/lanev2__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/lane_property_segment__functions.h"  // lane_property_segment
...
using _Lanev2__ros_msg_type = deva_perception_msgs__msg__Lanev2;

static bool _Lanev2__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Lanev2__ros_msg_type * ros_message = static_cast<const _Lanev2__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: lane_property_segment
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, LanePropertySegment
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->lane_property_segment, cdr))
    {
      return false;
    }
  }
...
static bool _Lanev2__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Lanev2__ros_msg_type * ros_message = static_cast<_Lanev2__ros_msg_type *>(untyped_ros_message);
  // Field name: confidence
  {
    cdr >> ros_message->confidence;
  }
  ...
  // Field name: lane_property_segment
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->lane_property_segment))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_perception_msgs__msg__LanePropertySegment(
    &(ros_message->lane_property_segment), current_alignment);
  // field.name fork_property
  {
...
static uint32_t _Lanev2__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__Lanev2(
  ...
  size_t current_alignment)
{
  ...
  // member: lane_property_segment
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__LanePropertySegment(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__Lanev2;
    is_plain =
      (
...
static size_t _Lanev2__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_perception_msgs__msg__Lanev2(
...
static message_type_support_callbacks_t __callbacks_Lanev2 = {
  "deva_perception_msgs::msg",
  "Lanev2",
  _Lanev2__cdr_serialize,
  _Lanev2__cdr_deserialize,
  _Lanev2__get_serialized_size,
  _Lanev2__max_serialized_size
};

static rosidl_message_type_support_t _Lanev2__type_support = {
