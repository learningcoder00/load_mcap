...
#include "deva_perception_msgs/msg/detail/rvadb__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_perception_msgs/msg/detail/rv_light_list__functions.h"  // lights_list
...
using _RVADB__ros_msg_type = deva_perception_msgs__msg__RVADB;

static bool _RVADB__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RVADB__ros_msg_type * ros_message = static_cast<const _RVADB__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: lights_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, RVLightList
      )()->data);
    size_t size = ros_message->lights_list.size;
    auto array_ptr = ros_message->lights_list.data;
...
static bool _RVADB__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _RVADB__ros_msg_type * ros_message = static_cast<_RVADB__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: lights_list
  {
    ...
    if (ros_message->lights_list.data) {
      deva_perception_msgs__msg__RVLightList__Sequence__fini(&ros_message->lights_list);
    }
    if (!deva_perception_msgs__msg__RVLightList__Sequence__init(&ros_message->lights_list, size)) {
      fprintf(stderr, "failed to create array for field 'lights_list'");
      return false;
    }
    auto array_ptr = ros_message->lights_list.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name lights_list
  {
    size_t array_size = ros_message->lights_list.size;
    auto array_ptr = ros_message->lights_list.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);

    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_deva_perception_msgs__msg__RVLightList(
...
static uint32_t _RVADB__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__RVADB(
  ...
  size_t current_alignment)
{
  ...
  // member: lights_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__RVLightList(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__RVADB;
    is_plain =
      (
...
static size_t _RVADB__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_perception_msgs__msg__RVADB(
...
static message_type_support_callbacks_t __callbacks_RVADB = {
  "deva_perception_msgs::msg",
  "RVADB",
  _RVADB__cdr_serialize,
  _RVADB__cdr_deserialize,
  _RVADB__get_serialized_size,
  _RVADB__max_serialized_size
};

static rosidl_message_type_support_t _RVADB__type_support = {
