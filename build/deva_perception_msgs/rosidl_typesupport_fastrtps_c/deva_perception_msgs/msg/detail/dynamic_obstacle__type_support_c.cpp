...
#include "deva_perception_msgs/msg/detail/dynamic_obstacle__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_common_msgs/msg/detail/bounding_box2d__functions.h"  // head_bbox, ped_bbox, tail_bbox
...
using _DynamicObstacle__ros_msg_type = deva_perception_msgs__msg__DynamicObstacle;
...
static uint32_t _DynamicObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__DynamicObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__DynamicObstacle;
    is_plain =
      (
...
static size_t _DynamicObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__DynamicObstacle(
