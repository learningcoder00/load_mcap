...
#include "deva_perception_msgs/msg/detail/traffic_light__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficLight__ros_msg_type = deva_perception_msgs__msg__TrafficLight;
...
static uint32_t _TrafficLight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__TrafficLight(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__TrafficLight;
    is_plain =
      (
...
static size_t _TrafficLight__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__TrafficLight(
