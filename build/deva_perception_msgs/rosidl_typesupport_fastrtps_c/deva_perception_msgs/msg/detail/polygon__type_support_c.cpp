...
#include "deva_perception_msgs/msg/detail/polygon__rosidl_typesupport_fastrtps_c.h"
...
using _Polygon__ros_msg_type = deva_perception_msgs__msg__Polygon;
...
static uint32_t _Polygon__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__Polygon(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__Polygon;
    is_plain =
      (
...
static size_t _Polygon__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__Polygon(
