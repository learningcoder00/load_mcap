...
#include "deva_perception_msgs/msg/detail/edge_equation_curve__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_common_msgs/msg/detail/equation_curve__functions.h"  // segment
...
using _EdgeEquationCurve__ros_msg_type = deva_perception_msgs__msg__EdgeEquationCurve;

static bool _EdgeEquationCurve__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EdgeEquationCurve__ros_msg_type * ros_message = static_cast<const _EdgeEquationCurve__ros_msg_type *>(untyped_ros_message);
  // Field name: segment
  {
...
static bool _EdgeEquationCurve__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _EdgeEquationCurve__ros_msg_type * ros_message = static_cast<_EdgeEquationCurve__ros_msg_type *>(untyped_ros_message);
  // Field name: segment
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _EdgeEquationCurve__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__EdgeEquationCurve(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__EdgeEquationCurve;
    is_plain =
      (
...
static size_t _EdgeEquationCurve__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_deva_perception_msgs__msg__EdgeEquationCurve(
...
static message_type_support_callbacks_t __callbacks_EdgeEquationCurve = {
  "deva_perception_msgs::msg",
  "EdgeEquationCurve",
  _EdgeEquationCurve__cdr_serialize,
  _EdgeEquationCurve__cdr_deserialize,
  _EdgeEquationCurve__get_serialized_size,
  _EdgeEquationCurve__max_serialized_size
};

static rosidl_message_type_support_t _EdgeEquationCurve__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EdgeEquationCurve,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, EdgeEquationCurve)() {
  return &_EdgeEquationCurve__type_support;
}
