...
#include "deva_perception_msgs/msg/detail/stop_line2d__rosidl_typesupport_fastrtps_c.h"
...
using _StopLine2d__ros_msg_type = deva_perception_msgs__msg__StopLine2d;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StopLine2d__ros_msg_type * ros_message = static_cast<const _StopLine2d__ros_msg_type *>(untyped_ros_message);
  // Field name: lane_id
  {
  ...
  // Field name: left_point_pos_lgt
  {
    cdr << ros_message->left_point_pos_lgt;
  }

  // Field name: left_point_pos_lat
  {
    cdr << ros_message->left_point_pos_lat;
  }

  // Field name: right_point_pos_lgt
  {
    cdr << ros_message->right_point_pos_lgt;
  }

  // Field name: right_point_pos_lat
  {
  ...
  void * untyped_ros_message)
{
  ...
  _StopLine2d__ros_msg_type * ros_message = static_cast<_StopLine2d__ros_msg_type *>(untyped_ros_message);
  // Field name: lane_id
  {
    cdr >> ros_message->lane_id;
  }
...
static uint32_t _StopLine2d__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__StopLine2d(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__StopLine2d;
    is_plain =
      (
...
static size_t _StopLine2d__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__StopLine2d(
...
static message_type_support_callbacks_t __callbacks_StopLine2d = {
...
static rosidl_message_type_support_t _StopLine2d__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_StopLine2d,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, StopLine2d)() {
  return &_StopLine2d__type_support;
}
