...
#include "deva_perception_msgs/msg/detail/lane_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // actual_turn, navi_turn
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // actual_turn, navi_turn
...
using _LaneInfo__ros_msg_type = deva_perception_msgs__msg__LaneInfo;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: actual_turn
  {
    ...
    if (ros_message->actual_turn.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->actual_turn);
    }
  ...
  // Field name: navi_turn
  {
    ...
    if (ros_message->navi_turn.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->navi_turn);
    }
...
static uint32_t _LaneInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__LaneInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__LaneInfo;
    is_plain =
      (
...
static size_t _LaneInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__LaneInfo(
