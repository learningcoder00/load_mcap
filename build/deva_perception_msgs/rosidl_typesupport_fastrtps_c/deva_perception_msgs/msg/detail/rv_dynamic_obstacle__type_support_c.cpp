...
#include "deva_perception_msgs/msg/detail/rv_dynamic_obstacle__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_common_msgs/msg/detail/bounding_box2d__functions.h"  // full_bbox, tail_bbox
#include "deva_perception_msgs/msg/detail/dynamic_obst_world_space_info__functions.h"  // world_info
...
using _RVDynamicObstacle__ros_msg_type = deva_perception_msgs__msg__RVDynamicObstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RVDynamicObstacle__ros_msg_type * ros_message = static_cast<const _RVDynamicObstacle__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: mapped_type
  {
    cdr << ros_message->mapped_type;
  }

  // Field name: world_info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, DynamicObstWorldSpaceInfo
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->world_info, cdr))
    {
      return false;
    }
  }

  // Field name: full_bbox
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  void * untyped_ros_message)
{
  ...
  _RVDynamicObstacle__ros_msg_type * ros_message = static_cast<_RVDynamicObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: life_time
  {
    cdr >> ros_message->life_time;
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_perception_msgs__msg__DynamicObstWorldSpaceInfo(
...
static uint32_t _RVDynamicObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__RVDynamicObstacle(
  ...
  size_t current_alignment)
{
  ...
  // member: world_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_perception_msgs__msg__DynamicObstWorldSpaceInfo(
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__RVDynamicObstacle;
    is_plain =
      (
...
static size_t _RVDynamicObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__RVDynamicObstacle(
...
static message_type_support_callbacks_t __callbacks_RVDynamicObstacle = {
...
static rosidl_message_type_support_t _RVDynamicObstacle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RVDynamicObstacle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, RVDynamicObstacle)() {
  return &_RVDynamicObstacle__type_support;
}
