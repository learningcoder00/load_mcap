...
#include "deva_perception_msgs/msg/detail/center_line__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_common_msgs/msg/detail/equation_curve__functions.h"  // lane_equalization
...
using _CenterLine__ros_msg_type = deva_perception_msgs__msg__CenterLine;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lane_equalization
  {
    ...
    auto array_ptr = ros_message->lane_equalization.data;
  ...
  // Field name: is_current_lane
  {
    cdr << (ros_message->is_current_lane ? true : false);
  }

  // Field name: is_virtual_lane
  {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: lane_equalization
  {
    ...
    if (ros_message->lane_equalization.data) {
      deva_common_msgs__msg__EquationCurve__Sequence__fini(&ros_message->lane_equalization);
    }
    if (!deva_common_msgs__msg__EquationCurve__Sequence__init(&ros_message->lane_equalization, size)) {
      fprintf(stderr, "failed to create array for field 'lane_equalization'");
      return false;
    }
    auto array_ptr = ros_message->lane_equalization.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_deva_perception_msgs__msg__CenterLine(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CenterLine__ros_msg_type * ros_message = static_cast<const _CenterLine__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CenterLine__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_perception_msgs__msg__CenterLine(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_perception_msgs
size_t max_serialized_size_deva_perception_msgs__msg__CenterLine(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_perception_msgs__msg__CenterLine;
    is_plain =
      (
...
static size_t _CenterLine__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_perception_msgs__msg__CenterLine(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, CenterLine)() {
