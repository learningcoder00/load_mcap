...
class Metaclass_DynamicObstacle(type):
    ...
    def UNKNOWN(self):
        ...
        return Metaclass_DynamicObstacle.__constants['UNKNOWN']

    @property
    def CAR(self):
        """Message constant 'CAR'."""
        return Metaclass_DynamicObstacle.__constants['CAR']

    @property
    def TRUCK(self):
        """Message constant 'TRUCK'."""
        return Metaclass_DynamicObstacle.__constants['TRUCK']

    @property
    def CONSTRUCTION_VEHICLE(self):
        """Message constant 'CONSTRUCTION_VEHICLE'."""
        return Metaclass_DynamicObstacle.__constants['CONSTRUCTION_VEHICLE']

    @property
    def BUS(self):
        """Message constant 'BUS'."""
        return Metaclass_DynamicObstacle.__constants['BUS']

    @property
    def MOTORCYCLE(self):
        """Message constant 'MOTORCYCLE'."""
        return Metaclass_DynamicObstacle.__constants['MOTORCYCLE']

    @property
    def BICYCLE(self):
        """Message constant 'BICYCLE'."""
        return Metaclass_DynamicObstacle.__constants['BICYCLE']

    @property
    def TRICYCLE(self):
        """Message constant 'TRICYCLE'."""
        return Metaclass_DynamicObstacle.__constants['TRICYCLE']

    @property
    def CYCLIST(self):
        """Message constant 'CYCLIST'."""
        return Metaclass_DynamicObstacle.__constants['CYCLIST']
    ...
    def ANIMAL(self):
        ...
        return Metaclass_DynamicObstacle.__constants['ANIMAL']

    @property
    def NO_DIRECTION(self):
        """Message constant 'NO_DIRECTION'."""
        return Metaclass_DynamicObstacle.__constants['NO_DIRECTION']

    @property
    def TURN_LEFT(self):
        """Message constant 'TURN_LEFT'."""
        return Metaclass_DynamicObstacle.__constants['TURN_LEFT']

    @property
    def TURN_RIGHT(self):
        """Message constant 'TURN_RIGHT'."""
        return Metaclass_DynamicObstacle.__constants['TURN_RIGHT']

    @property
    def DIRECTION_UNKNOWN(self):
        """Message constant 'DIRECTION_UNKNOWN'."""
        return Metaclass_DynamicObstacle.__constants['DIRECTION_UNKNOWN']

    @property
    def BRAKE_UNKNOWN(self):
        """Message constant 'BRAKE_UNKNOWN'."""
        return Metaclass_DynamicObstacle.__constants['BRAKE_UNKNOWN']

    @property
    def BRAKE_OFF(self):
        """Message constant 'BRAKE_OFF'."""
        return Metaclass_DynamicObstacle.__constants['BRAKE_OFF']

    @property
    def BRAKE_ON(self):
        """Message constant 'BRAKE_ON'."""
        return Metaclass_DynamicObstacle.__constants['BRAKE_ON']

    @property
    def HAZARD_UNKNOWN(self):
        """Message constant 'HAZARD_UNKNOWN'."""
        return Metaclass_DynamicObstacle.__constants['HAZARD_UNKNOWN']

    @property
    def HAZARD_OFF(self):
        """Message constant 'HAZARD_OFF'."""
        return Metaclass_DynamicObstacle.__constants['HAZARD_OFF']

    @property
    def HAZARD_ON(self):
        """Message constant 'HAZARD_ON'."""
        return Metaclass_DynamicObstacle.__constants['HAZARD_ON']

    @property
    def FOV120(self):
        """Message constant 'FOV120'."""
        return Metaclass_DynamicObstacle.__constants['FOV120']

    @property
    def FOV30(self):
        """Message constant 'FOV30'."""
        return Metaclass_DynamicObstacle.__constants['FOV30']

    @property
    def TRANS(self):
        """Message constant 'TRANS'."""
        return Metaclass_DynamicObstacle.__constants['TRANS']

    @property
    def FUSION(self):
        """Message constant 'FUSION'."""
        return Metaclass_DynamicObstacle.__constants['FUSION']
