...
class Metaclass_EntranceArray(type):
    """Metaclass of message 'EntranceArray'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_perception_msgs.msg.EntranceArray')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__entrance_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__entrance_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__entrance_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__entrance_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__entrance_array
...
class EntranceArray(metaclass=Metaclass_EntranceArray):
    """Message class 'EntranceArray'."""
