...
class Metaclass_Cone(type):
    ...
    def FAIL(self):
        ...
        return Metaclass_Cone.__constants['FAIL']

    @property
    def LEFT(self):
        """Message constant 'LEFT'."""
        return Metaclass_Cone.__constants['LEFT']

    @property
    def MID(self):
        """Message constant 'MID'."""
        return Metaclass_Cone.__constants['MID']

    @property
    def RIGHT(self):
        """Message constant 'RIGHT'."""
        return Metaclass_Cone.__constants['RIGHT']
