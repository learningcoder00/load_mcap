...
bool deva_perception_msgs__msg__lanev2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._lanev2.Lanev2", full_classname_dest, 39) == 0);
  }
  deva_perception_msgs__msg__Lanev2 * ros_message = _ros_message;
  {  // confidence
  ...
  {  // lane_property_segment
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_property_segment");
    if (!field) {
      return false;
    }
    if (!deva_perception_msgs__msg__lane_property_segment__convert_from_py(field, &ros_message->lane_property_segment)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of Lanev2 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._lanev2");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Lanev2");
  ...
  {  // lane_property_segment
    PyObject * field = NULL;
    field = deva_perception_msgs__msg__lane_property_segment__convert_to_py(&ros_message->lane_property_segment);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_property_segment", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
