...
bool deva_perception_msgs__msg__cone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._cone.Cone", full_classname_dest, 35) == 0);
  }
  deva_perception_msgs__msg__Cone * ros_message = _ros_message;
  {  // id
...
PyObject * deva_perception_msgs__msg__cone__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._cone");
