...
bool deva_perception_msgs__msg__area__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._area.Area", full_classname_dest, 35) == 0);
  }
  deva_perception_msgs__msg__Area * ros_message = _ros_message;
  {  // id
  ...
  {  // direction_pixcoord
    PyObject * field = PyObject_GetAttrString(_pymsg, "direction_pixcoord");
    if (!field) {
      return false;
    }
    if (!deva_common_msgs__msg__point2d__convert_from_py(field, &ros_message->direction_pixcoord)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // depth_carcoord
    PyObject * field = PyObject_GetAttrString(_pymsg, "depth_carcoord");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->depth_carcoord = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // is_occupied
  ...
  {  // occupied_confidence
    ...
    assert(PyFloat_Check(field));
    ros_message->occupied_confidence = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // static_obstacles
    ...
    deva_perception_msgs__msg__StaticObstacle * dest = ros_message->static_obstacles.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * deva_perception_msgs__msg__area__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._area");
  ...
  {  // direction_pixcoord
    PyObject * field = NULL;
    field = deva_common_msgs__msg__point2d__convert_to_py(&ros_message->direction_pixcoord);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "direction_pixcoord", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // depth_carcoord
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->depth_carcoord);
    {
      int rc = PyObject_SetAttrString(_pymessage, "depth_carcoord", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
