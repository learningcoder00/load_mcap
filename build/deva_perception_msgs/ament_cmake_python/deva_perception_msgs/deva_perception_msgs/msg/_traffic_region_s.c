...
bool deva_perception_msgs__msg__traffic_region__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._traffic_region.TrafficRegion", full_classname_dest, 54) == 0);
  }
  deva_perception_msgs__msg__TrafficRegion * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of TrafficRegion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._traffic_region");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficRegion");
