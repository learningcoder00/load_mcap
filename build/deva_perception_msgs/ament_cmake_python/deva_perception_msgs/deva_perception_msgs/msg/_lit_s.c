...
bool deva_perception_msgs__msg__lit__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._lit.Lit", full_classname_dest, 33) == 0);
  }
  deva_perception_msgs__msg__Lit * ros_message = _ros_message;
  {  // header
  ...
  {  // lit_area
    ...
    ros_message->lit_area = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // brightness
...
{
  /* NOTE(esteve): Call constructor of Lit */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._lit");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Lit");
  ...
  {  // lit_area
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->lit_area);
    {
