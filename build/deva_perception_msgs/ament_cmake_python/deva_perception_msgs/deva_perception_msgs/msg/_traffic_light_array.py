...
class Metaclass_TrafficLightArray(type):
    """Metaclass of message 'TrafficLightArray'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_perception_msgs.msg.TrafficLightArray')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__traffic_light_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__traffic_light_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__traffic_light_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__traffic_light_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__traffic_light_array
...
class TrafficLightArray(metaclass=Metaclass_TrafficLightArray):
    """Message class 'TrafficLightArray'."""
    ...
    _fields_and_field_types = {
        ...
        'traffic_lights': 'sequence<deva_perception_msgs/TrafficLight>',
    }
