...
bool deva_perception_msgs__msg__po_p_fusion_tflnoa__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._po_p_fusion_tflnoa.PoPFusionTFLNOA", full_classname_dest, 60) == 0);
  }
  deva_perception_msgs__msg__PoPFusionTFLNOA * ros_message = _ros_message;
  {  // color
...
{
  /* NOTE(esteve): Call constructor of PoPFusionTFLNOA */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._po_p_fusion_tflnoa");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoPFusionTFLNOA");
