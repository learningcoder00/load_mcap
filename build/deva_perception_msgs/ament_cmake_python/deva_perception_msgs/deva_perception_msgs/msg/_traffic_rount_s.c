...
bool deva_perception_msgs__msg__traffic_rount__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._traffic_rount.TrafficRount", full_classname_dest, 52) == 0);
  }
  deva_perception_msgs__msg__TrafficRount * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // lane_info
    ...
    if (!deva_perception_msgs__msg__lane_info__convert_from_py(field, &ros_message->lane_info)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // road_info
    ...
    if (!deva_perception_msgs__msg__road_info__convert_from_py(field, &ros_message->road_info)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of TrafficRount */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._traffic_rount");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficRount");
  ...
  {  // lane_info
    PyObject * field = NULL;
    field = deva_perception_msgs__msg__lane_info__convert_to_py(&ros_message->lane_info);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // road_info
    PyObject * field = NULL;
    field = deva_perception_msgs__msg__road_info__convert_to_py(&ros_message->road_info);
    if (!field) {
      return NULL;
    }
    {
