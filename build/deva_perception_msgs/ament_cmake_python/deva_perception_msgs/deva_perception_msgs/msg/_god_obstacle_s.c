...
bool deva_perception_msgs__msg__god_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._god_obstacle.GodObstacle", full_classname_dest, 50) == 0);
  }
  deva_perception_msgs__msg__GodObstacle * ros_message = _ros_message;
  {  // obstacle
...
{
  /* NOTE(esteve): Call constructor of GodObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._god_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GodObstacle");
