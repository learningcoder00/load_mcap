...
bool deva_perception_msgs__msg__rv_light_list__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_perception_msgs__msg__rvadb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_perception_msgs.msg._rvadb.RVADB", full_classname_dest, 37) == 0);
  }
  deva_perception_msgs__msg__RVADB * ros_message = _ros_message;
  {  // header
  ...
  {  // lights_list
    PyObject * field = PyObject_GetAttrString(_pymsg, "lights_list");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'lights_list'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_perception_msgs__msg__RVLightList__Sequence__init(&(ros_message->lights_list), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_perception_msgs__msg__RVLightList__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_perception_msgs__msg__RVLightList * dest = ros_message->lights_list.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_perception_msgs__msg__rv_light_list__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of RVADB */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_perception_msgs.msg._rvadb");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RVADB");
  ...
  {  // lights_list
    PyObject * field = NULL;
    size_t size = ros_message->lights_list.size;
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->lights_list.data[i]);
      PyObject * pyitem = deva_perception_msgs__msg__rv_light_list__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "lights_list", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
