...
static const _AdbTrafficSign_type_support_symbol_names_t _AdbTrafficSign_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_perception_msgs, msg, AdbTrafficSign)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_perception_msgs, msg, AdbTrafficSign)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_perception_msgs, msg, AdbTrafficSign)() {
  return &::deva_perception_msgs::msg::rosidl_typesupport_c::AdbTrafficSign_message_type_support_handle;
}
