...
static const _AdsMarker_type_support_symbol_names_t _AdsMarker_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_ads_msgs, msg, AdsMarker)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_ads_msgs, msg, AdsMarker)),
  }
};
...
{
  return &::deva_ads_msgs::msg::rosidl_typesupport_cpp::AdsMarker_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_ads_msgs, msg, AdsMarker)() {
  return get_message_type_support_handle<deva_ads_msgs::msg::AdsMarker>();
}
