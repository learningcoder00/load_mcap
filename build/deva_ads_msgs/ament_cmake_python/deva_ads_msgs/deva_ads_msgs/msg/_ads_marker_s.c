...
bool deva_ads_msgs__msg__ads_info__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_ads_msgs__msg__ads_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_ads_msgs.msg._ads_marker.AdsMarker", full_classname_dest, 39) == 0);
  }
  deva_ads_msgs__msg__AdsMarker * ros_message = _ros_message;
  {  // points
  ...
  {  // clickable
    PyObject * field = PyObject_GetAttrString(_pymsg, "clickable");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->clickable = (Py_True == field);
    Py_DECREF(field);
  }
  {  // detail
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'detail'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_ads_msgs__msg__AdsInfo__Sequence__init(&(ros_message->detail), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_ads_msgs__msg__AdsInfo__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_ads_msgs__msg__AdsInfo * dest = ros_message->detail.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_ads_msgs__msg__ads_info__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of AdsMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_ads_msgs.msg._ads_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AdsMarker");
  ...
  {  // clickable
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->clickable ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "clickable", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // detail
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->detail.data[i]);
      PyObject * pyitem = deva_ads_msgs__msg__ads_info__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
