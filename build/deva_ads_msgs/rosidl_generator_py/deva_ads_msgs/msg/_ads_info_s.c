...
bool deva_ads_msgs__msg__ads_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_ads_msgs.msg._ads_info.AdsInfo", full_classname_dest, 35) == 0);
  }
  deva_ads_msgs__msg__AdsInfo * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of AdsInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_ads_msgs.msg._ads_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AdsInfo");
