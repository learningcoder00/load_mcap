...
#include "deva_function_msgs/msg/detail/fault_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_function_msgs::msg::FaultStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const deva_function_msgs::msg::FaultRequest & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  deva_function_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.report_fault_status,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_function_msgs::msg::FaultRequest & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_function_msgs
max_serialized_size_FaultRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: report_fault_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_function_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_FaultStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_function_msgs::msg::FaultRequest;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_function_msgs::msg::FaultRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_function_msgs::msg::FaultRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaultRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_function_msgs::msg::FaultRequest *>(
...
static size_t _FaultRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaultRequest(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FaultRequest__callbacks = {
...
static rosidl_message_type_support_t _FaultRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaultRequest__callbacks,
...
{
  return &deva_function_msgs::msg::typesupport_fastrtps_cpp::_FaultRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_function_msgs, msg, FaultRequest)() {
  return &deva_function_msgs::msg::typesupport_fastrtps_cpp::_FaultRequest__handle;
}
