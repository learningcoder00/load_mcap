...
#include "deva_function_msgs/msg/detail/para_ser_apa_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_function_msgs::msg::ParaSerApaMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_function_msgs::msg::ParaSerApaMsg & ros_message)
{
  // Member: publish_timestamp
  cdr >> ros_message.publish_timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_function_msgs
max_serialized_size_ParaSerApaMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_function_msgs::msg::ParaSerApaMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_function_msgs::msg::ParaSerApaMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_function_msgs::msg::ParaSerApaMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ParaSerApaMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_function_msgs::msg::ParaSerApaMsg *>(
...
static size_t _ParaSerApaMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ParaSerApaMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ParaSerApaMsg__callbacks = {
...
static rosidl_message_type_support_t _ParaSerApaMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ParaSerApaMsg__callbacks,
...
{
  return &deva_function_msgs::msg::typesupport_fastrtps_cpp::_ParaSerApaMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_function_msgs, msg, ParaSerApaMsg)() {
  return &deva_function_msgs::msg::typesupport_fastrtps_cpp::_ParaSerApaMsg__handle;
}
