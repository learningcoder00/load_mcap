...
class Metaclass_FsmHnopMsg(type):
    """Metaclass of message 'FsmHnopMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'deva_function_msgs.msg.FsmHnopMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__fsm_hnop_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__fsm_hnop_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__fsm_hnop_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__fsm_hnop_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__fsm_hnop_msg
...
class FsmHnopMsg(metaclass=Metaclass_FsmHnopMsg):
    """Message class 'FsmHnopMsg'."""
