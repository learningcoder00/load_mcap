...
bool deva_function_msgs__msg__fsm_test_tool_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_function_msgs.msg._fsm_test_tool_data_msg.FsmTestToolDataMsg", full_classname_dest, 65) == 0);
  }
  deva_function_msgs__msg__FsmTestToolDataMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // request_id
    ...
    assert(PyLong_Check(field));
    ros_message->request_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // keys
  ...
  {  // conditions
    PyObject * field = PyObject_GetAttrString(_pymsg, "conditions");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'conditions'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->conditions.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of FsmTestToolDataMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_function_msgs.msg._fsm_test_tool_data_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FsmTestToolDataMsg");
  ...
  {  // conditions
    ...
    rosidl_runtime_c__String * src = ros_message->conditions.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "conditions", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
