...
deva_function_msgs__msg__FsmParkingState__are_equal(const deva_function_msgs__msg__FsmParkingState * lhs, const deva_function_msgs__msg__FsmParkingState * rhs)
{
  ...
  // fsm_apa_current_state
  if (lhs->fsm_apa_current_state != rhs->fsm_apa_current_state) {
    return false;
  }
  return true;
}
  ...
  deva_function_msgs__msg__FsmParkingState * output)
{
  ...
  // fsm_apa_current_state
  output->fsm_apa_current_state = input->fsm_apa_current_state;
  return true;
}
...
deva_function_msgs__msg__FsmParkingState__create()
{
  ...
  deva_function_msgs__msg__FsmParkingState * msg = (deva_function_msgs__msg__FsmParkingState *)allocator.allocate(sizeof(deva_function_msgs__msg__FsmParkingState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(deva_function_msgs__msg__FsmParkingState));
  bool success = deva_function_msgs__msg__FsmParkingState__init(msg);
  if (!success) {
...
deva_function_msgs__msg__FsmParkingState__destroy(deva_function_msgs__msg__FsmParkingState * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    deva_function_msgs__msg__FsmParkingState__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
deva_function_msgs__msg__FsmParkingState__Sequence__init(deva_function_msgs__msg__FsmParkingState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_function_msgs__msg__FsmParkingState * data = NULL;

  if (size) {
    data = (deva_function_msgs__msg__FsmParkingState *)allocator.zero_allocate(size, sizeof(deva_function_msgs__msg__FsmParkingState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = deva_function_msgs__msg__FsmParkingState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        deva_function_msgs__msg__FsmParkingState__fini(&data[i - 1]);
      }
...
deva_function_msgs__msg__FsmParkingState__Sequence__fini(deva_function_msgs__msg__FsmParkingState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      deva_function_msgs__msg__FsmParkingState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  deva_function_msgs__msg__FsmParkingState__Sequence * array = (deva_function_msgs__msg__FsmParkingState__Sequence *)allocator.allocate(sizeof(deva_function_msgs__msg__FsmParkingState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = deva_function_msgs__msg__FsmParkingState__Sequence__init(array, size);
  if (!success) {
...
deva_function_msgs__msg__FsmParkingState__Sequence__destroy(deva_function_msgs__msg__FsmParkingState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    deva_function_msgs__msg__FsmParkingState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
deva_function_msgs__msg__FsmParkingState__Sequence__are_equal(const deva_function_msgs__msg__FsmParkingState__Sequence * lhs, const deva_function_msgs__msg__FsmParkingState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!deva_function_msgs__msg__FsmParkingState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  deva_function_msgs__msg__FsmParkingState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(deva_function_msgs__msg__FsmParkingState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    deva_function_msgs__msg__FsmParkingState * data =
      (deva_function_msgs__msg__FsmParkingState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!deva_function_msgs__msg__FsmParkingState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          deva_function_msgs__msg__FsmParkingState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!deva_function_msgs__msg__FsmParkingState__copy(
