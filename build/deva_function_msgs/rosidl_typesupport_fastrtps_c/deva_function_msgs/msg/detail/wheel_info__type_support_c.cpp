...
#include "deva_function_msgs/msg/detail/wheel_info__rosidl_typesupport_fastrtps_c.h"
...
using _WheelInfo__ros_msg_type = deva_function_msgs__msg__WheelInfo;
...
static uint32_t _WheelInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_function_msgs__msg__WheelInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_function_msgs__msg__WheelInfo;
    is_plain =
      (
...
static size_t _WheelInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_function_msgs__msg__WheelInfo(
