...
#include "deva_function_msgs/msg/detail/wheel_speed__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_function_msgs/msg/detail/wheel_info__functions.h"  // front_left, front_right, rear_left, rear_right

// forward declare type support functions
size_t get_serialized_size_deva_function_msgs__msg__WheelInfo(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_function_msgs__msg__WheelInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_function_msgs, msg, WheelInfo)();


using _WheelSpeed__ros_msg_type = deva_function_msgs__msg__WheelSpeed;
  ...
  // Field name: front_left
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_function_msgs, msg, WheelInfo
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_function_msgs__msg__WheelInfo(
...
static uint32_t _WheelSpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_function_msgs__msg__WheelSpeed(
  ...
  size_t current_alignment)
{
  ...
  // member: front_left
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_function_msgs__msg__WheelInfo(
  ...
  if (is_plain) {
    ...
    using DataType = deva_function_msgs__msg__WheelSpeed;
    is_plain =
      (
...
static size_t _WheelSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_function_msgs__msg__WheelSpeed(
