...
static const _FsmTestToolDataMsg_type_support_symbol_names_t _FsmTestToolDataMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_function_msgs, msg, FsmTestToolDataMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_function_msgs, msg, FsmTestToolDataMsg)),
  }
};
...
{
  return &::deva_function_msgs::msg::rosidl_typesupport_cpp::FsmTestToolDataMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_function_msgs, msg, FsmTestToolDataMsg)() {
  return get_message_type_support_handle<deva_function_msgs::msg::FsmTestToolDataMsg>();
}
