...
static const _WheelSpeed_type_support_symbol_names_t _WheelSpeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_function_msgs, msg, WheelSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_function_msgs, msg, WheelSpeed)),
  }
};
...
{
  return &::deva_function_msgs::msg::rosidl_typesupport_cpp::WheelSpeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_function_msgs, msg, WheelSpeed)() {
  return get_message_type_support_handle<deva_function_msgs::msg::WheelSpeed>();
}
