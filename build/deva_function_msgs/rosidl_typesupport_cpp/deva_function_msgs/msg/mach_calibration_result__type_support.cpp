...
static const _MachCalibrationResult_type_support_symbol_names_t _MachCalibrationResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_function_msgs, msg, MachCalibrationResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_function_msgs, msg, MachCalibrationResult)),
  }
};
...
{
  return &::deva_function_msgs::msg::rosidl_typesupport_cpp::MachCalibrationResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_function_msgs, msg, MachCalibrationResult)() {
  return get_message_type_support_handle<deva_function_msgs::msg::MachCalibrationResult>();
}
