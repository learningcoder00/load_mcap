...
static const _FsmInnerCommomMsg_type_support_symbol_names_t _FsmInnerCommomMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_function_msgs, msg, FsmInnerCommomMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_function_msgs, msg, FsmInnerCommomMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_function_msgs, msg, FsmInnerCommomMsg)() {
  return &::deva_function_msgs::msg::rosidl_typesupport_c::FsmInnerCommomMsg_message_type_support_handle;
}
