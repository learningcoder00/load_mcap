...
#include "environment_model_msgs/msg/detail/env_link__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const environment_model_msgs::msg::EnvLink & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  environment_model_msgs::msg::EnvLink & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = environment_model_msgs::msg::EnvLink;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const environment_model_msgs::msg::EnvLink *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<environment_model_msgs::msg::EnvLink *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EnvLink__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const environment_model_msgs::msg::EnvLink *>(
...
static size_t _EnvLink__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EnvLink(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EnvLink__callbacks = {
...
static rosidl_message_type_support_t _EnvLink__handle = {
...
{
  return &environment_model_msgs::msg::typesupport_fastrtps_cpp::_EnvLink__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, environment_model_msgs, msg, EnvLink)() {
  return &environment_model_msgs::msg::typesupport_fastrtps_cpp::_EnvLink__handle;
}
