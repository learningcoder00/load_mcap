...
bool environment_model_msgs__msg__pair_double__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("environment_model_msgs.msg._pair_double.PairDouble", full_classname_dest, 50) == 0);
  }
  environment_model_msgs__msg__PairDouble * ros_message = _ros_message;
  {  // first
...
{
  /* NOTE(esteve): Call constructor of PairDouble */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("environment_model_msgs.msg._pair_double");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PairDouble");
