...
bool environment_model_msgs__msg__scenario_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("environment_model_msgs.msg._scenario_info.ScenarioInfo", full_classname_dest, 54) == 0);
  }
  environment_model_msgs__msg__ScenarioInfo * ros_message = _ros_message;
  {  // scenario
    ...
    ros_message->scenario = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // distance
...
{
  /* NOTE(esteve): Call constructor of ScenarioInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("environment_model_msgs.msg._scenario_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScenarioInfo");
