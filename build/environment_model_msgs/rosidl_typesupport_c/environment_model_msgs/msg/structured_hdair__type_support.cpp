...
static const _StructuredHdair_type_support_symbol_names_t _StructuredHdair_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, environment_model_msgs, msg, StructuredHdair)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, environment_model_msgs, msg, StructuredHdair)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, environment_model_msgs, msg, StructuredHdair)() {
  return &::environment_model_msgs::msg::rosidl_typesupport_c::StructuredHdair_message_type_support_handle;
}
