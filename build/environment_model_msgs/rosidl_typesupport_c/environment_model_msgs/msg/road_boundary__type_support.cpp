...
static const _RoadBoundary_type_support_symbol_names_t _RoadBoundary_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, environment_model_msgs, msg, RoadBoundary)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, environment_model_msgs, msg, RoadBoundary)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, environment_model_msgs, msg, RoadBoundary)() {
  return &::environment_model_msgs::msg::rosidl_typesupport_c::RoadBoundary_message_type_support_handle;
}
