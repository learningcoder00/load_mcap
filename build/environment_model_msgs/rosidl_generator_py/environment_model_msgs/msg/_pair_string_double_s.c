...
bool environment_model_msgs__msg__pair_string_double__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("environment_model_msgs.msg._pair_string_double.PairStringDouble", full_classname_dest, 63) == 0);
  }
  environment_model_msgs__msg__PairStringDouble * ros_message = _ros_message;
  {  // first
...
{
  /* NOTE(esteve): Call constructor of PairStringDouble */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("environment_model_msgs.msg._pair_string_double");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PairStringDouble");
