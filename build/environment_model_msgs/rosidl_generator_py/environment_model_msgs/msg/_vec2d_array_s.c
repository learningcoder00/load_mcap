...
bool environment_model_msgs__msg__vec2d_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("environment_model_msgs.msg._vec2d_array.Vec2dArray", full_classname_dest, 50) == 0);
  }
  environment_model_msgs__msg__Vec2dArray * ros_message = _ros_message;
  {  // vec2d_array
    PyObject * field = PyObject_GetAttrString(_pymsg, "vec2d_array");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'vec2d_array'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    environment_model_msgs__msg__Vec2d * dest = ros_message->vec2d_array.data;
...
{
  /* NOTE(esteve): Call constructor of Vec2dArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("environment_model_msgs.msg._vec2d_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vec2dArray");
  ...
  {  // vec2d_array
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->vec2d_array.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "vec2d_array", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
