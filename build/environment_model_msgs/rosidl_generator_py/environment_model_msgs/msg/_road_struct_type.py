...
class Metaclass_RoadStructType(type):
    """Metaclass of message 'RoadStructType'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'environment_model_msgs.msg.RoadStructType')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__road_struct_type
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__road_struct_type
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__road_struct_type
            cls._TYPE_SUPPORT = module.type_support_msg__msg__road_struct_type
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__road_struct_type
...
class RoadStructType(metaclass=Metaclass_RoadStructType):
    """Message class 'RoadStructType'."""
