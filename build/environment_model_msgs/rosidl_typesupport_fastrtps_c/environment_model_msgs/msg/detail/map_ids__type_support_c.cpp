...
#include "environment_model_msgs/msg/detail/map_ids__rosidl_typesupport_fastrtps_c.h"
...
using _MapIds__ros_msg_type = environment_model_msgs__msg__MapIds;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MapIds__ros_msg_type * ros_message = static_cast<const _MapIds__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    cdr << ros_message->key;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MapIds__ros_msg_type * ros_message = static_cast<_MapIds__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    cdr >> ros_message->key;
  }
...
static uint32_t _MapIds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_environment_model_msgs__msg__MapIds(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = environment_model_msgs__msg__MapIds;
    is_plain =
      (
...
static size_t _MapIds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_environment_model_msgs__msg__MapIds(
...
static message_type_support_callbacks_t __callbacks_MapIds = {
...
static rosidl_message_type_support_t _MapIds__type_support = {
