...
#include "environment_model_msgs/msg/detail/scenario_info__rosidl_typesupport_fastrtps_c.h"
...
using _ScenarioInfo__ros_msg_type = environment_model_msgs__msg__ScenarioInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScenarioInfo__ros_msg_type * ros_message = static_cast<const _ScenarioInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: scenario
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ScenarioInfo__ros_msg_type * ros_message = static_cast<_ScenarioInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: scenario
  {
    cdr >> ros_message->scenario;
  }
...
static uint32_t _ScenarioInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_environment_model_msgs__msg__ScenarioInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = environment_model_msgs__msg__ScenarioInfo;
    is_plain =
      (
...
static size_t _ScenarioInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_environment_model_msgs__msg__ScenarioInfo(
...
static message_type_support_callbacks_t __callbacks_ScenarioInfo = {
...
static rosidl_message_type_support_t _ScenarioInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScenarioInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, environment_model_msgs, msg, ScenarioInfo)() {
  return &_ScenarioInfo__type_support;
}
