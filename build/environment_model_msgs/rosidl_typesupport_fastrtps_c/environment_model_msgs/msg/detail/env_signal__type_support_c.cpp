...
#include "environment_model_msgs/msg/detail/env_signal__rosidl_typesupport_fastrtps_c.h"
...
#include "environment_model_msgs/msg/detail/vec3d__functions.h"  // polygen, virtual_brake_point
...
using _EnvSignal__ros_msg_type = environment_model_msgs__msg__EnvSignal;

static bool _EnvSignal__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EnvSignal__ros_msg_type * ros_message = static_cast<const _EnvSignal__ros_msg_type *>(untyped_ros_message);
  // Field name: enum_color
  {
    cdr << ros_message->enum_color;
  }

  // Field name: remain_time
  {
  ...
  // Field name: enum_shape_type
  {
    cdr << ros_message->enum_shape_type;
  }
  ...
  // Field name: virtual_brake_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    auto array_ptr = ros_message->virtual_brake_point.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
...
static bool _EnvSignal__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _EnvSignal__ros_msg_type * ros_message = static_cast<_EnvSignal__ros_msg_type *>(untyped_ros_message);
  // Field name: enum_color
  {
    cdr >> ros_message->enum_color;
  }
  ...
  // Field name: virtual_brake_point
  {
    ...
    if (ros_message->virtual_brake_point.data) {
      environment_model_msgs__msg__Vec3d__Sequence__fini(&ros_message->virtual_brake_point);
    }
    if (!environment_model_msgs__msg__Vec3d__Sequence__init(&ros_message->virtual_brake_point, size)) {
      fprintf(stderr, "failed to create array for field 'virtual_brake_point'");
      return false;
    }
    auto array_ptr = ros_message->virtual_brake_point.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name enum_color
  {
    size_t item_size = sizeof(ros_message->enum_color);
  ...
  // field.name enum_shape_type
  {
    size_t item_size = sizeof(ros_message->enum_shape_type);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name polygen
  ...
  // field.name virtual_brake_point
  {
    size_t array_size = ros_message->virtual_brake_point.size;
    auto array_ptr = ros_message->virtual_brake_point.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
...
static uint32_t _EnvSignal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_environment_model_msgs__msg__EnvSignal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = environment_model_msgs__msg__EnvSignal;
    is_plain =
      (
...
static size_t _EnvSignal__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_environment_model_msgs__msg__EnvSignal(
...
static message_type_support_callbacks_t __callbacks_EnvSignal = {
  "environment_model_msgs::msg",
  "EnvSignal",
  _EnvSignal__cdr_serialize,
  _EnvSignal__cdr_deserialize,
  _EnvSignal__get_serialized_size,
  _EnvSignal__max_serialized_size
};

static rosidl_message_type_support_t _EnvSignal__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EnvSignal,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, environment_model_msgs, msg, EnvSignal)() {
  return &_EnvSignal__type_support;
}
