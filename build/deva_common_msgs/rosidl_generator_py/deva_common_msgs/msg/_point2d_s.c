...
bool deva_common_msgs__msg__point2d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_common_msgs.msg._point2d.Point2d", full_classname_dest, 37) == 0);
  }
  deva_common_msgs__msg__Point2d * ros_message = _ros_message;
  {  // x
...
PyObject * deva_common_msgs__msg__point2d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_common_msgs.msg._point2d");
