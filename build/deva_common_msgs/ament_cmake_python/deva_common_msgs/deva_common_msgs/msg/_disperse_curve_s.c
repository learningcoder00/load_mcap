...
bool deva_common_msgs__msg__disperse_curve__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_common_msgs.msg._disperse_curve.DisperseCurve", full_classname_dest, 50) == 0);
  }
  deva_common_msgs__msg__DisperseCurve * ros_message = _ros_message;
  {  // points
...
{
  /* NOTE(esteve): Call constructor of DisperseCurve */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_common_msgs.msg._disperse_curve");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DisperseCurve");
