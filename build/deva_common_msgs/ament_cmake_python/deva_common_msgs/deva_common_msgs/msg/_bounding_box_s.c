...
bool deva_common_msgs__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_common_msgs.msg._bounding_box.BoundingBox", full_classname_dest, 46) == 0);
  }
  deva_common_msgs__msg__BoundingBox * ros_message = _ros_message;
  {  // xmin
...
PyObject * deva_common_msgs__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_common_msgs.msg._bounding_box");
