...
#include "deva_common_msgs/msg/detail/bounding_box2d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_common_msgs::msg::BoundingBox2d & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_common_msgs::msg::BoundingBox2d & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_common_msgs::msg::BoundingBox2d;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_common_msgs::msg::BoundingBox2d *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_common_msgs::msg::BoundingBox2d *>(
    untyped_ros_message);
...
{
  return &deva_common_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2d__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_common_msgs, msg, BoundingBox2d)() {
  return &deva_common_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2d__handle;
}
