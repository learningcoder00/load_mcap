...
#include "deva_common_msgs/msg/detail/header__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_common_msgs::msg::String &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const deva_common_msgs::msg::Header & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_common_msgs::msg::Header & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  // Member: frame_id
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_common_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_String(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_common_msgs::msg::Header;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_common_msgs::msg::Header *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_common_msgs::msg::Header *>(
    untyped_ros_message);
...
{
  return &deva_common_msgs::msg::typesupport_fastrtps_cpp::_Header__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_common_msgs, msg, Header)() {
  return &deva_common_msgs::msg::typesupport_fastrtps_cpp::_Header__handle;
}
