...
{
  new (message_memory) deva_common_msgs::msg::Point2d(_init);
}

void Point2d_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_common_msgs::msg::Point2d *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point2d_message_member_array[2] = {
  {
    ...
    offsetof(deva_common_msgs::msg::Point2d, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_common_msgs::msg::Point2d, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point2d_message_members = {
  ...
  2,  // number of fields
  sizeof(deva_common_msgs::msg::Point2d),
...
get_message_type_support_handle<deva_common_msgs::msg::Point2d>()
{
  return &::deva_common_msgs::msg::rosidl_typesupport_introspection_cpp::Point2d_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_common_msgs, msg, Point2d)() {
  return &::deva_common_msgs::msg::rosidl_typesupport_introspection_cpp::Point2d_message_type_support_handle;
}
