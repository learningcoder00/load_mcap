...
#include "deva_common_msgs/msg/detail/header__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // pub_stamp, stamp
#include "deva_common_msgs/msg/detail/string__functions.h"  // frame_id
...
size_t get_serialized_size_deva_common_msgs__msg__String(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_deva_common_msgs__msg__String(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_common_msgs, msg, String)();


using _Header__ros_msg_type = deva_common_msgs__msg__Header;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: frame_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, deva_common_msgs, msg, String
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->frame_id, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Time(
    &(ros_message->pub_stamp), current_alignment);
  // field.name index
  {
  ...
  current_alignment += get_serialized_size_deva_common_msgs__msg__String(
    &(ros_message->frame_id), current_alignment);
...
static uint32_t _Header__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_common_msgs__msg__Header(
  ...
  size_t current_alignment)
{
  ...
  // member: frame_id
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_deva_common_msgs__msg__String(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_common_msgs__msg__Header;
    is_plain =
      (
...
static size_t _Header__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_common_msgs__msg__Header(
