...
#include "deva_common_msgs/msg/detail/bounding_box2d__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox2d__ros_msg_type = deva_common_msgs__msg__BoundingBox2d;
...
static uint32_t _BoundingBox2d__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_common_msgs__msg__BoundingBox2d(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_common_msgs__msg__BoundingBox2d;
    is_plain =
      (
...
static size_t _BoundingBox2d__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_common_msgs__msg__BoundingBox2d(
