...
#include "deva_common_msgs/msg/detail/point2d__rosidl_typesupport_fastrtps_c.h"
...
using _Point2d__ros_msg_type = deva_common_msgs__msg__Point2d;
...
static uint32_t _Point2d__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_common_msgs__msg__Point2d(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_common_msgs__msg__Point2d;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Point2d__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_common_msgs__msg__Point2d(
