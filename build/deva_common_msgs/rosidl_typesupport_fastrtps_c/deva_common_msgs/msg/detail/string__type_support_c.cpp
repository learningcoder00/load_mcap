...
#include "deva_common_msgs/msg/detail/string__rosidl_typesupport_fastrtps_c.h"
...
using _String__ros_msg_type = deva_common_msgs__msg__String;
...
static uint32_t _String__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_common_msgs__msg__String(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_common_msgs__msg__String;
    is_plain =
      (
...
static size_t _String__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_common_msgs__msg__String(
