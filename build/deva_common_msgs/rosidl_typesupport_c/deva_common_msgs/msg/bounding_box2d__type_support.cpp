...
static const _BoundingBox2d_type_support_symbol_names_t _BoundingBox2d_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_common_msgs, msg, BoundingBox2d)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_common_msgs, msg, BoundingBox2d)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_common_msgs, msg, BoundingBox2d)() {
  return &::deva_common_msgs::msg::rosidl_typesupport_c::BoundingBox2d_message_type_support_handle;
}
