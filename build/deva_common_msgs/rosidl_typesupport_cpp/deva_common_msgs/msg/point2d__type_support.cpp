...
static const _Point2d_type_support_symbol_names_t _Point2d_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_common_msgs, msg, Point2d)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_common_msgs, msg, Point2d)),
  }
};
...
{
  return &::deva_common_msgs::msg::rosidl_typesupport_cpp::Point2d_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_common_msgs, msg, Point2d)() {
  return get_message_type_support_handle<deva_common_msgs::msg::Point2d>();
}
