...
#ifndef DEVA_MAP_MSGS__MSG__DETAIL__TRAFFIC_LIGHT__TRAITS_HPP_
#define DEVA_MAP_MSGS__MSG__DETAIL__TRAFFIC_LIGHT__TRAITS_HPP_
...
inline void to_yaml(
  const deva_map_msgs::msg::TrafficLight & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const deva_map_msgs::msg::TrafficLight & msg)
{
  return deva_map_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<deva_map_msgs::msg::TrafficLight>()
{
  return "deva_map_msgs::msg::TrafficLight";
}

template<>
inline const char * name<deva_map_msgs::msg::TrafficLight>()
{
  return "deva_map_msgs/msg/TrafficLight";
}

template<>
struct has_fixed_size<deva_map_msgs::msg::TrafficLight>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<deva_map_msgs::msg::TrafficLight>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<deva_map_msgs::msg::TrafficLight>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DEVA_MAP_MSGS__MSG__DETAIL__TRAFFIC_LIGHT__TRAITS_HPP_
