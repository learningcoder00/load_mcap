...
#ifndef DEVA_MAP_MSGS__MSG__DETAIL__PATH_POINT__STRUCT_HPP_
#define DEVA_MAP_MSGS__MSG__DETAIL__PATH_POINT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__deva_map_msgs__msg__PathPoint __attribute__((deprecated))
#else
# define DEPRECATED__deva_map_msgs__msg__PathPoint __declspec(deprecated)
#endif
...
struct PathPoint_
{
  ...
  using _is_expand_type =
    bool;
  _is_expand_type is_expand;
  ...
  // pointer types
  using RawPtr =
    deva_map_msgs::msg::PathPoint_<ContainerAllocator> *;
  using ConstRawPtr =
    const deva_map_msgs::msg::PathPoint_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      deva_map_msgs::msg::PathPoint_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__deva_map_msgs__msg__PathPoint
    std::shared_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__deva_map_msgs__msg__PathPoint
    std::shared_ptr<deva_map_msgs::msg::PathPoint_<ContainerAllocator> const>
  ...
  bool operator==(const PathPoint_ & other) const
  {
    ...
    if (this->is_expand != other.is_expand) {
      return false;
    }
...
using PathPoint =
  deva_map_msgs::msg::PathPoint_<std::allocator<void>>;
...
#endif  // DEVA_MAP_MSGS__MSG__DETAIL__PATH_POINT__STRUCT_HPP_
