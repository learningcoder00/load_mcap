...
bool deva_map_msgs__msg__channel_object_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._channel_object_info.ChannelObjectInfo", full_classname_dest, 56) == 0);
  }
  deva_map_msgs__msg__ChannelObjectInfo * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ChannelObjectInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._channel_object_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChannelObjectInfo");
