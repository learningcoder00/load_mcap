...
bool deva_map_msgs__msg__channel_lane_line__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._channel_lane_line.ChannelLaneLine", full_classname_dest, 52) == 0);
  }
  deva_map_msgs__msg__ChannelLaneLine * ros_message = _ros_message;
  {  // available
  ...
  {  // markingequation_vec
    PyObject * field = PyObject_GetAttrString(_pymsg, "markingequation_vec");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'markingequation_vec'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    deva_common_msgs__msg__EquationCurve * dest = ros_message->markingequation_vec.data;
  ...
  {  // markingpoint_vec
    PyObject * field = PyObject_GetAttrString(_pymsg, "markingpoint_vec");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'markingpoint_vec'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    deva_common_msgs__msg__Point2d * dest = ros_message->markingpoint_vec.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of ChannelLaneLine */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._channel_lane_line");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChannelLaneLine");
  ...
  {  // markingequation_vec
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->markingequation_vec.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "markingequation_vec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // markingpoint_vec
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->markingpoint_vec.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "markingpoint_vec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
