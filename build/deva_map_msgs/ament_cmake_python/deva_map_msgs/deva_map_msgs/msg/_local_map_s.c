...
bool deva_map_msgs__msg__st_local_map__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_map_msgs__msg__local_map_header__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_map_msgs__msg__local_map_header__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool deva_map_msgs__msg__local_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._local_map.LocalMap", full_classname_dest, 37) == 0);
  }
  deva_map_msgs__msg__LocalMap * ros_message = _ros_message;
  {  // header
  ...
  {  // map_mode
    ...
    assert(PyLong_Check(field));
    ros_message->map_mode = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // is_localization_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_localization_mode");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_localization_mode = (Py_True == field);
    Py_DECREF(field);
  }
  {  // st_map
    PyObject * field = PyObject_GetAttrString(_pymsg, "st_map");
    if (!field) {
      return false;
    }
    if (!deva_map_msgs__msg__st_local_map__convert_from_py(field, &ros_message->st_map)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // ust_map
    PyObject * field = PyObject_GetAttrString(_pymsg, "ust_map");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'ust_map'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    deva_perception_msgs__msg__USTBoundary * dest = ros_message->ust_map.data;
  ...
  {  // avp_map
    PyObject * field = PyObject_GetAttrString(_pymsg, "avp_map");
    if (!field) {
      return false;
    }
    if (!deva_map_msgs__msg__avp_local_map__convert_from_py(field, &ros_message->avp_map)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // sensor_header
    PyObject * field = PyObject_GetAttrString(_pymsg, "sensor_header");
    if (!field) {
      return false;
    }
    if (!deva_map_msgs__msg__local_map_header__convert_from_py(field, &ros_message->sensor_header)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * deva_map_msgs__msg__local_map__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._local_map");
  ...
  {  // is_localization_mode
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_localization_mode ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_localization_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // st_map
    PyObject * field = NULL;
    field = deva_map_msgs__msg__st_local_map__convert_to_py(&ros_message->st_map);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "st_map", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ust_map
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->ust_map.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "ust_map", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // avp_map
    PyObject * field = NULL;
    field = deva_map_msgs__msg__avp_local_map__convert_to_py(&ros_message->avp_map);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "avp_map", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // sensor_header
    PyObject * field = NULL;
    field = deva_map_msgs__msg__local_map_header__convert_to_py(&ros_message->sensor_header);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "sensor_header", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
