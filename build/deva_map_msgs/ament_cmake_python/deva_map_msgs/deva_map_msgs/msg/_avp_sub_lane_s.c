...
bool deva_map_msgs__msg__avp_sub_lane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._avp_sub_lane.AvpSubLane", full_classname_dest, 42) == 0);
  }
  deva_map_msgs__msg__AvpSubLane * ros_message = _ros_message;
  {  // lane_id
  ...
  {  // successor_lane_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "successor_lane_ids");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'successor_lane_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->successor_lane_ids.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // left_lane_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "left_lane_ids");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'left_lane_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->left_lane_ids.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // right_lane_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "right_lane_ids");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'right_lane_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->right_lane_ids.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of AvpSubLane */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._avp_sub_lane");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AvpSubLane");
  ...
  {  // successor_lane_ids
    ...
    rosidl_runtime_c__String * src = ros_message->successor_lane_ids.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "successor_lane_ids", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // left_lane_ids
    ...
    rosidl_runtime_c__String * src = ros_message->left_lane_ids.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "left_lane_ids", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // right_lane_ids
    ...
    rosidl_runtime_c__String * src = ros_message->right_lane_ids.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "right_lane_ids", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
