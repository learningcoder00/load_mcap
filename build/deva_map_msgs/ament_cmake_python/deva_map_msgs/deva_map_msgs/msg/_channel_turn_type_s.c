...
bool deva_map_msgs__msg__channel_turn_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._channel_turn_type.ChannelTurnType", full_classname_dest, 52) == 0);
  }
  deva_map_msgs__msg__ChannelTurnType * ros_message = _ros_message;
  {  // s_start
  ...
  {  // laneturntype
    PyObject * field = PyObject_GetAttrString(_pymsg, "laneturntype");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->laneturntype = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ChannelTurnType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._channel_turn_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChannelTurnType");
  ...
  {  // laneturntype
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->laneturntype);
    {
      int rc = PyObject_SetAttrString(_pymessage, "laneturntype", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
