...
bool deva_map_msgs__msg__traffic_light__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_map_msgs.msg._traffic_light.TrafficLight", full_classname_dest, 45) == 0);
  }
  deva_map_msgs__msg__TrafficLight * ros_message = _ros_message;
  {  // perception_obstacle
  ...
  {  // color_type
    ...
    ros_message->color_type = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // blink
...
PyObject * deva_map_msgs__msg__traffic_light__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_map_msgs.msg._traffic_light");
