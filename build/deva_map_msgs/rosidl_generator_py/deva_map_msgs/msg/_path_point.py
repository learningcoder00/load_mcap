...
class PathPoint(metaclass=Metaclass_PathPoint):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_expand = kwargs.get('is_expand', bool())
    ...
    def __eq__(self, other):
        ...
        if self.lane_width != other.lane_width:
            return False
        if self.is_expand != other.is_expand:
            return False
    ...
    @builtins.property
    def is_expand(self):
        """Message field 'is_expand'."""
        return self._is_expand

    @is_expand.setter
    def is_expand(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'is_expand' field must be of type 'bool'"
        self._is_expand = value
