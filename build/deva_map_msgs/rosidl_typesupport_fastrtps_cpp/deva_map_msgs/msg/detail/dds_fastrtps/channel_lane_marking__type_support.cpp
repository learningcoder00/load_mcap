...
#include "deva_map_msgs/msg/detail/channel_lane_marking__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_map_msgs::msg::ChannelMarkingType &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_ChannelMarkingType(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_map_msgs::msg::ChannelLaneMarking & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: marking_equation_vec
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.marking_equation_vec[i],
        cdr);
    }
  }
  // Member: marking_type_vec
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_map_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.marking_type_vec[i],
        cdr);
    }
  }
  // Member: marking_point_vec
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.marking_point_vec[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_map_msgs::msg::ChannelLaneMarking & ros_message)
{
  // Member: available
  {
    uint8_t tmp;
  ...
  // Member: marking_equation_vec
  {
    ...
    ros_message.marking_equation_vec.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.marking_equation_vec[i]);
    }
  }
  ...
  // Member: marking_type_vec
  {
    ...
    ros_message.marking_type_vec.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_map_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.marking_type_vec[i]);
    }
  }
  ...
  // Member: marking_point_vec
  {
    ...
    ros_message.marking_point_vec.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.marking_point_vec[i]);
    }
  }
  ...
  // Member: marking_equation_vec
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.marking_equation_vec[index], current_alignment);
    }
  }
  // Member: marking_type_vec
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.marking_type_vec[index], current_alignment);
    }
  }
  // Member: marking_point_vec
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_common_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.marking_point_vec[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: marking_type_vec
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_map_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ChannelMarkingType(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_map_msgs::msg::ChannelLaneMarking;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_map_msgs::msg::ChannelLaneMarking *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_map_msgs::msg::ChannelLaneMarking *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ChannelLaneMarking__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_map_msgs::msg::ChannelLaneMarking *>(
...
static size_t _ChannelLaneMarking__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ChannelLaneMarking(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ChannelLaneMarking__callbacks = {
  "deva_map_msgs::msg",
  "ChannelLaneMarking",
...
static rosidl_message_type_support_t _ChannelLaneMarking__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChannelLaneMarking__callbacks,
...
{
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_ChannelLaneMarking__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_map_msgs, msg, ChannelLaneMarking)() {
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_ChannelLaneMarking__handle;
}
