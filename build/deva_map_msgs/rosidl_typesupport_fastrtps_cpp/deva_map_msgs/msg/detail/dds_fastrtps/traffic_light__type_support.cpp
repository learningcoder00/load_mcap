...
#include "deva_map_msgs/msg/detail/traffic_light__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_map_msgs::msg::TrafficLight & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_map_msgs::msg::TrafficLight & ros_message)
{
  // Member: perception_obstacle
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_map_msgs::msg::TrafficLight;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_map_msgs::msg::TrafficLight *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_map_msgs::msg::TrafficLight *>(
    untyped_ros_message);
...
{
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_TrafficLight__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_map_msgs, msg, TrafficLight)() {
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_TrafficLight__handle;
}
