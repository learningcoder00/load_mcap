...
#include "deva_map_msgs/msg/detail/path_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: is_expand
  cdr << (ros_message.is_expand ? true : false);
  // Member: is_junction
  ...
  deva_map_msgs::msg::PathPoint & ros_message)
{
  ...
  // Member: is_expand
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.is_expand = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: is_expand
  {
    size_t item_size = sizeof(ros_message.is_expand);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: is_junction
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_map_msgs::msg::PathPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_map_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_map_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
