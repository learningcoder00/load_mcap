...
#include "deva_map_msgs/msg/detail/channel_lane_line__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_map_msgs::msg::ChannelLaneLine & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markingequation_vec
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.markingequation_vec[i],
        cdr);
    }
  }
  // Member: markingpoint_vec
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.markingpoint_vec[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_map_msgs::msg::ChannelLaneLine & ros_message)
{
  // Member: available
  {
    uint8_t tmp;
  ...
  // Member: markingequation_vec
  {
    ...
    ros_message.markingequation_vec.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.markingequation_vec[i]);
    }
  }
  ...
  // Member: markingpoint_vec
  {
    ...
    ros_message.markingpoint_vec.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_common_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.markingpoint_vec[i]);
    }
  }
  ...
  // Member: markingequation_vec
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.markingequation_vec[index], current_alignment);
    }
  }
  // Member: markingpoint_vec
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_common_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.markingpoint_vec[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_map_msgs::msg::ChannelLaneLine;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_map_msgs::msg::ChannelLaneLine *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_map_msgs::msg::ChannelLaneLine *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ChannelLaneLine__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_map_msgs::msg::ChannelLaneLine *>(
...
static size_t _ChannelLaneLine__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ChannelLaneLine(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ChannelLaneLine__callbacks = {
  "deva_map_msgs::msg",
  "ChannelLaneLine",
...
static rosidl_message_type_support_t _ChannelLaneLine__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChannelLaneLine__callbacks,
...
{
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_ChannelLaneLine__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_map_msgs, msg, ChannelLaneLine)() {
  return &deva_map_msgs::msg::typesupport_fastrtps_cpp::_ChannelLaneLine__handle;
}
