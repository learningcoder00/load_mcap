...
#include "deva_map_msgs/msg/detail/avp_boundary__rosidl_typesupport_fastrtps_c.h"
...
using _AvpBoundary__ros_msg_type = deva_map_msgs__msg__AvpBoundary;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AvpBoundary__ros_msg_type * ros_message = static_cast<const _AvpBoundary__ros_msg_type *>(untyped_ros_message);
  // Field name: s
  {
    cdr << ros_message->s;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _AvpBoundary__ros_msg_type * ros_message = static_cast<_AvpBoundary__ros_msg_type *>(untyped_ros_message);
  // Field name: s
  {
    cdr >> ros_message->s;
  }
...
static uint32_t _AvpBoundary__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_map_msgs__msg__AvpBoundary(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_map_msgs__msg__AvpBoundary;
    is_plain =
      (
...
static size_t _AvpBoundary__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_map_msgs__msg__AvpBoundary(
...
static message_type_support_callbacks_t __callbacks_AvpBoundary = {
  "deva_map_msgs::msg",
  "AvpBoundary",
...
static rosidl_message_type_support_t _AvpBoundary__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AvpBoundary,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_map_msgs, msg, AvpBoundary)() {
  return &_AvpBoundary__type_support;
}
