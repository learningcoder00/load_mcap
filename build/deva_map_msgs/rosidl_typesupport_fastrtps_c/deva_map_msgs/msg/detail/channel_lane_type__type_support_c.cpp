...
#include "deva_map_msgs/msg/detail/channel_lane_type__rosidl_typesupport_fastrtps_c.h"
...
using _ChannelLaneType__ros_msg_type = deva_map_msgs__msg__ChannelLaneType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ChannelLaneType__ros_msg_type * ros_message = static_cast<const _ChannelLaneType__ros_msg_type *>(untyped_ros_message);
  // Field name: s_start
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ChannelLaneType__ros_msg_type * ros_message = static_cast<_ChannelLaneType__ros_msg_type *>(untyped_ros_message);
  // Field name: s_start
  {
    cdr >> ros_message->s_start;
  }
...
static uint32_t _ChannelLaneType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_map_msgs__msg__ChannelLaneType(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_map_msgs__msg__ChannelLaneType;
    is_plain =
      (
...
static size_t _ChannelLaneType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_map_msgs__msg__ChannelLaneType(
...
static message_type_support_callbacks_t __callbacks_ChannelLaneType = {
  "deva_map_msgs::msg",
  "ChannelLaneType",
...
static rosidl_message_type_support_t _ChannelLaneType__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ChannelLaneType,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_map_msgs, msg, ChannelLaneType)() {
  return &_ChannelLaneType__type_support;
}
