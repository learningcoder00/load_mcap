...
bool deva_mdriver_msgs__msg__debug_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_mdriver_msgs.msg._debug_info.DebugInfo", full_classname_dest, 43) == 0);
  }
  deva_mdriver_msgs__msg__DebugInfo * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of DebugInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_mdriver_msgs.msg._debug_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DebugInfo");
