...
static const _ObstacleNudgeBuffer_type_support_symbol_names_t _ObstacleNudgeBuffer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_mdriver_msgs, msg, ObstacleNudgeBuffer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deva_mdriver_msgs, msg, ObstacleNudgeBuffer)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deva_mdriver_msgs, msg, ObstacleNudgeBuffer)() {
  return &::deva_mdriver_msgs::msg::rosidl_typesupport_c::ObstacleNudgeBuffer_message_type_support_handle;
}
