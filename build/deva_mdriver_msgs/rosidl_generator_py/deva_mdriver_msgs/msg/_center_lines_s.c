...
bool deva_mdriver_msgs__msg__center_lines__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_mdriver_msgs.msg._center_lines.CenterLines", full_classname_dest, 47) == 0);
  }
  deva_mdriver_msgs__msg__CenterLines * ros_message = _ros_message;
  {  // header
  ...
  {  // center_lines
    ...
    if (!deva_mdriver_msgs__msg__CenterLine__Sequence__init(&(ros_message->center_lines), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_mdriver_msgs__msg__CenterLine__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_mdriver_msgs__msg__CenterLine * dest = ros_message->center_lines.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_mdriver_msgs__msg__center_line__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of CenterLines */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_mdriver_msgs.msg._center_lines");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CenterLines");
  ...
  {  // center_lines
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = deva_mdriver_msgs__msg__center_line__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
