...
#include "deva_mdriver_msgs/msg/detail/debug_info__rosidl_typesupport_fastrtps_c.h"
...
using _DebugInfo__ros_msg_type = deva_mdriver_msgs__msg__DebugInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DebugInfo__ros_msg_type * ros_message = static_cast<const _DebugInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DebugInfo__ros_msg_type * ros_message = static_cast<_DebugInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _DebugInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_mdriver_msgs__msg__DebugInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_mdriver_msgs__msg__DebugInfo;
    is_plain =
      (
...
static size_t _DebugInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_mdriver_msgs__msg__DebugInfo(
...
static message_type_support_callbacks_t __callbacks_DebugInfo = {
...
static rosidl_message_type_support_t _DebugInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DebugInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_mdriver_msgs, msg, DebugInfo)() {
  return &_DebugInfo__type_support;
}
