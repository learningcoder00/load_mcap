...
#include "deva_mdriver_msgs/msg/detail/mdriver_ref_line__rosidl_typesupport_fastrtps_c.h"
...
using _MdriverRefLine__ros_msg_type = deva_mdriver_msgs__msg__MdriverRefLine;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MdriverRefLine__ros_msg_type * ros_message = static_cast<const _MdriverRefLine__ros_msg_type *>(untyped_ros_message);
  // Field name: points
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MdriverRefLine__ros_msg_type * ros_message = static_cast<_MdriverRefLine__ros_msg_type *>(untyped_ros_message);
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _MdriverRefLine__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_mdriver_msgs__msg__MdriverRefLine(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_mdriver_msgs__msg__MdriverRefLine;
    is_plain =
      (
...
static size_t _MdriverRefLine__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_mdriver_msgs__msg__MdriverRefLine(
...
static message_type_support_callbacks_t __callbacks_MdriverRefLine = {
...
static rosidl_message_type_support_t _MdriverRefLine__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MdriverRefLine,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_mdriver_msgs, msg, MdriverRefLine)() {
  return &_MdriverRefLine__type_support;
}
