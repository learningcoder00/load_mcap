...
#include "deva_mdriver_msgs/msg/detail/center_lines__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_mdriver_msgs::msg::CenterLine &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const deva_mdriver_msgs::msg::CenterLines & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_mdriver_msgs::msg::CenterLines & ros_message)
{
  // Member: header
  ...
  // Member: center_lines
  {
    ...
    ros_message.center_lines.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_mdriver_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.center_lines[i]);
    }
  }
  ...
  // Member: center_lines
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.center_lines[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_mdriver_msgs
max_serialized_size_CenterLines(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: center_lines
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_mdriver_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CenterLine(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_mdriver_msgs::msg::CenterLines;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_mdriver_msgs::msg::CenterLines *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_mdriver_msgs::msg::CenterLines *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CenterLines__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_mdriver_msgs::msg::CenterLines *>(
...
static size_t _CenterLines__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CenterLines(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CenterLines__callbacks = {
...
static rosidl_message_type_support_t _CenterLines__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CenterLines__callbacks,
...
{
  return &deva_mdriver_msgs::msg::typesupport_fastrtps_cpp::_CenterLines__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_mdriver_msgs, msg, CenterLines)() {
  return &deva_mdriver_msgs::msg::typesupport_fastrtps_cpp::_CenterLines__handle;
}
