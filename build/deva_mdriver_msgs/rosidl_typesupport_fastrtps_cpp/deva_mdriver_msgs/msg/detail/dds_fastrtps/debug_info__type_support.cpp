...
#include "deva_mdriver_msgs/msg/detail/debug_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_mdriver_msgs::msg::DebugInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_mdriver_msgs::msg::DebugInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_mdriver_msgs::msg::DebugInfo *>(
    untyped_ros_message);
...
{
  return &deva_mdriver_msgs::msg::typesupport_fastrtps_cpp::_DebugInfo__handle;
}
