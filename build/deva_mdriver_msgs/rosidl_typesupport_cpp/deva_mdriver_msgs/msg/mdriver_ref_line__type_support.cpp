...
static const _MdriverRefLine_type_support_symbol_names_t _MdriverRefLine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_mdriver_msgs, msg, MdriverRefLine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_mdriver_msgs, msg, MdriverRefLine)),
  }
};
...
{
  return &::deva_mdriver_msgs::msg::rosidl_typesupport_cpp::MdriverRefLine_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deva_mdriver_msgs, msg, MdriverRefLine)() {
  return get_message_type_support_handle<deva_mdriver_msgs::msg::MdriverRefLine>();
}
