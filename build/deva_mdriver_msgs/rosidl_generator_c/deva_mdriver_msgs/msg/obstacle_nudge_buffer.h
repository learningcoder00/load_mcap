...
#ifndef DEVA_MDRIVER_MSGS__MSG__OBSTACLE_NUDGE_BUFFER_H_
#define DEVA_MDRIVER_MSGS__MSG__OBSTACLE_NUDGE_BUFFER_H_
...
#endif  // DEVA_MDRIVER_MSGS__MSG__OBSTACLE_NUDGE_BUFFER_H_
