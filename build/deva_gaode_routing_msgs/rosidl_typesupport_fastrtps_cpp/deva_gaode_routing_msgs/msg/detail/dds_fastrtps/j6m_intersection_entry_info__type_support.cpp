...
#include "deva_gaode_routing_msgs/msg/detail/j6m_intersection_entry_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::J6mIntersectionEntryInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: crowd_sourcing_link_id
  deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.crowd_sourcing_link_id,
    cdr);
  // Member: offset
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::J6mIntersectionEntryInfo & ros_message)
{
  // Member: crowd_sourcing_link_id
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_gaode_routing_msgs
max_serialized_size_J6mIntersectionEntryInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::J6mIntersectionEntryInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::J6mIntersectionEntryInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::J6mIntersectionEntryInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _J6mIntersectionEntryInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::J6mIntersectionEntryInfo *>(
...
static size_t _J6mIntersectionEntryInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_J6mIntersectionEntryInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _J6mIntersectionEntryInfo__callbacks = {
...
static rosidl_message_type_support_t _J6mIntersectionEntryInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_J6mIntersectionEntryInfo__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_J6mIntersectionEntryInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, J6mIntersectionEntryInfo)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_J6mIntersectionEntryInfo__handle;
}
