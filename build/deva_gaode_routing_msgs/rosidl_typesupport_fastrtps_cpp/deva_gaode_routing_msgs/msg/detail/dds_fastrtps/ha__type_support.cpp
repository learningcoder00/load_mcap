...
#include "deva_gaode_routing_msgs/msg/detail/ha__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_gaode_routing_msgs::msg::FeaturePoint &,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::HA & ros_message)
{
  // Member: feature_point
  ...
  size_t current_alignment)
{
  ...
  // Member: feature_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_FeaturePoint(
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::HA;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::HA *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::HA *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HA__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::HA *>(
...
static size_t _HA__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HA(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HA__callbacks = {
...
static rosidl_message_type_support_t _HA__handle = {
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_HA__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, HA)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_HA__handle;
}
