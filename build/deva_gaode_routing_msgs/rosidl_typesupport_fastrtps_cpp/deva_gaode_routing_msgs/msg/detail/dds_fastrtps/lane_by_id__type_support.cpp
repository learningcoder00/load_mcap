...
#include "deva_gaode_routing_msgs/msg/detail/lane_by_id__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::LaneById & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: border_types
  {
    cdr << ros_message.border_types;
  }
  // Member: border_colors
  {
    cdr << ros_message.border_colors;
  }
  // Member: lane_width
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::LaneById & ros_message)
{
  // Member: id
  ...
  size_t current_alignment)
{
  ...
  // Member: border_types
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.border_types[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: border_colors
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.border_colors[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: lane_width
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::LaneById;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::LaneById *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::LaneById *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneById__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::LaneById *>(
...
static size_t _LaneById__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LaneById(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LaneById__callbacks = {
...
static rosidl_message_type_support_t _LaneById__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneById__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_LaneById__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, LaneById)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_LaneById__handle;
}
