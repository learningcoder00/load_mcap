...
#include "deva_gaode_routing_msgs/msg/detail/rg_red_light_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::RGRedLightResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::RGRedLightResult & ros_message)
{
  // Member: raw_link_id
  cdr >> ros_message.raw_link_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_gaode_routing_msgs
max_serialized_size_RGRedLightResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::RGRedLightResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::RGRedLightResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::RGRedLightResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RGRedLightResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::RGRedLightResult *>(
...
static size_t _RGRedLightResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RGRedLightResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RGRedLightResult__callbacks = {
...
static rosidl_message_type_support_t _RGRedLightResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RGRedLightResult__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_RGRedLightResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, RGRedLightResult)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_RGRedLightResult__handle;
}
