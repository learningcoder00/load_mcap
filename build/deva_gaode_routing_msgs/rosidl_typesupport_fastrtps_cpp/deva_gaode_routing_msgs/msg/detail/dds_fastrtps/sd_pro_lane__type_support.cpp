...
#include "deva_gaode_routing_msgs/msg/detail/sd_pro_lane__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_gaode_routing_msgs::msg::SdProLaneTopo &,
...
// functions for deva_gaode_routing_msgs::msg::SdProLaneTopo already declared above
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::SdProLane & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::SdProLane & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  // Member: pre_lanes
  {
    ...
    ros_message.pre_lanes.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.pre_lanes[i]);
    }
  }
  ...
  // Member: next_lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.next_lanes[index], current_alignment);
    }
  }
  // Member: pre_lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.pre_lanes[index], current_alignment);
    }
  }
  // Member: transition
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: next_lanes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SdProLaneTopo(
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::SdProLane;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::SdProLane *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::SdProLane *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SdProLane__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::SdProLane *>(
...
static size_t _SdProLane__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SdProLane(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SdProLane__callbacks = {
...
static rosidl_message_type_support_t _SdProLane__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SdProLane__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_SdProLane__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, SdProLane)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_SdProLane__handle;
}
