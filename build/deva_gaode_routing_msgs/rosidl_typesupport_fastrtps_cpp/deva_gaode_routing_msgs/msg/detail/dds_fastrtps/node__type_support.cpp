...
#include "deva_gaode_routing_msgs/msg/detail/node__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: links_enter_cross
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.links_enter_cross[i],
        cdr);
    }
  }
  // Member: links_out
  ...
  deva_gaode_routing_msgs::msg::Node & ros_message)
{
  ...
  // Member: links_enter
  {
    ...
    ros_message.links_enter.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.links_enter[i]);
    }
  }
  ...
  // Member: links_enter_cross
  {
    ...
    ros_message.links_enter_cross.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.links_enter_cross[i]);
    }
  }
  ...
  // Member: links_out
  {
    ...
    ros_message.links_out.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.links_out[i]);
    }
  }
  ...
  // Member: links_out_cross
  {
    ...
    ros_message.links_out_cross.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.links_out_cross[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: links_enter
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.links_enter[index], current_alignment);
    }
  }
  // Member: links_enter_cross
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.links_enter_cross[index], current_alignment);
    }
  }
  // Member: links_out
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.links_out[index], current_alignment);
    }
  }
  // Member: links_out_cross
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.links_out_cross[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::Node;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::Node *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::Node *>(
    untyped_ros_message);
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_Node__handle;
}
