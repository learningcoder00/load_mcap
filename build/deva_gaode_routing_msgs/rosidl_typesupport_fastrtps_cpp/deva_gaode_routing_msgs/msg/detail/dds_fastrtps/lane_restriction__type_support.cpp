...
#include "deva_gaode_routing_msgs/msg/detail/lane_restriction__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::LaneRestriction & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.limit_vehicle_type;
  }
  // Member: special_time_type
  {
    cdr << ros_message.special_time_type;
  }
  // Member: restrict_time_period
  cdr << ros_message.restrict_time_period;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::LaneRestriction & ros_message)
{
  // Member: id
  ...
  size_t current_alignment)
{
  ...
  // Member: limit_vehicle_type
  {
    ...
    size_t item_size = sizeof(ros_message.limit_vehicle_type[0]);
  ...
  // Member: special_time_type
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.special_time_type[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: restrict_time_period
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::LaneRestriction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::LaneRestriction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::LaneRestriction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LaneRestriction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::LaneRestriction *>(
...
static size_t _LaneRestriction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LaneRestriction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LaneRestriction__callbacks = {
...
static rosidl_message_type_support_t _LaneRestriction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LaneRestriction__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_LaneRestriction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, LaneRestriction)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_LaneRestriction__handle;
}
