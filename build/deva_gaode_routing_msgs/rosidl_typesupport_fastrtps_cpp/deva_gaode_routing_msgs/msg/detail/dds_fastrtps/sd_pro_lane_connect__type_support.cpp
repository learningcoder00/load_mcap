...
#include "deva_gaode_routing_msgs/msg/detail/sd_pro_lane_connect__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::SdProLaneConnect & ros_message,
  ...
  // Member: connect_restriction
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.connect_restriction[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::SdProLaneConnect & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  // Member: connect_restriction
  {
    ...
    ros_message.connect_restriction.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.connect_restriction[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: pass_road_ids
  {
    ...
    size_t item_size = sizeof(ros_message.pass_road_ids[0]);
  ...
  // Member: connect_restriction
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.connect_restriction[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::SdProLaneConnect;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::SdProLaneConnect *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::SdProLaneConnect *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SdProLaneConnect__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::SdProLaneConnect *>(
...
static size_t _SdProLaneConnect__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SdProLaneConnect(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SdProLaneConnect__callbacks = {
...
static rosidl_message_type_support_t _SdProLaneConnect__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SdProLaneConnect__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_SdProLaneConnect__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, SdProLaneConnect)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_SdProLaneConnect__handle;
}
