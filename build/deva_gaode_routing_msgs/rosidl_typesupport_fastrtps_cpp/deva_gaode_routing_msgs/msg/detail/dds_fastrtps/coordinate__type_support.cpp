...
#include "deva_gaode_routing_msgs/msg/detail/coordinate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::Coordinate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::Coordinate & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  // Member: relative_z
  {
    size_t item_size = sizeof(ros_message.relative_z);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::Coordinate;
    is_plain =
      (
      offsetof(DataType, relative_z) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::Coordinate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::Coordinate *>(
    untyped_ros_message);
...
get_message_type_support_handle<deva_gaode_routing_msgs::msg::Coordinate>()
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, Coordinate)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
