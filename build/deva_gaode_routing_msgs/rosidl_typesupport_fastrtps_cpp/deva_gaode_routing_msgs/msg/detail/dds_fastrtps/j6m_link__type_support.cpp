...
#include "deva_gaode_routing_msgs/msg/detail/j6m_link__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::J6mLink & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: successor_linkid_s
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.successor_linkid_s[i],
        cdr);
    }
  }
  // Member: predecessor_linkid_s
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.predecessor_linkid_s[i],
        cdr);
    }
  }
  // Member: referenced_lane_id_s
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.referenced_lane_id_s[i],
        cdr);
    }
  }
  // Member: referenced_intersection_id_s
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.referenced_intersection_id_s[i],
        cdr);
    }
  }
  // Member: referenced_lanemarking_id_s
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.referenced_lanemarking_id_s[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::J6mLink & ros_message)
{
  // Member: id
  ...
  // Member: successor_linkid_s
  {
    ...
    ros_message.successor_linkid_s.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.successor_linkid_s[i]);
    }
  }
  ...
  // Member: predecessor_linkid_s
  {
    ...
    ros_message.predecessor_linkid_s.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.predecessor_linkid_s[i]);
    }
  }
  ...
  // Member: referenced_lane_id_s
  {
    ...
    ros_message.referenced_lane_id_s.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.referenced_lane_id_s[i]);
    }
  }
  ...
  // Member: referenced_intersection_id_s
  {
    ...
    ros_message.referenced_intersection_id_s.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.referenced_intersection_id_s[i]);
    }
  }
  ...
  // Member: referenced_lanemarking_id_s
  {
    ...
    ros_message.referenced_lanemarking_id_s.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.referenced_lanemarking_id_s[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: successor_linkid_s
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.successor_linkid_s[index], current_alignment);
    }
  }
  // Member: predecessor_linkid_s
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.predecessor_linkid_s[index], current_alignment);
    }
  }
  // Member: referenced_lane_id_s
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.referenced_lane_id_s[index], current_alignment);
    }
  }
  // Member: referenced_intersection_id_s
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.referenced_intersection_id_s[index], current_alignment);
    }
  }
  // Member: referenced_lanemarking_id_s
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.referenced_lanemarking_id_s[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::J6mLink;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::J6mLink *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::J6mLink *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _J6mLink__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::J6mLink *>(
...
static size_t _J6mLink__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_J6mLink(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _J6mLink__callbacks = {
...
static rosidl_message_type_support_t _J6mLink__handle = {
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_J6mLink__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, J6mLink)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_J6mLink__handle;
}
