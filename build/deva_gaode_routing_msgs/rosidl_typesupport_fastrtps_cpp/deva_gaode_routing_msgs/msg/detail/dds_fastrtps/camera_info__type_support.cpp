...
#include "deva_gaode_routing_msgs/msg/detail/camera_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::CameraInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.camera_distance;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::CameraInfo & ros_message)
{
  // Member: camera_type
  cdr >> ros_message.camera_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: camera_type
  {
    size_t item_size = sizeof(ros_message.camera_type);
  ...
  // Member: camera_distance
  {
    size_t item_size = sizeof(ros_message.camera_distance);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::CameraInfo;
    is_plain =
      (
      offsetof(DataType, camera_distance) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::CameraInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::CameraInfo *>(
    untyped_ros_message);
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_CameraInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, CameraInfo)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_CameraInfo__handle;
}
