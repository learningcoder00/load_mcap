...
#include "deva_gaode_routing_msgs/msg/detail/j6m_lane_marking__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: lane_marking_coordinates
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.lane_marking_coordinates[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::J6mLaneMarking & ros_message)
{
  // Member: lane_marking_id
  ...
  // Member: lane_marking_coordinates
  {
    ...
    ros_message.lane_marking_coordinates.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.lane_marking_coordinates[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: lane_marking_coordinates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.lane_marking_coordinates[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::J6mLaneMarking;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::J6mLaneMarking *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::J6mLaneMarking *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _J6mLaneMarking__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::J6mLaneMarking *>(
...
static size_t _J6mLaneMarking__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_J6mLaneMarking(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _J6mLaneMarking__callbacks = {
...
static rosidl_message_type_support_t _J6mLaneMarking__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_J6mLaneMarking__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_J6mLaneMarking__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, J6mLaneMarking)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_J6mLaneMarking__handle;
}
