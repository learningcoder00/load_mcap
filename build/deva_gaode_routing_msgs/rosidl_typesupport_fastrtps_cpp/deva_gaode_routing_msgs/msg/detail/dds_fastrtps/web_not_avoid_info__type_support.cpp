...
#include "deva_gaode_routing_msgs/msg/detail/web_not_avoid_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::WebNotAvoidInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: coord_2d
  deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.coord_2d,
    cdr);
  // Member: dist_to_car
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::WebNotAvoidInfo & ros_message)
{
  // Member: coord_2d
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_deva_gaode_routing_msgs
max_serialized_size_WebNotAvoidInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::WebNotAvoidInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::WebNotAvoidInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::WebNotAvoidInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WebNotAvoidInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::WebNotAvoidInfo *>(
...
static size_t _WebNotAvoidInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WebNotAvoidInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WebNotAvoidInfo__callbacks = {
...
static rosidl_message_type_support_t _WebNotAvoidInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WebNotAvoidInfo__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_WebNotAvoidInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, WebNotAvoidInfo)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_WebNotAvoidInfo__handle;
}
