...
#include "deva_gaode_routing_msgs/msg/detail/feature_point_by_id__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::FeaturePointById & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: lane_id_s
  {
    size_t size = ros_message.lane_id_s.size();
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.lane_id_s[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::FeaturePointById & ros_message)
{
  // Member: id
  ...
  // Member: lane_id_s
  {
    ...
    ros_message.lane_id_s.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.lane_id_s[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: lane_id_s
  {
    size_t array_size = ros_message.lane_id_s.size();
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.lane_id_s[index], current_alignment);
    }
  }
  // Member: previous_id_s
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::FeaturePointById;
    is_plain =
      (
...
static bool _FeaturePointById__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::FeaturePointById *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _FeaturePointById__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::FeaturePointById *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FeaturePointById__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::FeaturePointById *>(
...
static size_t _FeaturePointById__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_FeaturePointById(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FeaturePointById__callbacks = {
  "deva_gaode_routing_msgs::msg",
  "FeaturePointById",
  _FeaturePointById__cdr_serialize,
  _FeaturePointById__cdr_deserialize,
  _FeaturePointById__get_serialized_size,
  _FeaturePointById__max_serialized_size
};

static rosidl_message_type_support_t _FeaturePointById__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FeaturePointById__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_FeaturePointById__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, FeaturePointById)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_FeaturePointById__handle;
}
