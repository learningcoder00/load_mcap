...
#include "deva_gaode_routing_msgs/msg/detail/stop_line__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::StopLine & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: related_lane_ids
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.related_lane_ids[i],
        cdr);
    }
  }
  // Member: related_intersection_road_ids
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.related_intersection_road_ids[i],
        cdr);
    }
  }
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::StopLine & ros_message)
{
  // Member: id
  ...
  // Member: related_lane_ids
  {
    ...
    ros_message.related_lane_ids.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.related_lane_ids[i]);
    }
  }
  ...
  // Member: related_intersection_road_ids
  {
    ...
    ros_message.related_intersection_road_ids.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.related_intersection_road_ids[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: related_lane_ids
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.related_lane_ids[index], current_alignment);
    }
  }
  // Member: related_intersection_road_ids
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.related_intersection_road_ids[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::StopLine;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::StopLine *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::StopLine *>(
    untyped_ros_message);
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_StopLine__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, StopLine)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_StopLine__handle;
}
