...
#include "deva_gaode_routing_msgs/msg/detail/sd_pro_path_split__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_gaode_routing_msgs::msg::SdProSplitList &,
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::SdProPathSplit & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::SdProPathSplit & ros_message)
{
  // Member: path_id
  cdr >> ros_message.path_id;
  ...
  // Member: split_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.split_list[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: split_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SdProSplitList(
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::SdProPathSplit;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::SdProPathSplit *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::SdProPathSplit *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SdProPathSplit__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::SdProPathSplit *>(
...
static size_t _SdProPathSplit__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SdProPathSplit(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SdProPathSplit__callbacks = {
...
static rosidl_message_type_support_t _SdProPathSplit__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SdProPathSplit__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_SdProPathSplit__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, SdProPathSplit)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_SdProPathSplit__handle;
}
