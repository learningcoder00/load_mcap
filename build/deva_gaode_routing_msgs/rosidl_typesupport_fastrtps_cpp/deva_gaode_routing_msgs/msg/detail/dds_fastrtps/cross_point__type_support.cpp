...
#include "deva_gaode_routing_msgs/msg/detail/cross_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::CrossPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::CrossPoint & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::CrossPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::CrossPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::CrossPoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CrossPoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::CrossPoint *>(
...
static size_t _CrossPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CrossPoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CrossPoint__callbacks = {
...
static rosidl_message_type_support_t _CrossPoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CrossPoint__callbacks,
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_CrossPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, CrossPoint)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_CrossPoint__handle;
}
