...
#include "deva_gaode_routing_msgs/msg/detail/web_road__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const deva_gaode_routing_msgs::msg::WebIntersection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_WebIntersection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const deva_gaode_routing_msgs::msg::WebRoad & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: intersection_msg
  {
    ...
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.intersection_msg[i],
        cdr);
    }
  }
  // Member: lane_num
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  deva_gaode_routing_msgs::msg::WebRoad & ros_message)
{
  // Member: has_traffic_light
  {
    uint8_t tmp;
  ...
  // Member: intersection_msg
  {
    ...
    ros_message.intersection_msg.resize(size);
    for (size_t i = 0; i < size; i++) {
      deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.intersection_msg[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: coord_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.coord_list[index], current_alignment);
    }
  }
  // Member: traffic_status
  {
  ...
  // Member: intersection_msg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.intersection_msg[index], current_alignment);
    }
  }
  // Member: lane_num
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: intersection_msg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_WebIntersection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs::msg::WebRoad;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::WebRoad *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deva_gaode_routing_msgs::msg::WebRoad *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WebRoad__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const deva_gaode_routing_msgs::msg::WebRoad *>(
...
static size_t _WebRoad__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WebRoad(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WebRoad__callbacks = {
...
static rosidl_message_type_support_t _WebRoad__handle = {
...
{
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_WebRoad__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deva_gaode_routing_msgs, msg, WebRoad)() {
  return &deva_gaode_routing_msgs::msg::typesupport_fastrtps_cpp::_WebRoad__handle;
}
