...
bool deva_gaode_routing_msgs__msg__link_id_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._link_id_type.LinkIDType", full_classname_dest, 52) == 0);
  }
  deva_gaode_routing_msgs__msg__LinkIDType * ros_message = _ros_message;
  {  // tile_id
...
{
  /* NOTE(esteve): Call constructor of LinkIDType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._link_id_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinkIDType");
