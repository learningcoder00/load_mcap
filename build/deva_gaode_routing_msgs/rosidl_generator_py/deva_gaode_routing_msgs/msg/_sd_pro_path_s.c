...
bool deva_gaode_routing_msgs__msg__sd_pro_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._sd_pro_path.SdProPath", full_classname_dest, 50) == 0);
  }
  deva_gaode_routing_msgs__msg__SdProPath * ros_message = _ros_message;
  {  // path_id
...
{
  /* NOTE(esteve): Call constructor of SdProPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._sd_pro_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SdProPath");
