...
bool deva_gaode_routing_msgs__msg__link_curvature__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._link_curvature.LinkCurvature", full_classname_dest, 57) == 0);
  }
  deva_gaode_routing_msgs__msg__LinkCurvature * ros_message = _ros_message;
  {  // offset
  ...
  {  // curvature
    ...
    assert(PyLong_Check(field));
    ros_message->curvature = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of LinkCurvature */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._link_curvature");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinkCurvature");
  ...
  {  // curvature
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->curvature);
    {
