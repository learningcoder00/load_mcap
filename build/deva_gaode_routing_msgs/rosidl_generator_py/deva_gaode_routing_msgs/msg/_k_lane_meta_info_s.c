...
bool deva_gaode_routing_msgs__msg__link_id_type__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * deva_gaode_routing_msgs__msg__link_id_type__convert_to_py(void * raw_ros_message);
bool deva_gaode_routing_msgs__msg__lane_traffic_info__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool deva_gaode_routing_msgs__msg__k_lane_meta_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._k_lane_meta_info.KLaneMetaInfo", full_classname_dest, 59) == 0);
  }
  deva_gaode_routing_msgs__msg__KLaneMetaInfo * ros_message = _ros_message;
  {  // in_link_id
  ...
  {  // lane_num_left
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_num_left");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->lane_num_left = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // lane_num_right
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_num_right");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->lane_num_right = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // lane_infos
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_infos");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'lane_infos'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_gaode_routing_msgs__msg__LaneTrafficInfo__Sequence__init(&(ros_message->lane_infos), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_gaode_routing_msgs__msg__LaneTrafficInfo__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_gaode_routing_msgs__msg__LaneTrafficInfo * dest = ros_message->lane_infos.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_gaode_routing_msgs__msg__lane_traffic_info__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // lane_topos
    PyObject * field = PyObject_GetAttrString(_pymsg, "lane_topos");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'lane_topos'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!deva_gaode_routing_msgs__msg__LaneTopo__Sequence__init(&(ros_message->lane_topos), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create deva_gaode_routing_msgs__msg__LaneTopo__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    deva_gaode_routing_msgs__msg__LaneTopo * dest = ros_message->lane_topos.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_gaode_routing_msgs__msg__lane_topo__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of KLaneMetaInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._k_lane_meta_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KLaneMetaInfo");
  ...
  {  // lane_num_left
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->lane_num_left);
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_num_left", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // lane_num_right
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->lane_num_right);
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_num_right", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // lane_infos
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->lane_infos.data[i]);
      PyObject * pyitem = deva_gaode_routing_msgs__msg__lane_traffic_info__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_infos", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // lane_topos
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->lane_topos.data[i]);
      PyObject * pyitem = deva_gaode_routing_msgs__msg__lane_topo__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "lane_topos", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
