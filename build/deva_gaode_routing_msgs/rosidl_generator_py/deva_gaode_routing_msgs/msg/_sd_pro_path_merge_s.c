...
bool deva_gaode_routing_msgs__msg__sd_pro_path_merge__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._sd_pro_path_merge.SdProPathMerge", full_classname_dest, 61) == 0);
  }
  deva_gaode_routing_msgs__msg__SdProPathMerge * ros_message = _ros_message;
  {  // path_id
...
{
  /* NOTE(esteve): Call constructor of SdProPathMerge */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._sd_pro_path_merge");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SdProPathMerge");
