...
bool deva_gaode_routing_msgs__msg__feature_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deva_gaode_routing_msgs.msg._feature_point.FeaturePoint", full_classname_dest, 55) == 0);
  }
  deva_gaode_routing_msgs__msg__FeaturePoint * ros_message = _ros_message;
  {  // feature_point_id_s
  ...
  {  // feature_point_id_s_by_link_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "feature_point_id_s_by_link_id");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'feature_point_id_s_by_link_id'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    deva_gaode_routing_msgs__msg__FeatureIDType * dest = ros_message->feature_point_id_s_by_link_id.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!deva_gaode_routing_msgs__msg__feature_id_type__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // feature_point_id_by_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "feature_point_id_by_id");
    if (!field) {
      return false;
    }
    if (!deva_gaode_routing_msgs__msg__feature_point_by_id__convert_from_py(field, &ros_message->feature_point_id_by_id)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of FeaturePoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("deva_gaode_routing_msgs.msg._feature_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FeaturePoint");
  ...
  {  // feature_point_id_s_by_link_id
    ...
    deva_gaode_routing_msgs__msg__FeatureIDType * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->feature_point_id_s_by_link_id.data[i]);
      PyObject * pyitem = deva_gaode_routing_msgs__msg__feature_id_type__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "feature_point_id_s_by_link_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // feature_point_id_by_id
    PyObject * field = NULL;
    field = deva_gaode_routing_msgs__msg__feature_point_by_id__convert_to_py(&ros_message->feature_point_id_by_id);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "feature_point_id_by_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
