...
class Metaclass_WebLocParallelRoad(type):
    """Metaclass of message 'WebLocParallelRoad'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__web_loc_parallel_road
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__web_loc_parallel_road
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__web_loc_parallel_road
            cls._TYPE_SUPPORT = module.type_support_msg__msg__web_loc_parallel_road
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__web_loc_parallel_road
...
class WebLocParallelRoad(metaclass=Metaclass_WebLocParallelRoad):
    """Message class 'WebLocParallelRoad'."""
