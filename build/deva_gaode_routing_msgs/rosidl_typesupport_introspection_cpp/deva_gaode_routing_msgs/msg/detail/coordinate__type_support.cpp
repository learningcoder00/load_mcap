...
{
  new (message_memory) deva_gaode_routing_msgs::msg::Coordinate(_init);
}

void Coordinate_fini_function(void * message_memory)
{
  auto typed_message = static_cast<deva_gaode_routing_msgs::msg::Coordinate *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Coordinate_message_member_array[3] = {
  {
    ...
    offsetof(deva_gaode_routing_msgs::msg::Coordinate, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_gaode_routing_msgs::msg::Coordinate, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(deva_gaode_routing_msgs::msg::Coordinate, relative_z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coordinate_message_members = {
  ...
  3,  // number of fields
  sizeof(deva_gaode_routing_msgs::msg::Coordinate),
...
{
  return &::deva_gaode_routing_msgs::msg::rosidl_typesupport_introspection_cpp::Coordinate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deva_gaode_routing_msgs, msg, Coordinate)() {
  return &::deva_gaode_routing_msgs::msg::rosidl_typesupport_introspection_cpp::Coordinate_message_type_support_handle;
}
