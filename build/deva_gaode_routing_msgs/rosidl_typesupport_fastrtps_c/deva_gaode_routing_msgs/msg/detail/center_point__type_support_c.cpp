...
#include "deva_gaode_routing_msgs/msg/detail/center_point__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_gaode_routing_msgs/msg/detail/web_point__functions.h"  // point
...
using _CenterPoint__ros_msg_type = deva_gaode_routing_msgs__msg__CenterPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CenterPoint__ros_msg_type * ros_message = static_cast<const _CenterPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: offset
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CenterPoint__ros_msg_type * ros_message = static_cast<_CenterPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: offset
  {
    cdr >> ros_message->offset;
  }
...
static uint32_t _CenterPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__CenterPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__CenterPoint;
    is_plain =
      (
...
static size_t _CenterPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__CenterPoint(
...
static message_type_support_callbacks_t __callbacks_CenterPoint = {
...
static rosidl_message_type_support_t _CenterPoint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CenterPoint,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_gaode_routing_msgs, msg, CenterPoint)() {
  return &_CenterPoint__type_support;
}
