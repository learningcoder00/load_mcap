...
#include "deva_gaode_routing_msgs/msg/detail/rgv_tips_point_result__rosidl_typesupport_fastrtps_c.h"
...
using _RGVTipsPointResult__ros_msg_type = deva_gaode_routing_msgs__msg__RGVTipsPointResult;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RGVTipsPointResult__ros_msg_type * ros_message = static_cast<const _RGVTipsPointResult__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _RGVTipsPointResult__ros_msg_type * ros_message = static_cast<_RGVTipsPointResult__ros_msg_type *>(untyped_ros_message);
  // Field name: raw_link_id
  {
    cdr >> ros_message->raw_link_id;
  }
...
static uint32_t _RGVTipsPointResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__RGVTipsPointResult(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__RGVTipsPointResult;
    is_plain =
      (
...
static size_t _RGVTipsPointResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__RGVTipsPointResult(
...
static message_type_support_callbacks_t __callbacks_RGVTipsPointResult = {
...
static rosidl_message_type_support_t _RGVTipsPointResult__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RGVTipsPointResult,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_gaode_routing_msgs, msg, RGVTipsPointResult)() {
  return &_RGVTipsPointResult__type_support;
}
