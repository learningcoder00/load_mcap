...
#include "deva_gaode_routing_msgs/msg/detail/coordinate__rosidl_typesupport_fastrtps_c.h"
...
using _Coordinate__ros_msg_type = deva_gaode_routing_msgs__msg__Coordinate;
...
static uint32_t _Coordinate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__Coordinate(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__Coordinate;
    is_plain =
      (
...
static size_t _Coordinate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__Coordinate(
