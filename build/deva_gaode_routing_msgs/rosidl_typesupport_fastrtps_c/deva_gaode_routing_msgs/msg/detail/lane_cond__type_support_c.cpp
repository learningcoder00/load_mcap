...
#include "deva_gaode_routing_msgs/msg/detail/lane_cond__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // special_times, vehicles
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // special_times, vehicles
...
using _LaneCond__ros_msg_type = deva_gaode_routing_msgs__msg__LaneCond;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LaneCond__ros_msg_type * ros_message = static_cast<const _LaneCond__ros_msg_type *>(untyped_ros_message);
  ...
  {
    size_t size = ros_message->special_times.size;
    auto array_ptr = ros_message->special_times.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  _LaneCond__ros_msg_type * ros_message = static_cast<_LaneCond__ros_msg_type *>(untyped_ros_message);
  // Field name: laneinfo_cond
  {
    cdr >> ros_message->laneinfo_cond;
  }
  ...
  // Field name: vehicles
  {
    ...
    if (ros_message->vehicles.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->vehicles);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->vehicles, size)) {
  ...
  // Field name: special_times
  {
    ...
    if (ros_message->special_times.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->special_times);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->special_times, size)) {
      fprintf(stderr, "failed to create array for field 'special_times'");
      return false;
    }
    auto array_ptr = ros_message->special_times.data;
    cdr.deserializeArray(array_ptr, size);
...
static uint32_t _LaneCond__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__LaneCond(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__LaneCond;
    is_plain =
      (
...
static size_t _LaneCond__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__LaneCond(
...
static message_type_support_callbacks_t __callbacks_LaneCond = {
...
static rosidl_message_type_support_t _LaneCond__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LaneCond,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_gaode_routing_msgs, msg, LaneCond)() {
  return &_LaneCond__type_support;
}
