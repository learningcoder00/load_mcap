...
#include "deva_gaode_routing_msgs/msg/detail/trfc_sign__rosidl_typesupport_fastrtps_c.h"
...
using _TrfcSign__ros_msg_type = deva_gaode_routing_msgs__msg__TrfcSign;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrfcSign__ros_msg_type * ros_message = static_cast<const _TrfcSign__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }

  // Field name: speedflag
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrfcSign__ros_msg_type * ros_message = static_cast<_TrfcSign__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _TrfcSign__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__TrfcSign(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__TrfcSign;
    is_plain =
      (
...
static size_t _TrfcSign__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__TrfcSign(
...
static message_type_support_callbacks_t __callbacks_TrfcSign = {
...
static rosidl_message_type_support_t _TrfcSign__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrfcSign,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_gaode_routing_msgs, msg, TrfcSign)() {
  return &_TrfcSign__type_support;
}
