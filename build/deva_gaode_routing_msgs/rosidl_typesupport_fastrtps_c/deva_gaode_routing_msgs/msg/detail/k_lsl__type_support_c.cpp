...
#include "deva_gaode_routing_msgs/msg/detail/k_lsl__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // lsl_lanes
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // lsl_lanes
...
using _KLsl__ros_msg_type = deva_gaode_routing_msgs__msg__KLsl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _KLsl__ros_msg_type * ros_message = static_cast<const _KLsl__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: lane_nums
  {
    cdr << ros_message->lane_nums;
  }

  // Field name: lsl_lanes
  {
    size_t size = ros_message->lsl_lanes.size;
    auto array_ptr = ros_message->lsl_lanes.data;
  ...
  void * untyped_ros_message)
{
  ...
  _KLsl__ros_msg_type * ros_message = static_cast<_KLsl__ros_msg_type *>(untyped_ros_message);
  // Field name: in_link_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: lsl_lanes
  {
    ...
    if (ros_message->lsl_lanes.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->lsl_lanes);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->lsl_lanes, size)) {
      fprintf(stderr, "failed to create array for field 'lsl_lanes'");
      return false;
    }
    auto array_ptr = ros_message->lsl_lanes.data;
...
static uint32_t _KLsl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__KLsl(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__KLsl;
    is_plain =
      (
...
static size_t _KLsl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__KLsl(
...
static message_type_support_callbacks_t __callbacks_KLsl = {
...
static rosidl_message_type_support_t _KLsl__type_support = {
