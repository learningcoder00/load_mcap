...
#include "deva_gaode_routing_msgs/msg/detail/routing_nav_path__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_gaode_routing_msgs/msg/detail/web_point__functions.h"  // end_point, start_point, way_points
#include "rosidl_runtime_c/string.h"  // md5, version
#include "rosidl_runtime_c/string_functions.h"  // md5, version
...
using _RoutingNavPath__ros_msg_type = deva_gaode_routing_msgs__msg__RoutingNavPath;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RoutingNavPath__ros_msg_type * ros_message = static_cast<const _RoutingNavPath__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: way_points
  {
    ...
    auto array_ptr = ros_message->way_points.data;
  ...
  void * untyped_ros_message)
{
  ...
  _RoutingNavPath__ros_msg_type * ros_message = static_cast<_RoutingNavPath__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: way_points
  {
    ...
    if (ros_message->way_points.data) {
      deva_gaode_routing_msgs__msg__WebPoint__Sequence__fini(&ros_message->way_points);
    }
    if (!deva_gaode_routing_msgs__msg__WebPoint__Sequence__init(&ros_message->way_points, size)) {
      fprintf(stderr, "failed to create array for field 'way_points'");
      return false;
    }
    auto array_ptr = ros_message->way_points.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_deva_gaode_routing_msgs__msg__RoutingNavPath(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RoutingNavPath__ros_msg_type * ros_message = static_cast<const _RoutingNavPath__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RoutingNavPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__RoutingNavPath(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deva_gaode_routing_msgs
size_t max_serialized_size_deva_gaode_routing_msgs__msg__RoutingNavPath(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__RoutingNavPath;
    is_plain =
      (
...
static size_t _RoutingNavPath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__RoutingNavPath(
...
static message_type_support_callbacks_t __callbacks_RoutingNavPath = {
...
static rosidl_message_type_support_t _RoutingNavPath__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RoutingNavPath,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_gaode_routing_msgs, msg, RoutingNavPath)() {
  return &_RoutingNavPath__type_support;
}
