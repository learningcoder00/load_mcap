...
#include "deva_gaode_routing_msgs/msg/detail/node__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_gaode_routing_msgs/msg/detail/link_id_type__functions.h"  // links_enter, links_enter_cross, links_out, links_out_cross
#include "deva_gaode_routing_msgs/msg/detail/node_id_type__functions.h"  // tpid
...
using _Node__ros_msg_type = deva_gaode_routing_msgs__msg__Node;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tpid
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->tpid, cdr))
    {
      return false;
    }
  }

  // Field name: cross_flag
  {
    cdr << ros_message->cross_flag;
  }
  ...
  // Field name: links_enter
  {
    ...
    auto array_ptr = ros_message->links_enter.data;
  ...
  // Field name: links_enter_cross
  {
    ...
    auto array_ptr = ros_message->links_enter_cross.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: links_out
  {
    ...
    auto array_ptr = ros_message->links_out.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: links_out_cross
  {
    ...
    auto array_ptr = ros_message->links_out_cross.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: links_enter
  {
    ...
    if (ros_message->links_enter.data) {
      deva_gaode_routing_msgs__msg__LinkIDType__Sequence__fini(&ros_message->links_enter);
    }
    if (!deva_gaode_routing_msgs__msg__LinkIDType__Sequence__init(&ros_message->links_enter, size)) {
      fprintf(stderr, "failed to create array for field 'links_enter'");
      return false;
    }
    auto array_ptr = ros_message->links_enter.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: links_enter_cross
  {
    ...
    if (ros_message->links_enter_cross.data) {
      deva_gaode_routing_msgs__msg__LinkIDType__Sequence__fini(&ros_message->links_enter_cross);
    }
    if (!deva_gaode_routing_msgs__msg__LinkIDType__Sequence__init(&ros_message->links_enter_cross, size)) {
      fprintf(stderr, "failed to create array for field 'links_enter_cross'");
      return false;
    }
    auto array_ptr = ros_message->links_enter_cross.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: links_out
  {
    ...
    if (ros_message->links_out.data) {
      deva_gaode_routing_msgs__msg__LinkIDType__Sequence__fini(&ros_message->links_out);
    }
    if (!deva_gaode_routing_msgs__msg__LinkIDType__Sequence__init(&ros_message->links_out, size)) {
      fprintf(stderr, "failed to create array for field 'links_out'");
      return false;
    }
    auto array_ptr = ros_message->links_out.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: links_out_cross
  {
    ...
    if (ros_message->links_out_cross.data) {
      deva_gaode_routing_msgs__msg__LinkIDType__Sequence__fini(&ros_message->links_out_cross);
    }
    if (!deva_gaode_routing_msgs__msg__LinkIDType__Sequence__init(&ros_message->links_out_cross, size)) {
      fprintf(stderr, "failed to create array for field 'links_out_cross'");
      return false;
    }
    auto array_ptr = ros_message->links_out_cross.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_deva_gaode_routing_msgs__msg__NodeIDType(
    &(ros_message->tpid), current_alignment);
  // field.name cross_flag
  {
    size_t item_size = sizeof(ros_message->cross_flag);
  ...
  // field.name links_enter
  {
    size_t array_size = ros_message->links_enter.size;
    auto array_ptr = ros_message->links_enter.data;
  ...
  // field.name links_enter_cross
  {
    size_t array_size = ros_message->links_enter_cross.size;
    auto array_ptr = ros_message->links_enter_cross.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
  ...
  // field.name links_out
  {
    size_t array_size = ros_message->links_out.size;
    auto array_ptr = ros_message->links_out.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
  ...
  // field.name links_out_cross
  {
    size_t array_size = ros_message->links_out_cross.size;
    auto array_ptr = ros_message->links_out_cross.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
...
static uint32_t _Node__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__Node(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__Node;
    is_plain =
      (
      offsetof(DataType, links_out_cross) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Node__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__Node(
