...
#include "deva_gaode_routing_msgs/msg/detail/intersection_road_node__rosidl_typesupport_fastrtps_c.h"
...
#include "deva_gaode_routing_msgs/msg/detail/feature_id_type__functions.h"  // enter_intersection_road_ids, id, out_intersection_roads_ids
...
using _IntersectionRoadNode__ros_msg_type = deva_gaode_routing_msgs__msg__IntersectionRoadNode;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IntersectionRoadNode__ros_msg_type * ros_message = static_cast<const _IntersectionRoadNode__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
  ...
  // Field name: enter_intersection_road_ids
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    auto array_ptr = ros_message->enter_intersection_road_ids.data;
  ...
  // Field name: out_intersection_roads_ids
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    auto array_ptr = ros_message->out_intersection_roads_ids.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  _IntersectionRoadNode__ros_msg_type * ros_message = static_cast<_IntersectionRoadNode__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: enter_intersection_road_ids
  {
    ...
    if (ros_message->enter_intersection_road_ids.data) {
      deva_gaode_routing_msgs__msg__FeatureIDType__Sequence__fini(&ros_message->enter_intersection_road_ids);
    }
    if (!deva_gaode_routing_msgs__msg__FeatureIDType__Sequence__init(&ros_message->enter_intersection_road_ids, size)) {
      fprintf(stderr, "failed to create array for field 'enter_intersection_road_ids'");
      return false;
    }
    auto array_ptr = ros_message->enter_intersection_road_ids.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: out_intersection_roads_ids
  {
    ...
    if (ros_message->out_intersection_roads_ids.data) {
      deva_gaode_routing_msgs__msg__FeatureIDType__Sequence__fini(&ros_message->out_intersection_roads_ids);
    }
    if (!deva_gaode_routing_msgs__msg__FeatureIDType__Sequence__init(&ros_message->out_intersection_roads_ids, size)) {
      fprintf(stderr, "failed to create array for field 'out_intersection_roads_ids'");
      return false;
    }
    auto array_ptr = ros_message->out_intersection_roads_ids.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _IntersectionRoadNode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deva_gaode_routing_msgs__msg__IntersectionRoadNode(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deva_gaode_routing_msgs__msg__IntersectionRoadNode;
    is_plain =
      (
...
static size_t _IntersectionRoadNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deva_gaode_routing_msgs__msg__IntersectionRoadNode(
...
static message_type_support_callbacks_t __callbacks_IntersectionRoadNode = {
...
static rosidl_message_type_support_t _IntersectionRoadNode__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IntersectionRoadNode,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deva_gaode_routing_msgs, msg, IntersectionRoadNode)() {
  return &_IntersectionRoadNode__type_support;
}
